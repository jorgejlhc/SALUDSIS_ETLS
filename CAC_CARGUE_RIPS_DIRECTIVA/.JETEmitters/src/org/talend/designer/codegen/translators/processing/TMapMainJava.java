...
public class TMapMainJava {
  ...
  protected final String TEXT_249 = NL + "\t\t\t\t\t\t\tif((tHash_Lookup_";
  protected final String TEXT_250 = " != null && !tHash_Lookup_";
  protected final String TEXT_251 = ".hasNext())){" + NL + "\t\t\t\t\t\t\t\ttHash_Lookup_";
  protected final String TEXT_252 = ".endGet();" + NL + "\t\t\t\t\t\t\t\ttHash_Lookup_";
  protected final String TEXT_253 = "=null;" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_254 = NL + "\t    \t        \t} // G_TM_M_250 loop \"";
  protected final String TEXT_255 = "\"" + NL + "" + NL + "\t            \t\t";
  protected final String TEXT_256 = NL + "\t            \t" + NL + "\t           \t";
  protected final String TEXT_257 = NL + "\t\t\t\t\t\tif((tHash_Lookup_";
  protected final String TEXT_258 = ".hasNext())){" + NL + "\t\t\t\t\t\t\ttHash_Lookup_";
  protected final String TEXT_259 = ".endGet();" + NL + "\t\t\t\t\t\t\ttHash_Lookup_";
  protected final String TEXT_260 = " = null;" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_261 = NL + "\t            \t" + NL + "\t            ";
  protected final String TEXT_262 = "\t\t\t\t" + NL + "\t\t\t\t\tfsi_";
  protected final String TEXT_263 = ".endGet();" + NL + "\t\t\t\t";
  protected final String TEXT_264 = " " + NL + "\t            \t" + NL + "\t            \tfsi_";
  protected final String TEXT_265 = ".endPut();" + NL + "\t            \t" + NL + "\t\t\t\t";
  protected final String TEXT_266 = NL + "                try {";
  protected final String TEXT_267 = "// ###############################";
  protected final String TEXT_268 = NL + "        { // start of Var scope" + NL + "        " + NL + "\t        // ###############################" + NL + "        \t// # Vars tables" + NL + "        ";
  protected final String TEXT_269 = NL + "        // ###############################" + NL + "        // # Output tables";
  protected final String TEXT_270 = NL;
  protected final String TEXT_271 = NL + "\t\t} catch (java.lang.Exception e) {" + NL + "\t\t\t//if anohter java.lang.Exception when processing an java.lang.Exception" + NL + "    \t\t";
  protected final String TEXT_272 = NL + "    \t\t\tlog.error(\"";
  protected final String TEXT_273 = " - \" + e.getMessage());" + NL + "    \t\t";
  protected final String TEXT_274 = NL + "\t\t\ttry{//EE";
  protected final String TEXT_275 = "                " + NL + "                ";
  protected final String TEXT_276 = "            " + NL + "               ";
  protected final String TEXT_277 = NL + "                ";
  protected final String TEXT_278 = "_tmp;";
  protected final String TEXT_279 = ".errorMessage = e.getMessage();";
  protected final String TEXT_280 = ".errorStackTrace = ResumeUtil.getExceptionStackTrace(e);" + NL + "              " + NL + "                ";
  protected final String TEXT_281 = "\t\t\t" + NL + "\t\t\t" + NL + "    ";
  protected final String TEXT_282 = "\t" + NL + "                \t\t";
  protected final String TEXT_283 = "_List.clear();" + NL + "            \t";
  protected final String TEXT_284 = "\t\t\t\t\t" + NL + "                \t\t";
  protected final String TEXT_285 = " = null;";
  protected final String TEXT_286 = NL + "         } catch (java.lang.Exception ee) {//EE" + NL + "        \t\t";
  protected final String TEXT_287 = NL + "        \t\t\tlog.error(\"";
  protected final String TEXT_288 = " - \" + ee.getMessage());" + NL + "        \t\t";
  protected final String TEXT_289 = NL + "\t\t\t\tee.printStackTrace();";
  protected final String TEXT_290 = NL + "\t\t}//EE  \t\t\t" + NL + "\t}//end catch";
  protected final String TEXT_291 = NL + NL + NL + NL + NL + NL + NL;
...
autoConverterMap.put(contact(JavaTypesManager.STRING.getId(), ":", "id_Document"), "routines.system.ParserUtils.parseTo_Document(${0})");
    ...
    stringBuffer.append(TEXT_173);
                		...
                		if(org.talend.designer.mapper.model.table.LOOKUP_MODE.RELOAD.name().equals(lookupMode) ) {
