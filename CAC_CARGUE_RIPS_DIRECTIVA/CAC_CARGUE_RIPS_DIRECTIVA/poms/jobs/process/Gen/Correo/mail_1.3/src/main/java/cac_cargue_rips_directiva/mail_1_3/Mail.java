...
package cac_cargue_rips_directiva.mail_1_3;
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_CAC_CARGUE_RIPS_DIRECTIVA_Mail = new byte[0];
    static byte[] commonByteArray_CAC_CARGUE_RIPS_DIRECTIVA_Mail = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_CAC_CARGUE_RIPS_DIRECTIVA_Mail.length) {
				if(length < 1024 && commonByteArray_CAC_CARGUE_RIPS_DIRECTIVA_Mail.length == 0) {
   					commonByteArray_CAC_CARGUE_RIPS_DIRECTIVA_Mail = new byte[1024];
				} else {
   					commonByteArray_CAC_CARGUE_RIPS_DIRECTIVA_Mail = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_CAC_CARGUE_RIPS_DIRECTIVA_Mail, 0, length);
			strReturn = new String(commonByteArray_CAC_CARGUE_RIPS_DIRECTIVA_Mail, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_CAC_CARGUE_RIPS_DIRECTIVA_Mail, 0, length);
			strReturn = new String(commonByteArray_CAC_CARGUE_RIPS_DIRECTIVA_Mail, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_CAC_CARGUE_RIPS_DIRECTIVA_Mail) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Mail.class.getClassLoader().getResourceAsStream("cac_cargue_rips_directiva/mail_1_3/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     142374 characters generated by Talend Open Studio for ESB 
 *     on the October 28, 2024, 11:25:44 AM COT
 ************************************************************************************************/