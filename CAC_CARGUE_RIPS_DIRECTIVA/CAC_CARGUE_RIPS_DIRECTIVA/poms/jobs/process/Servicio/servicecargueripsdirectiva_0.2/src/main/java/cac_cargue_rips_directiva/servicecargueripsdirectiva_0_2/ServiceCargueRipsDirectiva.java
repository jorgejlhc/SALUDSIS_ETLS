...
package cac_cargue_rips_directiva.servicecargueripsdirectiva_0_2;
...
/**
 * Job: ServiceCargueRipsDirectiva Purpose: <br>
 * Description:  <br>
 * @author jorgejlhc@gmail.com
 * @version 8.8.8.20240722_1936-SNAPSHOT
 * @status 
 */
public class ServiceCargueRipsDirectiva implements TalendJob {
...
public BigDecimal getIdSolicitud(){
	...
	private final String jobName = "ServiceCargueRipsDirectiva";
	private final String projectName = "CAC_CARGUE_RIPS_DIRECTIVA";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ServiceCargueRipsDirectiva.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ServiceCargueRipsDirectiva.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class RestServiceProviderImpl4TalendJob {
	...
	private final ServiceCargueRipsDirectiva job;

	public RestServiceProviderImpl4TalendJob(ServiceCargueRipsDirectiva job) {
		this.job = job;
	}

	private void populateRequestWithJobContext(java.util.Map<String, Object> requestGlobalMap, ServiceCargueRipsDirectiva job) {
...
class Thread4RestServiceProviderEndpoint extends Thread {
	...
	public Thread4RestServiceProviderEndpoint(ServiceCargueRipsDirectiva job, String endpointUrl) {
		this.job = job;
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression, String jobName)
			...
			java.io.InputStream inContext = ServiceCargueRipsDirectiva.class.getClassLoader()
					.getResourceAsStream("cac_cargue_rips_directiva/servicecargueripsdirectiva_0_2/contexts/" + currentContext  + ".properties");
			if (inContext == null) {
				inContext = ServiceCargueRipsDirectiva.class.getClassLoader()
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_CAC_CARGUE_RIPS_DIRECTIVA_ServiceCargueRipsDirectiva = new byte[0];
    static byte[] commonByteArray_CAC_CARGUE_RIPS_DIRECTIVA_ServiceCargueRipsDirectiva = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_CAC_CARGUE_RIPS_DIRECTIVA_ServiceCargueRipsDirectiva) {
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_CAC_CARGUE_RIPS_DIRECTIVA_ServiceCargueRipsDirectiva.length) {
				if(length < 1024 && commonByteArray_CAC_CARGUE_RIPS_DIRECTIVA_ServiceCargueRipsDirectiva.length == 0) {
   					commonByteArray_CAC_CARGUE_RIPS_DIRECTIVA_ServiceCargueRipsDirectiva = new byte[1024];
				} else {
   					commonByteArray_CAC_CARGUE_RIPS_DIRECTIVA_ServiceCargueRipsDirectiva = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_CAC_CARGUE_RIPS_DIRECTIVA_ServiceCargueRipsDirectiva, 0, length);
			strReturn = new String(commonByteArray_CAC_CARGUE_RIPS_DIRECTIVA_ServiceCargueRipsDirectiva, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_CAC_CARGUE_RIPS_DIRECTIVA_ServiceCargueRipsDirectiva, 0, length);
			strReturn = new String(commonByteArray_CAC_CARGUE_RIPS_DIRECTIVA_ServiceCargueRipsDirectiva, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
if (needRoot) {
	needRoot=false;
		...
		valueMap.put("root_1","Proceso de cargue rips directiva ejecuctado satisfactoriamente");
...
if (needRoot) {
	needRoot=false;
		...
		org.dom4j.Element root_1 = null;
				root_1 = root.addElement("Message");
		valueMap.put("root_1","Error de ejecución del proceso de cargue rips directiva");
		if(valueMap.get("root_1")!=null) {
			routines.system.NestXMLTool.setText(root_1,FormatterUtils.fm(valueMap.get("root_1"),null));
		}
		org.dom4j.Element root_2 = null;
...
if (needRoot) {
	needRoot=false;
		...
		org.dom4j.Element root_1 = null;
				root_1 = root.addElement("Message");
		valueMap.put("root_1","Error en el llamado del ETL de cargue rips directiva");
		if(valueMap.get("root_1")!=null) {
			routines.system.NestXMLTool.setText(root_1,FormatterUtils.fm(valueMap.get("root_1"),null));
		}
		org.dom4j.Element root_2 = null;
...
if (needRoot) {
	needRoot=false;
		...
		org.dom4j.Element root_1 = null;
				root_1 = root.addElement("Message");
		valueMap.put("root_1","El identificador de la solicitud no puede ser nulo");
		if(valueMap.get("root_1")!=null) {
			routines.system.NestXMLTool.setText(root_1, FormatterUtils.fm(valueMap.get("root_1"),null));
		}
		org.dom4j.Element root_2 = null;
...
if(in != null) { 
	...
	boolean isMatchDocRowtXMLMap_4_TXMLMAP_OUT = false;
				...
				absolutePathMappings_tXMLMap_4_TXMLMAP_OUT[0] = "in.body:/root/CargueArchivoId";
				relativePathMappings_tXMLMap_4_TXMLMAP_OUT[0] = "CargueArchivoId";
...
treeNodeAPI_tXMLMap_4_TXMLMAP_OUT.get_String("in.body:/root/CargueArchivoId") != null

 ) {

RequestOK_tmp = new RequestOKStruct();
RequestOK_tmp.IdSolicitud = treeNodeAPI_tXMLMap_4_TXMLMAP_OUT.get_String("in.body:/root/CargueArchivoId");allOutsForAggregate_tXMLMap_4.add(RequestOK_tmp);
...
context.IdSolicitud = new BigDecimal(RequestOK.IdSolicitud);
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_1 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_1 {
                    ...
                    paraList_tRunJob_1.add("--context_type " + "IdSolicitud" + "=" + "id_BigDecimal");
                        }
	...
	Object obj_tRunJob_1 = null;
		...
		if(obj_tRunJob_1!=null) {
			if (obj_tRunJob_1.getClass().getName().equals("java.util.Date")) {
				paraList_tRunJob_1.add("--context_param CargueArchivoId=" + ((java.util.Date) obj_tRunJob_1).getTime());
			} else {
				
					paraList_tRunJob_1.add("--context_param CargueArchivoId=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
					
				
			}
		} else {
			paraList_tRunJob_1.add("--context_param CargueArchivoId=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_1.put("CargueArchivoId", obj_tRunJob_1);
	
	
		cac_cargue_rips_directiva.cargue_rips_directiva_1_0.CARGUE_RIPS_DIRECTIVA childJob_tRunJob_1 = new cac_cargue_rips_directiva.cargue_rips_directiva_1_0.CARGUE_RIPS_DIRECTIVA();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final ServiceCargueRipsDirectiva ServiceCargueRipsDirectivaClass = new ServiceCargueRipsDirectiva();

        int exitCode = ServiceCargueRipsDirectivaClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ServiceCargueRipsDirectiva.class.getClassLoader().getResourceAsStream("cac_cargue_rips_directiva/servicecargueripsdirectiva_0_2/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = ServiceCargueRipsDirectiva.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
            ...
            class ContextProcessing {
                private void processContext_0() {
                        context.setContextType("IdSolicitud", "id_BigDecimal");
                        if(context.getStringValue("IdSolicitud") == null) {
                            context.IdSolicitud = null;
                        } else {
                            try{
                                context.IdSolicitud=routines.system.ParserUtils.parseTo_BigDecimal (context.getProperty("IdSolicitud"));
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("IdSolicitud")) {
                context.IdSolicitud = (BigDecimal) parentContextMap.get("IdSolicitud");
            }
        }
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ServiceCargueRipsDirectiva");
        }
...
/************************************************************************************************
 *     213626 characters generated by Talend Open Studio for ESB 
 *     on the October 28, 2024, 11:25:53 AM COT
 ************************************************************************************************/