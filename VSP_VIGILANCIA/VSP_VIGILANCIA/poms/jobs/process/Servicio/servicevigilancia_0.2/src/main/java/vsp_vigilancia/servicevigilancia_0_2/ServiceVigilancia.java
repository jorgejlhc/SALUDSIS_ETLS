...
package vsp_vigilancia.servicevigilancia_0_2;
...
/**
 * Job: ServiceVigilancia Purpose: <br>
 * Description:  <br>
 * @author jorgejlhc@gmail.com
 * @version 8.8.8.20240722_1936-SNAPSHOT
 * @status 
 */
public class ServiceVigilancia implements TalendJob {
...
public Integer getIdSolicitud(){
	...
	private final String jobName = "ServiceVigilancia";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ServiceVigilancia.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ServiceVigilancia.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class RestServiceProviderImpl4TalendJob {
	...
	private final ServiceVigilancia job;

	public RestServiceProviderImpl4TalendJob(ServiceVigilancia job) {
		this.job = job;
	}

	private void populateRequestWithJobContext(java.util.Map<String, Object> requestGlobalMap, ServiceVigilancia job) {
...
class Thread4RestServiceProviderEndpoint extends Thread {
	...
	public Thread4RestServiceProviderEndpoint(ServiceVigilancia job, String endpointUrl) {
		this.job = job;
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression, String jobName)
			...
			java.io.InputStream inContext = ServiceVigilancia.class.getClassLoader()
					.getResourceAsStream("vsp_vigilancia/servicevigilancia_0_2/contexts/" + currentContext  + ".properties");
			if (inContext == null) {
				inContext = ServiceVigilancia.class.getClassLoader()
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_VSP_VIGILANCIA_ServiceVigilancia = new byte[0];
    static byte[] commonByteArray_VSP_VIGILANCIA_ServiceVigilancia = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_VSP_VIGILANCIA_ServiceVigilancia) {
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_VSP_VIGILANCIA_ServiceVigilancia.length) {
				if(length < 1024 && commonByteArray_VSP_VIGILANCIA_ServiceVigilancia.length == 0) {
   					commonByteArray_VSP_VIGILANCIA_ServiceVigilancia = new byte[1024];
				} else {
   					commonByteArray_VSP_VIGILANCIA_ServiceVigilancia = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_VSP_VIGILANCIA_ServiceVigilancia, 0, length);
			strReturn = new String(commonByteArray_VSP_VIGILANCIA_ServiceVigilancia, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_VSP_VIGILANCIA_ServiceVigilancia, 0, length);
			strReturn = new String(commonByteArray_VSP_VIGILANCIA_ServiceVigilancia, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
if (needRoot) {
	needRoot=false;
		...
		valueMap.put("root_1","Proceso de vigilancia ejecuctado satisfactoriamente");
...
if (needRoot) {
	needRoot=false;
		...
		org.dom4j.Element root_1 = null;
				root_1 = root.addElement("Message");
		valueMap.put("root_1","Error de ejecución del proceso de vigilancia");
		if(valueMap.get("root_1")!=null) {
			routines.system.NestXMLTool.setText(root_1,FormatterUtils.fm(valueMap.get("root_1"),null));
		}
		org.dom4j.Element root_2 = null;
...
if (needRoot) {
	needRoot=false;
		...
		org.dom4j.Element root_1 = null;
				root_1 = root.addElement("Message");
		valueMap.put("root_1","Error en el llamado del ETL de vigilancia");
		if(valueMap.get("root_1")!=null) {
			routines.system.NestXMLTool.setText(root_1,FormatterUtils.fm(valueMap.get("root_1"),null));
		}
		org.dom4j.Element root_2 = null;
...
if(in != null) { 
	...
	boolean isMatchDocRowtXMLMap_4_TXMLMAP_OUT = false;
				...
				absolutePathMappings_tXMLMap_4_TXMLMAP_OUT[0] = "in.body:/root/PriorizacionId";
				relativePathMappings_tXMLMap_4_TXMLMAP_OUT[0] = "PriorizacionId";
...
treeNodeAPI_tXMLMap_4_TXMLMAP_OUT.get_String("in.body:/root/PriorizacionId") != null

 ) {

RequestOK_tmp = new RequestOKStruct();
RequestOK_tmp.IdSolicitud = treeNodeAPI_tXMLMap_4_TXMLMAP_OUT.get_String("in.body:/root/PriorizacionId");allOutsForAggregate_tXMLMap_4.add(RequestOK_tmp);
	...
	Object obj_tRunJob_1 = null;
		...
		if(obj_tRunJob_1!=null) {
			if (obj_tRunJob_1.getClass().getName().equals("java.util.Date")) {
				paraList_tRunJob_1.add("--context_param PriorizacionId=" + ((java.util.Date) obj_tRunJob_1).getTime());
			} else {
				
					paraList_tRunJob_1.add("--context_param PriorizacionId=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
					
				
			}
		} else {
			paraList_tRunJob_1.add("--context_param PriorizacionId=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_1.put("PriorizacionId", obj_tRunJob_1);
	
	
		vsp_vigilancia.etl_vigilancia_1_0.ETL_vigilancia childJob_tRunJob_1 = new vsp_vigilancia.etl_vigilancia_1_0.ETL_vigilancia();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final ServiceVigilancia ServiceVigilanciaClass = new ServiceVigilancia();

        int exitCode = ServiceVigilanciaClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ServiceVigilancia.class.getClassLoader().getResourceAsStream("vsp_vigilancia/servicevigilancia_0_2/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = ServiceVigilancia.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ServiceVigilancia");
        }
...
/************************************************************************************************
 *     211520 characters generated by Talend Open Studio for ESB 
 *     on the October 28, 2024, 3:36:44 PM COT
 ************************************************************************************************/