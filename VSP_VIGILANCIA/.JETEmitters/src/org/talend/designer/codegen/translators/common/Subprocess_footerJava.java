...
public class Subprocess_footerJava
{
  ...
  protected final String TEXT_1 = NL + "\t\t\t\t\t} catch (java.lang.Exception e) {" + NL + "\t\t\t\t\t\tthis.status = \"failure\";" + NL + "\t\t\t\t\t\tInteger localErrorCode = (Integer) (((java.util.Map) threadLocal.get()).get(\"errorCode\"));" + NL + "\t\t\t\t\t\tif (localErrorCode != null) {" + NL + "\t\t\t\t\t\t\tif (this.errorCode == null || localErrorCode.compareTo(this.errorCode) > 0) {" + NL + "\t\t\t\t\t\t\t\tthis.errorCode = localErrorCode;" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t}\t\t\t\t\t" + NL + "\t\t\t            pool.setErrorThread(this, new TalendException(e, currentComponent, cLabel, globalMap));" + NL + "\t\t\t            //pool.setErrorThread(this,e);" + NL + "\t\t\t            pool.stopAllThreads();" + NL + "\t\t\t\t\t}finally{" + NL + "\t\t\t\t\t\ttry{" + NL + "\t\t\t\t\t\t\t";
  ...
  protected final String TEXT_6 = "\"));" + NL + "\t\t\t\tpt.putBuffer(buffer);" + NL + "\t\t\t\tpool.execThread(pt);" + NL + "\t\t\t}" + NL + "\t\t} catch (InterruptedException e) {" + NL + "\t\t\te.printStackTrace();" + NL + "\t\t} catch (java.lang.Exception te) {" + NL + "\t\t\tthrow new TalendException(te, currentComponent, cLabel, globalMap);" + NL + "\t\t}" + NL + "\t";
  ...
  protected final String TEXT_28 = NL + "\t\t\t\tTalendException te = new TalendException(e, currentComponent, cLabel, globalMap);" + NL + "\t\t\t\t";
