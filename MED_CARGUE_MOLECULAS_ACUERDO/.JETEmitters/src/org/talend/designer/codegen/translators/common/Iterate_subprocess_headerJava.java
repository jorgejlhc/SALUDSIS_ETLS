...
public class Iterate_subprocess_headerJava
{
  ...
  protected final String TEXT_39 = NL + "\t\t\t\t}" + NL + "" + NL + "" + NL + "\t\t\t\tpublic void run() {" + NL + "\t\t\t\t\t";
  protected final String TEXT_40 = NL + "\t\t\t\t\t\tmdcInfo.forEach(";
  protected final String TEXT_41 = "::put);" + NL + "\t\t\t\t\t";
  protected final String TEXT_42 = NL + NL + "\t\t\t\t\tjava.util.Map threadRunResultMap = new java.util.HashMap();" + NL + "\t\t\t\t\tthreadRunResultMap.put(\"errorCode\", null);" + NL + "\t\t\t\t\tthreadRunResultMap.put(\"status\", \"\");" + NL + "\t\t\t\t\tthreadLocal.set(threadRunResultMap);" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\tthis.isRunning = true;" + NL + "\t\t\t\t\tString currentComponent = \"\";" + NL + "\t\t\t\t\tString cLabel = null;" + NL + "\t\t\t\t\tjava.util.Map<String, Object> resourceMap = new java.util.HashMap<String, Object>();" + NL + "\t\t\t\t\t";
  protected final String TEXT_43 = NL + "\t\t\t\t\t\tString currentVirtualComponent = null;" + NL + "\t\t\t\t\t";
  protected final String TEXT_44 = NL + "\t\t\t\t\ttry {\t\t\t" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_45 = NL + "\t\t\t\t\t\t\tif(execStat){" + NL + "\t\t\t\t\t\t\t\trunStat.updateStatOnConnection(\"";
  protected final String TEXT_46 = "\",0,\"exec\"+iterateId);" + NL + "\t\t\t\t\t\t\t}\t\t\t\t" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_47 = NL + "\t\t\t\t\tif(execStat){\t\t\t\t" + NL + "\t       \t\t\t\trunStat.updateStatOnConnection(\"";
  protected final String TEXT_48 = "\", 3, 0);" + NL + "\t\t\t\t\t}           \t\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_49 = NL + "\t\t\t\tif(execStat){" + NL + "\t\t\t\t\trunStat.updateStatOnIterate(\"";
  protected final String TEXT_50 = "\", RunStat.RUNNING);" + NL + "\t\t\t\t}        \t\t" + NL + "\t\t\t";
  protected final String TEXT_51 = NL + "\t\t\t\tif(execStat){" + NL + "\t\t\t\t\trunStat.updateStatOnConnection(\"";
  protected final String TEXT_52 = "\", 1, \"exec\" + NB_ITERATE_";
  protected final String TEXT_53 = ");" + NL + "\t\t\t\t\t//Thread.sleep(1000);" + NL + "\t\t\t\t}\t\t\t\t" + NL + "\t\t\t";
