...
package med_cargue_moleculas_acuerdo.servicecarguemoleculasacuerdo_0_2;
...
/**
 * Job: ServiceCargueMoleculasAcuerdo Purpose: <br>
 * Description:  <br>
 * @author jorgejlhc@gmail.com
 * @version 8.8.8.20240722_1936-SNAPSHOT
 * @status 
 */
public class ServiceCargueMoleculasAcuerdo implements TalendJob {
...
public String getResult(){
	...
	private final String jobName = "ServiceCargueMoleculasAcuerdo";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ServiceCargueMoleculasAcuerdo.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ServiceCargueMoleculasAcuerdo.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class RestServiceProviderImpl4TalendJob {
	...
	private final ServiceCargueMoleculasAcuerdo job;

	public RestServiceProviderImpl4TalendJob(ServiceCargueMoleculasAcuerdo job) {
		this.job = job;
	}

	private void populateRequestWithJobContext(java.util.Map<String, Object> requestGlobalMap, ServiceCargueMoleculasAcuerdo job) {
...
class Thread4RestServiceProviderEndpoint extends Thread {
	...
	public Thread4RestServiceProviderEndpoint(ServiceCargueMoleculasAcuerdo job, String endpointUrl) {
		this.job = job;
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression, String jobName)
			...
			java.io.InputStream inContext = ServiceCargueMoleculasAcuerdo.class.getClassLoader()
					.getResourceAsStream("med_cargue_moleculas_acuerdo/servicecarguemoleculasacuerdo_0_2/contexts/" + currentContext  + ".properties");
			if (inContext == null) {
				inContext = ServiceCargueMoleculasAcuerdo.class.getClassLoader()
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_MED_CARGUE_MOLECULAS_ACUERDO_ServiceCargueMoleculasAcuerdo = new byte[0];
    static byte[] commonByteArray_MED_CARGUE_MOLECULAS_ACUERDO_ServiceCargueMoleculasAcuerdo = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_MED_CARGUE_MOLECULAS_ACUERDO_ServiceCargueMoleculasAcuerdo) {
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_MED_CARGUE_MOLECULAS_ACUERDO_ServiceCargueMoleculasAcuerdo.length) {
				if(length < 1024 && commonByteArray_MED_CARGUE_MOLECULAS_ACUERDO_ServiceCargueMoleculasAcuerdo.length == 0) {
   					commonByteArray_MED_CARGUE_MOLECULAS_ACUERDO_ServiceCargueMoleculasAcuerdo = new byte[1024];
				} else {
   					commonByteArray_MED_CARGUE_MOLECULAS_ACUERDO_ServiceCargueMoleculasAcuerdo = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_MED_CARGUE_MOLECULAS_ACUERDO_ServiceCargueMoleculasAcuerdo, 0, length);
			strReturn = new String(commonByteArray_MED_CARGUE_MOLECULAS_ACUERDO_ServiceCargueMoleculasAcuerdo, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_MED_CARGUE_MOLECULAS_ACUERDO_ServiceCargueMoleculasAcuerdo, 0, length);
			strReturn = new String(commonByteArray_MED_CARGUE_MOLECULAS_ACUERDO_ServiceCargueMoleculasAcuerdo, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
if (needRoot) {
	needRoot=false;
		...
		valueMap.put("root_1","Proceso de cargue moleculas acuerdo ejecuctado satisfactoriamente");
...
if (needRoot) {
	needRoot=false;
		...
		org.dom4j.Element root_1 = null;
				root_1 = root.addElement("Message");
		valueMap.put("root_1","Error de ejecución del proceso de cargue moleculas acuerdo");
		if(valueMap.get("root_1")!=null) {
			routines.system.NestXMLTool.setText(root_1,FormatterUtils.fm(valueMap.get("root_1"),null));
		}
		org.dom4j.Element root_2 = null;
...
if (needRoot) {
	needRoot=false;
		...
		org.dom4j.Element root_1 = null;
				root_1 = root.addElement("Message");
		valueMap.put("root_1","Error en el llamado del ETL de cargue moleculas acuerdo");
		if(valueMap.get("root_1")!=null) {
			routines.system.NestXMLTool.setText(root_1,FormatterUtils.fm(valueMap.get("root_1"),null));
		}
		org.dom4j.Element root_2 = null;
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		med_cargue_moleculas_acuerdo.cargamoleculasacuerdo_3_3.CargaMoleculasAcuerdo childJob_tRunJob_1 = new med_cargue_moleculas_acuerdo.cargamoleculasacuerdo_3_3.CargaMoleculasAcuerdo();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final ServiceCargueMoleculasAcuerdo ServiceCargueMoleculasAcuerdoClass = new ServiceCargueMoleculasAcuerdo();

        int exitCode = ServiceCargueMoleculasAcuerdoClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ServiceCargueMoleculasAcuerdo.class.getClassLoader().getResourceAsStream("med_cargue_moleculas_acuerdo/servicecarguemoleculasacuerdo_0_2/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = ServiceCargueMoleculasAcuerdo.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ServiceCargueMoleculasAcuerdo");
        }
...
/************************************************************************************************
 *     225296 characters generated by Talend Open Studio for ESB 
 *     on the October 28, 2024, 3:09:15 PM COT
 ************************************************************************************************/