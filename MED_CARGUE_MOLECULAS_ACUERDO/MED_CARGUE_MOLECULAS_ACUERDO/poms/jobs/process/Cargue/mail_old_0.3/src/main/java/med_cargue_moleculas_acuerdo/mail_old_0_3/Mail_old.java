...
package med_cargue_moleculas_acuerdo.mail_old_0_3;
...
/**
 * Job: Mail_old Purpose: <br>
 * Description:  <br>
 * @author jorgejlhc@gmail.com
 * @version 8.8.8.20240722_1936-SNAPSHOT
 * @status 
 */
public class Mail_old implements TalendJob {
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext(){
			...
			if(TipoCarga != null){
					...
					this.setProperty("TipoCarga", TipoCarga.toString());
...
public String getHORA_INICIO(){
	...
	private final String jobName = "Mail_old";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Mail_old.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_MED_CARGUE_MOLECULAS_ACUERDO_Mail_old = new byte[0];
    static byte[] commonByteArray_MED_CARGUE_MOLECULAS_ACUERDO_Mail_old = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_MED_CARGUE_MOLECULAS_ACUERDO_Mail_old.length) {
				if(length < 1024 && commonByteArray_MED_CARGUE_MOLECULAS_ACUERDO_Mail_old.length == 0) {
   					commonByteArray_MED_CARGUE_MOLECULAS_ACUERDO_Mail_old = new byte[1024];
				} else {
   					commonByteArray_MED_CARGUE_MOLECULAS_ACUERDO_Mail_old = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_MED_CARGUE_MOLECULAS_ACUERDO_Mail_old, 0, length);
			strReturn = new String(commonByteArray_MED_CARGUE_MOLECULAS_ACUERDO_Mail_old, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_MED_CARGUE_MOLECULAS_ACUERDO_Mail_old, 0, length);
			strReturn = new String(commonByteArray_MED_CARGUE_MOLECULAS_ACUERDO_Mail_old, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_MED_CARGUE_MOLECULAS_ACUERDO_Mail_old) {
...
java.util.Map<Integer,org.dom4j.XPath> xpaths_tFileInputXML_1=new java.util.HashMap<Integer,org.dom4j.XPath>();
	...
	org.dom4j.XPath xpath_6 = org.dom4j.DocumentHelper.createXPath(nsTool.addDefaultNSPrefix("SMTPHost","/connectionStrings"));
	xpath_6.setNamespaceURIs(xmlNameSpaceMap);
	
			xpaths.put(6,xpath_6);
			
	org.dom4j.XPath xpath_7 = org.dom4j.DocumentHelper.createXPath(nsTool.addDefaultNSPrefix("SMTPPort","/connectionStrings"));
	xpath_7.setNamespaceURIs(xmlNameSpaceMap);
	
			xpaths.put(7,xpath_7);
			
	org.dom4j.XPath xpath_8 = org.dom4j.DocumentHelper.createXPath(nsTool.addDefaultNSPrefix("UsernameMail","/connectionStrings"));
	xpath_8.setNamespaceURIs(xmlNameSpaceMap);
	
			xpaths.put(8,xpath_8);
			
	org.dom4j.XPath xpath_9 = org.dom4j.DocumentHelper.createXPath(nsTool.addDefaultNSPrefix("PasswordMail","/connectionStrings"));
 ...
 */
    ...
    String subject_tSendMail_1 = (context.mail_Subject + " - " + context.TipoCarga);
	...
	props_tSendMail_1.put("mail.smtp.port", smtpPort_tSendMail_1);
		...
		props_tSendMail_1.put("mail.smtp.localhost", "localhost");
 ...
 */
    ...
    public static void main(String[] args){
        final Mail_old Mail_oldClass = new Mail_old();

        int exitCode = Mail_oldClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Mail_old.class.getClassLoader().getResourceAsStream("med_cargue_moleculas_acuerdo/mail_old_0_3/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Mail_old.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
            ...
            class ContextProcessing {
                private void processContext_0() {
                        ...
                        context.setContextType("TipoCarga", "id_String");
                        if(context.getStringValue("TipoCarga") == null) {
                            context.TipoCarga = null;
                        } else {
                            context.TipoCarga=(String) context.getProperty("TipoCarga");
                        }
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("moment")) {
            ...
            }if (parentContextMap.containsKey("TipoCarga")) {
                context.TipoCarga = (String) parentContextMap.get("TipoCarga");
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Mail_old");
        }
...
/************************************************************************************************
 *     114003 characters generated by Talend Open Studio for ESB 
 *     on the October 28, 2024, 3:09:07 PM COT
 ************************************************************************************************/