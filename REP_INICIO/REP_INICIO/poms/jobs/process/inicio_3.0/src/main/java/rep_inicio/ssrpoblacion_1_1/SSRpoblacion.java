...
package rep_inicio.ssrpoblacion_1_1;
...
public static class row32Struct implements routines.system.IPersistableRow<row32Struct> {
    final static byte[] commonByteArrayLock_REP_INICIO_SSRpoblacion = new byte[0];
    static byte[] commonByteArray_REP_INICIO_SSRpoblacion = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_REP_INICIO_SSRpoblacion.length) {
				if(length < 1024 && commonByteArray_REP_INICIO_SSRpoblacion.length == 0) {
   					commonByteArray_REP_INICIO_SSRpoblacion = new byte[1024];
				} else {
   					commonByteArray_REP_INICIO_SSRpoblacion = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_REP_INICIO_SSRpoblacion, 0, length);
			strReturn = new String(commonByteArray_REP_INICIO_SSRpoblacion, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_REP_INICIO_SSRpoblacion, 0, length);
			strReturn = new String(commonByteArray_REP_INICIO_SSRpoblacion, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_REP_INICIO_SSRpoblacion) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = SSRpoblacion.class.getClassLoader().getResourceAsStream("rep_inicio/ssrpoblacion_1_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     803317 characters generated by Talend Open Studio for ESB 
 *     on the October 28, 2024, 11:47:19 AM COT
 ************************************************************************************************/