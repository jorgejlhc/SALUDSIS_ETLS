...
package rep_inicio.carnetsgenerados_1_0;
...
public static class row7Struct implements routines.system.IPersistableRow<row7Struct> {
    final static byte[] commonByteArrayLock_REP_INICIO_CarnetsGenerados = new byte[0];
    static byte[] commonByteArray_REP_INICIO_CarnetsGenerados = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_REP_INICIO_CarnetsGenerados.length) {
				if(length < 1024 && commonByteArray_REP_INICIO_CarnetsGenerados.length == 0) {
   					commonByteArray_REP_INICIO_CarnetsGenerados = new byte[1024];
				} else {
   					commonByteArray_REP_INICIO_CarnetsGenerados = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_REP_INICIO_CarnetsGenerados, 0, length);
			strReturn = new String(commonByteArray_REP_INICIO_CarnetsGenerados, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_REP_INICIO_CarnetsGenerados, 0, length);
			strReturn = new String(commonByteArray_REP_INICIO_CarnetsGenerados, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_REP_INICIO_CarnetsGenerados) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = CarnetsGenerados.class.getClassLoader().getResourceAsStream("rep_inicio/carnetsgenerados_1_0/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     466802 characters generated by Talend Open Studio for ESB 
 *     on the October 28, 2024, 11:47:13 AM COT
 ************************************************************************************************/