...
package rep_inicio.vacunacion_1_1;
...
public static class row41Struct implements routines.system.IPersistableRow<row41Struct> {
    final static byte[] commonByteArrayLock_REP_INICIO_Vacunacion = new byte[0];
    static byte[] commonByteArray_REP_INICIO_Vacunacion = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_REP_INICIO_Vacunacion.length) {
				if(length < 1024 && commonByteArray_REP_INICIO_Vacunacion.length == 0) {
   					commonByteArray_REP_INICIO_Vacunacion = new byte[1024];
				} else {
   					commonByteArray_REP_INICIO_Vacunacion = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_REP_INICIO_Vacunacion, 0, length);
			strReturn = new String(commonByteArray_REP_INICIO_Vacunacion, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_REP_INICIO_Vacunacion, 0, length);
			strReturn = new String(commonByteArray_REP_INICIO_Vacunacion, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_REP_INICIO_Vacunacion) {
...
//context.FANTERIOR = TalendDate.formatDate("dd-MM-YYYY",TalendDate.addDate(TalendDate.getCurrentDate(),-2,"DD"));
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Vacunacion.class.getClassLoader().getResourceAsStream("rep_inicio/vacunacion_1_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     700203 characters generated by Talend Open Studio for ESB 
 *     on the October 28, 2024, 11:47:18 AM COT
 ************************************************************************************************/