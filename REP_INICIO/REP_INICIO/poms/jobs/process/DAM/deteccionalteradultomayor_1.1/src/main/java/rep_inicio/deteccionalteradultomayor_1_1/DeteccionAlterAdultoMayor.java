...
package rep_inicio.deteccionalteradultomayor_1_1;
...
public static class row6Struct implements routines.system.IPersistableRow<row6Struct> {
    final static byte[] commonByteArrayLock_REP_INICIO_DeteccionAlterAdultoMayor = new byte[0];
    static byte[] commonByteArray_REP_INICIO_DeteccionAlterAdultoMayor = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_REP_INICIO_DeteccionAlterAdultoMayor.length) {
				if(length < 1024 && commonByteArray_REP_INICIO_DeteccionAlterAdultoMayor.length == 0) {
   					commonByteArray_REP_INICIO_DeteccionAlterAdultoMayor = new byte[1024];
				} else {
   					commonByteArray_REP_INICIO_DeteccionAlterAdultoMayor = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_REP_INICIO_DeteccionAlterAdultoMayor, 0, length);
			strReturn = new String(commonByteArray_REP_INICIO_DeteccionAlterAdultoMayor, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_REP_INICIO_DeteccionAlterAdultoMayor, 0, length);
			strReturn = new String(commonByteArray_REP_INICIO_DeteccionAlterAdultoMayor, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_REP_INICIO_DeteccionAlterAdultoMayor) {
 ...
 */
	...
	currentComponent="tUnite_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"out2","out3");
					}
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = DeteccionAlterAdultoMayor.class.getClassLoader().getResourceAsStream("rep_inicio/deteccionalteradultomayor_1_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     674189 characters generated by Talend Open Studio for ESB 
