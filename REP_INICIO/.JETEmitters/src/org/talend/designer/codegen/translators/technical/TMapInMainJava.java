...
public class TMapInMainJava {
  ...
  protected final String TEXT_270 = NL + "\t\t} catch (java.lang.Exception e) {" + NL + "\t\t\t//if anohter java.lang.Exception when processing an java.lang.Exception" + NL + "    \t\t";
  protected final String TEXT_271 = NL + "    \t\t\tlog.error(\"";
  protected final String TEXT_272 = " - \" + e.getMessage());" + NL + "    \t\t";
  protected final String TEXT_273 = NL + "\t\t\ttry{//EE";
  protected final String TEXT_274 = "                " + NL + "                ";
  protected final String TEXT_275 = "            " + NL + "               ";
  protected final String TEXT_276 = NL + "                ";
  protected final String TEXT_277 = "_tmp;";
  protected final String TEXT_278 = ".errorMessage = e.getMessage();";
  protected final String TEXT_279 = ".errorStackTrace = ResumeUtil.getExceptionStackTrace(e);" + NL + "              " + NL + "                ";
  protected final String TEXT_280 = "\t\t\t" + NL + "\t\t\t" + NL + "    ";
  protected final String TEXT_281 = "\t" + NL + "                \t\t";
  protected final String TEXT_282 = "_List.clear();" + NL + "            \t";
  protected final String TEXT_283 = "\t\t\t\t\t" + NL + "                \t\t";
  protected final String TEXT_284 = " = null;";
  protected final String TEXT_285 = NL + "         } catch (java.lang.Exception ee) {//EE" + NL + "        \t\t";
  protected final String TEXT_286 = NL + "        \t\t\tlog.error(\"";
  protected final String TEXT_287 = " - \" + ee.getMessage());" + NL + "        \t\t";
  protected final String TEXT_288 = NL + "\t\t\t\tee.printStackTrace();";
  protected final String TEXT_289 = NL + "\t\t}//EE  \t\t\t" + NL + "\t}//end catch";
  protected final String TEXT_290 = NL + NL + NL + NL;
