...
public class TMapInBeginJava {
  ...
  protected final String TEXT_151 = ") objectIn.readObject();" + NL + "\t\t\t\t\t";
  ...
  protected final String TEXT_189 = NL + "\t\t\t\t\t\tobjectOut.clearInstanceCache();" + NL + "\t\t\t\t\t\tobjectOut.writeObject(this.";
  protected final String TEXT_190 = " == null) {" + NL + "\t\t\t                objectOut.writeByte(-1);" + NL + "\t\t\t\t\t\t} else {" + NL + "               \t\t\t\tobjectOut.writeByte(0);" + NL + "           \t\t\t    \t";
  protected final String TEXT_191 = NL + "           \t\t\t\t\t\t\tobjectOut.clearInstanceCache();" + NL + "           \t\t\t\t\t\t\tobjectOut.writeObject(this.";
  ...
  protected final String TEXT_197 = NL + "\t\t\t\t\t\tobjectOut.clearInstanceCache();" + NL + "\t\t\t\t\t\tobjectOut.writeObject(this.exprKey_";
  ...
  protected final String TEXT_210 = "        " + NL + "        " + NL + "" + NL + "" + NL + "" + NL + "        " + NL + NL + NL;
