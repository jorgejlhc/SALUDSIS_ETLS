...
public class TPivotToColumnsDelimitedBeginJava {
  ...
  protected final String TEXT_20 = ".substring(0, fileName_";
  protected final String TEXT_21 = ".lastIndexOf(\".\"));" + NL + "        extension_";
  protected final String TEXT_22 = ".substring(fileName_";
  protected final String TEXT_23 = ".lastIndexOf(\".\"));" + NL + "    }           " + NL + "    directory_";
  ...
  protected final String TEXT_26 = ".lastIndexOf(\".\"));" + NL + "    } else {" + NL + "        fullName_";
  protected final String TEXT_27 = " = \"\";" + NL + "    }" + NL + "    directory_";
  protected final String TEXT_28 = " = \"\";" + NL + "}";
  protected final String TEXT_29 = NL + "\t //create directory only if not exists" + NL + "\tif(directory_";
  protected final String TEXT_30 = " != null && directory_";
  protected final String TEXT_31 = ".trim().length() != 0) {" + NL + "\t    java.io.File dir_";
  protected final String TEXT_32 = " = new java.io.File(directory_";
  protected final String TEXT_33 = ");" + NL + "\t    if(!dir_";
  protected final String TEXT_34 = ".exists()) {" + NL + "\t\tdir_";
  protected final String TEXT_35 = ".mkdirs();" + NL + "\t    }" + NL + "\t}";
  protected final String TEXT_36 = NL + "\tjava.io.FileOutputStream fos_";
  protected final String TEXT_37 = " = null;" + NL + "    java.io.OutputStreamWriter osw_";
  protected final String TEXT_38 = " = null;" + NL + "    java.io.BufferedWriter out";
  protected final String TEXT_39 = " = null;";
  protected final String TEXT_40 = NL + "    com.talend.csv.CSVWriter CsvWriter";
  protected final String TEXT_41 = " =null;";
  protected final String TEXT_42 = NL + "\tout";
  protected final String TEXT_43 = " = new java.io.BufferedWriter(new java.io.OutputStreamWriter(new java.io.FileOutputStream(fileName_";
  protected final String TEXT_44 = ", false),";
  protected final String TEXT_45 = "));" + NL + "\tresourceMap.put(\"out";
  protected final String TEXT_46 = "\", out";
  protected final String TEXT_47 = ");";
  protected final String TEXT_48 = NL + "    CsvWriter";
  protected final String TEXT_49 = " = new com.talend.csv.CSVWriter(out";
  protected final String TEXT_50 = ");" + NL + "    resourceMap.put(\"CsvWriter";
  protected final String TEXT_51 = "\", CsvWriter";
  protected final String TEXT_52 = ");" + NL + "    CsvWriter";
  protected final String TEXT_53 = ".setSeparator('";
  protected final String TEXT_54 = "');  " + NL + "    ";
  protected final String TEXT_55 = ".setLineEnd(\"";
  protected final String TEXT_56 = "\");";
  protected final String TEXT_57 = ".setQuoteChar('";
  protected final String TEXT_58 = "');                " + NL;
  protected final String TEXT_59 = ".setEscapeChar('\\\\');";
  protected final String TEXT_60 = ".setEscapeChar('";
  protected final String TEXT_61 = "');";
  protected final String TEXT_62 = NL + "\tCsvWriter";
  protected final String TEXT_63 = "    " + NL + "\tCsvWriter";
  protected final String TEXT_64 = ".setQuoteStatus(com.talend.csv.CSVWriter.QuoteStatus.FORCE);   " + NL + NL;
  protected final String TEXT_65 = NL + NL + NL + "java.io.File file";
  protected final String TEXT_66 = " = new java.io.File(fileName_";
  protected final String TEXT_67 = ");" + NL + "" + NL + "boolean pivot_Exists";
  protected final String TEXT_68 = " = false;" + NL + "" + NL + "StringBuilder pivot_Key";
  protected final String TEXT_69 = " = new StringBuilder();" + NL + "" + NL + "java.util.List<String> pivot_Keys";
  protected final String TEXT_70 = " = new java.util.ArrayList<String>();" + NL + "" + NL + "boolean group_Exists";
  protected final String TEXT_71 = " = false;" + NL + "" + NL + "StringBuilder group_Key";
  protected final String TEXT_72 = " = new StringBuilder();" + NL + "" + NL + "java.util.Set<java.util.List<String>> group_Keys";
  protected final String TEXT_73 = " = new java.util.LinkedHashSet<java.util.List<String>>();" + NL + "" + NL + "java.util.List<String> gKvalue";
  protected final String TEXT_74 = " = null;" + NL + "" + NL + "java.util.List<String> aggValues";
  protected final String TEXT_75 = " = null;" + NL + "" + NL + "java.util.Map<java.util.List<String>,java.util.List<String>> aggregation";
  protected final String TEXT_76 = " = new java.util.HashMap<java.util.List<String>,java.util.List<String>>();" + NL;
