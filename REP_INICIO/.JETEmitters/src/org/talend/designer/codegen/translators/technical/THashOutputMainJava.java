...
public class THashOutputMainJava
{
  ...
  protected final String TEXT_8 = "Struct oneRow_";
  protected final String TEXT_9 = " = new ";
  protected final String TEXT_10 = "Struct();" + NL + "\t\t\t\t";
  protected final String TEXT_11 = NL + "\t\t\t\t\toneRow_";
  protected final String TEXT_12 = ".";
  protected final String TEXT_13 = " = ";
  protected final String TEXT_14 = ".clone();";
  protected final String TEXT_15 = ";";
  protected final String TEXT_16 = NL + "\t\t" + NL + "        tHashFile_";
  protected final String TEXT_17 = ".put(oneRow_";
  protected final String TEXT_18 = ");" + NL + "        nb_line_";
  protected final String TEXT_19 = " ++;";
  protected final String TEXT_20 = NL + "\t\tif(tHashFile_";
  protected final String TEXT_21 = " == null){" + NL + "\t\t\ttHashFile_";
  protected final String TEXT_22 = " = mf_";
  protected final String TEXT_23 = ".getAdvancedMemoryHashFile(\"tHashFile_";
  protected final String TEXT_24 = "_\" + pid +\"_";
  protected final String TEXT_25 = "\");" + NL + "\t\t\tmf_";
  protected final String TEXT_26 = ".getResourceMap().put(\"tHashFile_";
  protected final String TEXT_27 = "\", tHashFile_";
  protected final String TEXT_28 = ");" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_29 = "Struct();";
  protected final String TEXT_30 = NL + "\t\t\toneRow_";
  protected final String TEXT_31 = NL + "        tHashFile_";
