...
public class TOracleOutputEndJava
{
  ...
  protected final String TEXT_132 = ");" + NL + "\t\t\t\tresourceMap.remove(\"keyPsmt_";
  protected final String TEXT_133 = NL + "        }";
  protected final String TEXT_134 = NL + "    resourceMap.put(\"statementClosed_";
  protected final String TEXT_135 = "\", true);";
  protected final String TEXT_136 = NL + "\t\tif(commitCounter_";
  protected final String TEXT_137 = " > 0 && rowsToCommitCount_";
  protected final String TEXT_138 = " != 0) {" + NL + "\t\t\t";
  protected final String TEXT_139 = NL + "\t\t}" + NL + "\t\tconn_";
  protected final String TEXT_140 = ".commit();" + NL + "\t\tif(commitCounter_";
  protected final String TEXT_141 = NL + "\t\t\trowsToCommitCount_";
  protected final String TEXT_142 = " = 0;" + NL + "\t\t}" + NL + "\t\tcommitCounter_";
  ...
  protected final String TEXT_147 = NL + "\t\tresourceMap.put(\"finish_";
  protected final String TEXT_148 = "\", true);" + NL + "   \t";
  protected final String TEXT_149 = NL + NL + "\t";
  protected final String TEXT_150 = NL + "\tnb_line_deleted_";
  protected final String TEXT_151 = "=nb_line_deleted_";
  protected final String TEXT_152 = "+ deletedCount_";
  protected final String TEXT_153 = ";" + NL + "\tnb_line_update_";
  protected final String TEXT_154 = "=nb_line_update_";
  protected final String TEXT_155 = " + updatedCount_";
  protected final String TEXT_156 = ";" + NL + "\tnb_line_inserted_";
  protected final String TEXT_157 = "=nb_line_inserted_";
  protected final String TEXT_158 = " + insertedCount_";
  protected final String TEXT_159 = ";" + NL + "\tnb_line_rejected_";
  protected final String TEXT_160 = "=nb_line_rejected_";
  protected final String TEXT_161 = " + rejectedCount_";
  protected final String TEXT_162 = ";" + NL + "\t";
  protected final String TEXT_163 = NL + "    \tif (globalMap.get(\"";
  protected final String TEXT_164 = "_NB_LINE\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_165 = "_NB_LINE\",nb_line_";
  protected final String TEXT_166 = ");" + NL + "        } else {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_167 = "_NB_LINE\",(Integer)globalMap.get(\"";
  protected final String TEXT_168 = "_NB_LINE\") + nb_line_";
  protected final String TEXT_169 = ");" + NL + "        }" + NL + "        if (globalMap.get(\"";
  protected final String TEXT_170 = "_NB_LINE_UPDATED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_171 = "_NB_LINE_UPDATED\",nb_line_update_";
  protected final String TEXT_172 = "_NB_LINE_UPDATED\",(Integer)globalMap.get(\"";
  protected final String TEXT_173 = "_NB_LINE_UPDATED\") + nb_line_update_";
  protected final String TEXT_174 = "_NB_LINE_INSERTED\") == null) {" + NL + "        \tglobalMap.put(\"";
  protected final String TEXT_175 = "_NB_LINE_INSERTED\",nb_line_inserted_";
  protected final String TEXT_176 = "_NB_LINE_INSERTED\",(Integer)globalMap.get(\"";
  protected final String TEXT_177 = "_NB_LINE_INSERTED\") + nb_line_inserted_";
  ...
  protected final String TEXT_180 = "_NB_LINE_DELETED\",(Integer)globalMap.get(\"";
