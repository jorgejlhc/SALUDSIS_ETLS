...
public class TMapOutBeginJava {
  ...
  protected final String TEXT_9 = NL + "\t\t" + NL + "\t\t\tcurrentThreadNumber_";
  protected final String TEXT_10 = " = (Integer) ";
  protected final String TEXT_11 = ".this.globalMap.get(\"currentThreadNumber_";
  protected final String TEXT_12 = "\");" + NL + "\t\t" + NL + "\t\t\tif(currentThreadNumber_";
  protected final String TEXT_13 = " == null) {" + NL + "\t\t\t\tcurrentThreadNumber_";
  protected final String TEXT_14 = " = 1;" + NL + "\t\t\t} else {" + NL + "\t\t\t\tcurrentThreadNumber_";
  protected final String TEXT_15 = "++;" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_16 = ".this.globalMap.put(\"currentThreadNumber_";
  protected final String TEXT_17 = "\", currentThreadNumber_";
  protected final String TEXT_18 = ");" + NL + "\t" + NL + "\t\t}";
  protected final String TEXT_19 = NL + "\t\tint count_";
  protected final String TEXT_20 = "_";
  protected final String TEXT_21 = " = 0;" + NL + "\t\t";
  protected final String TEXT_22 = NL + NL + "\t\torg.talend.designer.components.lookup.persistent.Persistent";
  protected final String TEXT_23 = "LookupManager<";
  protected final String TEXT_24 = "Struct> tHash_Lookup_";
  protected final String TEXT_25 = " = " + NL + "\t\t\t(org.talend.designer.components.lookup.persistent.Persistent";
  protected final String TEXT_26 = "Struct>) " + NL + "\t\t\t\t((org.talend.designer.components.lookup.persistent.Persistent";
  ...
  protected final String TEXT_34 = "(org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<";
  protected final String TEXT_35 = "Struct>) " + NL + "\t\t\t\t((org.talend.designer.components.lookup.memory.AdvancedMemoryLookup<";
  protected final String TEXT_36 = "Struct>) " + NL + "\t\t\t\t\tglobalMap.get( \"tHash_Lookup_";
  ...
  protected final String TEXT_48 = "HashKey = new ";
  protected final String TEXT_49 = "();";
  protected final String TEXT_50 = "Default = new ";
  protected final String TEXT_51 = NL + "// ###############################        " + NL + "" + NL + "// ###############################" + NL + "// # Vars initialization";
  ...
  protected final String TEXT_58 = NL + "// ###############################" + NL + "" + NL + "// ###############################" + NL + "// # Outputs initialization";
  protected final String TEXT_59 = NL + "\t\t\t\tint count_";
  protected final String TEXT_60 = " = 0;" + NL + "\t\t\t\t";
  protected final String TEXT_61 = "_tmp = new ";
  protected final String TEXT_62 = NL + "// ###############################" + NL;
  protected final String TEXT_63 = NL + "\t\tList<";
  protected final String TEXT_64 = "Struct> ";
  protected final String TEXT_65 = "_List = new java.util.ArrayList<";
  protected final String TEXT_66 = "Struct>();";
  protected final String TEXT_67 = NL + "\t" + NL + "\t\tclass SortableRow_";
  protected final String TEXT_68 = " implements Comparable<SortableRow_";
  protected final String TEXT_69 = ">, routines.system.IPersistableRow<SortableRow_";
  protected final String TEXT_70 = "> { // G_TM_B_001 " + NL + "" + NL + "\t\t\tboolean is__rejectedInnerJoin;" + NL + "" + NL + "\t\t";
  protected final String TEXT_71 = " exprKey_";
  protected final String TEXT_72 = "__";
  protected final String TEXT_73 = ";" + NL + "                            \t";
  protected final String TEXT_74 = NL + "\t\t\t//";
  protected final String TEXT_75 = NL + "\t\t\t";
  protected final String TEXT_76 = NL + "\t\t" + NL + "\t\t" + NL + "\t\t" + NL + "\t\t         public void fillFrom(";
  protected final String TEXT_77 = "Struct ";
  protected final String TEXT_78 = ") {" + NL + "" + NL + "\t\t\t\t\t";
  protected final String TEXT_79 = NL + "\t\t\t\t\t\t\t\tthis.";
  protected final String TEXT_80 = " = (routines.system.Dynamic) ";
  protected final String TEXT_81 = ".";
  protected final String TEXT_82 = ".clone();" + NL + "\t                \t\t";
  protected final String TEXT_83 = NL + "\t                \t\t\tthis.";
  protected final String TEXT_84 = ";" + NL + "\t                \t\t";
  protected final String TEXT_85 = NL + "\t\t\t\t\t\t\tthis.exprKey_";
  protected final String TEXT_86 = " = (routines.system.Dynamic) exprKey_";
  protected final String TEXT_87 = ".clone();" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_88 = " = exprKey_";
  protected final String TEXT_89 = ";" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_90 = NL + "                }" + NL + "" + NL + "                public void copyDataTo(";
  protected final String TEXT_91 = " = this.";
  protected final String TEXT_92 = ";" + NL + "\t                \t";
  protected final String TEXT_93 = NL + "                }" + NL + "" + NL + "\t\t" + NL + "    public String toString() {" + NL + "\t\t" + NL + "\t\tStringBuilder sb = new StringBuilder();" + NL + "\t\tsb.append(super.toString());" + NL + "\t\tsb.append(\"[\");" + NL + "\t\t";
  protected final String TEXT_94 = NL + "\t\t\t\t\t\t\tsb.append(\"";
  protected final String TEXT_95 = "\");" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_96 = NL + "\t\t\t\t\t\tsb.append(\"";
  protected final String TEXT_97 = "\");" + NL + "\t\t\t\t\t\tsb.append(\"=\");" + NL + "\t\t\t\t\t\tsb.append(String.valueOf(this.";
  protected final String TEXT_98 = "));" + NL + "\t\t\t\t\t";
  protected final String TEXT_99 = NL + "\t    sb.append(\"]\");" + NL + "\t    " + NL + "\t    return sb.toString();" + NL + "    }" + NL + "" + NL + "\t\t" + NL + "\t\t" + NL + "\t\t" + NL + "\t\t        public int compareTo(SortableRow_";
  protected final String TEXT_100 = " other) {" + NL + "" + NL + "                    int returnValue = 0;" + NL + "                    ";
  protected final String TEXT_101 = NL + "                    " + NL + "                    \treturnValue = checkNullsAndCompare(this.exprKey_";
  protected final String TEXT_102 = ", other.exprKey_";
  protected final String TEXT_103 = ");" + NL + "                    \tif (returnValue != 0) {" + NL + "\t                        return returnValue;" + NL + "                    \t}" + NL + "                    ";
  protected final String TEXT_104 = NL + NL + "                    return returnValue;" + NL + "                }" + NL + "" + NL + "                private int checkNullsAndCompare(Object object1, Object object2) {" + NL + "                    int returnValue = 0;" + NL + "                    if (object1 instanceof Comparable && object2 instanceof Comparable) {" + NL + "                        returnValue = ((Comparable) object1).compareTo(object2);" + NL + "                    } else if (object1 != null && object2 != null) {" + NL + "                        returnValue = compareStrings(object1.toString(), object2" + NL + "                                .toString());" + NL + "                    } else if (object1 == null && object2 != null) {" + NL + "                        returnValue = 1;" + NL + "                    } else if (object1 != null && object2 == null) {" + NL + "                        returnValue = -1;" + NL + "                    } else {" + NL + "                        returnValue = 0;" + NL + "                    }" + NL + "" + NL + "                    return returnValue;" + NL + "                }" + NL + "" + NL + "                private int compareStrings(String string1, String string2) {" + NL + "                    return string1.compareTo(string2);" + NL + "                }" + NL + "" + NL + "" + NL + "\t\t" + NL + "    public void readData(ObjectInputStream dis) {" + NL + "" + NL + "\t\tsynchronized(";
  protected final String TEXT_105 = "Struct.commonByteArrayLock_";
  protected final String TEXT_106 = ") {" + NL + "" + NL + "\t        try {" + NL + "            " + NL + "\t\t\t\tint length = 0;" + NL + "\t\t\t" + NL + "\t\t\t\tthis.is__rejectedInnerJoin = dis.readBoolean();" + NL + "\t\t\t" + NL + "\t\t";
  protected final String TEXT_107 = NL + "\t\t\t            this.";
  protected final String TEXT_108 = " = dis.read";
  protected final String TEXT_109 = "();" + NL + "\t\t\t\t\t";
  protected final String TEXT_110 = NL + "\t\t\t            length = dis.readInt();" + NL + "           \t\t\t\tif (length == -1) {" + NL + "           \t    \t\t\tthis.";
  protected final String TEXT_111 = " = null;" + NL + "           \t\t\t\t} else {" + NL + "           \t\t\t\t\tif(length > ";
  protected final String TEXT_112 = "Struct.commonByteArray_";
  protected final String TEXT_113 = ".length) {" + NL + "           \t\t\t\t\t\tif(length < 1024 && ";
  protected final String TEXT_114 = ".length == 0) {" + NL + "\t               \t\t\t\t\t";
  protected final String TEXT_115 = " = new byte[1024];" + NL + "           \t\t\t\t\t\t} else {" + NL + "\t               \t\t\t\t\t";
  protected final String TEXT_116 = " = new byte[2 * length];" + NL + "\t               \t\t\t\t}" + NL + "           \t\t\t\t\t}" + NL + "               \t\t\t\tdis.readFully(";
  protected final String TEXT_117 = ", 0, length);" + NL + "               \t\t\t\tthis.";
  protected final String TEXT_118 = " = new String(";
  protected final String TEXT_119 = ", 0, length, utf8Charset);" + NL + "           \t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_120 = NL + "\t\t\t            length = dis.readByte();" + NL + "           \t\t\t\tif (length == -1) {" + NL + "           \t    \t\t\tthis.";
  protected final String TEXT_121 = " = null;" + NL + "           \t\t\t\t} else {" + NL + "           \t\t\t    \tthis.";
  protected final String TEXT_122 = " = new Date(dis.readLong());" + NL + "           \t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_123 = " = null;" + NL + "           \t\t\t\t} else {" + NL + "               \t\t\t\tbyte[] byteArray = new byte[length];" + NL + "               \t\t\t\tdis.readFully(byteArray);" + NL + "               \t\t\t\tthis.";
  protected final String TEXT_124 = " = byteArray;" + NL + "           \t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_125 = NL + "\t\t\t\t\t\tthis.";
  protected final String TEXT_126 = " = (";
  protected final String TEXT_127 = ") dis.readObject();" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t\t";
  protected final String TEXT_128 = " = null;" + NL + "           \t\t\t\t} else {" + NL + "           \t\t\t\t\t";
  protected final String TEXT_129 = NL + "           \t\t\t\t\t\t\tthis.";
  protected final String TEXT_130 = ") dis.readObject();" + NL + "           \t\t\t\t\t";
  protected final String TEXT_131 = "();" + NL + "           \t\t\t\t\t";
  protected final String TEXT_132 = NL + "           \t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_133 = NL + "\t\t\t            this.exprKey_";
  protected final String TEXT_134 = NL + "\t\t\t            length = dis.readByte();" + NL + "           \t\t\t\tif (length == -1) {" + NL + "           \t    \t\t\tthis.exprKey_";
  protected final String TEXT_135 = " = null;" + NL + "           \t\t\t\t} else {" + NL + "           \t\t\t    \tthis.exprKey_";
  protected final String TEXT_136 = NL + "\t\t\t            length = dis.readInt();" + NL + "           \t\t\t\tif (length == -1) {" + NL + "           \t    \t\t\tthis.exprKey_";
  protected final String TEXT_137 = ", 0, length);" + NL + "               \t\t\t\tthis.exprKey_";
  protected final String TEXT_138 = " = null;" + NL + "           \t\t\t\t} else {" + NL + "               \t\t\t\tbyte[] byteArray = new byte[length];" + NL + "               \t\t\t\tdis.readFully(byteArray);" + NL + "               \t\t\t\tthis.exprKey_";
  protected final String TEXT_139 = NL + "           \t\t\t\tthis.exprKey_";
  protected final String TEXT_140 = NL + "           \t\t\t\t\t\t\tthis.exprKey_";
  protected final String TEXT_141 = NL + "        \t} catch (IOException e) {" + NL + "\t            throw new RuntimeException(e);";
  protected final String TEXT_142 = NL + NL + "\t\t";
  protected final String TEXT_143 = NL + "\t\t\t} catch(ClassNotFoundException eCNFE) {" + NL + "\t\t\t\t throw new RuntimeException(eCNFE);" + NL + "\t\t";
  protected final String TEXT_144 = NL + NL + "        }" + NL + "        " + NL + "      } " + NL + "    }" + NL + "    " + NL + "    " + NL + "    public void readData(org.jboss.marshalling.Unmarshaller objectIn) {" + NL + "" + NL + "\t\tsynchronized(";
  protected final String TEXT_145 = ") {" + NL + "" + NL + "\t        try {" + NL + "            " + NL + "\t\t\t\tint length = 0;" + NL + "\t\t\t" + NL + "\t\t\t\tthis.is__rejectedInnerJoin = objectIn.readBoolean();" + NL + "\t\t\t" + NL + "\t\t";
  protected final String TEXT_146 = " = objectIn.read";
  protected final String TEXT_147 = NL + "\t\t\t            length = objectIn.readInt();" + NL + "           \t\t\t\tif (length == -1) {" + NL + "           \t    \t\t\tthis.";
  protected final String TEXT_148 = " = new byte[2 * length];" + NL + "\t               \t\t\t\t}" + NL + "           \t\t\t\t\t}" + NL + "               \t\t\t\tobjectIn.readFully(";
  protected final String TEXT_149 = NL + "\t\t\t            length = objectIn.readByte();" + NL + "           \t\t\t\tif (length == -1) {" + NL + "           \t    \t\t\tthis.";
  protected final String TEXT_150 = " = new Date(objectIn.readLong());" + NL + "           \t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_151 = " = null;" + NL + "           \t\t\t\t} else {" + NL + "               \t\t\t\tbyte[] byteArray = new byte[length];" + NL + "               \t\t\t\tobjectIn.readFully(byteArray);" + NL + "               \t\t\t\tthis.";
  protected final String TEXT_152 = ") objectIn.readObject();" + NL + "\t\t\t\t\t";
  protected final String TEXT_153 = ") objectIn.readObject();" + NL + "           \t\t\t\t\t";
  protected final String TEXT_154 = NL + "\t\t\t            length = objectIn.readByte();" + NL + "           \t\t\t\tif (length == -1) {" + NL + "           \t    \t\t\tthis.exprKey_";
  protected final String TEXT_155 = NL + "\t\t\t            length = objectIn.readInt();" + NL + "           \t\t\t\tif (length == -1) {" + NL + "           \t    \t\t\tthis.exprKey_";
  protected final String TEXT_156 = " = null;" + NL + "           \t\t\t\t} else {" + NL + "               \t\t\t\tbyte[] byteArray = new byte[length];" + NL + "               \t\t\t\tobjectIn.readFully(byteArray);" + NL + "               \t\t\t\tthis.exprKey_";
  protected final String TEXT_157 = NL + NL + "        }" + NL + "        " + NL + "      } " + NL + "    }" + NL + "" + NL + "    public void writeData(ObjectOutputStream dos) {" + NL + "        try {" + NL + "" + NL + "           \tdos.writeBoolean(this.is__rejectedInnerJoin);" + NL + "" + NL + "\t\t";
  protected final String TEXT_158 = NL + "\t\t            \tdos.write";
  protected final String TEXT_159 = "(this.";
  protected final String TEXT_160 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_161 = NL + "\t\t\t\t\t\tif(this.";
  protected final String TEXT_162 = " == null) {" + NL + "\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t} else {" + NL + "\t\t\t                byte[] byteArray = this.";
  protected final String TEXT_163 = ".getBytes(utf8Charset);" + NL + "           \t\t\t    \tdos.writeInt(byteArray.length);" + NL + "               \t\t\t\tdos.write(byteArray);" + NL + "\t\t            \t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_164 = " == null) {" + NL + "\t\t\t                dos.writeByte(-1);" + NL + "\t\t\t\t\t\t} else {" + NL + "               \t\t\t\tdos.writeByte(0);" + NL + "           \t\t\t    \tdos.writeLong(this.";
  protected final String TEXT_165 = ".getTime());" + NL + "\t\t            \t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_166 = " == null) {" + NL + "\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t} else {" + NL + "           \t\t\t    \tdos.writeInt(this.";
  protected final String TEXT_167 = ".length);" + NL + "               \t\t\t\tdos.write(this.";
  protected final String TEXT_168 = ");" + NL + "\t\t            \t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_169 = NL + "       \t\t\t    \tdos.writeObject(this.";
  protected final String TEXT_170 = " == null) {" + NL + "\t\t\t                dos.writeByte(-1);" + NL + "\t\t\t\t\t\t} else {" + NL + "               \t\t\t\tdos.writeByte(0);" + NL + "           \t\t\t    \t";
  protected final String TEXT_171 = NL + "           \t\t\t\t\t\t\tdos.writeObject(this.";
  protected final String TEXT_172 = ");" + NL + "           \t\t\t\t\t";
  protected final String TEXT_173 = NL + "           \t\t\t\t\t\t\tdos.write";
  protected final String TEXT_174 = NL + "\t\t            \t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_175 = "(this.exprKey_";
  protected final String TEXT_176 = NL + "\t\t\t\t\t\tif(this.exprKey_";
  protected final String TEXT_177 = " == null) {" + NL + "\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t} else {" + NL + "\t\t\t                byte[] byteArray = this.exprKey_";
  protected final String TEXT_178 = " == null) {" + NL + "\t\t\t                dos.writeByte(-1);" + NL + "\t\t\t\t\t\t} else {" + NL + "               \t\t\t\tdos.writeByte(0);" + NL + "           \t\t\t    \tdos.writeLong(this.exprKey_";
  protected final String TEXT_179 = " == null) {" + NL + "\t\t\t                dos.writeInt(-1);" + NL + "\t\t\t\t\t\t} else {" + NL + "           \t\t\t    \tdos.writeInt(this.exprKey_";
  protected final String TEXT_180 = ".length);" + NL + "               \t\t\t\tdos.write(this.exprKey_";
  protected final String TEXT_181 = NL + "       \t\t\t    \tdos.writeObject(this.exprKey_";
  protected final String TEXT_182 = NL + "           \t\t\t\t\t\t\tdos.writeObject(this.exprKey_";
  protected final String TEXT_183 = NL + "        }" + NL + "    }" + NL + "    " + NL + "    public void writeData(org.jboss.marshalling.Marshaller objectOut) {" + NL + "        try {" + NL + "" + NL + "           \tobjectOut.writeBoolean(this.is__rejectedInnerJoin);" + NL + "" + NL + "\t\t";
  protected final String TEXT_184 = NL + "\t\t            \tobjectOut.write";
  protected final String TEXT_185 = " == null) {" + NL + "\t\t\t                objectOut.writeInt(-1);" + NL + "\t\t\t\t\t\t} else {" + NL + "\t\t\t                byte[] byteArray = this.";
  protected final String TEXT_186 = ".getBytes(utf8Charset);" + NL + "           \t\t\t    \tobjectOut.writeInt(byteArray.length);" + NL + "               \t\t\t\tobjectOut.write(byteArray);" + NL + "\t\t            \t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_187 = " == null) {" + NL + "\t\t\t                objectOut.writeByte(-1);" + NL + "\t\t\t\t\t\t} else {" + NL + "               \t\t\t\tobjectOut.writeByte(0);" + NL + "           \t\t\t    \tobjectOut.writeLong(this.";
  protected final String TEXT_188 = " == null) {" + NL + "\t\t\t                objectOut.writeInt(-1);" + NL + "\t\t\t\t\t\t} else {" + NL + "           \t\t\t    \tobjectOut.writeInt(this.";
  protected final String TEXT_189 = ".length);" + NL + "               \t\t\t\tobjectOut.write(this.";
  protected final String TEXT_190 = NL + "\t\t\t\t\t\tobjectOut.clearInstanceCache();" + NL + "\t\t\t\t\t\tobjectOut.writeObject(this.";
  protected final String TEXT_191 = " == null) {" + NL + "\t\t\t                objectOut.writeByte(-1);" + NL + "\t\t\t\t\t\t} else {" + NL + "               \t\t\t\tobjectOut.writeByte(0);" + NL + "           \t\t\t    \t";
  protected final String TEXT_192 = NL + "           \t\t\t\t\t\t\tobjectOut.clearInstanceCache();" + NL + "           \t\t\t\t\t\t\tobjectOut.writeObject(this.";
  protected final String TEXT_193 = NL + "           \t\t\t\t\t\t\tobjectOut.write";
  protected final String TEXT_194 = " == null) {" + NL + "\t\t\t                objectOut.writeInt(-1);" + NL + "\t\t\t\t\t\t} else {" + NL + "\t\t\t                byte[] byteArray = this.exprKey_";
  protected final String TEXT_195 = " == null) {" + NL + "\t\t\t                objectOut.writeByte(-1);" + NL + "\t\t\t\t\t\t} else {" + NL + "               \t\t\t\tobjectOut.writeByte(0);" + NL + "           \t\t\t    \tobjectOut.writeLong(this.exprKey_";
  protected final String TEXT_196 = " == null) {" + NL + "\t\t\t                objectOut.writeInt(-1);" + NL + "\t\t\t\t\t\t} else {" + NL + "           \t\t\t    \tobjectOut.writeInt(this.exprKey_";
  protected final String TEXT_197 = ".length);" + NL + "               \t\t\t\tobjectOut.write(this.exprKey_";
  protected final String TEXT_198 = NL + "\t\t\t\t\t\tobjectOut.clearInstanceCache();" + NL + "\t\t\t\t\t\tobjectOut.writeObject(this.exprKey_";
  protected final String TEXT_199 = NL + "           \t\t\t\t\t\t\tobjectOut.clearInstanceCache();" + NL + "           \t\t\t\t\t\t\tobjectOut.writeObject(this.exprKey_";
  protected final String TEXT_200 = NL + "        }" + NL + "    }" + NL + "    " + NL + "    public boolean supportJboss(){" + NL + "    \treturn true;" + NL + "    }" + NL + "\t\t" + NL + "\t\t" + NL + "\t\t" + NL + "\t\t} // G_TM_B_001" + NL + "\t" + NL + "\t";
  protected final String TEXT_201 = NL + "\t" + NL + "" + NL + "\torg.talend.designer.components.lookup.persistent.PersistentRowSorterIterator<SortableRow_";
  protected final String TEXT_202 = "> fsi_";
  protected final String TEXT_203 = " = " + NL + "\t\tnew org.talend.designer.components.lookup.persistent.PersistentRowSorterIterator<SortableRow_";
  protected final String TEXT_204 = ">(" + NL + "\t\t\t";
  protected final String TEXT_205 = " + \"/\"+ jobName +\"_tMapData_\" + Thread.currentThread().getId() + \"_\" + pid +\"_";
  protected final String TEXT_206 = "\", ";
  protected final String TEXT_207 = ") {" + NL + "\t\t\tpublic SortableRow_";
  protected final String TEXT_208 = " createRowInstance() {" + NL + "\t\t\t\treturn new SortableRow_";
  protected final String TEXT_209 = "();" + NL + "\t\t\t}" + NL + "\t\t};" + NL + "\t" + NL + "\tfsi_";
  protected final String TEXT_210 = ".initPut();" + NL + "" + NL + "\t\t" + NL + "\t\t";
  protected final String TEXT_211 = "        " + NL + "        " + NL + "" + NL + "" + NL + "" + NL + "        " + NL + NL + NL;
