...
package afi_novedades_afiliado.servicenovedadesafiliados_0_2;
...
/**
 * Job: ServiceNovedadesAfiliados Purpose: <br>
 * Description:  <br>
 * @author jorgejlhc@gmail.com
 * @version 8.8.8.20240722_1936-SNAPSHOT
 * @status 
 */
public class ServiceNovedadesAfiliados implements TalendJob {
...
public String getFECHA_INICIO(){
	...
	private final String jobName = "ServiceNovedadesAfiliados";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ServiceNovedadesAfiliados.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ServiceNovedadesAfiliados.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class RestServiceProviderImpl4TalendJob {
	...
	private final ServiceNovedadesAfiliados job;

	public RestServiceProviderImpl4TalendJob(ServiceNovedadesAfiliados job) {
		this.job = job;
	}

	private void populateRequestWithJobContext(java.util.Map<String, Object> requestGlobalMap, ServiceNovedadesAfiliados job) {
...
class Thread4RestServiceProviderEndpoint extends Thread {
	...
	public Thread4RestServiceProviderEndpoint(ServiceNovedadesAfiliados job, String endpointUrl) {
		this.job = job;
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression, String jobName)
			...
			java.io.InputStream inContext = ServiceNovedadesAfiliados.class.getClassLoader()
					.getResourceAsStream("afi_novedades_afiliado/servicenovedadesafiliados_0_2/contexts/" + currentContext  + ".properties");
			if (inContext == null) {
				inContext = ServiceNovedadesAfiliados.class.getClassLoader()
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_AFI_NOVEDADES_AFILIADO_ServiceNovedadesAfiliados = new byte[0];
    static byte[] commonByteArray_AFI_NOVEDADES_AFILIADO_ServiceNovedadesAfiliados = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_AFI_NOVEDADES_AFILIADO_ServiceNovedadesAfiliados) {
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_AFI_NOVEDADES_AFILIADO_ServiceNovedadesAfiliados.length) {
				if(length < 1024 && commonByteArray_AFI_NOVEDADES_AFILIADO_ServiceNovedadesAfiliados.length == 0) {
   					commonByteArray_AFI_NOVEDADES_AFILIADO_ServiceNovedadesAfiliados = new byte[1024];
				} else {
   					commonByteArray_AFI_NOVEDADES_AFILIADO_ServiceNovedadesAfiliados = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_AFI_NOVEDADES_AFILIADO_ServiceNovedadesAfiliados, 0, length);
			strReturn = new String(commonByteArray_AFI_NOVEDADES_AFILIADO_ServiceNovedadesAfiliados, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_AFI_NOVEDADES_AFILIADO_ServiceNovedadesAfiliados, 0, length);
			strReturn = new String(commonByteArray_AFI_NOVEDADES_AFILIADO_ServiceNovedadesAfiliados, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
if (needRoot) {
	needRoot=false;
		...
		org.dom4j.Element root_1 = null;
				root_1 = root.addElement("Message");
		valueMap.put("root_1","Error en el llamado del ETL de novedades afiliado");
		if(valueMap.get("root_1")!=null) {
			routines.system.NestXMLTool.setText(root_1,FormatterUtils.fm(valueMap.get("root_1"),null));
		}
		org.dom4j.Element root_2 = null;
...
if (needRoot) {
	needRoot=false;
		...
		org.dom4j.Element root_1 = null;
				root_1 = root.addElement("Message");
		valueMap.put("root_1","El identificador del usuario no puede ser nulo");
		if(valueMap.get("root_1")!=null) {
			routines.system.NestXMLTool.setText(root_1, FormatterUtils.fm(valueMap.get("root_1"),null));
		}
		org.dom4j.Element root_2 = null;
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		afi_novedades_afiliado.novedadesafiliadosetapa1_0_2.NovedadesAfiliadosEtapa1 childJob_tRunJob_1 = new afi_novedades_afiliado.novedadesafiliadosetapa1_0_2.NovedadesAfiliadosEtapa1();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final ServiceNovedadesAfiliados ServiceNovedadesAfiliadosClass = new ServiceNovedadesAfiliados();

        int exitCode = ServiceNovedadesAfiliadosClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ServiceNovedadesAfiliados.class.getClassLoader().getResourceAsStream("afi_novedades_afiliado/servicenovedadesafiliados_0_2/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = ServiceNovedadesAfiliados.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ServiceNovedadesAfiliados");
        }
...
/************************************************************************************************
 *     220774 characters generated by Talend Open Studio for ESB 
