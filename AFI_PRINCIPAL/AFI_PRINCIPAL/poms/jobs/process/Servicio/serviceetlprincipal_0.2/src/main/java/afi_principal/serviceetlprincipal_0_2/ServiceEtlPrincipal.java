...
package afi_principal.serviceetlprincipal_0_2;
...
/**
 * Job: ServiceEtlPrincipal Purpose: <br>
 * Description:  <br>
 * @author jorgejlhc@gmail.com
 * @version 8.8.8.20240722_1936-SNAPSHOT
 * @status 
 */
public class ServiceEtlPrincipal implements TalendJob {
...
public Integer getIdSolicitud(){
	...
	private final String jobName = "ServiceEtlPrincipal";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ServiceEtlPrincipal.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ServiceEtlPrincipal.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class RestServiceProviderImpl4TalendJob {
	...
	private final ServiceEtlPrincipal job;

	public RestServiceProviderImpl4TalendJob(ServiceEtlPrincipal job) {
		this.job = job;
	}

	private void populateRequestWithJobContext(java.util.Map<String, Object> requestGlobalMap, ServiceEtlPrincipal job) {
...
class Thread4RestServiceProviderEndpoint extends Thread {
	...
	public Thread4RestServiceProviderEndpoint(ServiceEtlPrincipal job, String endpointUrl) {
		this.job = job;
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression, String jobName)
			...
			java.io.InputStream inContext = ServiceEtlPrincipal.class.getClassLoader()
					.getResourceAsStream("afi_principal/serviceetlprincipal_0_2/contexts/" + currentContext  + ".properties");
			if (inContext == null) {
				inContext = ServiceEtlPrincipal.class.getClassLoader()
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_AFI_PRINCIPAL_ServiceEtlPrincipal = new byte[0];
    static byte[] commonByteArray_AFI_PRINCIPAL_ServiceEtlPrincipal = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_AFI_PRINCIPAL_ServiceEtlPrincipal) {
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_AFI_PRINCIPAL_ServiceEtlPrincipal.length) {
				if(length < 1024 && commonByteArray_AFI_PRINCIPAL_ServiceEtlPrincipal.length == 0) {
   					commonByteArray_AFI_PRINCIPAL_ServiceEtlPrincipal = new byte[1024];
				} else {
   					commonByteArray_AFI_PRINCIPAL_ServiceEtlPrincipal = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_AFI_PRINCIPAL_ServiceEtlPrincipal, 0, length);
			strReturn = new String(commonByteArray_AFI_PRINCIPAL_ServiceEtlPrincipal, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_AFI_PRINCIPAL_ServiceEtlPrincipal, 0, length);
			strReturn = new String(commonByteArray_AFI_PRINCIPAL_ServiceEtlPrincipal, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
if (needRoot) {
	needRoot=false;
		...
		valueMap.put("root_1","Proceso del ETL principal ejecuctado satisfactoriamente");
...
if (needRoot) {
	needRoot=false;
		...
		org.dom4j.Element root_1 = null;
				root_1 = root.addElement("Message");
		valueMap.put("root_1","Error en el llamado del ETL principal");
		if(valueMap.get("root_1")!=null) {
			routines.system.NestXMLTool.setText(root_1,FormatterUtils.fm(valueMap.get("root_1"),null));
		}
		org.dom4j.Element root_2 = null;
...
if(in != null) { 
	...
	boolean isMatchDocRowtXMLMap_4_TXMLMAP_OUT = false;
				...
				absolutePathMappings_tXMLMap_4_TXMLMAP_OUT[0] = "in.body:/root/infoIdArchivo";
				relativePathMappings_tXMLMap_4_TXMLMAP_OUT[0] = "infoIdArchivo";
...
treeNodeAPI_tXMLMap_4_TXMLMAP_OUT.get_String("in.body:/root/infoIdArchivo") != null

 ) {

RequestOK_tmp = new RequestOKStruct();
RequestOK_tmp.IdSolicitud = treeNodeAPI_tXMLMap_4_TXMLMAP_OUT.get_String("in.body:/root/infoIdArchivo");allOutsForAggregate_tXMLMap_4.add(RequestOK_tmp);
	...
	Object obj_tRunJob_1 = null;
		...
		if(obj_tRunJob_1!=null) {
			if (obj_tRunJob_1.getClass().getName().equals("java.util.Date")) {
				paraList_tRunJob_1.add("--context_param infoIdArchivo=" + ((java.util.Date) obj_tRunJob_1).getTime());
			} else {
				
					paraList_tRunJob_1.add("--context_param infoIdArchivo=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
					
				
			}
		} else {
			paraList_tRunJob_1.add("--context_param infoIdArchivo=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_1.put("infoIdArchivo", obj_tRunJob_1);
	
	
		afi_principal.etl_principal_1_0.ETL_principal childJob_tRunJob_1 = new afi_principal.etl_principal_1_0.ETL_principal();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final ServiceEtlPrincipal ServiceEtlPrincipalClass = new ServiceEtlPrincipal();

        int exitCode = ServiceEtlPrincipalClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ServiceEtlPrincipal.class.getClassLoader().getResourceAsStream("afi_principal/serviceetlprincipal_0_2/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = ServiceEtlPrincipal.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ServiceEtlPrincipal");
        }
...
/************************************************************************************************
 *     211617 characters generated by Talend Open Studio for ESB 
 *     on the October 28, 2024, 2:33:32 PM COT
 ************************************************************************************************/