...
public class TPivotToColumnsDelimitedFinallyJava
{
  ...
  protected final String TEXT_10 = "\") != null && resourceMap.get(\"fileName_";
  protected final String TEXT_11 = "\") != null){" + NL + "\t\t\t\t\tif(Integer.valueOf(String.valueOf(resourceMap.get(\"out";
  protected final String TEXT_12 = "\"))) == 0 && (new java.io.File(String.valueOf(resourceMap.get(\"fileName_";
  protected final String TEXT_13 = "\"))).exists())){" + NL + "\t\t\t\t\t\tnew java.io.File(String.valueOf(resourceMap.get(\"fileName_";
  protected final String TEXT_14 = "\"))).delete();" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t";
