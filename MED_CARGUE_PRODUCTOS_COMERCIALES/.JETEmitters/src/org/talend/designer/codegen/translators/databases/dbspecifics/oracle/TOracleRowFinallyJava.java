...
public class TOracleRowFinallyJava
{
  ...
  protected final String TEXT_72 = NL + "try {";
  protected final String TEXT_73 = NL + "    if (resourceMap.get(\"statementClosed_";
  protected final String TEXT_74 = "\") == null) {";
  protected final String TEXT_75 = NL + "            java.sql.PreparedStatement pstmtToClose_";
  protected final String TEXT_76 = " = null;" + NL + "            if ((pstmtToClose_";
  protected final String TEXT_77 = " = (java.sql.PreparedStatement) resourceMap.remove(\"pstmt_";
  protected final String TEXT_78 = "\")) != null) {" + NL + "                pstmtToClose_";
  protected final String TEXT_79 = ".close();" + NL + "            }";
  protected final String TEXT_80 = NL + "            java.sql.Statement stmtToClose_";
  protected final String TEXT_81 = " = null;" + NL + "            if ((stmtToClose_";
  protected final String TEXT_82 = " = (java.sql.Statement) resourceMap.remove(\"stmt_";
  protected final String TEXT_83 = "\")) != null) {" + NL + "                stmtToClose_";
  protected final String TEXT_84 = NL + "    }";
  protected final String TEXT_85 = NL + "} finally {" + NL + "        if(resourceMap.get(\"finish_";
  protected final String TEXT_86 = "\") == null){" + NL + "            java.sql.Connection ctn_";
  protected final String TEXT_87 = " = null;" + NL + "            if((ctn_";
  protected final String TEXT_88 = " = (java.sql.Connection)resourceMap.get(\"conn_";
  protected final String TEXT_89 = "\")) != null){" + NL + "                try {";
  protected final String TEXT_90 = NL + "                    ctn_";
  protected final String TEXT_91 = ".close();";
  protected final String TEXT_92 = NL + "                } catch (java.sql.SQLException sqlEx_";
  protected final String TEXT_93 = ") {" + NL + "                    String errorMessage_";
  protected final String TEXT_94 = " = \"failed to close the connection in ";
  protected final String TEXT_95 = " :\" + sqlEx_";
  protected final String TEXT_96 = ".getMessage();";
  protected final String TEXT_97 = NL + "                    System.err.println(errorMessage_";
