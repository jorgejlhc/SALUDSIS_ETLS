...
public class ColumnName {
    ...
    public static boolean IsValidAnexoTecnico(String ... data) {   
    	...
    	if (Utils.mayusculasSinAcentos(data[14].replaceAll("\\s","").toUpperCase()).equals("NOMBRECOMERCIALPRODUCTO/MARCA") == false){return false;}
    	if (Utils.mayusculasSinAcentos(data[15].replaceAll("\\s","").toUpperCase()).equals("LABORATORIO/FABRICANTETITULAR") == false){return false;}    	
    	if (Utils.mayusculasSinAcentos(data[16].replaceAll("\\s","").toUpperCase()).equals("NOREGISTROSANITARIO") == false){return false;}    	
    	if (Utils.mayusculasSinAcentos(data[17].replaceAll("\\s","").toUpperCase()).equals("IMPORTADOR") == false){return false;}    	
    	...
    	if (Utils.mayusculasSinAcentos(data[29].replaceAll("\\s","").toUpperCase()).equals("FECHAEXPEDICIONREGINVIMA") == false){return false;}    	
