...
package med_cargue_productos_comerciales.servicecargueproductoscomerciales_0_2;
...
/**
 * Job: ServiceCargueProductosComerciales Purpose: <br>
 * Description:  <br>
 * @author jorgejlhc@gmail.com
 * @version 8.8.8.20240722_1936-SNAPSHOT
 * @status 
 */
public class ServiceCargueProductosComerciales implements TalendJob {
...
public String getResult(){
	...
	private final String jobName = "ServiceCargueProductosComerciales";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ServiceCargueProductosComerciales.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ServiceCargueProductosComerciales.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class RestServiceProviderImpl4TalendJob {
	...
	private final ServiceCargueProductosComerciales job;

	public RestServiceProviderImpl4TalendJob(ServiceCargueProductosComerciales job) {
		this.job = job;
	}

	private void populateRequestWithJobContext(java.util.Map<String, Object> requestGlobalMap, ServiceCargueProductosComerciales job) {
...
class Thread4RestServiceProviderEndpoint extends Thread {
	...
	public Thread4RestServiceProviderEndpoint(ServiceCargueProductosComerciales job, String endpointUrl) {
		this.job = job;
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression, String jobName)
			...
			java.io.InputStream inContext = ServiceCargueProductosComerciales.class.getClassLoader()
					.getResourceAsStream("med_cargue_productos_comerciales/servicecargueproductoscomerciales_0_2/contexts/" + currentContext  + ".properties");
			if (inContext == null) {
				inContext = ServiceCargueProductosComerciales.class.getClassLoader()
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_MED_CARGUE_PRODUCTOS_COMERCIALES_ServiceCargueProductosComerciales = new byte[0];
    static byte[] commonByteArray_MED_CARGUE_PRODUCTOS_COMERCIALES_ServiceCargueProductosComerciales = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_MED_CARGUE_PRODUCTOS_COMERCIALES_ServiceCargueProductosComerciales) {
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_MED_CARGUE_PRODUCTOS_COMERCIALES_ServiceCargueProductosComerciales.length) {
				if(length < 1024 && commonByteArray_MED_CARGUE_PRODUCTOS_COMERCIALES_ServiceCargueProductosComerciales.length == 0) {
   					commonByteArray_MED_CARGUE_PRODUCTOS_COMERCIALES_ServiceCargueProductosComerciales = new byte[1024];
				} else {
   					commonByteArray_MED_CARGUE_PRODUCTOS_COMERCIALES_ServiceCargueProductosComerciales = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_MED_CARGUE_PRODUCTOS_COMERCIALES_ServiceCargueProductosComerciales, 0, length);
			strReturn = new String(commonByteArray_MED_CARGUE_PRODUCTOS_COMERCIALES_ServiceCargueProductosComerciales, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_MED_CARGUE_PRODUCTOS_COMERCIALES_ServiceCargueProductosComerciales, 0, length);
			strReturn = new String(commonByteArray_MED_CARGUE_PRODUCTOS_COMERCIALES_ServiceCargueProductosComerciales, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
if (needRoot) {
	needRoot=false;
		...
		valueMap.put("root_1","Proceso de cargue de productos comerciales ejecuctado satisfactoriamente");
...
if (needRoot) {
	needRoot=false;
		...
		org.dom4j.Element root_1 = null;
				root_1 = root.addElement("Message");
		valueMap.put("root_1","Error de ejecución del proceso de cargue de productos comerciales");
		if(valueMap.get("root_1")!=null) {
			routines.system.NestXMLTool.setText(root_1,FormatterUtils.fm(valueMap.get("root_1"),null));
		}
		org.dom4j.Element root_2 = null;
...
if (needRoot) {
	needRoot=false;
		...
		org.dom4j.Element root_1 = null;
				root_1 = root.addElement("Message");
		valueMap.put("root_1","Error en el llamado del ETL de cargue de productos comerciales");
		if(valueMap.get("root_1")!=null) {
			routines.system.NestXMLTool.setText(root_1,FormatterUtils.fm(valueMap.get("root_1"),null));
		}
		org.dom4j.Element root_2 = null;
...
if (needRoot) {
	needRoot=false;
		...
		org.dom4j.Element root_1 = null;
				root_1 = root.addElement("Message");
		valueMap.put("root_1","El identificador de la carga no puede ser nulo" );
		if(valueMap.get("root_1")!=null) {
			routines.system.NestXMLTool.setText(root_1, FormatterUtils.fm(valueMap.get("root_1"),null));
		}
		org.dom4j.Element root_2 = null;
...
if(in != null) { 
	...
	boolean isMatchDocRowtXMLMap_4_TXMLMAP_OUT = false;
				...
				absolutePathMappings_tXMLMap_4_TXMLMAP_OUT[0] = "in.body:/root/carga_id";
				relativePathMappings_tXMLMap_4_TXMLMAP_OUT[0] = "carga_id";
...
treeNodeAPI_tXMLMap_4_TXMLMAP_OUT.get_String("in.body:/root/carga_id") != null

 ) {

RequestOK_tmp = new RequestOKStruct();
RequestOK_tmp.carga_id = treeNodeAPI_tXMLMap_4_TXMLMAP_OUT.get_String("in.body:/root/carga_id");allOutsForAggregate_tXMLMap_4.add(RequestOK_tmp);
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		med_cargue_productos_comerciales.cargaproductoscomerciales_0_2.CargaProductosComerciales childJob_tRunJob_1 = new med_cargue_productos_comerciales.cargaproductoscomerciales_0_2.CargaProductosComerciales();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final ServiceCargueProductosComerciales ServiceCargueProductosComercialesClass = new ServiceCargueProductosComerciales();

        int exitCode = ServiceCargueProductosComercialesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ServiceCargueProductosComerciales.class.getClassLoader().getResourceAsStream("med_cargue_productos_comerciales/servicecargueproductoscomerciales_0_2/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = ServiceCargueProductosComerciales.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ServiceCargueProductosComerciales");
        }
...
/************************************************************************************************
 *     226277 characters generated by Talend Open Studio for ESB 
 *     on the October 28, 2024, 3:14:30 PM COT
 ************************************************************************************************/