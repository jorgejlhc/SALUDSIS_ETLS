...
package rep_consolidados_f5.mail_1_3;
...
public String getService_name_destino(){
	...
	private final String projectName = "REP_CONSOLIDADOS_F5";
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_REP_CONSOLIDADOS_F5_Mail = new byte[0];
    static byte[] commonByteArray_REP_CONSOLIDADOS_F5_Mail = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_REP_CONSOLIDADOS_F5_Mail.length) {
				if(length < 1024 && commonByteArray_REP_CONSOLIDADOS_F5_Mail.length == 0) {
   					commonByteArray_REP_CONSOLIDADOS_F5_Mail = new byte[1024];
				} else {
   					commonByteArray_REP_CONSOLIDADOS_F5_Mail = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_REP_CONSOLIDADOS_F5_Mail, 0, length);
			strReturn = new String(commonByteArray_REP_CONSOLIDADOS_F5_Mail, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_REP_CONSOLIDADOS_F5_Mail, 0, length);
			strReturn = new String(commonByteArray_REP_CONSOLIDADOS_F5_Mail, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_REP_CONSOLIDADOS_F5_Mail) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Mail.class.getClassLoader().getResourceAsStream("rep_consolidados_f5/mail_1_3/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     109874 characters generated by Talend Open Studio for ESB 
 *     on the November 4, 2024, 9:57:31 PM COT
 ************************************************************************************************/