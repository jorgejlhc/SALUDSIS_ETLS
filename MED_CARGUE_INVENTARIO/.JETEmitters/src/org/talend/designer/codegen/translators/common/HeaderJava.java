...
public class HeaderJava
{
  ...
  protected final String TEXT_82 = "\t\t" + NL + "\tprotected ContextProperties context = new ContextProperties(); // will be instanciated by MS." + NL + "\tpublic ContextProperties getContext() {" + NL + "\t\treturn this.context;" + NL + "\t}" + NL + "\tprivate final String jobVersion = \"";
  ...
  protected final String TEXT_86 = NL + "\tprivate String cLabel =  null;" + NL + "\t";
  protected final String TEXT_87 = NL + "\t\tprivate final java.util.Map<String, Object> globalMap = java.util.Collections.synchronizedMap(new java.util.HashMap<String, Object>());" + NL + "\t\t";
  protected final String TEXT_88 = NL + "\t\t\tprivate final static java.util.Map<String, Object> junitGlobalMap = java.util.Collections.synchronizedMap(new java.util.HashMap<String, Object>());" + NL + "\t\t";
  ...
  protected final String TEXT_92 = NL + "\t\t\tprivate class DaemonThreadFactory implements java.util.concurrent.ThreadFactory {" + NL + "\t\t\t\tjava.util.concurrent.ThreadFactory factory = java.util.concurrent.Executors.defaultThreadFactory();" + NL + "\t\t\t\t" + NL + "\t\t\t\tpublic java.lang.Thread newThread(java.lang.Runnable r) {" + NL + "\t\t\t\t\tjava.lang.Thread t = factory.newThread(r);" + NL + "\t\t\t\t\tt.setDaemon(true);" + NL + "\t\t\t\t\treturn t;" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
  protected final String TEXT_93 = NL + "private final java.util.concurrent.ExecutorService es = java.util.concurrent.Executors.newFixedThreadPool(";
  protected final String TEXT_94 = ",new DaemonThreadFactory()";
  protected final String TEXT_95 = ");";
  protected final String TEXT_96 = NL + "private final java.util.concurrent.ExecutorService es = java.util.concurrent.Executors.newCachedThreadPool(";
  protected final String TEXT_97 = "new DaemonThreadFactory()";
  protected final String TEXT_98 = NL + "\t\t{" + NL + "\t\t\tjava.lang.Runtime.getRuntime().addShutdownHook(new java.lang.Thread() {" + NL + "\t\t\t\tpublic void run() {" + NL + "\t\t\t\t\tes.shutdown();" + NL + "\t\t\t\t\ttry {" + NL + "\t\t\t\t\t\tif(!es.awaitTermination(60, java.util.concurrent.TimeUnit.SECONDS)) {" + NL + "\t\t\t\t\t\t\tes.shutdownNow();" + NL + "\t\t\t\t\t\t\tif(!es.awaitTermination(60, java.util.concurrent.TimeUnit.SECONDS)) {" + NL + "" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t} catch (java.lang.InterruptedException ie) {" + NL + "\t\t\t\t\t\tes.shutdownNow();" + NL + "\t\t\t\t\t} catch (java.lang.Exception e) {" + NL + "" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t});" + NL + "\t\t}";
  protected final String TEXT_99 = NL + "private final JobStructureCatcherUtils ";
  protected final String TEXT_100 = " = new JobStructureCatcherUtils(jobName, \"";
  protected final String TEXT_101 = "\", \"";
  protected final String TEXT_102 = "\");";
  protected final String TEXT_103 = NL + "private org.talend.job.audit.JobAuditLogger runtime_lineage_logger_";
  protected final String TEXT_104 = " = null;";
  protected final String TEXT_105 = NL + "private org.talend.job.audit.JobAuditLogger auditLogger_";
  protected final String TEXT_106 = " = null;" + NL + "" + NL + "private RunStat runStat = new RunStat(";
  protected final String TEXT_107 = ", System.getProperty(\"audit.interval\"));";
  protected final String TEXT_108 = NL + "private RunStat runStat = new RunStat();";
  protected final String TEXT_109 = NL + "private RunTrace runTrace = new RunTrace();";
  protected final String TEXT_110 = NL + NL + "\t// OSGi DataSource" + NL + "\tprivate final static String KEY_DB_DATASOURCES = \"KEY_DB_DATASOURCES\";" + NL + "\t" + NL + "\tprivate final static String KEY_DB_DATASOURCES_RAW = \"KEY_DB_DATASOURCES_RAW\";" + NL + "" + NL + "\tpublic void setDataSources(java.util.Map<String, javax.sql.DataSource> dataSources) {" + NL + "\t\tjava.util.Map<String, routines.system.TalendDataSource> talendDataSources = new java.util.HashMap<String, routines.system.TalendDataSource>();" + NL + "\t\tfor (java.util.Map.Entry<String, javax.sql.DataSource> dataSourceEntry : dataSources.entrySet()) {" + NL + "\t\t\ttalendDataSources.put(dataSourceEntry.getKey(), new routines.system.TalendDataSource(dataSourceEntry.getValue()));" + NL + "\t\t}" + NL + "\t\tglobalMap.put(KEY_DB_DATASOURCES, talendDataSources);" + NL + "\t\tglobalMap.put(KEY_DB_DATASOURCES_RAW, new java.util.HashMap<String, javax.sql.DataSource>(dataSources));" + NL + "\t}" + NL + "\t" + NL + "\tpublic void setDataSourceReferences(List serviceReferences) throws Exception{" + NL + "\t\t" + NL + "\t\tjava.util.Map<String, routines.system.TalendDataSource> talendDataSources = new java.util.HashMap<String, routines.system.TalendDataSource>();" + NL + "\t\tjava.util.Map<String, javax.sql.DataSource> dataSources = new java.util.HashMap<String, javax.sql.DataSource>();" + NL + "\t\t" + NL + "\t\tfor (java.util.Map.Entry<String, javax.sql.DataSource> entry : BundleUtils.getServices(serviceReferences,  javax.sql.DataSource.class).entrySet()) {" + NL + "                    dataSources.put(entry.getKey(), entry.getValue());" + NL + "                    talendDataSources.put(entry.getKey(), new routines.system.TalendDataSource(entry.getValue()));" + NL + "\t\t}" + NL + "" + NL + "\t\tglobalMap.put(KEY_DB_DATASOURCES, talendDataSources);" + NL + "\t\tglobalMap.put(KEY_DB_DATASOURCES_RAW, new java.util.HashMap<String, javax.sql.DataSource>(dataSources));" + NL + "\t}" + NL;
  protected final String TEXT_111 = NL + "\tLogCatcherUtils ";
  protected final String TEXT_112 = " = new LogCatcherUtils();";
  protected final String TEXT_113 = NL + "\tStatCatcherUtils ";
  protected final String TEXT_114 = " = new StatCatcherUtils(\"";
  protected final String TEXT_115 = NL + "\tMetterCatcherUtils ";
  protected final String TEXT_116 = " = new MetterCatcherUtils(\"";
  protected final String TEXT_117 = NL + "\tAssertCatcherUtils ";
  protected final String TEXT_118 = " = new AssertCatcherUtils();";
  protected final String TEXT_119 = NL + NL + "private final java.io.ByteArrayOutputStream baos = new java.io.ByteArrayOutputStream();" + NL + "private final java.io.PrintStream errorMessagePS = new java.io.PrintStream(new java.io.BufferedOutputStream(baos));" + NL + "" + NL + "public String getExceptionStackTrace() {" + NL + "\tif (\"failure\".equals(this.getStatus())) {" + NL + "\t\terrorMessagePS.flush();" + NL + "\t\treturn baos.toString();" + NL + "\t}" + NL + "\treturn null;" + NL + "}" + NL + "" + NL + "private Exception exception;" + NL + "" + NL + "public Exception getException() {" + NL + "\tif (\"failure\".equals(this.getStatus())) {" + NL + "\t\treturn this.exception;" + NL + "\t}" + NL + "\treturn null;" + NL + "}" + NL + "" + NL + "private class TalendException extends Exception {" + NL + "" + NL + "\tprivate static final long serialVersionUID = 1L;" + NL + "" + NL + "\tprivate java.util.Map<String, Object> globalMap = null;" + NL + "\tprivate Exception e = null;" + NL + "\t" + NL + "\tprivate String currentComponent = null;" + NL + "\tprivate String cLabel =  null;" + NL + "\t" + NL + "\tprivate String virtualComponentName = null;" + NL + "\t" + NL + "\tpublic void setVirtualComponentName (String virtualComponentName){" + NL + "\t\tthis.virtualComponentName = virtualComponentName;" + NL + "\t}" + NL + "" + NL + "\tprivate TalendException(Exception e, String errorComponent, final java.util.Map<String, Object> globalMap) {" + NL + "\t\tthis.currentComponent= errorComponent;" + NL + "\t\tthis.globalMap = globalMap;" + NL + "\t\tthis.e = e;" + NL + "\t}" + NL + "\t" + NL + "\tprivate TalendException(Exception e, String errorComponent, String errorComponentLabel, final java.util.Map<String, Object> globalMap) {" + NL + "\t\tthis(e, errorComponent, globalMap);" + NL + "\t\tthis.cLabel = errorComponentLabel;" + NL + "\t}" + NL + "" + NL + "\tpublic Exception getException() {" + NL + "\t\treturn this.e;" + NL + "\t}" + NL + "" + NL + "\tpublic String getCurrentComponent() {" + NL + "\t\treturn this.currentComponent;" + NL + "\t}" + NL + "" + NL + "\t";
  protected final String TEXT_120 = NL + "    public String getExceptionCauseMessage(Exception e){" + NL + "        Throwable cause = e;" + NL + "        String message = null;" + NL + "        int i = 10;" + NL + "        while (null != cause && 0 < i--) {" + NL + "            message = cause.getMessage();" + NL + "            if (null == message) {" + NL + "                cause = cause.getCause();" + NL + "            } else {" + NL + "                break;          " + NL + "            }" + NL + "        }" + NL + "        if (null == message) {" + NL + "            message = e.getClass().getName();" + NL + "        }   " + NL + "        return message;" + NL + "    }" + NL + "" + NL + "\t@Override" + NL + "\tpublic void printStackTrace() {" + NL + "\t\tif (!(e instanceof TalendException || e instanceof TDieException)) {" + NL + "\t\t\tif(virtualComponentName!=null && currentComponent.indexOf(virtualComponentName+\"_\")==0){" + NL + "\t\t\t\tglobalMap.put(virtualComponentName+\"_ERROR_MESSAGE\",getExceptionCauseMessage(e));" + NL + "\t\t\t}" + NL + "\t\t\tglobalMap.put(currentComponent+\"_ERROR_MESSAGE\",getExceptionCauseMessage(e));" + NL + "\t\t\tSystem.err.println(\"Exception in component \" + currentComponent + \" (\" + jobName + \")\");" + NL + "\t\t}" + NL + "\t\tif (!(e instanceof TDieException)) {" + NL + "\t\t\tif(e instanceof TalendException){" + NL + "\t\t\t\te.printStackTrace();" + NL + "\t\t\t} else {" + NL + "\t\t\t\te.printStackTrace();" + NL + "\t\t\t\te.printStackTrace(errorMessagePS);" + NL + "\t\t\t\t";
  protected final String TEXT_121 = ".this.exception = e;" + NL + "\t\t\t}" + NL + "\t\t}" + NL + "\t\tif (!(e instanceof TalendException)) {" + NL + "\t\ttry {" + NL + "\t\t\tfor (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {" + NL + "\t\t\t\tif (m.getName().compareTo(currentComponent + \"_error\") == 0) {" + NL + "\t\t\t\t\tm.invoke(";
  protected final String TEXT_122 = ".this, new Object[] { e , currentComponent, globalMap});" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "" + NL + "\t\t\tif(!(e instanceof TDieException)){";
  protected final String TEXT_123 = NL + "\t\tif(enableLogStash) {" + NL + "\t\t\t";
  protected final String TEXT_124 = ".addJobExceptionMessage(currentComponent, cLabel, null, e);" + NL + "\t\t\t";
  protected final String TEXT_125 = "Process(globalMap);" + NL + "\t\t}";
  protected final String TEXT_126 = NL + "\t\t\t\t";
  protected final String TEXT_127 = ".addMessage(\"Java Exception\", currentComponent, 6, e.getClass().getName() + \":\" + e.getMessage(), 1);";
  protected final String TEXT_128 = NL + "\t\t\ttry{";
  protected final String TEXT_129 = "Process(globalMap);";
  protected final String TEXT_130 = NL + "\t\t\t}finally{";
  protected final String TEXT_131 = NL + "\t\t\t}";
  protected final String TEXT_132 = NL + "\t\t\t} catch (TalendException e) {" + NL + "\t\t\t\t// do nothing" + NL + "\t\t\t";
  protected final String TEXT_133 = NL + "\t\t} catch (Exception e) {" + NL + "\t\t\tthis.e.printStackTrace();" + NL + "\t\t}" + NL + "\t\t}" + NL + "\t}" + NL + "}" + NL;
  protected final String TEXT_134 = NL + "\t\t\tpublic void ";
  protected final String TEXT_135 = "_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {" + NL + "\t\t\t\t";
  protected final String TEXT_136 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_137 = "_error(exception, errorComponent, globalMap);" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_138 = NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_139 = NL + "\t\t\t\t\t";
  protected final String TEXT_140 = "_error(exception, errorComponent, globalMap);" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_141 = NL + "\t\t\t\tend_Hash.put(errorComponent, System.currentTimeMillis());" + NL + "\t\t\t\t";
  protected final String TEXT_142 = NL + "\t\t\t\t\t\t\t\tif(!(exception instanceof TDieException)){" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_143 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_144 = ".addMessage(pid, projectName, jobName, \"java\", null, \"Failed\", \"Job execution error\", exception);" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_145 = ".addMessage(pid, projectName, jobName, \"java\", null, \"Failed\", \"Job execution error\", exception.getMessage());" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_146 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_147 = "Process(globalMap);" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_148 = ".addMessage(\"failure\",errorComponent, end_Hash.get(errorComponent)-start_Hash.get(errorComponent));" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_149 = "Process(globalMap);" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_150 = NL + "\t\t\t\t\t\ttry {" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_151 = NL + "\t\t\t\t\t\t\t\tif(this.execStat){" + NL + "\t\t\t\t\t\t\t\t\trunStat.updateStatOnConnection(\"";
  protected final String TEXT_152 = "\", 0, \"error\");" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_153 = NL + "\t\t\t\t\t\t\t\t((java.util.Map)threadLocal.get()).put(\"errorCode\", null);" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_154 = "Process(globalMap);" + NL + "\t\t\t\t\t\t\t\tif ( !\"failure\".equals(((java.util.Map)threadLocal.get()).get(\"status\")) ) {" + NL + "\t\t\t\t\t\t\t\t\t((java.util.Map)threadLocal.get()).put(\"status\", \"end\");" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_155 = NL + "\t\t\t\t\t\t\t\terrorCode = null;" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_156 = "Process(globalMap);" + NL + "\t\t\t\t\t\t\t\tif (!\"failure\".equals(status)) {" + NL + "\t\t\t\t\t\t\t\t\tstatus = \"end\";" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_157 = NL + NL + "\t\t\t\t\t\t} catch (Exception e) {" + NL + "\t\t\t\t\t\t\te.printStackTrace();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_158 = NL + "\t\t\t\t((java.util.Map)threadLocal.get()).put(\"status\", \"failure\");" + NL + "\t\t\t\t";
  protected final String TEXT_159 = NL + "\t\t\t\tstatus = \"failure\";" + NL + "\t\t\t\t";
  protected final String TEXT_160 = "_onSubJobError(exception, errorComponent, globalMap);" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_161 = "_onSubJobError(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {";
  protected final String TEXT_162 = NL + NL + "resumeUtil.addLog(\"SYSTEM_LOG\", \"NODE:\"+ errorComponent, \"\", Thread.currentThread().getId()+ \"\", \"";
  protected final String TEXT_163 = "\", \"\", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),\"\");" + NL;
  protected final String TEXT_164 = NL + "\t\t\t\ttry {" + NL + "\t\t\t\t\t";
  protected final String TEXT_165 = NL + "\t\t\t\t\t\tif(this.execStat){" + NL + "\t\t\t\t\t\t\trunStat.updateStatOnConnection(\"";
  protected final String TEXT_166 = "\", 0, \"error\");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_167 = NL + "\t\t\t\t\t((java.util.Map)threadLocal.get()).put(\"errorCode\", null);" + NL + "\t\t\t\t\t";
  protected final String TEXT_168 = "Process(globalMap);" + NL + "\t\t\t\t\tif ( !\"failure\".equals(((java.util.Map)threadLocal.get()).get(\"status\")) ) {" + NL + "\t\t\t\t\t\t((java.util.Map)threadLocal.get()).put(\"status\", \"end\");" + NL + "\t\t\t\t\t}";
  protected final String TEXT_169 = NL + "\t\t\t\t\terrorCode = null;" + NL + "\t\t\t\t\t";
  protected final String TEXT_170 = "Process(globalMap);" + NL + "\t\t\t\t\tif (!\"failure\".equals(status)) {" + NL + "\t\t\t\t\t\tstatus = \"end\";" + NL + "\t\t\t\t\t}";
  protected final String TEXT_171 = NL + "\t\t\t\t} catch (Exception e) {" + NL + "\t\t\t\t\te.printStackTrace();" + NL + "\t\t\t\t}";
