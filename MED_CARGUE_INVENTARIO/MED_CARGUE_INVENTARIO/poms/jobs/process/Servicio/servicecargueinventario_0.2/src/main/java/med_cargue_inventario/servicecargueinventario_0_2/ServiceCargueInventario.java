...
package med_cargue_inventario.servicecargueinventario_0_2;
...
/**
 * Job: ServiceCargueInventario Purpose: <br>
 * Description:  <br>
 * @author jorgejlhc@gmail.com
 * @version 8.8.8.20240722_1936-SNAPSHOT
 * @status 
 */
public class ServiceCargueInventario implements TalendJob {
...
public String getResult(){
	...
	private final String jobName = "ServiceCargueInventario";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ServiceCargueInventario.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ServiceCargueInventario.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class RestServiceProviderImpl4TalendJob {
	...
	private final ServiceCargueInventario job;

	public RestServiceProviderImpl4TalendJob(ServiceCargueInventario job) {
		this.job = job;
	}

	private void populateRequestWithJobContext(java.util.Map<String, Object> requestGlobalMap, ServiceCargueInventario job) {
...
class Thread4RestServiceProviderEndpoint extends Thread {
	...
	public Thread4RestServiceProviderEndpoint(ServiceCargueInventario job, String endpointUrl) {
		this.job = job;
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression, String jobName)
			...
			java.io.InputStream inContext = ServiceCargueInventario.class.getClassLoader()
					.getResourceAsStream("med_cargue_inventario/servicecargueinventario_0_2/contexts/" + currentContext  + ".properties");
			if (inContext == null) {
				inContext = ServiceCargueInventario.class.getClassLoader()
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_MED_CARGUE_INVENTARIO_ServiceCargueInventario = new byte[0];
    static byte[] commonByteArray_MED_CARGUE_INVENTARIO_ServiceCargueInventario = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_MED_CARGUE_INVENTARIO_ServiceCargueInventario) {
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_MED_CARGUE_INVENTARIO_ServiceCargueInventario.length) {
				if(length < 1024 && commonByteArray_MED_CARGUE_INVENTARIO_ServiceCargueInventario.length == 0) {
   					commonByteArray_MED_CARGUE_INVENTARIO_ServiceCargueInventario = new byte[1024];
				} else {
   					commonByteArray_MED_CARGUE_INVENTARIO_ServiceCargueInventario = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_MED_CARGUE_INVENTARIO_ServiceCargueInventario, 0, length);
			strReturn = new String(commonByteArray_MED_CARGUE_INVENTARIO_ServiceCargueInventario, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_MED_CARGUE_INVENTARIO_ServiceCargueInventario, 0, length);
			strReturn = new String(commonByteArray_MED_CARGUE_INVENTARIO_ServiceCargueInventario, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
if (needRoot) {
	needRoot=false;
		...
		valueMap.put("root_1","Proceso de cargue de inventario ejecuctado satisfactoriamente");
...
if (needRoot) {
	needRoot=false;
		...
		org.dom4j.Element root_1 = null;
				root_1 = root.addElement("Message");
		valueMap.put("root_1","Error de ejecución del proceso de cargue de inventario");
		if(valueMap.get("root_1")!=null) {
			routines.system.NestXMLTool.setText(root_1,FormatterUtils.fm(valueMap.get("root_1"),null));
		}
		org.dom4j.Element root_2 = null;
...
if (needRoot) {
	needRoot=false;
		...
		org.dom4j.Element root_1 = null;
				root_1 = root.addElement("Message");
		valueMap.put("root_1","Error en el llamado del ETL de cargue de inventario");
		if(valueMap.get("root_1")!=null) {
			routines.system.NestXMLTool.setText(root_1,FormatterUtils.fm(valueMap.get("root_1"),null));
		}
		org.dom4j.Element root_2 = null;
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		med_cargue_inventario.cargainventario_1_5.CargaInventario childJob_tRunJob_1 = new med_cargue_inventario.cargainventario_1_5.CargaInventario();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final ServiceCargueInventario ServiceCargueInventarioClass = new ServiceCargueInventario();

        int exitCode = ServiceCargueInventarioClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ServiceCargueInventario.class.getClassLoader().getResourceAsStream("med_cargue_inventario/servicecargueinventario_0_2/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = ServiceCargueInventario.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ServiceCargueInventario");
        }
...
/************************************************************************************************
 *     223734 characters generated by Talend Open Studio for ESB 
 *     on the October 28, 2024, 3:00:39 PM COT
 ************************************************************************************************/