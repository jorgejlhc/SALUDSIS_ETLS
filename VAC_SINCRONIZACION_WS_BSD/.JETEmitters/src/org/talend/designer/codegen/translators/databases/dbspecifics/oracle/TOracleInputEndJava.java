...
public class TOracleInputEndJava
{
  ...
  protected final String TEXT_72 = NL + "}" + NL + "}finally{" + NL + "\tif (rs_";
  protected final String TEXT_73 = " != null) {" + NL + "\t\trs_";
  protected final String TEXT_74 = ".close();" + NL + "\t}" + NL + "\tif (stmt_";
  protected final String TEXT_75 = " != null) {" + NL + "\t\tstmt_";
  protected final String TEXT_76 = ".close();" + NL + "\t}";
  protected final String TEXT_77 = NL + "\tif(conn_";
  protected final String TEXT_78 = " != null && !conn_";
  protected final String TEXT_79 = ".isClosed()) {" + NL + "\t";
  protected final String TEXT_80 = NL + "\t}" + NL + "\t";
  protected final String TEXT_81 = NL + "}" + NL + "" + NL + "globalMap.put(\"";
