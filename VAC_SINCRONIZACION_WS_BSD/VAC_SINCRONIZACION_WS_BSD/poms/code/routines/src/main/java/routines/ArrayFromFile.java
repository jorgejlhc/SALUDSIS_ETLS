...
public class ArrayFromFile {
	...
	/**
     * It has a ByteArrayFromFile function, that requires a file path as input parameter and is used to read 
     * a file and convert it to a byte array. The user routine code for this example as follows.     
     */
