...
package vac_sincronizacion_ws_bsd.mail_1_3;
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_VAC_SINCRONIZACION_WS_BSD_Mail = new byte[0];
    static byte[] commonByteArray_VAC_SINCRONIZACION_WS_BSD_Mail = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_VAC_SINCRONIZACION_WS_BSD_Mail.length) {
				if(length < 1024 && commonByteArray_VAC_SINCRONIZACION_WS_BSD_Mail.length == 0) {
   					commonByteArray_VAC_SINCRONIZACION_WS_BSD_Mail = new byte[1024];
				} else {
   					commonByteArray_VAC_SINCRONIZACION_WS_BSD_Mail = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_VAC_SINCRONIZACION_WS_BSD_Mail, 0, length);
			strReturn = new String(commonByteArray_VAC_SINCRONIZACION_WS_BSD_Mail, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_VAC_SINCRONIZACION_WS_BSD_Mail, 0, length);
			strReturn = new String(commonByteArray_VAC_SINCRONIZACION_WS_BSD_Mail, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_VAC_SINCRONIZACION_WS_BSD_Mail) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Mail.class.getClassLoader().getResourceAsStream("vac_sincronizacion_ws_bsd/mail_1_3/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     116964 characters generated by Talend Open Studio for ESB 
 *     on the November 1, 2024, 12:57:15 AM COT
 ************************************************************************************************/