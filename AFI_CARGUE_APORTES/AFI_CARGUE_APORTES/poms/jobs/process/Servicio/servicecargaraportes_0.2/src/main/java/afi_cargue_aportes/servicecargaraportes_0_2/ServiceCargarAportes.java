...
package afi_cargue_aportes.servicecargaraportes_0_2;
...
/**
 * Job: ServiceCargarAportes Purpose: <br>
 * Description:  <br>
 * @author jorgejlhc@gmail.com
 * @version 8.8.8.20240722_1936-SNAPSHOT
 * @status 
 */
public class ServiceCargarAportes implements TalendJob {
...
public BigDecimal getIdSolicitud(){
	...
	private final String jobName = "ServiceCargarAportes";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ServiceCargarAportes.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ServiceCargarAportes.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class RestServiceProviderImpl4TalendJob {
	...
	private final ServiceCargarAportes job;

	public RestServiceProviderImpl4TalendJob(ServiceCargarAportes job) {
		this.job = job;
	}

	private void populateRequestWithJobContext(java.util.Map<String, Object> requestGlobalMap, ServiceCargarAportes job) {
...
class Thread4RestServiceProviderEndpoint extends Thread {
	...
	public Thread4RestServiceProviderEndpoint(ServiceCargarAportes job, String endpointUrl) {
		this.job = job;
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression, String jobName)
			...
			java.io.InputStream inContext = ServiceCargarAportes.class.getClassLoader()
					.getResourceAsStream("afi_cargue_aportes/servicecargaraportes_0_2/contexts/" + currentContext  + ".properties");
			if (inContext == null) {
				inContext = ServiceCargarAportes.class.getClassLoader()
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_AFI_CARGUE_APORTES_ServiceCargarAportes = new byte[0];
    static byte[] commonByteArray_AFI_CARGUE_APORTES_ServiceCargarAportes = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_AFI_CARGUE_APORTES_ServiceCargarAportes) {
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_AFI_CARGUE_APORTES_ServiceCargarAportes.length) {
				if(length < 1024 && commonByteArray_AFI_CARGUE_APORTES_ServiceCargarAportes.length == 0) {
   					commonByteArray_AFI_CARGUE_APORTES_ServiceCargarAportes = new byte[1024];
				} else {
   					commonByteArray_AFI_CARGUE_APORTES_ServiceCargarAportes = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_AFI_CARGUE_APORTES_ServiceCargarAportes, 0, length);
			strReturn = new String(commonByteArray_AFI_CARGUE_APORTES_ServiceCargarAportes, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_AFI_CARGUE_APORTES_ServiceCargarAportes, 0, length);
			strReturn = new String(commonByteArray_AFI_CARGUE_APORTES_ServiceCargarAportes, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
if (needRoot) {
	needRoot=false;
		...
		valueMap.put("root_1","Proceso de cargue de aportes ejecuctado satisfactoriamente");
...
if (needRoot) {
	needRoot=false;
		...
		org.dom4j.Element root_1 = null;
				root_1 = root.addElement("Message");
		valueMap.put("root_1","Error de ejecución del proceso de cargue de aportes");
		if(valueMap.get("root_1")!=null) {
			routines.system.NestXMLTool.setText(root_1,FormatterUtils.fm(valueMap.get("root_1"),null));
		}
		org.dom4j.Element root_2 = null;
...
if (needRoot) {
	needRoot=false;
		...
		org.dom4j.Element root_1 = null;
				root_1 = root.addElement("Message");
		valueMap.put("root_1","Error en el llamado del ETL de cargue de aportes");
		if(valueMap.get("root_1")!=null) {
			routines.system.NestXMLTool.setText(root_1,FormatterUtils.fm(valueMap.get("root_1"),null));
		}
		org.dom4j.Element root_2 = null;
...
if(in != null) { 
	...
	boolean isMatchDocRowtXMLMap_4_TXMLMAP_OUT = false;
				...
				absolutePathMappings_tXMLMap_4_TXMLMAP_OUT[0] = "in.body:/root/ARCHIVOS_ID";
				relativePathMappings_tXMLMap_4_TXMLMAP_OUT[0] = "ARCHIVOS_ID";
...
if( 
 ...
 treeNodeAPI_tXMLMap_4_TXMLMAP_OUT.get_String("in.body:/root/ARCHIVOS_ID") != null

 ) {

RequestOK_tmp = new RequestOKStruct();
RequestOK_tmp.IdSolicitud = treeNodeAPI_tXMLMap_4_TXMLMAP_OUT.get_String("in.body:/root/ARCHIVOS_ID");allOutsForAggregate_tXMLMap_4.add(RequestOK_tmp);
	...
	Object obj_tRunJob_1 = null;
		...
		if(obj_tRunJob_1!=null) {
			if (obj_tRunJob_1.getClass().getName().equals("java.util.Date")) {
				paraList_tRunJob_1.add("--context_param ARCHIVOS_ID=" + ((java.util.Date) obj_tRunJob_1).getTime());
			} else {
				
					paraList_tRunJob_1.add("--context_param ARCHIVOS_ID=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
					
				
			}
		} else {
			paraList_tRunJob_1.add("--context_param ARCHIVOS_ID=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_1.put("ARCHIVOS_ID", obj_tRunJob_1);
	
	
		afi_cargue_aportes.cargaraportes_0_1.CargarAportes childJob_tRunJob_1 = new afi_cargue_aportes.cargaraportes_0_1.CargarAportes();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final ServiceCargarAportes ServiceCargarAportesClass = new ServiceCargarAportes();

        int exitCode = ServiceCargarAportesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ServiceCargarAportes.class.getClassLoader().getResourceAsStream("afi_cargue_aportes/servicecargaraportes_0_2/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = ServiceCargarAportes.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ServiceCargarAportes");
        }
...
/************************************************************************************************
 *     212231 characters generated by Talend Open Studio for ESB 
 *     on the October 28, 2024, 10:59:38 AM COT
 ************************************************************************************************/