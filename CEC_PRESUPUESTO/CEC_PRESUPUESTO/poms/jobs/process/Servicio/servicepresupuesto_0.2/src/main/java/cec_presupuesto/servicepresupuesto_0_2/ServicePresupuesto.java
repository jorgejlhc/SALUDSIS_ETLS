...
package cec_presupuesto.servicepresupuesto_0_2;
...
/**
 * Job: ServicePresupuesto Purpose: <br>
 * Description:  <br>
 * @author jorgejlhc@gmail.com
 * @version 8.8.8.20240722_1936-SNAPSHOT
 * @status 
 */
public class ServicePresupuesto implements TalendJob {
...
public Integer getIdSolicitud(){
	...
	private final String jobName = "ServicePresupuesto";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ServicePresupuesto.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ServicePresupuesto.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class RestServiceProviderImpl4TalendJob {
	...
	private final ServicePresupuesto job;

	public RestServiceProviderImpl4TalendJob(ServicePresupuesto job) {
		this.job = job;
	}

	private void populateRequestWithJobContext(java.util.Map<String, Object> requestGlobalMap, ServicePresupuesto job) {
...
class Thread4RestServiceProviderEndpoint extends Thread {
	...
	public Thread4RestServiceProviderEndpoint(ServicePresupuesto job, String endpointUrl) {
		this.job = job;
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression, String jobName)
			...
			java.io.InputStream inContext = ServicePresupuesto.class.getClassLoader()
					.getResourceAsStream("cec_presupuesto/servicepresupuesto_0_2/contexts/" + currentContext  + ".properties");
			if (inContext == null) {
				inContext = ServicePresupuesto.class.getClassLoader()
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_CEC_PRESUPUESTO_ServicePresupuesto = new byte[0];
    static byte[] commonByteArray_CEC_PRESUPUESTO_ServicePresupuesto = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_CEC_PRESUPUESTO_ServicePresupuesto) {
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_CEC_PRESUPUESTO_ServicePresupuesto.length) {
				if(length < 1024 && commonByteArray_CEC_PRESUPUESTO_ServicePresupuesto.length == 0) {
   					commonByteArray_CEC_PRESUPUESTO_ServicePresupuesto = new byte[1024];
				} else {
   					commonByteArray_CEC_PRESUPUESTO_ServicePresupuesto = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_CEC_PRESUPUESTO_ServicePresupuesto, 0, length);
			strReturn = new String(commonByteArray_CEC_PRESUPUESTO_ServicePresupuesto, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_CEC_PRESUPUESTO_ServicePresupuesto, 0, length);
			strReturn = new String(commonByteArray_CEC_PRESUPUESTO_ServicePresupuesto, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
if (needRoot) {
	needRoot=false;
		...
		valueMap.put("root_1","Proceso de presupuesto ejecuctado satisfactoriamente");
...
if (needRoot) {
	needRoot=false;
		...
		org.dom4j.Element root_1 = null;
				root_1 = root.addElement("Message");
		valueMap.put("root_1","Error en el llamado del ETL presupuesto");
		if(valueMap.get("root_1")!=null) {
			routines.system.NestXMLTool.setText(root_1,FormatterUtils.fm(valueMap.get("root_1"),null));
		}
		org.dom4j.Element root_2 = null;
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		cec_presupuesto.presupuesto_0_1.Presupuesto childJob_tRunJob_1 = new cec_presupuesto.presupuesto_0_1.Presupuesto();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final ServicePresupuesto ServicePresupuestoClass = new ServicePresupuesto();

        int exitCode = ServicePresupuestoClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ServicePresupuesto.class.getClassLoader().getResourceAsStream("cec_presupuesto/servicepresupuesto_0_2/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = ServicePresupuesto.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ServicePresupuesto");
        }
...
/************************************************************************************************
 *     211633 characters generated by Talend Open Studio for ESB 
 *     on the October 28, 2024, 11:31:00 AM COT
 ************************************************************************************************/