...
public class TOracleRowEndJava
{
  ...
  protected final String TEXT_72 = NL + "        stmt_";
  protected final String TEXT_73 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_74 = " +\" OFF\");" + NL + "\t";
  protected final String TEXT_75 = NL + "\tglobalMap.put(\"";
  protected final String TEXT_76 = "_NB_LINE\", count_";
  protected final String TEXT_77 = NL + "        pstmt_";
  protected final String TEXT_78 = ".close();" + NL + "        resourceMap.remove(\"pstmt_";
  protected final String TEXT_79 = "\");";
  protected final String TEXT_80 = NL + "        stmt_";
  protected final String TEXT_81 = ".close();" + NL + "        resourceMap.remove(\"stmt_";
  protected final String TEXT_82 = NL + "    resourceMap.put(\"statementClosed_";
  protected final String TEXT_83 = "\", true);";
  protected final String TEXT_84 = NL + "\t\tif(commitEvery_";
  protected final String TEXT_85 = ">commitCounter_";
  protected final String TEXT_86 = "){" + NL + "" + NL + "\t\t\t";
  protected final String TEXT_87 = NL + "\t" + NL + "\t\t\tcommitCounter_";
  protected final String TEXT_88 = "=0;" + NL + "\t" + NL + "\t\t}";
