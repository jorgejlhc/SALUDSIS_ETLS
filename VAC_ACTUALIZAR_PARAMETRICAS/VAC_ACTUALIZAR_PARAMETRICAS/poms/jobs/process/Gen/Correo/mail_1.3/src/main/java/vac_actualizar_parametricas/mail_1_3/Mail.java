...
package vac_actualizar_parametricas.mail_1_3;
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_VAC_ACTUALIZAR_PARAMETRICAS_Mail = new byte[0];
    static byte[] commonByteArray_VAC_ACTUALIZAR_PARAMETRICAS_Mail = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_VAC_ACTUALIZAR_PARAMETRICAS_Mail.length) {
				if(length < 1024 && commonByteArray_VAC_ACTUALIZAR_PARAMETRICAS_Mail.length == 0) {
   					commonByteArray_VAC_ACTUALIZAR_PARAMETRICAS_Mail = new byte[1024];
				} else {
   					commonByteArray_VAC_ACTUALIZAR_PARAMETRICAS_Mail = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_VAC_ACTUALIZAR_PARAMETRICAS_Mail, 0, length);
			strReturn = new String(commonByteArray_VAC_ACTUALIZAR_PARAMETRICAS_Mail, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_VAC_ACTUALIZAR_PARAMETRICAS_Mail, 0, length);
			strReturn = new String(commonByteArray_VAC_ACTUALIZAR_PARAMETRICAS_Mail, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_VAC_ACTUALIZAR_PARAMETRICAS_Mail) {
...
context.server_origen = row1.Host;
context.service_name_origen = row1.ServiceName;
context.moment = TalendDate.getCurrentDate();
context.user_origen = row1.User;
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Mail.class.getClassLoader().getResourceAsStream("vac_actualizar_parametricas/mail_1_3/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     117028 characters generated by Talend Open Studio for ESB 
 *     on the November 1, 2024, 12:23:27 AM COT
 ************************************************************************************************/