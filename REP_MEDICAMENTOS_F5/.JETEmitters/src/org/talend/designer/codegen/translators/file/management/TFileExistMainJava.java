...
public class TFileExistMainJava
{
  ...
  protected final String TEXT_25 = ".exists()) {" + NL + "    globalMap.put(\"";
  protected final String TEXT_26 = "_EXISTS\",false);";
  protected final String TEXT_27 = NL + "    log.info(\"";
  protected final String TEXT_28 = " - Directory or file : \" + file_";
  protected final String TEXT_29 = ".getAbsolutePath() + \" doesn't exist.\");";
  protected final String TEXT_30 = NL + "}else{" + NL + "\tglobalMap.put(\"";
  protected final String TEXT_31 = "_EXISTS\",true);";
  protected final String TEXT_32 = ".getAbsolutePath() + \" exists.\");";
  protected final String TEXT_33 = NL + "}" + NL + "" + NL + "globalMap.put(\"";
  protected final String TEXT_34 = "_FILENAME\",";
