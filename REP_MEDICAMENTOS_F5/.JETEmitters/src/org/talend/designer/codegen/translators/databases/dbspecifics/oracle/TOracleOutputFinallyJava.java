...
public class TOracleOutputFinallyJava {
  ...
  protected final String TEXT_35 = NL + "    String keyPsmt_";
  protected final String TEXT_36 = " = null;" + NL + "    if ((keyPsmt_";
  protected final String TEXT_37 = " = (String) resourceMap.remove(\"keyPsmt_";
  protected final String TEXT_38 = "\")) != null) {" + NL + "        SharedDBPreparedStatement.releasePreparedStatement(keyPsmt_";
  protected final String TEXT_39 = ");" + NL + "    }";
  protected final String TEXT_40 = NL + "    try {";
  protected final String TEXT_41 = NL + "    if (resourceMap.get(\"statementClosed_";
  protected final String TEXT_42 = "\") == null) {";
  protected final String TEXT_43 = NL + "            java.sql.Statement stmtToClose_";
  protected final String TEXT_44 = " = null;" + NL + "            if ((stmtToClose_";
  protected final String TEXT_45 = " = (java.sql.Statement) resourceMap.remove(\"stmt_";
  protected final String TEXT_46 = "\")) != null) {" + NL + "                stmtToClose_";
  ...
  protected final String TEXT_62 = NL + "    } finally {" + NL + "        if(resourceMap.get(\"finish_";
  protected final String TEXT_63 = "\") == null){" + NL + "            java.sql.Connection ctn_";
  protected final String TEXT_64 = " = null;" + NL + "            if((ctn_";
  protected final String TEXT_65 = " = (java.sql.Connection)resourceMap.get(\"conn_";
  protected final String TEXT_66 = "\")) != null){" + NL + "                try {";
  protected final String TEXT_67 = NL + "                        if(!ctn_";
  protected final String TEXT_68 = ".getAutoCommit() && !ctn_";
  protected final String TEXT_69 = ".isClosed()) {" + NL + "                            ctn_";
  protected final String TEXT_70 = ".commit();" + NL + "                        }";
  protected final String TEXT_71 = NL + "                    ctn_";
  protected final String TEXT_72 = ".close();";
  protected final String TEXT_73 = NL + "                } catch (java.sql.SQLException sqlEx_";
  protected final String TEXT_74 = ") {" + NL + "                    String errorMessage_";
  protected final String TEXT_75 = " = \"failed to close the connection in ";
  protected final String TEXT_76 = " :\" + sqlEx_";
  protected final String TEXT_77 = ".getMessage();";
  protected final String TEXT_78 = NL + "                    System.err.println(errorMessage_";
