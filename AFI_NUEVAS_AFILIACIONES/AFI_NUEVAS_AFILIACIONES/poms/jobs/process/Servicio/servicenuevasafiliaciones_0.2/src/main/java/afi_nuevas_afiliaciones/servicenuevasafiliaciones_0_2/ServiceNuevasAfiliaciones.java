...
package afi_nuevas_afiliaciones.servicenuevasafiliaciones_0_2;
...
/**
 * Job: ServiceNuevasAfiliaciones Purpose: <br>
 * Description:  <br>
 * @author jorgejlhc@gmail.com
 * @version 8.8.8.20240722_1936-SNAPSHOT
 * @status 
 */
public class ServiceNuevasAfiliaciones implements TalendJob {
...
public String getFECHA_INICIO(){
	...
	private final String jobName = "ServiceNuevasAfiliaciones";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ServiceNuevasAfiliaciones.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ServiceNuevasAfiliaciones.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class RestServiceProviderImpl4TalendJob {
	...
	private final ServiceNuevasAfiliaciones job;

	public RestServiceProviderImpl4TalendJob(ServiceNuevasAfiliaciones job) {
		this.job = job;
	}

	private void populateRequestWithJobContext(java.util.Map<String, Object> requestGlobalMap, ServiceNuevasAfiliaciones job) {
...
class Thread4RestServiceProviderEndpoint extends Thread {
	...
	public Thread4RestServiceProviderEndpoint(ServiceNuevasAfiliaciones job, String endpointUrl) {
		this.job = job;
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression, String jobName)
			...
			java.io.InputStream inContext = ServiceNuevasAfiliaciones.class.getClassLoader()
					.getResourceAsStream("afi_nuevas_afiliaciones/servicenuevasafiliaciones_0_2/contexts/" + currentContext  + ".properties");
			if (inContext == null) {
				inContext = ServiceNuevasAfiliaciones.class.getClassLoader()
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_AFI_NUEVAS_AFILIACIONES_ServiceNuevasAfiliaciones = new byte[0];
    static byte[] commonByteArray_AFI_NUEVAS_AFILIACIONES_ServiceNuevasAfiliaciones = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_AFI_NUEVAS_AFILIACIONES_ServiceNuevasAfiliaciones) {
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_AFI_NUEVAS_AFILIACIONES_ServiceNuevasAfiliaciones.length) {
				if(length < 1024 && commonByteArray_AFI_NUEVAS_AFILIACIONES_ServiceNuevasAfiliaciones.length == 0) {
   					commonByteArray_AFI_NUEVAS_AFILIACIONES_ServiceNuevasAfiliaciones = new byte[1024];
				} else {
   					commonByteArray_AFI_NUEVAS_AFILIACIONES_ServiceNuevasAfiliaciones = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_AFI_NUEVAS_AFILIACIONES_ServiceNuevasAfiliaciones, 0, length);
			strReturn = new String(commonByteArray_AFI_NUEVAS_AFILIACIONES_ServiceNuevasAfiliaciones, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_AFI_NUEVAS_AFILIACIONES_ServiceNuevasAfiliaciones, 0, length);
			strReturn = new String(commonByteArray_AFI_NUEVAS_AFILIACIONES_ServiceNuevasAfiliaciones, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
if (needRoot) {
	needRoot=false;
		...
		valueMap.put("root_1","Proceso de nuevas afiliaciones ejecuctado satisfactoriamente");
...
if (needRoot) {
	needRoot=false;
		...
		org.dom4j.Element root_1 = null;
				root_1 = root.addElement("Message");
		valueMap.put("root_1","Error de ejecución del proceso de nuevas afiliaciones");
		if(valueMap.get("root_1")!=null) {
			routines.system.NestXMLTool.setText(root_1,FormatterUtils.fm(valueMap.get("root_1"),null));
		}
		org.dom4j.Element root_2 = null;
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    ...
    static byte[] commonByteArray_AFI_NUEVAS_AFILIACIONES_ServiceNuevasAfiliaciones = new byte[0];
				...
				public Boolean FechaInicioIsNullable(){
				    return true;
				}
				public Boolean FechaInicioIsKey(){
				    return false;
				}
				public Integer FechaInicioLength(){
				    return null;
				}
				public Integer FechaInicioPrecision(){
				    return null;
				}
				public String FechaInicioDefault(){
				
					return null;
				
				}
				public String FechaInicioComment(){
				
				    return "";
				
				}
				public String FechaInicioPattern(){
				
					return "";
				
				}
				public String FechaInicioOriginalDbColumnName(){
		...
		synchronized(commonByteArrayLock_AFI_NUEVAS_AFILIACIONES_ServiceNuevasAfiliaciones) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.FechaInicio = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.FechaInicio,dos);
...
if (needRoot) {
	needRoot=false;
		...
		org.dom4j.Element root_1 = null;
				root_1 = root.addElement("Message");
		valueMap.put("root_1","Error en el llamado del ETL de nuevas afiliaciones");
		if(valueMap.get("root_1")!=null) {
			routines.system.NestXMLTool.setText(root_1,FormatterUtils.fm(valueMap.get("root_1"),null));
		}
		org.dom4j.Element root_2 = null;
...
if (needRoot) {
	needRoot=false;
		...
		org.dom4j.Element root_1 = null;
				root_1 = root.addElement("Message");
		valueMap.put("root_1","El identificador de la solicitud no puede ser nulo 1");
		if(valueMap.get("root_1")!=null) {
			routines.system.NestXMLTool.setText(root_1, FormatterUtils.fm(valueMap.get("root_1"),null));
		}
		org.dom4j.Element root_2 = null;
...
if(in != null) { 
	...
	boolean isMatchDocRowtXMLMap_4_TXMLMAP_OUT = false;
				...
				absolutePathMappings_tXMLMap_4_TXMLMAP_OUT[0] = "in.body:/root/FECHA_INICIO";
				relativePathMappings_tXMLMap_4_TXMLMAP_OUT[0] = "FECHA_INICIO";
				
				absolutePathMappings_tXMLMap_4_TXMLMAP_OUT[1] = "in.body:/root/Usuario";
				relativePathMappings_tXMLMap_4_TXMLMAP_OUT[1] = "Usuario";
...
treeNodeAPI_tXMLMap_4_TXMLMAP_OUT.get_String("in.body:/root/Usuario") != null

 ) {

RequestOK_tmp = new RequestOKStruct();
RequestOK_tmp.IdSolicitud = treeNodeAPI_tXMLMap_4_TXMLMAP_OUT.get_String("in.body:/root/Usuario");
RequestOK_tmp.FechaInicio = treeNodeAPI_tXMLMap_4_TXMLMAP_OUT.get_String("in.body:/root/FECHA_INICIO");allOutsForAggregate_tXMLMap_4.add(RequestOK_tmp);
...
row2.IdSolicitud = RequestOK.IdSolicitud;
row2.FechaInicio = RequestOK.FechaInicio;

context.Usuario = new BigDecimal(RequestOK.IdSolicitud);
context.FECHA_INICIO = RequestOK.FechaInicio;
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_1 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_1 {
                    ...
                    paraList_tRunJob_1.add("--context_type " + "Usuario" + "=" + "id_BigDecimal");
                    parentContextMap_tRunJob_1.put("FECHA_INICIO", context.FECHA_INICIO);
                    paraList_tRunJob_1.add("--context_type " + "FECHA_INICIO" + "=" + "id_String");
                        }
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = context.Usuario;
		if(obj_tRunJob_1!=null) {
			if (obj_tRunJob_1.getClass().getName().equals("java.util.Date")) {
				paraList_tRunJob_1.add("--context_param Usuario=" + ((java.util.Date) obj_tRunJob_1).getTime());
			} else {
				
					paraList_tRunJob_1.add("--context_param Usuario=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
					
				
			}
		} else {
			paraList_tRunJob_1.add("--context_param Usuario=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_1.put("Usuario", obj_tRunJob_1);
	
		obj_tRunJob_1 = context.FECHA_INICIO;
		if(obj_tRunJob_1!=null) {
			if (obj_tRunJob_1.getClass().getName().equals("java.util.Date")) {
				paraList_tRunJob_1.add("--context_param FECHA_INICIO=" + ((java.util.Date) obj_tRunJob_1).getTime());
			} else {
				
					paraList_tRunJob_1.add("--context_param FECHA_INICIO=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
					
				
			}
		} else {
			paraList_tRunJob_1.add("--context_param FECHA_INICIO=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_1.put("FECHA_INICIO", obj_tRunJob_1);
	
	
		afi_nuevas_afiliaciones.nuevasafiliacionesetapa1_0_2.NuevasAfiliacionesEtapa1 childJob_tRunJob_1 = new afi_nuevas_afiliaciones.nuevasafiliacionesetapa1_0_2.NuevasAfiliacionesEtapa1();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final ServiceNuevasAfiliaciones ServiceNuevasAfiliacionesClass = new ServiceNuevasAfiliaciones();

        int exitCode = ServiceNuevasAfiliacionesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ServiceNuevasAfiliaciones.class.getClassLoader().getResourceAsStream("afi_nuevas_afiliaciones/servicenuevasafiliaciones_0_2/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = ServiceNuevasAfiliaciones.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("Usuario")) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ServiceNuevasAfiliaciones");
        }
...
/************************************************************************************************
 *     220889 characters generated by Talend Open Studio for ESB 
 *     on the October 28, 2024, 11:22:24 AM COT
 ************************************************************************************************/