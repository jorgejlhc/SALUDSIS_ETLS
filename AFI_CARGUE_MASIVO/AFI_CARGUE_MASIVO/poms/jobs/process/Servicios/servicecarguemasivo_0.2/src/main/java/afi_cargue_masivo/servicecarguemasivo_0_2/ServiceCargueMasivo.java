...
package afi_cargue_masivo.servicecarguemasivo_0_2;
...
/**
 * Job: ServiceCargueMasivo Purpose: <br>
 * Description:  <br>
 * @author jorgejlhc@gmail.com
 * @version 8.8.8.20240722_1936-SNAPSHOT
 * @status 
 */
public class ServiceCargueMasivo implements TalendJob {
...
public Integer getIdSolicitud(){
	...
	private final String jobName = "ServiceCargueMasivo";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ServiceCargueMasivo.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ServiceCargueMasivo.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class RestServiceProviderImpl4TalendJob {
	...
	private final ServiceCargueMasivo job;

	public RestServiceProviderImpl4TalendJob(ServiceCargueMasivo job) {
		this.job = job;
	}

	private void populateRequestWithJobContext(java.util.Map<String, Object> requestGlobalMap, ServiceCargueMasivo job) {
...
class Thread4RestServiceProviderEndpoint extends Thread {
	...
	public Thread4RestServiceProviderEndpoint(ServiceCargueMasivo job, String endpointUrl) {
		this.job = job;
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression, String jobName)
			...
			java.io.InputStream inContext = ServiceCargueMasivo.class.getClassLoader()
					.getResourceAsStream("afi_cargue_masivo/servicecarguemasivo_0_2/contexts/" + currentContext  + ".properties");
			if (inContext == null) {
				inContext = ServiceCargueMasivo.class.getClassLoader()
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_AFI_CARGUE_MASIVO_ServiceCargueMasivo = new byte[0];
    static byte[] commonByteArray_AFI_CARGUE_MASIVO_ServiceCargueMasivo = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_AFI_CARGUE_MASIVO_ServiceCargueMasivo) {
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_AFI_CARGUE_MASIVO_ServiceCargueMasivo.length) {
				if(length < 1024 && commonByteArray_AFI_CARGUE_MASIVO_ServiceCargueMasivo.length == 0) {
   					commonByteArray_AFI_CARGUE_MASIVO_ServiceCargueMasivo = new byte[1024];
				} else {
   					commonByteArray_AFI_CARGUE_MASIVO_ServiceCargueMasivo = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_AFI_CARGUE_MASIVO_ServiceCargueMasivo, 0, length);
			strReturn = new String(commonByteArray_AFI_CARGUE_MASIVO_ServiceCargueMasivo, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_AFI_CARGUE_MASIVO_ServiceCargueMasivo, 0, length);
			strReturn = new String(commonByteArray_AFI_CARGUE_MASIVO_ServiceCargueMasivo, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
if (needRoot) {
	needRoot=false;
		...
		valueMap.put("root_1","Proceso de cargue masivo ejecuctado satisfactoriamente");
...
if (needRoot) {
	needRoot=false;
		...
		org.dom4j.Element root_1 = null;
				root_1 = root.addElement("Message");
		valueMap.put("root_1","Error de ejecución del proceso de cargue masivo");
		if(valueMap.get("root_1")!=null) {
			routines.system.NestXMLTool.setText(root_1,FormatterUtils.fm(valueMap.get("root_1"),null));
		}
		org.dom4j.Element root_2 = null;
...
public static class copyOfRequestERRORStruct implements routines.system.IPersistableRow<copyOfRequestERRORStruct> {
    final static byte[] commonByteArrayLock_AFI_CARGUE_MASIVO_ServiceCargueMasivo = new byte[0];
    static byte[] commonByteArray_AFI_CARGUE_MASIVO_ServiceCargueMasivo = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(copyOfRequestERRORStruct other) {
...
copyOfRequestERRORStruct copyOfRequestERROR = new copyOfRequestERRORStruct();
...
RequestERRORStruct RequestERROR = new RequestERRORStruct();
	...
	currentComponent="tRESTRequest_1_Loop";
		...
		int tos_count_tRESTRequest_1_Loop = 0;
						...
						if(execStat){
							runStat.updateStatOnConnection(iterateId,0,0,"row3","copyOfRequestERROR","in","RequestOK","row2","RequestERROR");
						}
 ...
 */
	...
	currentComponent="tRESTResponse_2";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"copyOfRequestERROR");
					}
...
// ###############################
// # Outputs initialization
copyOfRequestERRORStruct copyOfRequestERROR_tmp = new copyOfRequestERRORStruct();
copyOfRequestERRORStruct copyOfRequestERROR_save = null;
// ###############################
		int nb_line_tXMLMap_1 = 0; 
	
    XML_API_tXMLMap_1 xml_api_tXMLMap_1 = new XML_API_tXMLMap_1();

class GenerateDocument_copyOfRequestERROR {
    ...
    public GenerateDocument_copyOfRequestERROR() {
//    	this.treeNodeAPI = treeNodeAPI;
	...
	//We generate the TreeNode_API object only if there is a document in the main input table.
    void generateElements(boolean isInnerJoin, row3Struct row3, Var__tXMLMap_1__Struct Var
	) {
...
if (needRoot) {
	needRoot=false;
		...
		org.dom4j.Element root_1 = null;
				root_1 = root.addElement("Message");
		valueMap.put("root_1","Error en el llamado del servicio  de cargue masivo de afiliados");
		if(valueMap.get("root_1")!=null) {
			routines.system.NestXMLTool.setText(root_1,FormatterUtils.fm(valueMap.get("root_1"),null));
		}
		org.dom4j.Element root_2 = null;
...
if (needRoot) {
	needRoot=false;
		...
		org.dom4j.Element root_1 = null;
				root_1 = root.addElement("Message");
		valueMap.put("root_1","El identificador de la solicitud de cargue masivo no puede ser nulo");
		if(valueMap.get("root_1")!=null) {
			routines.system.NestXMLTool.setText(root_1, FormatterUtils.fm(valueMap.get("root_1"),null));
		}
		org.dom4j.Element root_2 = null;
...
if(row3 != null) { 
	...
	boolean isMatchDocRowtXMLMap_1 = false;
				    ...
				    GenerateDocument_copyOfRequestERROR gen_Doc_copyOfRequestERROR_tXMLMap_1 = new GenerateDocument_copyOfRequestERROR();
					copyOfRequestERROR_tmp.body = null;
...
copyOfRequestERROR = null;


// # Output table : 'copyOfRequestERROR'

gen_Doc_copyOfRequestERROR_tXMLMap_1.generateElements(rejectedDocInnerJoin_tXMLMap_1,row3,Var);

if(copyOfRequestERROR_tmp.body == null){
copyOfRequestERROR_tmp.body = new routines.system.Document();
copyOfRequestERROR_tmp.body.setDocument(gen_Doc_copyOfRequestERROR_tXMLMap_1.getDocument());
}

copyOfRequestERROR = copyOfRequestERROR_tmp;
copyOfRequestERROR_save = copyOfRequestERROR_tmp;
// ###############################
 ...
 */
// Start of branch "copyOfRequestERROR"
if(copyOfRequestERROR != null) { 
	...
	if (null == outputStream_tRESTResponse_2 && responseAlreadySent_tRESTResponse_2) {
		...
		if (null != copyOfRequestERROR.body) {
			restProviderResponse_tRESTResponse_2 = copyOfRequestERROR.body.getDocument();
		}
...
} // End of branch "copyOfRequestERROR"
...
if(in != null) { 
	...
	boolean isMatchDocRowtXMLMap_4_TXMLMAP_OUT = false;
				...
				absolutePathMappings_tXMLMap_4_TXMLMAP_OUT[0] = "in.body:/root/afiarchivos_id";
				relativePathMappings_tXMLMap_4_TXMLMAP_OUT[0] = "afiarchivos_id";
...
treeNodeAPI_tXMLMap_4_TXMLMAP_OUT.get_String("in.body:/root/afiarchivos_id") != null

 ) {

RequestOK_tmp = new RequestOKStruct();
RequestOK_tmp.IdSolicitud = treeNodeAPI_tXMLMap_4_TXMLMAP_OUT.get_String("in.body:/root/afiarchivos_id");allOutsForAggregate_tXMLMap_4.add(RequestOK_tmp);
 ...
 */
	...
	currentComponent="tRESTResponse_2";
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"copyOfRequestERROR");
			  	}
	...
	Object obj_tRunJob_1 = null;
		...
		if(obj_tRunJob_1!=null) {
			if (obj_tRunJob_1.getClass().getName().equals("java.util.Date")) {
				paraList_tRunJob_1.add("--context_param afiarchivos_id=" + ((java.util.Date) obj_tRunJob_1).getTime());
			} else {
				
					paraList_tRunJob_1.add("--context_param afiarchivos_id=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
					
				
			}
		} else {
			paraList_tRunJob_1.add("--context_param afiarchivos_id=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_1.put("afiarchivos_id", obj_tRunJob_1);
	
	
		afi_cargue_masivo.carguemasivo_0_1.carguemasivo childJob_tRunJob_1 = new afi_cargue_masivo.carguemasivo_0_1.carguemasivo();
	    // pass DataSources
 ...
 */
	...
	globalMap.put("tRESTRequest_1_NB_LINE", nb_line_tRESTRequest_1);
				...
				if(execStat){
					runStat.updateStatOnConnection(iterateId,2,0,"row3","copyOfRequestERROR","in","RequestOK","row2","RequestERROR");
				}
 ...
 */
    ...
    public static void main(String[] args){
        final ServiceCargueMasivo ServiceCargueMasivoClass = new ServiceCargueMasivo();

        int exitCode = ServiceCargueMasivoClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ServiceCargueMasivo.class.getClassLoader().getResourceAsStream("afi_cargue_masivo/servicecarguemasivo_0_2/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = ServiceCargueMasivo.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ServiceCargueMasivo");
        }
...
/************************************************************************************************
 *     212398 characters generated by Talend Open Studio for ESB 
 *     on the October 28, 2024, 2:28:08 PM COT
 ************************************************************************************************/