...
package afi_cargue_masivo.mail_1_3;
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_AFI_CARGUE_MASIVO_Mail = new byte[0];
    static byte[] commonByteArray_AFI_CARGUE_MASIVO_Mail = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_AFI_CARGUE_MASIVO_Mail.length) {
				if(length < 1024 && commonByteArray_AFI_CARGUE_MASIVO_Mail.length == 0) {
   					commonByteArray_AFI_CARGUE_MASIVO_Mail = new byte[1024];
				} else {
   					commonByteArray_AFI_CARGUE_MASIVO_Mail = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_AFI_CARGUE_MASIVO_Mail, 0, length);
			strReturn = new String(commonByteArray_AFI_CARGUE_MASIVO_Mail, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_AFI_CARGUE_MASIVO_Mail, 0, length);
			strReturn = new String(commonByteArray_AFI_CARGUE_MASIVO_Mail, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_AFI_CARGUE_MASIVO_Mail) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Mail.class.getClassLoader().getResourceAsStream("afi_cargue_masivo/mail_1_3/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     128188 characters generated by Talend Open Studio for ESB 
 *     on the October 28, 2024, 2:28:00 PM COT
 ************************************************************************************************/