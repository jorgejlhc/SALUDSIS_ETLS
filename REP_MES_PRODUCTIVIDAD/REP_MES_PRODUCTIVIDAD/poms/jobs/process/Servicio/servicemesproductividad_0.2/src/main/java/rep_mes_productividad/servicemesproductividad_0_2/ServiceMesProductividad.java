...
package rep_mes_productividad.servicemesproductividad_0_2;
...
/**
 * Job: ServiceMesProductividad Purpose: <br>
 * Description:  <br>
 * @author jorgejlhc@gmail.com
 * @version 8.8.8.20240722_1936-SNAPSHOT
 * @status 
 */
public class ServiceMesProductividad implements TalendJob {
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext(){
			...
			if(UorgId != null){
					...
					this.setProperty("UorgId", UorgId.toString());
				
			}
			
			if(FechaFinal != null){
				
					this.setProperty("FechaFinal", FechaFinal.toString());
				
			}
			
			if(FechaInicial != null){
				
					this.setProperty("FechaInicial", FechaInicial.toString());
				
			}
			
			if(UsuarioId != null){
				
					this.setProperty("UsuarioId", UsuarioId.toString());
...
public Integer UorgId;
public Integer getUorgId(){
	return this.UorgId;
}
...
public Integer getUsuarioId(){
	...
	private final String jobName = "ServiceMesProductividad";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ServiceMesProductividad.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ServiceMesProductividad.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class RestServiceProviderImpl4TalendJob {
	...
	private final ServiceMesProductividad job;

	public RestServiceProviderImpl4TalendJob(ServiceMesProductividad job) {
		this.job = job;
	}

	private void populateRequestWithJobContext(java.util.Map<String, Object> requestGlobalMap, ServiceMesProductividad job) {
...
class Thread4RestServiceProviderEndpoint extends Thread {
	...
	public Thread4RestServiceProviderEndpoint(ServiceMesProductividad job, String endpointUrl) {
		this.job = job;
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression, String jobName)
			...
			java.io.InputStream inContext = ServiceMesProductividad.class.getClassLoader()
					.getResourceAsStream("rep_mes_productividad/servicemesproductividad_0_2/contexts/" + currentContext  + ".properties");
			if (inContext == null) {
				inContext = ServiceMesProductividad.class.getClassLoader()
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_REP_MES_PRODUCTIVIDAD_ServiceMesProductividad = new byte[0];
    static byte[] commonByteArray_REP_MES_PRODUCTIVIDAD_ServiceMesProductividad = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_REP_MES_PRODUCTIVIDAD_ServiceMesProductividad) {
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_REP_MES_PRODUCTIVIDAD_ServiceMesProductividad.length) {
				if(length < 1024 && commonByteArray_REP_MES_PRODUCTIVIDAD_ServiceMesProductividad.length == 0) {
   					commonByteArray_REP_MES_PRODUCTIVIDAD_ServiceMesProductividad = new byte[1024];
				} else {
   					commonByteArray_REP_MES_PRODUCTIVIDAD_ServiceMesProductividad = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_REP_MES_PRODUCTIVIDAD_ServiceMesProductividad, 0, length);
			strReturn = new String(commonByteArray_REP_MES_PRODUCTIVIDAD_ServiceMesProductividad, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_REP_MES_PRODUCTIVIDAD_ServiceMesProductividad, 0, length);
			strReturn = new String(commonByteArray_REP_MES_PRODUCTIVIDAD_ServiceMesProductividad, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
if (needRoot) {
	needRoot=false;
		...
		valueMap.put("root_1","Proceso del reporte de turno mes de productividad ejecuctado satisfactoriamente");
...
if (needRoot) {
	needRoot=false;
		...
		org.dom4j.Element root_1 = null;
				root_1 = root.addElement("Message");
		valueMap.put("root_1","Error de ejecución del proceso del reporte de turno mes de productividad");
		if(valueMap.get("root_1")!=null) {
			routines.system.NestXMLTool.setText(root_1,FormatterUtils.fm(valueMap.get("root_1"),null));
		}
		org.dom4j.Element root_2 = null;
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    ...
    static byte[] commonByteArray_REP_MES_PRODUCTIVIDAD_ServiceMesProductividad = new byte[0];
				...
				public Boolean PersonaIdIsNullable(){
				    return true;
				}
				public Boolean PersonaIdIsKey(){
				    return false;
				}
				public Integer PersonaIdLength(){
				    return null;
				}
				public Integer PersonaIdPrecision(){
				    return null;
				}
				public String PersonaIdDefault(){
				
					return null;
				
				}
				public String PersonaIdComment(){
				
				    return "";
				
				}
				public String PersonaIdPattern(){
				
					return "";
				
				}
				public String PersonaIdOriginalDbColumnName(){
				...
				public Boolean FechaInicialIsNullable(){
				    return true;
				}
				public Boolean FechaInicialIsKey(){
				    return false;
				}
				public Integer FechaInicialLength(){
				    return null;
				}
				public Integer FechaInicialPrecision(){
				    return null;
				}
				public String FechaInicialDefault(){
				
					return null;
				
				}
				public String FechaInicialComment(){
				
				    return "";
				
				}
				public String FechaInicialPattern(){
				
					return "";
				
				}
				public String FechaInicialOriginalDbColumnName(){
				...
				public Boolean FechaFinalIsNullable(){
				    return true;
				}
				public Boolean FechaFinalIsKey(){
				    return false;
				}
				public Integer FechaFinalLength(){
				    return null;
				}
				public Integer FechaFinalPrecision(){
				    return null;
				}
				public String FechaFinalDefault(){
				
					return null;
				
				}
				public String FechaFinalComment(){
				
				    return "";
				
				}
				public String FechaFinalPattern(){
				
					return "";
				
				}
				public String FechaFinalOriginalDbColumnName(){
				...
				public Boolean UsuarioIdIsNullable(){
				    return true;
				}
				public Boolean UsuarioIdIsKey(){
				    return false;
				}
				public Integer UsuarioIdLength(){
				    return null;
				}
				public Integer UsuarioIdPrecision(){
				    return null;
				}
				public String UsuarioIdDefault(){
				
					return null;
				
				}
				public String UsuarioIdComment(){
				
				    return "";
				
				}
				public String UsuarioIdPattern(){
				
					return "";
				
				}
				public String UsuarioIdOriginalDbColumnName(){
		...
		synchronized(commonByteArrayLock_REP_MES_PRODUCTIVIDAD_ServiceMesProductividad) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.PersonaId = readString(dis);
					
					this.FechaInicial = readString(dis);
					
					this.FechaFinal = readString(dis);
					
					this.UorgId = readString(dis);
					
					this.UsuarioId = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.PersonaId,dos);
					
					// String
				
						writeString(this.FechaInicial,dos);
					
					// String
				
						writeString(this.FechaFinal,dos);
					
					// String
				
						writeString(this.UorgId,dos);
					
					// String
				
						writeString(this.UsuarioId,dos);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("PersonaId="+PersonaId);
		sb.append(",FechaInicial="+FechaInicial);
		sb.append(",FechaFinal="+FechaFinal);
		sb.append(",UorgId="+UorgId);
...
if (needRoot) {
	needRoot=false;
		...
		org.dom4j.Element root_1 = null;
				root_1 = root.addElement("Message");
		valueMap.put("root_1","Error en el llamado del ETL del reporte de turno mes de productividad");
		if(valueMap.get("root_1")!=null) {
			routines.system.NestXMLTool.setText(root_1,FormatterUtils.fm(valueMap.get("root_1"),null));
		}
		org.dom4j.Element root_2 = null;
...
if (needRoot) {
	needRoot=false;
		...
		org.dom4j.Element root_1 = null;
				root_1 = root.addElement("Message");
		valueMap.put("root_1",treeNodeAPI.get_String("in.body:/root/PERSONA_ID") == null ? "El identificador de la persona no puede ser nulo" : (treeNodeAPI.get_String("in.body:/root/FECHA_INICIAL") == null ? "La fecha inicial no puede ser nula" : (treeNodeAPI.get_String("in.body:/root/FECHA_FINAL") == null ? "La fecha final no puede ser nula" : (treeNodeAPI.get_String("in.body:/root/UORG_ID") == null ? "El identificador del establecimiento no puede ser nulo" : (treeNodeAPI.get_String("in.body:/root/USUARIO_ID") == null ? "El identificador del usuario no puede ser nulo" : "")))) );
		if(valueMap.get("root_1")!=null) {
			routines.system.NestXMLTool.setText(root_1, FormatterUtils.fm(valueMap.get("root_1"),null));
		}
		org.dom4j.Element root_2 = null;
...
if(in != null) { 
	...
	boolean isMatchDocRowtXMLMap_4_TXMLMAP_OUT = false;
				...
				String[] absolutePathMappings_tXMLMap_4_TXMLMAP_OUT = new String[5];
				String[] relativePathMappings_tXMLMap_4_TXMLMAP_OUT = new String[5];
				
				absolutePathMappings_tXMLMap_4_TXMLMAP_OUT[0] = "in.body:/root/UORG_ID";
				relativePathMappings_tXMLMap_4_TXMLMAP_OUT[0] = "UORG_ID";
				
				absolutePathMappings_tXMLMap_4_TXMLMAP_OUT[1] = "in.body:/root/USUARIO_ID";
				relativePathMappings_tXMLMap_4_TXMLMAP_OUT[1] = "USUARIO_ID";
				
				absolutePathMappings_tXMLMap_4_TXMLMAP_OUT[2] = "in.body:/root/PERSONA_ID";
				relativePathMappings_tXMLMap_4_TXMLMAP_OUT[2] = "PERSONA_ID";
				
				absolutePathMappings_tXMLMap_4_TXMLMAP_OUT[3] = "in.body:/root/FECHA_FINAL";
				relativePathMappings_tXMLMap_4_TXMLMAP_OUT[3] = "FECHA_FINAL";
				
				absolutePathMappings_tXMLMap_4_TXMLMAP_OUT[4] = "in.body:/root/FECHA_INICIAL";
				relativePathMappings_tXMLMap_4_TXMLMAP_OUT[4] = "FECHA_INICIAL";
...
treeNodeAPI_tXMLMap_4_TXMLMAP_OUT.get_String("in.body:/root/PERSONA_ID") != null && treeNodeAPI_tXMLMap_4_TXMLMAP_OUT.get_String("in.body:/root/FECHA_INICIAL") != null && treeNodeAPI_tXMLMap_4_TXMLMAP_OUT.get_String("in.body:/root/FECHA_FINAL") != null && treeNodeAPI_tXMLMap_4_TXMLMAP_OUT.get_String("in.body:/root/ESPECILIADADES_ID") != null&& treeNodeAPI_tXMLMap_4_TXMLMAP_OUT.get_String("in.body:/root/UORG_ID") != null && 
treeNodeAPI_tXMLMap_4_TXMLMAP_OUT.get_String("in.body:/root/USUARIO_ID") != null

 ) {

RequestOK_tmp = new RequestOKStruct();
RequestOK_tmp.PersonaId = treeNodeAPI_tXMLMap_4_TXMLMAP_OUT.get_String("in.body:/root/PERSONA_ID");
RequestOK_tmp.FechaInicial = treeNodeAPI_tXMLMap_4_TXMLMAP_OUT.get_String("in.body:/root/FECHA_INICIAL");
RequestOK_tmp.FechaFinal = treeNodeAPI_tXMLMap_4_TXMLMAP_OUT.get_String("in.body:/root/FECHA_FINAL");
RequestOK_tmp.UorgId = treeNodeAPI_tXMLMap_4_TXMLMAP_OUT.get_String("in.body:/root/UORG_ID");
RequestOK_tmp.UsuarioId = treeNodeAPI_tXMLMap_4_TXMLMAP_OUT.get_String("in.body:/root/USUARIO_ID");allOutsForAggregate_tXMLMap_4.add(RequestOK_tmp);
...
treeNodeAPI_tXMLMap_4_TXMLMAP_OUT.get_String("in.body:/root/PERSONA_ID") == null || 
 treeNodeAPI_tXMLMap_4_TXMLMAP_OUT.get_String("in.body:/root/FECHA_INICIAL") == null || treeNodeAPI_tXMLMap_4_TXMLMAP_OUT.get_String("in.body:/root/FECHA_FINAL") == null ||treeNodeAPI_tXMLMap_4_TXMLMAP_OUT.get_String("in.body:/root/UORG_ID") == null ||
treeNodeAPI_tXMLMap_4_TXMLMAP_OUT.get_String("in.body:/root/USUARIO_ID") == null
...
row2.PersonaId = RequestOK.PersonaId;
row2.FechaInicial = RequestOK.FechaInicial;
row2.FechaFinal = RequestOK.FechaFinal;
row2.UorgId = RequestOK.UorgId;
row2.UsuarioId = RequestOK.UsuarioId;

context.IdSolicitud = Integer.parseInt(RequestOK.PersonaId);
context.FechaInicial = RequestOK.FechaInicial;
context.FechaFinal = RequestOK.FechaFinal;
context.UorgId = Integer.parseInt(RequestOK.UorgId);
context.UsuarioId = Integer.parseInt(RequestOK.UsuarioId);
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_1 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_1 {
                    ...
                    parentContextMap_tRunJob_1.put("UorgId", context.UorgId);
                    paraList_tRunJob_1.add("--context_type " + "UorgId" + "=" + "id_Integer");
                    parentContextMap_tRunJob_1.put("FechaFinal", context.FechaFinal);
                    paraList_tRunJob_1.add("--context_type " + "FechaFinal" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("FechaInicial", context.FechaInicial);
                    paraList_tRunJob_1.add("--context_type " + "FechaInicial" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("UsuarioId", context.UsuarioId);
                    paraList_tRunJob_1.add("--context_type " + "UsuarioId" + "=" + "id_Integer");
                        }
	...
	Object obj_tRunJob_1 = null;
		...
		if(obj_tRunJob_1!=null) {
			if (obj_tRunJob_1.getClass().getName().equals("java.util.Date")) {
				paraList_tRunJob_1.add("--context_param PERSONA_ID=" + ((java.util.Date) obj_tRunJob_1).getTime());
			} else {
				
					paraList_tRunJob_1.add("--context_param PERSONA_ID=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
					
				
			}
		} else {
			paraList_tRunJob_1.add("--context_param PERSONA_ID=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_1.put("PERSONA_ID", obj_tRunJob_1);
	
		obj_tRunJob_1 = context.FechaInicial;
		if(obj_tRunJob_1!=null) {
			if (obj_tRunJob_1.getClass().getName().equals("java.util.Date")) {
				paraList_tRunJob_1.add("--context_param FECHA_INICIAL=" + ((java.util.Date) obj_tRunJob_1).getTime());
			} else {
				
					paraList_tRunJob_1.add("--context_param FECHA_INICIAL=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
					
				
			}
		} else {
			paraList_tRunJob_1.add("--context_param FECHA_INICIAL=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_1.put("FECHA_INICIAL", obj_tRunJob_1);
	
		obj_tRunJob_1 = context.FechaFinal;
		if(obj_tRunJob_1!=null) {
			if (obj_tRunJob_1.getClass().getName().equals("java.util.Date")) {
				paraList_tRunJob_1.add("--context_param FECHA_FINAL=" + ((java.util.Date) obj_tRunJob_1).getTime());
			} else {
				
					paraList_tRunJob_1.add("--context_param FECHA_FINAL=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
					
				
			}
		} else {
			paraList_tRunJob_1.add("--context_param FECHA_FINAL=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_1.put("FECHA_FINAL", obj_tRunJob_1);
	
		obj_tRunJob_1 = context.UorgId;
		if(obj_tRunJob_1!=null) {
			if (obj_tRunJob_1.getClass().getName().equals("java.util.Date")) {
				paraList_tRunJob_1.add("--context_param UORG_ID=" + ((java.util.Date) obj_tRunJob_1).getTime());
			} else {
				
					paraList_tRunJob_1.add("--context_param UORG_ID=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
					
				
			}
		} else {
			paraList_tRunJob_1.add("--context_param UORG_ID=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_1.put("UORG_ID", obj_tRunJob_1);
	
		obj_tRunJob_1 = context.UsuarioId;
		if(obj_tRunJob_1!=null) {
			if (obj_tRunJob_1.getClass().getName().equals("java.util.Date")) {
				paraList_tRunJob_1.add("--context_param USUARIO_ID=" + ((java.util.Date) obj_tRunJob_1).getTime());
			} else {
				
					paraList_tRunJob_1.add("--context_param USUARIO_ID=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
					
				
			}
		} else {
			paraList_tRunJob_1.add("--context_param USUARIO_ID=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_1.put("USUARIO_ID", obj_tRunJob_1);
	
	
		rep_mes_productividad.reporteturnomesproductividad_0_1.ReporteTurnoMesProductividad childJob_tRunJob_1 = new rep_mes_productividad.reporteturnomesproductividad_0_1.ReporteTurnoMesProductividad();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final ServiceMesProductividad ServiceMesProductividadClass = new ServiceMesProductividad();

        int exitCode = ServiceMesProductividadClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ServiceMesProductividad.class.getClassLoader().getResourceAsStream("rep_mes_productividad/servicemesproductividad_0_2/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = ServiceMesProductividad.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
            ...
            class ContextProcessing {
                private void processContext_0() {
                        ...
                        context.setContextType("UorgId", "id_Integer");
                        if(context.getStringValue("UorgId") == null) {
                            context.UorgId = null;
                        } else {
                            try{
                                context.UorgId=routines.system.ParserUtils.parseTo_Integer (context.getProperty("UorgId"));
                            } catch(NumberFormatException e){
                                System.err.println(String.format("Null value will be used for context parameter %s: %s", "UorgId", e.getMessage()));
                                context.UorgId=null;
                            }
                        }
                        context.setContextType("FechaFinal", "id_String");
                        if(context.getStringValue("FechaFinal") == null) {
                            context.FechaFinal = null;
                        } else {
                            context.FechaFinal=(String) context.getProperty("FechaFinal");
                        }
                        context.setContextType("FechaInicial", "id_String");
                        if(context.getStringValue("FechaInicial") == null) {
                            context.FechaInicial = null;
                        } else {
                            context.FechaInicial=(String) context.getProperty("FechaInicial");
                        }
                        context.setContextType("UsuarioId", "id_Integer");
                        if(context.getStringValue("UsuarioId") == null) {
                            context.UsuarioId = null;
                        } else {
                            try{
                                context.UsuarioId=routines.system.ParserUtils.parseTo_Integer (context.getProperty("UsuarioId"));
                            } catch(NumberFormatException e){
                                System.err.println(String.format("Null value will be used for context parameter %s: %s", "UsuarioId", e.getMessage()));
                                context.UsuarioId=null;
                            }
                        }
                } 
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("IdSolicitud")) {
            ...
            }if (parentContextMap.containsKey("UorgId")) {
                context.UorgId = (Integer) parentContextMap.get("UorgId");
            }if (parentContextMap.containsKey("FechaFinal")) {
                context.FechaFinal = (String) parentContextMap.get("FechaFinal");
            }if (parentContextMap.containsKey("FechaInicial")) {
                context.FechaInicial = (String) parentContextMap.get("FechaInicial");
            }if (parentContextMap.containsKey("UsuarioId")) {
                context.UsuarioId = (Integer) parentContextMap.get("UsuarioId");
            }
        }
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ServiceMesProductividad");
        }
...
/************************************************************************************************
 *     233917 characters generated by Talend Open Studio for ESB 
 *     on the October 28, 2024, 3:28:13 PM COT
 ************************************************************************************************/