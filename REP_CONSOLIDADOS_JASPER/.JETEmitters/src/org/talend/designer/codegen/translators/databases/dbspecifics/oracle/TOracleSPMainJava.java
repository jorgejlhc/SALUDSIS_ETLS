...
public class TOracleSPMainJava
{
  ...
  protected final String TEXT_53 = NL + "\t\t\t\t\tstatement_";
  protected final String TEXT_54 = ", oracle.jdbc.OracleTypes.OPAQUE, \"SYS.XMLTYPE\");";
  protected final String TEXT_55 = ", java.sql.Types.TIMESTAMP_WITH_TIMEZONE);";
  protected final String TEXT_56 = ", java.sql.Types.TIMESTAMP);";
  ...
  protected final String TEXT_65 = NL + "\t\t\t\t\t\t\t\t\toracle.xdb.XMLType xml_";
  protected final String TEXT_66 = " = (oracle.xdb.XMLType) statement_";
  protected final String TEXT_67 = ");" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_68 = " = xml_";
  protected final String TEXT_69 = ".getStringVal();";
  protected final String TEXT_70 = NL + "\t\t\t\t\t\t\t \t\ttmpString_";
  protected final String TEXT_71 = ".getString(";
  protected final String TEXT_72 = ");" + NL + "\t\t\t\t\t\t  \t\t\tif (tmpString_";
  protected final String TEXT_73 = " != null && tmpString_";
  protected final String TEXT_74 = ".length() > 0) {" + NL + "\t\t\t\t\t\t  \t\t\t\t";
  protected final String TEXT_75 = " = tmpString_";
  protected final String TEXT_76 = ".charAt(0);" + NL + "\t\t\t\t\t\t\t  \t\t}" + NL + "\t\t\t\t\t\t\t  \t\t";
  protected final String TEXT_77 = NL + "\t\t\t\t\t\t\t\t\ttmpDate_";
  protected final String TEXT_78 = ".getTimestamp(";
  protected final String TEXT_79 = ");" + NL + "\t\t\t\t\t\t\t\t\tif (tmpDate_";
  protected final String TEXT_80 = " != null)" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_81 = " = new java.util.Date(tmpDate_";
  protected final String TEXT_82 = ".getTime());" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_83 = NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_84 = ".get";
  protected final String TEXT_85 = NL + "\t\t\t\t\t\t\t\t\tif (statement_";
  protected final String TEXT_86 = ".wasNull()) {" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_87 = " = null;" + NL + "\t\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_88 = ";" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_89 = NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_90 = ";" + NL + "\t\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_91 = NL + "\t\t// No code generated: define a schema for ";
