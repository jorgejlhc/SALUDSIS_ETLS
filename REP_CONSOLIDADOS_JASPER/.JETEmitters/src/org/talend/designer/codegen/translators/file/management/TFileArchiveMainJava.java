...
public class TFileArchiveMainJava
{
  ...
  protected final String TEXT_84 = ".setUseZip4jEncryption(true);" + NL + "\t      zip_";
  protected final String TEXT_85 = ".setEncryptionMethod(net.lingala.zip4j.util.Zip4jConstants.";
  protected final String TEXT_86 = ");" + NL + "\t      ";
  protected final String TEXT_87 = NL + "\t         zip_";
  protected final String TEXT_88 = ".setAesKeyStrength(net.lingala.zip4j.util.Zip4jConstants.";
  protected final String TEXT_89 = NL + "\t\t  zip_";
  protected final String TEXT_90 = ".setUseZip4jEncryption(false);" + NL + "\t   ";
  protected final String TEXT_91 = NL + "  " + NL + "  " + NL + "   globalMap.put(\"";
  protected final String TEXT_92 = "_ARCHIVE_FILEPATH\",zipFile_";
  protected final String TEXT_93 = ");" + NL + "   " + NL + "   globalMap.put(\"";
  protected final String TEXT_94 = "_ARCHIVE_FILENAME\", new java.io.File(zipFile_";
  protected final String TEXT_95 = ").getName());" + NL + "" + NL + "   zip_";
  protected final String TEXT_96 = ".doZip();" + NL;
