...
package rep_resolucion_4505.mail_1_2;
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_REP_RESOLUCION_4505_Mail = new byte[0];
    static byte[] commonByteArray_REP_RESOLUCION_4505_Mail = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_REP_RESOLUCION_4505_Mail.length) {
				if(length < 1024 && commonByteArray_REP_RESOLUCION_4505_Mail.length == 0) {
   					commonByteArray_REP_RESOLUCION_4505_Mail = new byte[1024];
				} else {
   					commonByteArray_REP_RESOLUCION_4505_Mail = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_REP_RESOLUCION_4505_Mail, 0, length);
			strReturn = new String(commonByteArray_REP_RESOLUCION_4505_Mail, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_REP_RESOLUCION_4505_Mail, 0, length);
			strReturn = new String(commonByteArray_REP_RESOLUCION_4505_Mail, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_REP_RESOLUCION_4505_Mail) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Mail.class.getClassLoader().getResourceAsStream("rep_resolucion_4505/mail_1_2/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     95914 characters generated by Talend Open Studio for ESB 
 *     on the November 4, 2024, 4:08:33 PM COT
 ************************************************************************************************/