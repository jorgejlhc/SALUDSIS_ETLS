...
public class TFixedFlowInputBeginJava
{
  ...
  protected final String TEXT_47 = ".toString()), utf8Charset);" + NL + "} catch (java.lang.Exception e) {" + NL + "globalMap.put(\"";
  protected final String TEXT_48 = "_ERROR_MESSAGE\",e.getMessage());" + NL + "    e.printStackTrace();" + NL + "}" + NL + "" + NL + "int nb_line_";
  protected final String TEXT_49 = " = 0;" + NL + "" + NL + "for (int i_";
  protected final String TEXT_50 = "++) {\t" + NL + "" + NL + "java.io.InputStream ins_";
  protected final String TEXT_51 = " = new java.io.ByteArrayInputStream(originalFileContent_";
  protected final String TEXT_52 = ".getBytes(utf8Charset));        " + NL + "org.talend.fileprocess.FileInputDelimited fid_";
  protected final String TEXT_53 = " = new org.talend.fileprocess.FileInputDelimited(ins_";
  protected final String TEXT_54 = ", utf8Charset,";
  protected final String TEXT_55 = ",";
  protected final String TEXT_56 = ",true, 0, 0, -1, -1, false);" + NL + "" + NL + "while (fid_";
  protected final String TEXT_57 = ".nextRecord()) {" + NL + "\tnb_line_";
  protected final String TEXT_58 = "++;";
  protected final String TEXT_59 = NL + "\t\t\t";
  protected final String TEXT_60 = NL + NL + "\t\t\t\tif(";
  protected final String TEXT_61 = " < fid_";
  protected final String TEXT_62 = ".getColumnsCountOfCurrentRow()){" + NL + "\t\t\t\t\tString colContent = fid_";
  protected final String TEXT_63 = ".get(";
  protected final String TEXT_64 = ");\t\t\t\t";
  protected final String TEXT_65 = NL + "                    \t\t";
  protected final String TEXT_66 = " = (colContent == null || colContent.length() == 0) ? ";
  protected final String TEXT_67 = ": colContent;";
  protected final String TEXT_68 = " = (colContent == null || colContent.length() == 0) ? ParserUtils.parseTo_Date(";
  protected final String TEXT_69 = "(String)";
  protected final String TEXT_70 = " ";
  protected final String TEXT_71 = ", ";
  protected final String TEXT_72 = ") : ParserUtils.parseTo_Date(colContent, ";
  protected final String TEXT_73 = " : colContent.getBytes();";
  protected final String TEXT_74 = " = (colContent == null || colContent.trim().length() == 0) ? ";
  protected final String TEXT_75 = " : ParserUtils.parseTo_";
  protected final String TEXT_76 = "(colContent);";
  protected final String TEXT_77 = "\t\t\t" + NL + "\t\t\t\t} else { " + NL + "\t\t\t\t";
  protected final String TEXT_78 = "\t" + NL + "\t\t\t\t\t";
  protected final String TEXT_79 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_80 = NL + "\t\t\t\t\t";
  protected final String TEXT_81 = " = ParserUtils.parseTo_Date(";
