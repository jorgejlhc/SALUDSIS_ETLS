...
public class TFileOutputDelimitedBeginJava
{
  ...
  protected final String TEXT_204 = NL + "                resourceMap.put(\"out_";
  protected final String TEXT_205 = "\", out";
  protected final String TEXT_206 = NL + "                        synchronized (multiThreadLockWrite) {";
  protected final String TEXT_207 = NL + "                            synchronized (fileName_";
  protected final String TEXT_208 = ".intern()) {";
  protected final String TEXT_209 = NL + "                                Object[] pLockWrite = (Object[])globalMap.get(\"PARALLEL_LOCK_WRITE\");" + NL + "                                synchronized (pLockWrite) {";
  protected final String TEXT_210 = NL + "                                    if(file_";
  protected final String TEXT_211 = ".length()==0){";
  protected final String TEXT_212 = NL + "                                    if(file";
  protected final String TEXT_213 = NL + "                                            fileOutputDelimitedUtil_";
  protected final String TEXT_214 = ".putHeaderValue_";
  protected final String TEXT_215 = "(out";
  protected final String TEXT_216 = ",OUT_DELIM_";
  protected final String TEXT_217 = NL + "                                        out";
  protected final String TEXT_218 = NL + "                                            out";
  protected final String TEXT_219 = ".write(OUT_DELIM_ROWSEP_";
  protected final String TEXT_220 = ");" + NL + "                                        out";
  protected final String TEXT_221 = ".flush();" + NL + "                                    }";
  protected final String TEXT_222 = NL + "                        }";
  protected final String TEXT_223 = NL + "                    //routines.system.Row" + NL + "                    java.util.zip.ZipOutputStream zipOut_";
  protected final String TEXT_224 = "= null;" + NL + "                    java.io.OutputStreamWriter writer_";
  protected final String TEXT_225 = " = null;" + NL + "                    java.io.Writer out";
  protected final String TEXT_226 = " = null;" + NL + "                    zipOut_";
  protected final String TEXT_227 = "=new java.util.zip.ZipOutputStream(new java.io.BufferedOutputStream(";
  protected final String TEXT_228 = "));" + NL + "                    zipOut_";
  protected final String TEXT_229 = ".putNextEntry(new java.util.zip.ZipEntry(\"TalendOutputDelimited\"));" + NL + "                    writer_";
  protected final String TEXT_230 = " = new java.io.OutputStreamWriter(zipOut_";
  protected final String TEXT_231 = ");" + NL + "                    out";
  protected final String TEXT_232 = "(writer_";
  protected final String TEXT_233 = NL + "                    //routines.system.Row" + NL + "                    java.io.OutputStreamWriter writer_";
  protected final String TEXT_234 = " = null;" + NL + "                    writer_";
  protected final String TEXT_235 = " = new java.io.OutputStreamWriter(";
  protected final String TEXT_236 = ");" + NL + "            \tresourceMap.put(\"writer_";
  protected final String TEXT_237 = "\", writer_";
  protected final String TEXT_238 = ");" + NL + "            \t";
  protected final String TEXT_239 = NL + "                                fileOutputDelimitedUtil_";
  protected final String TEXT_240 = NL + "                            out";
  protected final String TEXT_241 = NL + "                                out";
  protected final String TEXT_242 = "= true;" + NL + "                String[] headColu";
  protected final String TEXT_243 = " = null;";
  protected final String TEXT_244 = NL + "                String[] headColu";
  protected final String TEXT_245 = "=new String[";
  protected final String TEXT_246 = "];";
  protected final String TEXT_247 = NL + "            class CSVBasicSet_";
  protected final String TEXT_248 = "{" + NL + "                private char field_Delim;" + NL + "                private char row_Delim;" + NL + "                private char escape;" + NL + "                private char textEnclosure;" + NL + "                private boolean useCRLFRecordDelimiter;" + NL + "" + NL + "                public boolean isUseCRLFRecordDelimiter() {" + NL + "                    return useCRLFRecordDelimiter;" + NL + "                }" + NL + "" + NL + "                public void setFieldSeparator(String fieldSep) throws IllegalArgumentException{" + NL + "                    char field_Delim_";
  protected final String TEXT_249 = "[] = null;" + NL + "" + NL + "                    //support passing value (property: Field Separator) by 'context.fs' or 'globalMap.get(\"fs\")'." + NL + "                    if (fieldSep.length() > 0 ){" + NL + "                        field_Delim_";
  protected final String TEXT_250 = " = fieldSep.toCharArray();" + NL + "                    }else {" + NL + "                        throw new IllegalArgumentException(\"Field Separator must be assigned a char.\");" + NL + "                    }" + NL + "                    this.field_Delim = field_Delim_";
  protected final String TEXT_251 = "[0];" + NL + "                }" + NL + "" + NL + "                public char getFieldDelim(){" + NL + "                    if(this.field_Delim==0){" + NL + "                        setFieldSeparator(";
  protected final String TEXT_252 = ");" + NL + "                    }" + NL + "                    return this.field_Delim;" + NL + "                }" + NL + "" + NL + "                public void setRowSeparator(String rowSep){" + NL + "                    if(\"\\r\\n\".equals(rowSep)) {" + NL + "                        useCRLFRecordDelimiter = true;" + NL + "                        return;" + NL + "                    }" + NL + "                    char row_Delim";
  protected final String TEXT_253 = "[] = null;" + NL + "" + NL + "                    //support passing value (property: Row Separator) by 'context.rs' or 'globalMap.get(\"rs\")'." + NL + "                    if (rowSep.length() > 0 ){" + NL + "                        row_Delim";
  protected final String TEXT_254 = " = rowSep.toCharArray();" + NL + "                    }else {" + NL + "                        throw new IllegalArgumentException(\"Row Separator must be assigned a char.\");" + NL + "                    }" + NL + "                    this.row_Delim = row_Delim";
  protected final String TEXT_255 = "[0];" + NL + "                }" + NL + "" + NL + "                public char getRowDelim(){" + NL + "                    if(this.row_Delim==0){" + NL + "                        setRowSeparator(";
  protected final String TEXT_256 = ");" + NL + "                    }" + NL + "                    return this.row_Delim;" + NL + "                }" + NL + "" + NL + "                public void setEscapeAndTextEnclosure(String strEscape, String strTextEnclosure) throws IllegalArgumentException{" + NL + "                    if(strEscape.length() <= 0 ){" + NL + "                        throw new IllegalArgumentException(\"Escape Char must be assigned a char.\");" + NL + "                    }" + NL + "" + NL + "                    if (\"\".equals(strTextEnclosure)) strTextEnclosure = \"\\0\";" + NL + "                    char textEnclosure_";
  protected final String TEXT_257 = "[] = null;" + NL + "" + NL + "                    if(strTextEnclosure.length() > 0 ){" + NL + "                        textEnclosure_";
  protected final String TEXT_258 = " = strTextEnclosure.toCharArray();" + NL + "                    }else {" + NL + "                        throw new IllegalArgumentException(\"Text Enclosure must be assigned a char.\");" + NL + "                    }" + NL + "" + NL + "                    this.textEnclosure = textEnclosure_";
  ...
  protected final String TEXT_260 = " =0;" + NL + "            int currentRow_";
  protected final String TEXT_261 = " = 0;" + NL + "" + NL + "" + NL + "            CSVBasicSet_";
  protected final String TEXT_262 = " csvSettings_";
  protected final String TEXT_263 = " = new CSVBasicSet_";
  protected final String TEXT_264 = "();" + NL + "            csvSettings_";
  protected final String TEXT_265 = ".setFieldSeparator(";
  protected final String TEXT_266 = ");" + NL + "            csvSettings_";
  protected final String TEXT_267 = ".setRowSeparator(";
  protected final String TEXT_268 = ".setEscapeAndTextEnclosure(";
  protected final String TEXT_269 = " - Creating directory '\" +dir_";
  protected final String TEXT_270 = " - The directory '\" + dir_";
  protected final String TEXT_271 = NL + "                            file";
  protected final String TEXT_272 = ");" + NL + "                            String zipName_";
  protected final String TEXT_273 = " + \".zip\";" + NL + "                            java.io.File file_";
  protected final String TEXT_274 = ");" + NL + "                            //routines.system.Row" + NL + "                            java.util.zip.ZipOutputStream zipOut_";
  protected final String TEXT_275 = " = null;" + NL + "                            java.io.Writer out";
  protected final String TEXT_276 = " = null;" + NL + "                            com.talend.csv.CSVWriter CsvWriter";
  protected final String TEXT_277 = " = null;" + NL + "" + NL + "                            if(file_";
  protected final String TEXT_278 = ".exists()) {" + NL + "                                file_";
  protected final String TEXT_279 = ".delete();" + NL + "                            }" + NL + "                            zipOut_";
  protected final String TEXT_280 = "=new java.util.zip.ZipOutputStream(" + NL + "                                    new java.io.BufferedOutputStream(new java.io.FileOutputStream(zipName_";
  protected final String TEXT_281 = ")));" + NL + "                            zipOut_";
  protected final String TEXT_282 = ".getName()));" + NL + "                            out";
  protected final String TEXT_283 = " = new routines.system.BufferedOutput(new java.io.OutputStreamWriter(zipOut_";
  protected final String TEXT_284 = "));" + NL + "                            java.io.StringWriter strWriter";
  protected final String TEXT_285 = " = new java.io.StringWriter();" + NL + "                            CsvWriter";
  protected final String TEXT_286 = " = new com.talend.csv.CSVWriter(strWriter";
  protected final String TEXT_287 = ");" + NL + "                            CsvWriter";
  protected final String TEXT_288 = ".setSeparator(csvSettings_";
  protected final String TEXT_289 = ".getFieldDelim());";
  protected final String TEXT_290 = NL + "                            java.io.Writer out";
  protected final String TEXT_291 = NL + "                            java.io.File fileToDelete_";
  protected final String TEXT_292 = ");" + NL + "                            if(fileToDelete_";
  protected final String TEXT_293 = ".exists()) {" + NL + "                                fileToDelete_";
  protected final String TEXT_294 = ".delete();" + NL + "                            }";
  protected final String TEXT_295 = NL + "                            if (resourceMap.get(\"outWriter_for_\" + (";
  protected final String TEXT_296 = ")) == null) {" + NL + "                                out";
  protected final String TEXT_297 = " = new routines.system.BufferedOutput(new java.io.OutputStreamWriter(" + NL + "                                    new java.io.FileOutputStream(fileName_";
  protected final String TEXT_298 = "), ";
  protected final String TEXT_299 = "));" + NL + "                                resourceMap.put(\"outWriter_for_\" + (";
  protected final String TEXT_300 = "), out";
  protected final String TEXT_301 = ");" + NL + "                            } else {" + NL + "                                out";
  protected final String TEXT_302 = " = (java.io.Writer) resourceMap.get(\"outWriter_for_\" + (";
  protected final String TEXT_303 = "));" + NL + "                            }" + NL + "                            java.io.StringWriter strWriter";
  protected final String TEXT_304 = ".getName()));" + NL + "                            CsvWriter";
  protected final String TEXT_305 = " = new com.talend.csv.CSVWriter(new java.io.BufferedWriter(new java.io.OutputStreamWriter(" + NL + "                            zipOut_";
  protected final String TEXT_306 = ")));" + NL + "                            CsvWriter";
  protected final String TEXT_307 = NL + "                            com.talend.csv.CSVWriter CsvWriter";
  protected final String TEXT_308 = NL + "                            CsvWriter";
  protected final String TEXT_309 = " = new com.talend.csv.CSVWriter(new java.io.BufferedWriter(new java.io.OutputStreamWriter(" + NL + "                            new java.io.FileOutputStream(fileName_";
  protected final String TEXT_310 = ");" + NL + "                        java.io.Writer out";
  protected final String TEXT_311 = " = null;" + NL + "                        com.talend.csv.CSVWriter CsvWriter";
  protected final String TEXT_312 = NL + "                        if(file";
  protected final String TEXT_313 = ".exists()) {" + NL + "                            file";
  protected final String TEXT_314 = " = new routines.system.BufferedOutput(new java.io.OutputStreamWriter(" + NL + "                            new java.io.FileOutputStream(fullName_";
  protected final String TEXT_315 = "));" + NL + "                        java.io.StringWriter strWriter";
  protected final String TEXT_316 = " = new java.io.StringWriter();" + NL + "                        CsvWriter";
  protected final String TEXT_317 = ");" + NL + "                        CsvWriter";
  protected final String TEXT_318 = ".getFieldDelim());" + NL;
  protected final String TEXT_319 = ");" + NL + "                        com.talend.csv.CSVWriter CsvWriter";
  protected final String TEXT_320 = NL + "                        CsvWriter";
  protected final String TEXT_321 = " = new com.talend.csv.CSVWriter(new java.io.BufferedWriter(new java.io.OutputStreamWriter(" + NL + "                            new java.io.FileOutputStream(fullName_";
  protected final String TEXT_322 = ")));" + NL + "                        CsvWriter";
  protected final String TEXT_323 = NL + "                resourceMap.put(\"CsvWriter_";
  protected final String TEXT_324 = "\", CsvWriter";
  protected final String TEXT_325 = NL + "                \tresourceMap.put(\"out_";
  protected final String TEXT_326 = NL + "                    if(csvSettings_";
  protected final String TEXT_327 = ".isUseCRLFRecordDelimiter()) {" + NL + "                        CsvWriter";
  protected final String TEXT_328 = ".setLineEnd(\"\\r\\n\");" + NL + "                    } else {" + NL + "                        CsvWriter";
  protected final String TEXT_329 = ".setLineEnd(\"\"+csvSettings_";
  protected final String TEXT_330 = ".getRowDelim());" + NL + "                    }";
  protected final String TEXT_331 = NL + "                    if(!csvSettings_";
  protected final String TEXT_332 = ".isUseCRLFRecordDelimiter() && csvSettings_";
  protected final String TEXT_333 = ".getRowDelim()!='\\r' && csvSettings_";
  protected final String TEXT_334 = ".getRowDelim()!='\\n') {" + NL + "                        CsvWriter";
  protected final String TEXT_335 = NL + "                        synchronized (fileName_";
  protected final String TEXT_336 = NL + "                        Object[] pLockWrite = (Object[])globalMap.get(\"PARALLEL_LOCK_WRITE\");" + NL + "                        synchronized (pLockWrite) {";
  protected final String TEXT_337 = NL + "                        if(file_";
  protected final String TEXT_338 = NL + "                                        fileOutputDelimitedUtil_";
  protected final String TEXT_339 = "(headColu";
  protected final String TEXT_340 = NL + "                                    headColu";
  protected final String TEXT_341 = ".writeNext(headColu";
  protected final String TEXT_342 = ".flush();";
  protected final String TEXT_343 = ".write(strWriter";
  protected final String TEXT_344 = ".getBuffer().toString());" + NL + "                                out";
  protected final String TEXT_345 = ".flush();" + NL + "                                strWriter";
  protected final String TEXT_346 = ".getBuffer().delete(0, strWriter";
  protected final String TEXT_347 = ".getBuffer().length());";
  protected final String TEXT_348 = NL + "                        java.util.zip.ZipOutputStream zipOut_";
  protected final String TEXT_349 = " = null;" + NL + "                        java.io.OutputStreamWriter outWriter_";
  protected final String TEXT_350 = " = null;" + NL + "                        java.io.Writer out";
  protected final String TEXT_351 = " = null;" + NL + "                        zipOut_";
  ...
  protected final String TEXT_354 = ".putNextEntry(new java.util.zip.ZipEntry(\"TalendOutputDelimited\"));" + NL + "                        outWriter_";
  protected final String TEXT_355 = ");" + NL + "                        out";
  protected final String TEXT_356 = " = new routines.system.BufferedOutput(outWriter_";
  protected final String TEXT_357 = ");" + NL + "                        java.io.StringWriter strWriter";
  protected final String TEXT_358 = NL + "                        java.io.OutputStreamWriter outWriter_";
  protected final String TEXT_359 = " = null;" + NL + "                        outWriter_";
  protected final String TEXT_360 = " = null;" + NL + "                        java.io.BufferedWriter bufferWriter_";
  protected final String TEXT_361 = ");" + NL + "                        bufferWriter_";
  protected final String TEXT_362 = " = new java.io.BufferedWriter(outWriter_";
  protected final String TEXT_363 = " = new com.talend.csv.CSVWriter(bufferWriter_";
  protected final String TEXT_364 = NL + "                    resourceMap.put(\"out_";
  protected final String TEXT_365 = ");" + NL + "                    resourceMap.put(\"outWriter_";
  protected final String TEXT_366 = "\", outWriter_";
  protected final String TEXT_367 = NL + "                    resourceMap.put(\"bufferWriter_";
  protected final String TEXT_368 = "\", bufferWriter_";
  protected final String TEXT_369 = NL + "                            headColu";
  protected final String TEXT_370 = NL + "                    CsvWriter";
  protected final String TEXT_371 = ".getBuffer().toString());" + NL + "                        strWriter";
  protected final String TEXT_372 = NL + "                CsvWriter";
  protected final String TEXT_373 = ".setEscapeChar(csvSettings_";
  protected final String TEXT_374 = ".getEscapeChar());" + NL + "                CsvWriter";
  protected final String TEXT_375 = ".setQuoteChar(csvSettings_";
  protected final String TEXT_376 = ".getTextEnclosure());" + NL + "                CsvWriter";
  protected final String TEXT_377 = ".setQuoteStatus(com.talend.csv.CSVWriter.QuoteStatus.FORCE);";
  protected final String TEXT_378 = NL + NL + "resourceMap.put(\"nb_line_";
  protected final String TEXT_379 = "\", nb_line_";
  protected final String TEXT_380 = NL + "    resourceMap.put(\"isFileGenerated_";
  protected final String TEXT_381 = "\", isFileGenerated_";
  protected final String TEXT_382 = NL + "        resourceMap.put(\"file_";
  protected final String TEXT_383 = "\", file_";
  protected final String TEXT_384 = NL + "        resourceMap.put(\"file";
  protected final String TEXT_385 = "\", file";
