...
package rep_diario_recaudo.recconsolidado_4_0;
...
/**
 * Job: RecConsolidado Purpose: <br>
 * Description: Crea la vista createvmrecconsolidado y elimina de la bodega todos los registros del recaudo del periodo a ejecutar . <br>
 * @author jorgejlhc@gmail.com
 * @version 8.8.8.20240722_1936-SNAPSHOT
 * @status DEV
 */
public class RecConsolidado implements TalendJob {
...
public String getDb_destino_ServiceName(){
	...
	private final String jobName = "RecConsolidado";
...
private RunStat runStat = new RunStat();
	...
	StatCatcherUtils tStatCatcher_1 = new StatCatcherUtils("_B0BMAHkjEee1equY2UByPw", "4.0");
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				RecConsolidado.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(RecConsolidado.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
			...
			public void tOracleRow_9_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
				...
				((java.util.Map)threadLocal.get()).put("status", "failure");
					...
					tOracleRow_9_onSubJobError(exception, errorComponent, globalMap);
			}
			
			public void tOracleRow_10_error(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
resumeUtil.addLog("SYSTEM_LOG", "NODE:"+ errorComponent, "", Thread.currentThread().getId()+ "", "FATAL", "", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),"");
			...
			public void tOracleRow_9_onSubJobError(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {

resumeUtil.addLog("SYSTEM_LOG", "NODE:"+ errorComponent, "", Thread.currentThread().getId()+ "", "FATAL", "", exception.getMessage(), ResumeUtil.getExceptionStackTrace(exception),"");

			}
			public void tOracleRow_10_onSubJobError(Exception exception, String errorComponent, final java.util.Map<String, Object> globalMap) throws TalendException {
...
public static class row75Struct implements routines.system.IPersistableRow<row75Struct> {
    final static byte[] commonByteArrayLock_REP_DIARIO_RECAUDO_RecConsolidado = new byte[0];
    static byte[] commonByteArray_REP_DIARIO_RECAUDO_RecConsolidado = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_REP_DIARIO_RECAUDO_RecConsolidado.length) {
				if(length < 1024 && commonByteArray_REP_DIARIO_RECAUDO_RecConsolidado.length == 0) {
   					commonByteArray_REP_DIARIO_RECAUDO_RecConsolidado = new byte[1024];
				} else {
   					commonByteArray_REP_DIARIO_RECAUDO_RecConsolidado = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_REP_DIARIO_RECAUDO_RecConsolidado, 0, length);
			strReturn = new String(commonByteArray_REP_DIARIO_RECAUDO_RecConsolidado, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_REP_DIARIO_RECAUDO_RecConsolidado, 0, length);
			strReturn = new String(commonByteArray_REP_DIARIO_RECAUDO_RecConsolidado, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_REP_DIARIO_RECAUDO_RecConsolidado) {
...
System.out.println("Reset: " + context.PERIODO);
 ...
 */
	...
	currentComponent="tOracleSP_1";
			...
			// code for the argument 1 (periodo_) of type 'IN AUTOMAPPING'
    					if (row1.periodo_ == null) {
    						statement_tOracleSP_1.setNull(1, java.sql.Types.VARCHAR);
    					} else {
    					
                        statement_tOracleSP_1.setString(1, row1.periodo_);
    					}
 ...
 final boolean execStat = this.execStat;
	 ...
	 */
		...
		start_Hash.put("tOracleRow_1", System.currentTimeMillis());
				...
				tStatCatcher_1.addMessage("begin","tOracleRow_1");
				tStatCatcher_1Process(globalMap);
...
query_tOracleRow_1 = "DELETE \nFROM BREC_NOVEDAD\nWHERE PERIODO =  '" + context.PERIODO + "'";
...
tStatCatcher_1.addMessage("end","tOracleRow_1", end_Hash.get("tOracleRow_1")-start_Hash.get("tOracleRow_1"));
tStatCatcher_1Process(globalMap);
				if(execStat){   
 ...
 final boolean execStat = this.execStat;
	 ...
	 */
		...
		start_Hash.put("tOracleRow_2", System.currentTimeMillis());
				...
				tStatCatcher_1.addMessage("begin","tOracleRow_2");
				tStatCatcher_1Process(globalMap);
...
tStatCatcher_1.addMessage("end","tOracleRow_2", end_Hash.get("tOracleRow_2")-start_Hash.get("tOracleRow_2"));
tStatCatcher_1Process(globalMap);
				if(execStat){   
 ...
 final boolean execStat = this.execStat;
	 ...
	 */
		...
		start_Hash.put("tOracleRow_3", System.currentTimeMillis());
				...
				tStatCatcher_1.addMessage("begin","tOracleRow_3");
				tStatCatcher_1Process(globalMap);
...
tStatCatcher_1.addMessage("end","tOracleRow_3", end_Hash.get("tOracleRow_3")-start_Hash.get("tOracleRow_3"));
tStatCatcher_1Process(globalMap);
				if(execStat){   
 ...
 final boolean execStat = this.execStat;
	 ...
	 */
		...
		start_Hash.put("tOracleRow_4", System.currentTimeMillis());
				...
				tStatCatcher_1.addMessage("begin","tOracleRow_4");
				tStatCatcher_1Process(globalMap);
	...
	final String decryptedPassword_tOracleRow_4 = context.db_destino_Password; 
        ...
        resourceMap.put("stmt_tOracleRow_4", stmt_tOracleRow_4);
				int nb_line_deleted_tOracleRow_4 = 0;
...
query_tOracleRow_4 = "DELETE \nFROM BREC_RECPORAFILIACIONES\nWHERE PERIODO =  '" + context.PERIODO + "'";
...
try {
		...
		nb_line_deleted_tOracleRow_4 += stmt_tOracleRow_4.getUpdateCount();
	} catch (java.lang.Exception e) {
 ...
 */
    ...
    globalMap.put("tOracleRow_4_NB_LINE_DELETED",nb_line_deleted_tOracleRow_4);
 

ok_Hash.put("tOracleRow_4", true);
end_Hash.put("tOracleRow_4", System.currentTimeMillis());

tStatCatcher_1.addMessage("end","tOracleRow_4", end_Hash.get("tOracleRow_4")-start_Hash.get("tOracleRow_4"));
tStatCatcher_1Process(globalMap);
				if(execStat){   
 ...
 final boolean execStat = this.execStat;
	 ...
	 */
		...
		start_Hash.put("tOracleRow_5", System.currentTimeMillis());
				...
				tStatCatcher_1.addMessage("begin","tOracleRow_5");
				tStatCatcher_1Process(globalMap);
...
query_tOracleRow_5 = "DELETE \nFROM BREC_INGRESOMENSUAL\nWHERE PERIODO =  '" + context.PERIODO + "'";
...
tStatCatcher_1.addMessage("end","tOracleRow_5", end_Hash.get("tOracleRow_5")-start_Hash.get("tOracleRow_5"));
tStatCatcher_1Process(globalMap);
				if(execStat){   
 ...
 final boolean execStat = this.execStat;
	 ...
	 */
		...
		start_Hash.put("tOracleRow_6", System.currentTimeMillis());
				...
				tStatCatcher_1.addMessage("begin","tOracleRow_6");
				tStatCatcher_1Process(globalMap);
...
query_tOracleRow_6 = "DELETE \nFROM BREC_TOTALAPORPERIODO\nWHERE PERIODO =  '" + context.PERIODO + "'";
...
tStatCatcher_1.addMessage("end","tOracleRow_6", end_Hash.get("tOracleRow_6")-start_Hash.get("tOracleRow_6"));
tStatCatcher_1Process(globalMap);
				if(execStat){   
 ...
 final boolean execStat = this.execStat;
	 ...
	 */
		...
		start_Hash.put("tOracleRow_7", System.currentTimeMillis());
				...
				tStatCatcher_1.addMessage("begin","tOracleRow_7");
				tStatCatcher_1Process(globalMap);
	...
	int count_tOracleRow_7 = 0;
			String driverClass_tOracleRow_7 = "oracle.jdbc.OracleDriver";
		    java.lang.Class jdbcclazz_tOracleRow_7 = java.lang.Class.forName(driverClass_tOracleRow_7);
		
			String url_tOracleRow_7 = null;
				url_tOracleRow_7 = "jdbc:oracle:thin:@(description=(address=(protocol=tcp)(host=" + context.db_destino_Server + ")(port=" + context.db_destino_Port + "))(connect_data=(service_name=" + context.db_destino_ServiceName + ")))";
					String dbUser_tOracleRow_7 = context.db_destino_Login;
	        
            		
            		
            		
	final String decryptedPassword_tOracleRow_7 = context.db_destino_Password; 
        		   	
        	        String dbPwd_tOracleRow_7 = decryptedPassword_tOracleRow_7;
	        
					
			conn_tOracleRow_7 = java.sql.DriverManager.getConnection(url_tOracleRow_7,dbUser_tOracleRow_7,dbPwd_tOracleRow_7);
		
        resourceMap.put("conn_tOracleRow_7", conn_tOracleRow_7);
					if(conn_tOracleRow_7.getAutoCommit()) {
						
				conn_tOracleRow_7.setAutoCommit(false);
			
					}        
					int commitEvery_tOracleRow_7 = 1000;
					int commitCounter_tOracleRow_7 = 0;
        ...
        resourceMap.put("stmt_tOracleRow_7", stmt_tOracleRow_7);
				int nb_line_deleted_tOracleRow_7 = 0;
...
try {
		...
		nb_line_deleted_tOracleRow_7 += stmt_tOracleRow_7.getUpdateCount();
	} catch (java.lang.Exception e) {
globalMap.put("tOracleRow_7_ERROR_MESSAGE",e.getMessage());
	...
	if(!whetherReject_tOracleRow_7) {
		...
		commitCounter_tOracleRow_7++;
		if(commitEvery_tOracleRow_7 <= commitCounter_tOracleRow_7) {
			
			conn_tOracleRow_7.commit();
			
			commitCounter_tOracleRow_7=0;
		}
 ...
 */
    ...
    globalMap.put("tOracleRow_7_NB_LINE_DELETED",nb_line_deleted_tOracleRow_7);
 

ok_Hash.put("tOracleRow_7", true);
end_Hash.put("tOracleRow_7", System.currentTimeMillis());

tStatCatcher_1.addMessage("end","tOracleRow_7", end_Hash.get("tOracleRow_7")-start_Hash.get("tOracleRow_7"));
tStatCatcher_1Process(globalMap);
				if(execStat){   
...
try {
    if (resourceMap.get("statementClosed_tOracleRow_7") == null) {
        ...
        if(resourceMap.get("finish_tOracleRow_7") == null){
            java.sql.Connection ctn_tOracleRow_7 = null;
            if((ctn_tOracleRow_7 = (java.sql.Connection)resourceMap.get("conn_tOracleRow_7")) != null){
                try {
                    ctn_tOracleRow_7.close();
                } catch (java.sql.SQLException sqlEx_tOracleRow_7) {
                    String errorMessage_tOracleRow_7 = "failed to close the connection in tOracleRow_7 :" + sqlEx_tOracleRow_7.getMessage();
                    System.err.println(errorMessage_tOracleRow_7);
                }
            }
        }
    }
 ...
 final boolean execStat = this.execStat;
	 ...
	 */
		...
		start_Hash.put("tOracleRow_8", System.currentTimeMillis());
				...
				tStatCatcher_1.addMessage("begin","tOracleRow_8");
				tStatCatcher_1Process(globalMap);
	...
	int count_tOracleRow_8 = 0;
			String driverClass_tOracleRow_8 = "oracle.jdbc.OracleDriver";
		    java.lang.Class jdbcclazz_tOracleRow_8 = java.lang.Class.forName(driverClass_tOracleRow_8);
		
			String url_tOracleRow_8 = null;
				url_tOracleRow_8 = "jdbc:oracle:thin:@(description=(address=(protocol=tcp)(host=" + context.db_destino_Server + ")(port=" + context.db_destino_Port + "))(connect_data=(service_name=" + context.db_destino_ServiceName + ")))";
					String dbUser_tOracleRow_8 = context.db_destino_Login;
	        
            		
            		
            		
	final String decryptedPassword_tOracleRow_8 = context.db_destino_Password; 
        		   	
        	        String dbPwd_tOracleRow_8 = decryptedPassword_tOracleRow_8;
	        
					
			conn_tOracleRow_8 = java.sql.DriverManager.getConnection(url_tOracleRow_8,dbUser_tOracleRow_8,dbPwd_tOracleRow_8);
		
        resourceMap.put("conn_tOracleRow_8", conn_tOracleRow_8);
					if(conn_tOracleRow_8.getAutoCommit()) {
						
				conn_tOracleRow_8.setAutoCommit(false);
			
					}        
					int commitEvery_tOracleRow_8 = 1000;
					int commitCounter_tOracleRow_8 = 0;
        ...
        resourceMap.put("stmt_tOracleRow_8", stmt_tOracleRow_8);
				int nb_line_deleted_tOracleRow_8 = 0;
...
query_tOracleRow_8 = "DELETE \nFROM BREC_TOTALESAPORTRECAUDO\nWHERE PERIODO =  '" + context.PERIODO + "'";
...
try {
		...
		nb_line_deleted_tOracleRow_8 += stmt_tOracleRow_8.getUpdateCount();
	} catch (java.lang.Exception e) {
globalMap.put("tOracleRow_8_ERROR_MESSAGE",e.getMessage());
	...
	if(!whetherReject_tOracleRow_8) {
		...
		commitCounter_tOracleRow_8++;
		if(commitEvery_tOracleRow_8 <= commitCounter_tOracleRow_8) {
			
			conn_tOracleRow_8.commit();
			
			commitCounter_tOracleRow_8=0;
		}
 ...
 */
    ...
    globalMap.put("tOracleRow_8_NB_LINE_DELETED",nb_line_deleted_tOracleRow_8);
 

ok_Hash.put("tOracleRow_8", true);
end_Hash.put("tOracleRow_8", System.currentTimeMillis());

tStatCatcher_1.addMessage("end","tOracleRow_8", end_Hash.get("tOracleRow_8")-start_Hash.get("tOracleRow_8"));
tStatCatcher_1Process(globalMap);
				if(execStat){   
   	 				runStat.updateStatOnConnection("OnComponentOk17", 0, "ok");
				}
				tOracleRow_9Process(globalMap);
...
try {
    if (resourceMap.get("statementClosed_tOracleRow_8") == null) {
        ...
        if(resourceMap.get("finish_tOracleRow_8") == null){
            java.sql.Connection ctn_tOracleRow_8 = null;
            if((ctn_tOracleRow_8 = (java.sql.Connection)resourceMap.get("conn_tOracleRow_8")) != null){
                try {
                    ctn_tOracleRow_8.close();
                } catch (java.sql.SQLException sqlEx_tOracleRow_8) {
                    String errorMessage_tOracleRow_8 = "failed to close the connection in tOracleRow_8 :" + sqlEx_tOracleRow_8.getMessage();
                    System.err.println(errorMessage_tOracleRow_8);
                }
            }
        }
    }
...
public void tOracleRow_9Process(final java.util.Map<String, Object> globalMap) throws TalendException {
	globalMap.put("tOracleRow_9_SUBPROCESS_STATE", 0);
 ...
 final boolean execStat = this.execStat;
	 ...
	 */
		...
		ok_Hash.put("tOracleRow_9", false);
		start_Hash.put("tOracleRow_9", System.currentTimeMillis());
		
				tStatCatcher_1.addMessage("begin","tOracleRow_9");
				tStatCatcher_1Process(globalMap);
			
	
	currentComponent="tOracleRow_9";
	
	
		int tos_count_tOracleRow_9 = 0;
		

	java.sql.Connection conn_tOracleRow_9 = null;
	String query_tOracleRow_9 = "";
	boolean whetherReject_tOracleRow_9 = false;
	int count_tOracleRow_9 = 0;
			String driverClass_tOracleRow_9 = "oracle.jdbc.OracleDriver";
		    java.lang.Class jdbcclazz_tOracleRow_9 = java.lang.Class.forName(driverClass_tOracleRow_9);
		
			String url_tOracleRow_9 = null;
				url_tOracleRow_9 = "jdbc:oracle:thin:@(description=(address=(protocol=tcp)(host=" + context.db_destino_Server + ")(port=" + context.db_destino_Port + "))(connect_data=(service_name=" + context.db_destino_ServiceName + ")))";
					String dbUser_tOracleRow_9 = context.db_destino_Login;
	        
            		
            		
            		
	final String decryptedPassword_tOracleRow_9 = context.db_destino_Password; 
        		   	
        	        String dbPwd_tOracleRow_9 = decryptedPassword_tOracleRow_9;
	        
					
			conn_tOracleRow_9 = java.sql.DriverManager.getConnection(url_tOracleRow_9,dbUser_tOracleRow_9,dbPwd_tOracleRow_9);
		
        resourceMap.put("conn_tOracleRow_9", conn_tOracleRow_9);
					if(conn_tOracleRow_9.getAutoCommit()) {
						
				conn_tOracleRow_9.setAutoCommit(false);
			
					}        
					int commitEvery_tOracleRow_9 = 1000;
					int commitCounter_tOracleRow_9 = 0;
				
        java.sql.Statement stmt_tOracleRow_9 = conn_tOracleRow_9.createStatement();
        resourceMap.put("stmt_tOracleRow_9", stmt_tOracleRow_9);
				int nb_line_deleted_tOracleRow_9 = 0;
...
/**
 * [tOracleRow_9 begin ] stop
 */
	
	/**
	 * [tOracleRow_9 main ] start
	 */
...
query_tOracleRow_9 = "DELETE \nFROM BREC_TOTALBENEFICIARIOS\nWHERE PERIODO =  '" + context.PERIODO + "'";
whetherReject_tOracleRow_9 = false;
globalMap.put("tOracleRow_9_QUERY",query_tOracleRow_9);
try {
		stmt_tOracleRow_9.execute(query_tOracleRow_9);
		
		nb_line_deleted_tOracleRow_9 += stmt_tOracleRow_9.getUpdateCount();
	} catch (java.lang.Exception e) {
globalMap.put("tOracleRow_9_ERROR_MESSAGE",e.getMessage());
		whetherReject_tOracleRow_9 = true;
		
				System.err.print(e.getMessage());
				
	}
	
	if(!whetherReject_tOracleRow_9) {
		
	}
	
		commitCounter_tOracleRow_9++;
		if(commitEvery_tOracleRow_9 <= commitCounter_tOracleRow_9) {
			
			conn_tOracleRow_9.commit();
			
			commitCounter_tOracleRow_9=0;
		}
	...
	tos_count_tOracleRow_9++;

/**
 * [tOracleRow_9 main ] stop
 */
	
	/**
	 * [tOracleRow_9 process_data_begin ] start
	 */
...
/**
 * [tOracleRow_9 process_data_begin ] stop
 */
	
	/**
	 * [tOracleRow_9 process_data_end ] start
	 */
...
/**
 * [tOracleRow_9 process_data_end ] stop
 */
	
	/**
	 * [tOracleRow_9 end ] start
	 */
	...
	globalMap.put("tOracleRow_9_NB_LINE", count_tOracleRow_9);
        stmt_tOracleRow_9.close();
        resourceMap.remove("stmt_tOracleRow_9");
    resourceMap.put("statementClosed_tOracleRow_9", true);
		if(commitEvery_tOracleRow_9>commitCounter_tOracleRow_9){
    ...
    resourceMap.put("finish_tOracleRow_9", true);

    globalMap.put("tOracleRow_9_NB_LINE_DELETED",nb_line_deleted_tOracleRow_9);
 

ok_Hash.put("tOracleRow_9", true);
end_Hash.put("tOracleRow_9", System.currentTimeMillis());

tStatCatcher_1.addMessage("end","tOracleRow_9", end_Hash.get("tOracleRow_9")-start_Hash.get("tOracleRow_9"));
tStatCatcher_1Process(globalMap);
				if(execStat){   
...
try {
    if (resourceMap.get("statementClosed_tOracleRow_9") == null) {
            java.sql.Statement stmtToClose_tOracleRow_9 = null;
            if ((stmtToClose_tOracleRow_9 = (java.sql.Statement) resourceMap.remove("stmt_tOracleRow_9")) != null) {
                stmtToClose_tOracleRow_9.close();
            }
    }
} finally {
        if(resourceMap.get("finish_tOracleRow_9") == null){
            java.sql.Connection ctn_tOracleRow_9 = null;
            if((ctn_tOracleRow_9 = (java.sql.Connection)resourceMap.get("conn_tOracleRow_9")) != null){
                try {
                    ctn_tOracleRow_9.close();
                } catch (java.sql.SQLException sqlEx_tOracleRow_9) {
                    String errorMessage_tOracleRow_9 = "failed to close the connection in tOracleRow_9 :" + sqlEx_tOracleRow_9.getMessage();
                    System.err.println(errorMessage_tOracleRow_9);
                }
            }
        }
    }
 ...
 */
		...
		globalMap.put("tOracleRow_9_SUBPROCESS_STATE", 1);
	}
	


public void tOracleRow_10Process(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	 ...
	 */
		...
		start_Hash.put("tOracleRow_10", System.currentTimeMillis());
				...
				tStatCatcher_1.addMessage("begin","tOracleRow_10");
				tStatCatcher_1Process(globalMap);
	...
	int count_tOracleRow_10 = 0;
			String driverClass_tOracleRow_10 = "oracle.jdbc.OracleDriver";
		    java.lang.Class jdbcclazz_tOracleRow_10 = java.lang.Class.forName(driverClass_tOracleRow_10);
		
			String url_tOracleRow_10 = null;
				url_tOracleRow_10 = "jdbc:oracle:thin:@(description=(address=(protocol=tcp)(host=" + context.db_destino_Server + ")(port=" + context.db_destino_Port + "))(connect_data=(service_name=" + context.db_destino_ServiceName + ")))";
					String dbUser_tOracleRow_10 = context.db_destino_Login;
	        
            		
            		
            		
	final String decryptedPassword_tOracleRow_10 = context.db_destino_Password; 
        		   	
        	        String dbPwd_tOracleRow_10 = decryptedPassword_tOracleRow_10;
	        
					
			conn_tOracleRow_10 = java.sql.DriverManager.getConnection(url_tOracleRow_10,dbUser_tOracleRow_10,dbPwd_tOracleRow_10);
		
        resourceMap.put("conn_tOracleRow_10", conn_tOracleRow_10);
					if(conn_tOracleRow_10.getAutoCommit()) {
						
				conn_tOracleRow_10.setAutoCommit(false);
			
					}        
					int commitEvery_tOracleRow_10 = 1000;
					int commitCounter_tOracleRow_10 = 0;
				
        java.sql.Statement stmt_tOracleRow_10 = conn_tOracleRow_10.createStatement();
        resourceMap.put("stmt_tOracleRow_10", stmt_tOracleRow_10);
				int nb_line_deleted_tOracleRow_10 = 0;
...
try {
		...
		nb_line_deleted_tOracleRow_10 += stmt_tOracleRow_10.getUpdateCount();
	} catch (java.lang.Exception e) {
globalMap.put("tOracleRow_10_ERROR_MESSAGE",e.getMessage());
		...
		commitCounter_tOracleRow_10++;
		if(commitEvery_tOracleRow_10 <= commitCounter_tOracleRow_10) {
			
			conn_tOracleRow_10.commit();
			
			commitCounter_tOracleRow_10=0;
		}
 ...
 */
	...
	/**
	 * [tOracleRow_10 process_data_begin ] start
	 */
...
/**
 * [tOracleRow_10 process_data_begin ] stop
 */
	
	/**
	 * [tOracleRow_10 process_data_end ] start
	 */
...
/**
 * [tOracleRow_10 process_data_end ] stop
 */
	...
	globalMap.put("tOracleRow_10_NB_LINE", count_tOracleRow_10);
        stmt_tOracleRow_10.close();
        resourceMap.remove("stmt_tOracleRow_10");
    resourceMap.put("statementClosed_tOracleRow_10", true);
		if(commitEvery_tOracleRow_10>commitCounter_tOracleRow_10){
    ...
    resourceMap.put("finish_tOracleRow_10", true);

    globalMap.put("tOracleRow_10_NB_LINE_DELETED",nb_line_deleted_tOracleRow_10);
 

ok_Hash.put("tOracleRow_10", true);
end_Hash.put("tOracleRow_10", System.currentTimeMillis());

tStatCatcher_1.addMessage("end","tOracleRow_10", end_Hash.get("tOracleRow_10")-start_Hash.get("tOracleRow_10"));
tStatCatcher_1Process(globalMap);
...
try {
    if (resourceMap.get("statementClosed_tOracleRow_10") == null) {
            java.sql.Statement stmtToClose_tOracleRow_10 = null;
            if ((stmtToClose_tOracleRow_10 = (java.sql.Statement) resourceMap.remove("stmt_tOracleRow_10")) != null) {
                stmtToClose_tOracleRow_10.close();
            }
    }
} finally {
        if(resourceMap.get("finish_tOracleRow_10") == null){
            java.sql.Connection ctn_tOracleRow_10 = null;
            if((ctn_tOracleRow_10 = (java.sql.Connection)resourceMap.get("conn_tOracleRow_10")) != null){
                try {
                    ctn_tOracleRow_10.close();
                } catch (java.sql.SQLException sqlEx_tOracleRow_10) {
                    String errorMessage_tOracleRow_10 = "failed to close the connection in tOracleRow_10 :" + sqlEx_tOracleRow_10.getMessage();
                    System.err.println(errorMessage_tOracleRow_10);
                }
            }
        }
    }
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = "VM_" + context.PERIODO;
		if(obj_tRunJob_1!=null) {
			if (obj_tRunJob_1.getClass().getName().equals("java.util.Date")) {
 ...
 */
    ...
    public static void main(String[] args){
        final RecConsolidado RecConsolidadoClass = new RecConsolidado();

        int exitCode = RecConsolidadoClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = RecConsolidado.class.getClassLoader().getResourceAsStream("rep_diario_recaudo/recconsolidado_4_0/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = RecConsolidado.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : RecConsolidado");
        }
...
/************************************************************************************************
 *     358039 characters generated by Talend Open Studio for ESB 
 *     on the November 1, 2024, 2:44:26 PM COT
 ************************************************************************************************/