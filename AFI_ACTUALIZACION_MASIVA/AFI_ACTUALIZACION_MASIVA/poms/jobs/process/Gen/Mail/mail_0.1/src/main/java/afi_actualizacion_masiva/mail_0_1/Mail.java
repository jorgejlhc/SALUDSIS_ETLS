...
package afi_actualizacion_masiva.mail_0_1;
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_AFI_ACTUALIZACION_MASIVA_Mail = new byte[0];
    static byte[] commonByteArray_AFI_ACTUALIZACION_MASIVA_Mail = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_AFI_ACTUALIZACION_MASIVA_Mail.length) {
				if(length < 1024 && commonByteArray_AFI_ACTUALIZACION_MASIVA_Mail.length == 0) {
   					commonByteArray_AFI_ACTUALIZACION_MASIVA_Mail = new byte[1024];
				} else {
   					commonByteArray_AFI_ACTUALIZACION_MASIVA_Mail = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_AFI_ACTUALIZACION_MASIVA_Mail, 0, length);
			strReturn = new String(commonByteArray_AFI_ACTUALIZACION_MASIVA_Mail, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_AFI_ACTUALIZACION_MASIVA_Mail, 0, length);
			strReturn = new String(commonByteArray_AFI_ACTUALIZACION_MASIVA_Mail, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_AFI_ACTUALIZACION_MASIVA_Mail) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Mail.class.getClassLoader().getResourceAsStream("afi_actualizacion_masiva/mail_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     132674 characters generated by Talend Open Studio for ESB 
 *     on the October 28, 2024, 2:22:58 PM COT
 ************************************************************************************************/