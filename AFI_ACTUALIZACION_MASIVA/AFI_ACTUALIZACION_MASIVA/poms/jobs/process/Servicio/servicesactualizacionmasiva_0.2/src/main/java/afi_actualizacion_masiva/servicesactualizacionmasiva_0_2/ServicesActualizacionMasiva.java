...
package afi_actualizacion_masiva.servicesactualizacionmasiva_0_2;
...
/**
 * Job: ServicesActualizacionMasiva Purpose: <br>
 * Description:  <br>
 * @author jorgejlhc@gmail.com
 * @version 8.8.8.20240722_1936-SNAPSHOT
 * @status 
 */
public class ServicesActualizacionMasiva implements TalendJob {
...
public Integer getIdSolicitud(){
	...
	private final String jobName = "ServicesActualizacionMasiva";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ServicesActualizacionMasiva.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ServicesActualizacionMasiva.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class RestServiceProviderImpl4TalendJob {
	...
	private final ServicesActualizacionMasiva job;

	public RestServiceProviderImpl4TalendJob(ServicesActualizacionMasiva job) {
		this.job = job;
	}

	private void populateRequestWithJobContext(java.util.Map<String, Object> requestGlobalMap, ServicesActualizacionMasiva job) {
...
class Thread4RestServiceProviderEndpoint extends Thread {
	...
	public Thread4RestServiceProviderEndpoint(ServicesActualizacionMasiva job, String endpointUrl) {
		this.job = job;
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression, String jobName)
			...
			java.io.InputStream inContext = ServicesActualizacionMasiva.class.getClassLoader()
					.getResourceAsStream("afi_actualizacion_masiva/servicesactualizacionmasiva_0_2/contexts/" + currentContext  + ".properties");
			if (inContext == null) {
				inContext = ServicesActualizacionMasiva.class.getClassLoader()
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_AFI_ACTUALIZACION_MASIVA_ServicesActualizacionMasiva = new byte[0];
    static byte[] commonByteArray_AFI_ACTUALIZACION_MASIVA_ServicesActualizacionMasiva = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_AFI_ACTUALIZACION_MASIVA_ServicesActualizacionMasiva) {
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_AFI_ACTUALIZACION_MASIVA_ServicesActualizacionMasiva.length) {
				if(length < 1024 && commonByteArray_AFI_ACTUALIZACION_MASIVA_ServicesActualizacionMasiva.length == 0) {
   					commonByteArray_AFI_ACTUALIZACION_MASIVA_ServicesActualizacionMasiva = new byte[1024];
				} else {
   					commonByteArray_AFI_ACTUALIZACION_MASIVA_ServicesActualizacionMasiva = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_AFI_ACTUALIZACION_MASIVA_ServicesActualizacionMasiva, 0, length);
			strReturn = new String(commonByteArray_AFI_ACTUALIZACION_MASIVA_ServicesActualizacionMasiva, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_AFI_ACTUALIZACION_MASIVA_ServicesActualizacionMasiva, 0, length);
			strReturn = new String(commonByteArray_AFI_ACTUALIZACION_MASIVA_ServicesActualizacionMasiva, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
if (needRoot) {
	needRoot=false;
		...
		valueMap.put("root_1","Proceso de actualización masiva ejecuctado satisfactoriamente");
...
if (needRoot) {
	needRoot=false;
		...
		org.dom4j.Element root_1 = null;
				root_1 = root.addElement("Message");
		valueMap.put("root_1","Error de ejecución del proceso de actualización masiva");
		if(valueMap.get("root_1")!=null) {
			routines.system.NestXMLTool.setText(root_1,FormatterUtils.fm(valueMap.get("root_1"),null));
		}
		org.dom4j.Element root_2 = null;
...
public static class copyOfrow1Struct implements routines.system.IPersistableRow<copyOfrow1Struct> {
    final static byte[] commonByteArrayLock_AFI_ACTUALIZACION_MASIVA_ServicesActualizacionMasiva = new byte[0];
    static byte[] commonByteArray_AFI_ACTUALIZACION_MASIVA_ServicesActualizacionMasiva = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(copyOfrow1Struct other) {
...
copyOfrow1Struct copyOfrow1 = new copyOfrow1Struct();
...
RequestERRORStruct RequestERROR = new RequestERRORStruct();
	...
	currentComponent="tRESTRequest_1_Loop";
		...
		int tos_count_tRESTRequest_1_Loop = 0;
						...
						if(execStat){
							runStat.updateStatOnConnection(iterateId,0,0,"row3","copyOfrow1","in","RequestOK","row2","RequestERROR");
						}
 ...
 */
	...
	currentComponent="tRESTResponse_2";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"copyOfrow1");
					}
...
// ###############################
// # Outputs initialization
copyOfrow1Struct copyOfrow1_tmp = new copyOfrow1Struct();
copyOfrow1Struct copyOfrow1_save = null;
// ###############################
		int nb_line_tXMLMap_1 = 0; 
	
    XML_API_tXMLMap_1 xml_api_tXMLMap_1 = new XML_API_tXMLMap_1();

class GenerateDocument_copyOfrow1 {
    ...
    public GenerateDocument_copyOfrow1() {
//    	this.treeNodeAPI = treeNodeAPI;
...
if (needRoot) {
	needRoot=false;
		...
		org.dom4j.Element root_1 = null;
				root_1 = root.addElement("Message");
		valueMap.put("root_1","Error en el llamado al ETL de Actualización Masiva de Afiliados");
		if(valueMap.get("root_1")!=null) {
			routines.system.NestXMLTool.setText(root_1,FormatterUtils.fm(valueMap.get("root_1"),null));
		}
		org.dom4j.Element root_2 = null;
...
if (needRoot) {
	needRoot=false;
		...
		org.dom4j.Element root_1 = null;
				root_1 = root.addElement("Message");
		valueMap.put("root_1","El identificador de la solicitud de actualización masiva no puede ser nulo");
		if(valueMap.get("root_1")!=null) {
			routines.system.NestXMLTool.setText(root_1, FormatterUtils.fm(valueMap.get("root_1"),null));
		}
		org.dom4j.Element root_2 = null;
...
if(row3 != null) { 
	...
	boolean isMatchDocRowtXMLMap_1 = false;
				    ...
				    GenerateDocument_copyOfrow1 gen_Doc_copyOfrow1_tXMLMap_1 = new GenerateDocument_copyOfrow1();
					copyOfrow1_tmp.body = null;
...
// # Output table : 'copyOfrow1'

gen_Doc_copyOfrow1_tXMLMap_1.generateElements(rejectedDocInnerJoin_tXMLMap_1,row3,Var);

if(copyOfrow1_tmp.body == null){
copyOfrow1_tmp.body = new routines.system.Document();
copyOfrow1_tmp.body.setDocument(gen_Doc_copyOfrow1_tXMLMap_1.getDocument());
}

copyOfrow1 = copyOfrow1_tmp;
copyOfrow1_save = copyOfrow1_tmp;
// ###############################
...
if(copyOfrow1 != null) { 
	...
	if (null == outputStream_tRESTResponse_2 && responseAlreadySent_tRESTResponse_2) {
		...
		Integer restProviderStatusCode_tRESTResponse_2 = 404;

		Object restProviderResponse_tRESTResponse_2 = null;
		if (null != copyOfrow1.body) {
			restProviderResponse_tRESTResponse_2 = copyOfrow1.body.getDocument();
		}
 ...
 */
	...
	currentComponent="tRESTResponse_2";
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"copyOfrow1");
			  	}
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		afi_actualizacion_masiva.actualizacionmsv_0_1.ActualizacionMSV childJob_tRunJob_1 = new afi_actualizacion_masiva.actualizacionmsv_0_1.ActualizacionMSV();
	    // pass DataSources
 ...
 */
	...
	globalMap.put("tRESTRequest_1_NB_LINE", nb_line_tRESTRequest_1);
				...
				if(execStat){
					runStat.updateStatOnConnection(iterateId,2,0,"row3","copyOfrow1","in","RequestOK","row2","RequestERROR");
				}
 ...
 */
    ...
    public static void main(String[] args){
        final ServicesActualizacionMasiva ServicesActualizacionMasivaClass = new ServicesActualizacionMasiva();

        int exitCode = ServicesActualizacionMasivaClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ServicesActualizacionMasiva.class.getClassLoader().getResourceAsStream("afi_actualizacion_masiva/servicesactualizacionmasiva_0_2/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = ServicesActualizacionMasiva.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ServicesActualizacionMasiva");
        }
...
/************************************************************************************************
 *     213678 characters generated by Talend Open Studio for ESB 
 *     on the October 28, 2024, 2:23:07 PM COT
 ************************************************************************************************/