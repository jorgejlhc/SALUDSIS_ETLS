...
public class TOracleRowMainJava
{
  ...
  protected final String TEXT_74 = NL + "query_";
  protected final String TEXT_75 = " = ";
  protected final String TEXT_76 = ";" + NL + "whetherReject_";
  ...
  protected final String TEXT_80 = NL + "\tjava.sql.ResultSet rs_";
  ...
  protected final String TEXT_86 = ", java.sql.Types.TIMESTAMP);" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\telse{" + NL + "\t\t\t\t\tpstmt_";
  protected final String TEXT_87 = ".setTimestamp(";
  protected final String TEXT_88 = ",new java.sql.Timestamp(";
  protected final String TEXT_89 = ".getTime()));" + NL + "\t\t\t\t\t}";
  protected final String TEXT_90 = NL + "\t\t\tpstmt_";
  protected final String TEXT_91 = ".set";
  protected final String TEXT_92 = "(";
  protected final String TEXT_93 = NL + "\t\trs_";
  protected final String TEXT_94 = " = pstmt_";
  protected final String TEXT_95 = ".executeQuery();";
  protected final String TEXT_96 = NL + "\t\tpstmt_";
  protected final String TEXT_97 = ".execute();" + NL + "\t\t";
  protected final String TEXT_98 = " = stmt_";
  ...
  protected final String TEXT_109 = NL + "\t} catch (java.lang.Exception e) {" + NL + "globalMap.put(\"";
  protected final String TEXT_110 = "_ERROR_MESSAGE\",e.getMessage());" + NL + "\t\twhetherReject_";
  protected final String TEXT_111 = " = true;" + NL + "\t\t";
  protected final String TEXT_112 = NL + "\t\t\tthrow(e);" + NL + "\t\t\t";
  ...
  protected final String TEXT_119 = ".errorCode = ((java.sql.SQLException)e).getSQLState();" + NL + "\t\t\t\t";
  protected final String TEXT_120 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_121 = ";" + NL + "\t\t\t\t";
  protected final String TEXT_122 = NL + "\t\t\t\tSystem.err.print(e.getMessage());" + NL + "\t\t\t\t";
  protected final String TEXT_123 = NL + "\t}" + NL + "\t";
  protected final String TEXT_124 = NL + "\tif(!whetherReject_";
  protected final String TEXT_125 = ") {" + NL + "\t\t";
  protected final String TEXT_126 = NL + "\t\t\t\t\t";
  protected final String TEXT_127 = "Struct();" + NL + "\t\t\t\t\t";
  protected final String TEXT_128 = NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_129 = " = rs_";
  protected final String TEXT_130 = ";" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_131 = NL + "\t\tcommitCounter_";
  protected final String TEXT_132 = "++;" + NL + "\t\tif(commitEvery_";
  protected final String TEXT_133 = " <= commitCounter_";
  protected final String TEXT_134 = ") {" + NL + "\t\t\t";
  protected final String TEXT_135 = NL + "\t\t\tcommitCounter_";
  protected final String TEXT_136 = "=0;" + NL + "\t\t}" + NL + "\t\t";
