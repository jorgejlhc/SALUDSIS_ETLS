...
public class TFileOutputExcelEndJava
{
  ...
  protected final String TEXT_62 = NL + "\t\t\t\t\texcelDynamicUtil_";
  protected final String TEXT_63 = ".autoDynamicColumnSize(xlsxTool_";
  protected final String TEXT_64 = NL + "\t\t\t\t\tfileOutputExcelUtil_";
  protected final String TEXT_65 = ".setColAutoSize_";
  protected final String TEXT_66 = "(xlsxTool_";
  protected final String TEXT_67 = NL + "\t\t\t\t\txlsxTool_";
  protected final String TEXT_68 = ".setColAutoSize(columnIndex_";
  protected final String TEXT_69 = NL + "\t\t\t\t\t\t\t\t\texcelDynamicUtil_";
  protected final String TEXT_70 = NL + "\t" + NL + "\t";
  protected final String TEXT_71 = NL + "\t\t\t\t\tif(bufferCount_";
  protected final String TEXT_72 = "!=0){" + NL + "    \t\t\t\t\txlsxTool_";
  protected final String TEXT_73 = ".flushRowInMemory();" + NL + "    \t\t\t\t\t//flush all rocords in memory on disk." + NL + "    \t\t\t\t}" + NL + "\t";
  protected final String TEXT_74 = NL + "\t";
  protected final String TEXT_75 = NL + "\t\t\txlsxTool_";
  protected final String TEXT_76 = ".writeExcel(";
  protected final String TEXT_77 = ".writeExcel(fileName_";
  protected final String TEXT_78 = ",";
  protected final String TEXT_79 = NL + "\t\tif(headerIsInserted_";
