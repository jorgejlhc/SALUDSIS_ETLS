...
public class TFileOutputExcelBeginJava
{
  ...
  protected final String TEXT_332 = " = new org.talend.ExcelTool();" + NL + "\t\txlsxTool_";
  protected final String TEXT_333 = ".setUseSharedStringTable(";
  protected final String TEXT_334 = ");" + NL + "\t\t";
  protected final String TEXT_335 = NL + "        xlsxTool_";
  protected final String TEXT_336 = ".setPasswordProtection(password_";
  protected final String TEXT_337 = NL + "    xlsxTool_";
  protected final String TEXT_338 = ".setTruncateExceedingCharacters(";
  protected final String TEXT_339 = NL + "\t\t\tint\tflushRowNum_";
  protected final String TEXT_340 = ";" + NL + "\t\t\tint bufferCount_";
  protected final String TEXT_341 = "=0;" + NL + "\t\t\txlsxTool_";
  protected final String TEXT_342 = ".setRowAccessWindowSize(-1);" + NL + "\t\t\t//turn-off auto flush";
  protected final String TEXT_343 = NL + "\t\txlsxTool_";
  protected final String TEXT_344 = ".setSheet(";
  protected final String TEXT_345 = ");" + NL + "\t\txlsxTool_";
  protected final String TEXT_346 = ".setAppend(";
  protected final String TEXT_347 = ".setRecalculateFormula(";
  protected final String TEXT_348 = ".setXY(";
  protected final String TEXT_349 = NL + "\t\tjava.util.concurrent.ConcurrentHashMap<java.lang.Object, java.lang.Object> chm_";
  protected final String TEXT_350 = " = (java.util.concurrent.ConcurrentHashMap<java.lang.Object, java.lang.Object>) globalMap.get(\"concurrentHashMap\");" + NL + "\t\tjava.lang.Object lockObj_";
  protected final String TEXT_351 = " = chm_";
  protected final String TEXT_352 = ".computeIfAbsent(\"EXCEL_OUTPUT_LOCK_OBJ_";
  protected final String TEXT_353 = "\", k -> new Object());" + NL + "\t\tsynchronized (lockObj_";
  protected final String TEXT_354 = ") {" + NL + "\t\t\t";
  protected final String TEXT_355 = NL + "\t\t\t\txlsxTool_";
  protected final String TEXT_356 = ".prepareXlsmFile(fileName_";
  protected final String TEXT_357 = ".prepareXlsxFile(fileName_";
  protected final String TEXT_358 = ");" + NL + "\t\t\t";
  protected final String TEXT_359 = NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_360 = ".prepareStream();" + NL + "\t\t";
  protected final String TEXT_361 = ".setFont(\"";
  protected final String TEXT_362 = "\");" + NL + "\t\t";
  protected final String TEXT_363 = NL + "\t\t\tclass FileOutputExcelUtil_";
  protected final String TEXT_364 = NL + "\t\t\t\tExcelDynamicUtil_";
  protected final String TEXT_365 = NL + "\t\t\t\tpublic void putHeaderValue_";
  protected final String TEXT_366 = "(final org.talend.ExcelTool xlsxTool_";
  protected final String TEXT_367 = NL + "\t\t\t\t\txlsxTool_";
  protected final String TEXT_368 = ".addCellValue(\"";
  protected final String TEXT_369 = "\");";
  protected final String TEXT_370 = NL + "\t\t\t\t}";
  protected final String TEXT_371 = NL + "\t\t\t\tpublic void setColAutoSize_";
  protected final String TEXT_372 = NL + "\t\t\t\t\t\tcolumnIndex_";
  protected final String TEXT_373 = ";" + NL + "\t\t\t\t\t";
  protected final String TEXT_374 = ".setColAutoSize(columnIndex_";
  protected final String TEXT_375 = NL + "    \t\t\t\texcelDynamicUtil_";
  protected final String TEXT_376 = ".autoDynamicColumnSize(xlsxTool_";
  protected final String TEXT_377 = ");" + NL + "    \t\t\t";
  protected final String TEXT_378 = NL + "    \t\t\tpublic void putValue_";
  protected final String TEXT_379 = "," + NL + "    \t\t\t\tfinal org.talend.ExcelTool xlsxTool_";
  protected final String TEXT_380 = NL + "\t\t\t\t";
  protected final String TEXT_381 = "\t\t\t\t\t";
  protected final String TEXT_382 = NL + "\t\t\t\t\t\t\txlsxTool_";
  protected final String TEXT_383 = ".addCellValue(";
  protected final String TEXT_384 = "\t\t\t\t\t" + NL + "\t\t\t\t\t\t\txlsxTool_";
  protected final String TEXT_385 = ".addCellValue(java.nio.charset.Charset.defaultCharset().decode(java.nio.ByteBuffer.wrap(";
  protected final String TEXT_386 = ")).toString());";
  protected final String TEXT_387 = ".addCellValue(FormatterUtils.format_Number(String.valueOf(";
  protected final String TEXT_388 = "));\t\t\t\t" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_389 = "));" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_390 = "\t\t" + NL + "\t\t\t\t\t\t\txlsxTool_";
  protected final String TEXT_391 = ".addCellValue((";
  protected final String TEXT_392 = ").doubleValue());";
  protected final String TEXT_393 = ".addCellValue(Double.parseDouble(String.valueOf(";
  protected final String TEXT_394 = ")));";
  protected final String TEXT_395 = ".addCellValue(String.valueOf(";
  protected final String TEXT_396 = ", xlsxTool_";
  protected final String TEXT_397 = NL + "\t    \t\t\t\t} else {" + NL + "\t    \t\t\t\t\txlsxTool_";
  protected final String TEXT_398 = ".addCellNullValue();" + NL + "\t    \t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_399 = NL + "\t\t\t}" + NL + "" + NL + "\t\t\tFileOutputExcelUtil_";
  protected final String TEXT_400 = NL + "\t\tif (xlsxTool_";
  protected final String TEXT_401 = ".getStartRow() == 0){" + NL + "\t\t";
  protected final String TEXT_402 = ".addRow();" + NL + "\t\t";
  protected final String TEXT_403 = NL + "\t\t\t\t\tfileOutputExcelUtil_";
  protected final String TEXT_404 = "(xlsxTool_";
  protected final String TEXT_405 = "++;" + NL + "\t\theaderIsInserted_";
  protected final String TEXT_406 = " = true;" + NL + "\t\t";
...
if(!hasDynamic && isIncludeHeader){
    ...
    stringBuffer.append(useSharedStringsTable);
