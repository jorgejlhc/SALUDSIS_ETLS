...
public class TDenormalizeOutEndJava
{
  ...
  protected final String TEXT_48 = NL + "\t\t}" + NL + "\t\t" + NL + "\t}" + NL + "\tif (sb_";
  protected final String TEXT_49 = " != null)" + NL + "\t\tdenormalize_row_";
  protected final String TEXT_50 = " = sb_";
  protected final String TEXT_51 = ".toString();" + NL + "\t" + NL + "\tsb_";
  protected final String TEXT_52 = " = null;" + NL + "\t";
  protected final String TEXT_53 = ".toString();" + NL + "\t";
  protected final String TEXT_54 = NL + "\t//in the deepest end" + NL + "\t" + NL + "\tresult_list_";
  protected final String TEXT_55 = ".add(denormalize_row_";
  protected final String TEXT_56 = NL + "}" + NL;
  protected final String TEXT_57 = NL + "}" + NL + "//generate result end" + NL + "globalMap.put(\"";
  protected final String TEXT_58 = "\", result_list_";
  protected final String TEXT_59 = ");" + NL + "globalMap.put(\"";
  protected final String TEXT_60 = "_NB_LINE\", result_list_";
  protected final String TEXT_61 = ".size()); ";
  protected final String TEXT_62 = NL + "\tlog.info(\"";
  protected final String TEXT_63 = " - Generated records count: \" + result_list_";
