...
public class Utils {
	...
	private static final String REPLACEMENT = "ñaeiouaeiouaoaeiooaeioucÑAEIOUAEIOUAOAEIOOAEIOUC"; //AaEeIiOoUuÑñUu";
    ...
    public static String[]  validarCUM (String cum) {
        if (!cum.matches("[a-zA-Z0-9]+\\s*-\\s*[0-9]+")) {
            return null;
		}
        return cum.split("-");        
	}
	...
	*  */
	...
	/* 
		...
		* 		nombreSegundoProducto: Es el nombre del segundo producto, utilizado para determinar si se debe guardar el error por motivo de segunda opción
	*  */
	public static String manejoErrorGFA(String descripcionCampo, String valorCampo, int opcion, String descripcionError){
		...
		switch (opcion) {
			case 1:
			opcionSeleccion = "Opcion: 1,";
			break;
			case 2:
			opcionSeleccion = "Opcion: 2,";
			break;
			case 0:
			opcionSeleccion = "Opcion: Generica,";
			break;
		}
		respuesta = " - Error en el campo: " +  descripcionCampo + " (" + valorCampo + "), " + opcionSeleccion + " " + descripcionError;
