...
package med_cargar_medicamentos_genericos.servicecarguemedgenericos_0_2;
...
/**
 * Job: ServiceCargueMedGenericos Purpose: <br>
 * Description:  <br>
 * @author jorgejlhc@gmail.com
 * @version 8.8.8.20240722_1936-SNAPSHOT
 * @status 
 */
public class ServiceCargueMedGenericos implements TalendJob {
...
public String getResult(){
	...
	private final String jobName = "ServiceCargueMedGenericos";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ServiceCargueMedGenericos.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ServiceCargueMedGenericos.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class RestServiceProviderImpl4TalendJob {
	...
	private final ServiceCargueMedGenericos job;

	public RestServiceProviderImpl4TalendJob(ServiceCargueMedGenericos job) {
		this.job = job;
	}

	private void populateRequestWithJobContext(java.util.Map<String, Object> requestGlobalMap, ServiceCargueMedGenericos job) {
...
class Thread4RestServiceProviderEndpoint extends Thread {
	...
	public Thread4RestServiceProviderEndpoint(ServiceCargueMedGenericos job, String endpointUrl) {
		this.job = job;
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression, String jobName)
			...
			java.io.InputStream inContext = ServiceCargueMedGenericos.class.getClassLoader()
					.getResourceAsStream("med_cargar_medicamentos_genericos/servicecarguemedgenericos_0_2/contexts/" + currentContext  + ".properties");
			if (inContext == null) {
				inContext = ServiceCargueMedGenericos.class.getClassLoader()
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_MED_CARGAR_MEDICAMENTOS_GENERICOS_ServiceCargueMedGenericos = new byte[0];
    static byte[] commonByteArray_MED_CARGAR_MEDICAMENTOS_GENERICOS_ServiceCargueMedGenericos = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_MED_CARGAR_MEDICAMENTOS_GENERICOS_ServiceCargueMedGenericos) {
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_MED_CARGAR_MEDICAMENTOS_GENERICOS_ServiceCargueMedGenericos.length) {
				if(length < 1024 && commonByteArray_MED_CARGAR_MEDICAMENTOS_GENERICOS_ServiceCargueMedGenericos.length == 0) {
   					commonByteArray_MED_CARGAR_MEDICAMENTOS_GENERICOS_ServiceCargueMedGenericos = new byte[1024];
				} else {
   					commonByteArray_MED_CARGAR_MEDICAMENTOS_GENERICOS_ServiceCargueMedGenericos = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_MED_CARGAR_MEDICAMENTOS_GENERICOS_ServiceCargueMedGenericos, 0, length);
			strReturn = new String(commonByteArray_MED_CARGAR_MEDICAMENTOS_GENERICOS_ServiceCargueMedGenericos, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_MED_CARGAR_MEDICAMENTOS_GENERICOS_ServiceCargueMedGenericos, 0, length);
			strReturn = new String(commonByteArray_MED_CARGAR_MEDICAMENTOS_GENERICOS_ServiceCargueMedGenericos, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
if (needRoot) {
	needRoot=false;
		...
		valueMap.put("root_1","Proceso de cargue de medicamentos genéricos ejecuctado satisfactoriamente");
...
if (needRoot) {
	needRoot=false;
		...
		org.dom4j.Element root_1 = null;
				root_1 = root.addElement("Message");
		valueMap.put("root_1","Error de ejecución del proceso de cargue de medicamentos genéricos");
		if(valueMap.get("root_1")!=null) {
			routines.system.NestXMLTool.setText(root_1,FormatterUtils.fm(valueMap.get("root_1"),null));
		}
		org.dom4j.Element root_2 = null;
...
if (needRoot) {
	needRoot=false;
		...
		org.dom4j.Element root_1 = null;
				root_1 = root.addElement("Message");
		valueMap.put("root_1","Error en el llamado del ETL de cargue de medicamentos genéricos");
		if(valueMap.get("root_1")!=null) {
			routines.system.NestXMLTool.setText(root_1,FormatterUtils.fm(valueMap.get("root_1"),null));
		}
		org.dom4j.Element root_2 = null;
 ...
 */
	...
	Object obj_tRunJob_1 = null;
		...
		med_cargar_medicamentos_genericos.cargamedicamentosgenericos_3_7.CargaMedicamentosGenericos childJob_tRunJob_1 = new med_cargar_medicamentos_genericos.cargamedicamentosgenericos_3_7.CargaMedicamentosGenericos();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final ServiceCargueMedGenericos ServiceCargueMedGenericosClass = new ServiceCargueMedGenericos();

        int exitCode = ServiceCargueMedGenericosClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ServiceCargueMedGenericos.class.getClassLoader().getResourceAsStream("med_cargar_medicamentos_genericos/servicecarguemedgenericos_0_2/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = ServiceCargueMedGenericos.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ServiceCargueMedGenericos");
        }
...
/************************************************************************************************
 *     225386 characters generated by Talend Open Studio for ESB 
 *     on the October 28, 2024, 2:48:21 PM COT
 ************************************************************************************************/