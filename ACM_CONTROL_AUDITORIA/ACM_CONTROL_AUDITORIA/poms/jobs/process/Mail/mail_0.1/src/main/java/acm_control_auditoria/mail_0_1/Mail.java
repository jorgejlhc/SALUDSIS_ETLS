...
package acm_control_auditoria.mail_0_1;
...
/**
 * Job: Mail Purpose: Enviar correo a los desarrolladores<br>
 * Description: Envia un correo eléctronico a los desarrolladores cuando ocurre un error en un ETL <br>
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_ACM_CONTROL_AUDITORIA_Mail = new byte[0];
    static byte[] commonByteArray_ACM_CONTROL_AUDITORIA_Mail = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ACM_CONTROL_AUDITORIA_Mail.length) {
				if(length < 1024 && commonByteArray_ACM_CONTROL_AUDITORIA_Mail.length == 0) {
   					commonByteArray_ACM_CONTROL_AUDITORIA_Mail = new byte[1024];
				} else {
   					commonByteArray_ACM_CONTROL_AUDITORIA_Mail = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ACM_CONTROL_AUDITORIA_Mail, 0, length);
			strReturn = new String(commonByteArray_ACM_CONTROL_AUDITORIA_Mail, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ACM_CONTROL_AUDITORIA_Mail, 0, length);
			strReturn = new String(commonByteArray_ACM_CONTROL_AUDITORIA_Mail, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ACM_CONTROL_AUDITORIA_Mail) {
...
if(row1 != null) { 
    ...
    //Guardamos en variables de cobntexto los datos necesarios para enviar el correo desde el archivo de conexión 
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Mail.class.getClassLoader().getResourceAsStream("acm_control_auditoria/mail_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("context")) {
...
/************************************************************************************************
 *     121990 characters generated by Talend Open Studio for ESB 
