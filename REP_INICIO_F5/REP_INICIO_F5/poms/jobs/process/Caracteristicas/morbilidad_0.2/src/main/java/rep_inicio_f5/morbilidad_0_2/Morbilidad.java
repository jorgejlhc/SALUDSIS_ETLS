...
package rep_inicio_f5.morbilidad_0_2;
...
/**
 * Job: Morbilidad Purpose: Transferir datos a la tabla de hechos<br>
 * Description: Fecha 			Quién 				Que 
07/09/2018		Roger Prieto		cambia los joblets por incompatibilidad con la versión comunity <br>
 * @author jorgejlhc@gmail.com
 * @version 8.8.8.20240722_1936-SNAPSHOT
 * @status 
 */
public class Morbilidad implements TalendJob {
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext(){
			...
			if(PRIMER_DIA != null){
					...
					this.setProperty("PRIMER_DIA", PRIMER_DIA.toString());
...
public String getPRIMER_DIA(){
	...
	private final String jobName = "Morbilidad";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Morbilidad.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
/*Obtiene la información del día en el que se esta ejecutando*/
context.PRIMER_DIA = TalendDate.getDate("DD");

/*Imprime en consola*/
System.out.println(context.PRIMER_DIA);
System.out.println(context.FECHA_EJECUCION);
...
end_Hash.put("tJava_1", System.currentTimeMillis());
   			...
   			if (context.PRIMER_DIA.equals("01")) {
...
public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
    final static byte[] commonByteArrayLock_REP_INICIO_F5_Morbilidad = new byte[0];
    static byte[] commonByteArray_REP_INICIO_F5_Morbilidad = new byte[0];
			    ...
			    public BigDecimal CANTIDAD_MASCULINO;

				public BigDecimal getCANTIDAD_MASCULINO () {
					return this.CANTIDAD_MASCULINO;
				}

				public Boolean CANTIDAD_MASCULINOIsNullable(){
				    return true;
				}
				public Boolean CANTIDAD_MASCULINOIsKey(){
				    return false;
				}
				public Integer CANTIDAD_MASCULINOLength(){
				    return 0;
				}
				public Integer CANTIDAD_MASCULINOPrecision(){
				    return 0;
				}
				public String CANTIDAD_MASCULINODefault(){
				
					return "";
				
				}
				public String CANTIDAD_MASCULINOComment(){
				
				    return "";
				
				}
				public String CANTIDAD_MASCULINOPattern(){
				
					return "";
				
				}
				public String CANTIDAD_MASCULINOOriginalDbColumnName(){
				
					return "CANTIDAD_MASCULINO";
				
				}

				
			    public BigDecimal CANTIDAD_FEMENINO;

				public BigDecimal getCANTIDAD_FEMENINO () {
					return this.CANTIDAD_FEMENINO;
				}

				public Boolean CANTIDAD_FEMENINOIsNullable(){
				    return true;
				}
				public Boolean CANTIDAD_FEMENINOIsKey(){
				    return false;
				}
				public Integer CANTIDAD_FEMENINOLength(){
				    return 0;
				}
				public Integer CANTIDAD_FEMENINOPrecision(){
				    return 0;
				}
				public String CANTIDAD_FEMENINODefault(){
				
					return "";
				
				}
				public String CANTIDAD_FEMENINOComment(){
				
				    return "";
				
				}
				public String CANTIDAD_FEMENINOPattern(){
				
					return "";
				
				}
				public String CANTIDAD_FEMENINOOriginalDbColumnName(){
				
					return "CANTIDAD_FEMENINO";
			    ...
			    public BigDecimal TIPOAFILIADO_ID;

				public BigDecimal getTIPOAFILIADO_ID () {
					return this.TIPOAFILIADO_ID;
				}

				public Boolean TIPOAFILIADO_IDIsNullable(){
				    return false;
				}
				public Boolean TIPOAFILIADO_IDIsKey(){
				    return false;
				}
				public Integer TIPOAFILIADO_IDLength(){
				    return 0;
				}
				public Integer TIPOAFILIADO_IDPrecision(){
				    return null;
				}
				public String TIPOAFILIADO_IDDefault(){
				
					return "";
				
				}
				public String TIPOAFILIADO_IDComment(){
				
				    return "";
				
				}
				public String TIPOAFILIADO_IDPattern(){
				
					return "";
				
				}
				public String TIPOAFILIADO_IDOriginalDbColumnName(){
				
					return "TIPOAFILIADO_ID";
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_REP_INICIO_F5_Morbilidad) {
        	...
        	try {
        		...
        		int length = 0;
						...
						this.CANTIDAD_MASCULINO = (BigDecimal) dis.readObject();
					
						this.CANTIDAD_FEMENINO = (BigDecimal) dis.readObject();
					
						this.TIEMPOS_ID = (BigDecimal) dis.readObject();
					
						this.TIPOAFILIADO_ID = (BigDecimal) dis.readObject();
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// BigDecimal
       			    	...
       			    	dos.writeObject(this.CANTIDAD_MASCULINO);
					
					// BigDecimal
				
       			    	dos.writeObject(this.CANTIDAD_FEMENINO);
					...
					// BigDecimal
       			    	...
       			    	dos.writeObject(this.TIPOAFILIADO_ID);
    ...
    public String toString() {
		...
		sb.append(",CANTIDAD_MASCULINO="+String.valueOf(CANTIDAD_MASCULINO));
		sb.append(",CANTIDAD_FEMENINO="+String.valueOf(CANTIDAD_FEMENINO));
		sb.append(",TIEMPOS_ID="+String.valueOf(TIEMPOS_ID));
		sb.append(",TIPOAFILIADO_ID="+String.valueOf(TIPOAFILIADO_ID));
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    ...
    static byte[] commonByteArray_REP_INICIO_F5_Morbilidad = new byte[0];
			    ...
			    public BigDecimal TIPOUSUARIO_ID;

				public BigDecimal getTIPOUSUARIO_ID () {
					return this.TIPOUSUARIO_ID;
				}

				public Boolean TIPOUSUARIO_IDIsNullable(){
				    return false;
				}
				public Boolean TIPOUSUARIO_IDIsKey(){
				    return false;
				}
				public Integer TIPOUSUARIO_IDLength(){
				    return 0;
				}
				public Integer TIPOUSUARIO_IDPrecision(){
				    return null;
				}
				public String TIPOUSUARIO_IDDefault(){
				
					return "";
				
				}
				public String TIPOUSUARIO_IDComment(){
				
				    return "";
				
				}
				public String TIPOUSUARIO_IDPattern(){
				
					return "";
				
				}
				public String TIPOUSUARIO_IDOriginalDbColumnName(){
		...
		synchronized(commonByteArrayLock_REP_INICIO_F5_Morbilidad) {
        	...
        	try {
        		...
        		int length = 0;
						...
						this.TIPOUSUARIO_ID = (BigDecimal) dis.readObject();
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// BigDecimal
       			    	...
       			    	dos.writeObject(this.TIPOUSUARIO_ID);
    ...
    public String toString() {
		...
		sb.append(",CANTIDAD_FEMENINO="+String.valueOf(CANTIDAD_FEMENINO));
		sb.append(",TIEMPOS_ID="+String.valueOf(TIEMPOS_ID));
		sb.append(",TIPOUSUARIO_ID="+String.valueOf(TIPOUSUARIO_ID));
		sb.append(",UORG_ID="+String.valueOf(UORG_ID));
		sb.append(",DIAGNOSTICOS_ID="+String.valueOf(DIAGNOSTICOS_ID));
		sb.append(",RANGOEDAD_ID="+String.valueOf(RANGOEDAD_ID));
	    sb.append("]");
...
out1Struct out1 = new out1Struct();
	...
	final String decryptedPassword_tOracleOutput_1 = context.db_destino_Password; 
        ...
        if(dbschema_tOracleOutput_1 == null || dbschema_tOracleOutput_1.trim().length() == 0) {
            tableName_tOracleOutput_1 = ("BGEN_MORBILIDAD");
        } else {
            tableName_tOracleOutput_1 = dbschema_tOracleOutput_1 + "." + ("BGEN_MORBILIDAD");
        }
                String insert_tOracleOutput_1 = "INSERT INTO " + tableName_tOracleOutput_1 + " (TOTAL,CANTIDAD_MASCULINO,CANTIDAD_FEMENINO,TIEMPOS_ID,TIPOAFILIADO_ID,UORG_ID,DIAGNOSTICOS_ID,RANGOEDAD_ID) VALUES (?,?,?,?,?,?,?,?)";    
 ...
 */
	...
	currentComponent="tOracleInput_1";
		...
		int tos_count_tOracleInput_1 = 0;
		    ...
		    String dbquery_tOracleInput_1 = "\nSELECT CANTIDAD_MASCULINO+CANTIDAD_FEMENINO AS TOTAL, T.* FROM(\nSELECT\n   SUM(CASE WHEN BRC.SEXO = 'M' THEN 1 ELSE "
+"0 END) AS CANTIDAD_MASCULINO, \n   SUM(CASE WHEN BRC.SEXO = 'F' THEN 1 ELSE 0 END) AS CANTIDAD_FEMENINO,\n   BTI.ID AS T"
+"IEMPOS_ID,\n   TA.ID  AS TIPOUSUARIO_ID,\n   BGU.ID AS UORG_ID,\n   BGD.ID AS DIAGNOSTICOS_ID,\n   BGR.ID AS RANGOEDAD_I"
+"D\nFROM (\n    SELECT \n      CODDIAGNOSTICOPPAL, \n      UORG_ID, \n      FECHA, \n      SEXO, \n      TUSUARIO_CODIGO,"
+" \n      CASE WHEN UMEDIDA_EDAD='Meses' THEN 0 ELSE EDAD END AS EDAD \n      FROM BRIPS_CONSULTA\n  ) BRC\n  INNER JOIN "
+"BGEN_DIAGNOSTICOS BGD  ON BGD.CODIGO = BRC.CODDIAGNOSTICOPPAL \n  INNER JOIN BGEN_UORG BGU          ON BGU.ID = BRC.UORG"
+"_ID AND BGU.ESTREGISTRO_ID=1 AND BGU.LONGITUD!=0 AND BGU.TIPO_ORGANIZACION<>'IPS' \n  INNER JOIN BGEN_RANGOEDAD BGR     "
+"ON BGR.CODIGO IN ('REP03','REP04','REP01','REP05') AND (BRC.EDAD BETWEEN BGR.VALOR_MENOR AND BGR.VALOR_MAYOR)\n  INNER J"
+"OIN BGEN_TIEMPOS BTI       ON BTI.ANIO = TO_CHAR(BRC.FECHA , 'YYYY') AND BTI.MES = TO_CHAR(BRC.FECHA , 'MM') \n  INNER J"
+"OIN BGEN_TIPOAFILIADO TA   ON TA.CODIGO = BRC.TUSUARIO_CODIGO\nWHERE  BTI.ANIO=TO_CHAR((trunc(TO_DATE('"+context.FECHA_EJECUCION+"', 'DD/MM/YYYY'), 'mm')-1), 'YYYY') \n	AND BTI.MES = TO_CHAR((trunc(TO_DATE('"+context.FECHA_EJECUCION+"', 'DD/MM/YYYY'), 'mm')-1), 'MM') AND BTI.DIA=1\nGROUP BY BGD.ID, BGU.ID, BGR.ID, BTI.ID, TA.ID)T \n";
		    ...
		    while (rs_tOracleInput_1.next()) {
		        nb_line_tOracleInput_1++;
					...
					if(rs_tOracleInput_1.getObject(1) != null) {
						row3.TOTAL = rs_tOracleInput_1.getBigDecimal(1);
					} else {
						...
						row3.TOTAL = null;
							...
							if(colQtyInRs_tOracleInput_1 < 2) {
								row3.CANTIDAD_MASCULINO = null;
							} else {
		                          
					if(rs_tOracleInput_1.getObject(2) != null) {
						row3.CANTIDAD_MASCULINO = rs_tOracleInput_1.getBigDecimal(2);
					} else {
						...
						row3.CANTIDAD_MASCULINO = null;
							...
							if(colQtyInRs_tOracleInput_1 < 3) {
								row3.CANTIDAD_FEMENINO = null;
							} else {
		                          
					if(rs_tOracleInput_1.getObject(3) != null) {
						row3.CANTIDAD_FEMENINO = rs_tOracleInput_1.getBigDecimal(3);
					} else {
						...
						row3.CANTIDAD_FEMENINO = null;
							...
							if(colQtyInRs_tOracleInput_1 < 4) {
								row3.TIEMPOS_ID = null;
							} else {
		                          
					if(rs_tOracleInput_1.getObject(4) != null) {
						row3.TIEMPOS_ID = rs_tOracleInput_1.getBigDecimal(4);
					} else {
 	                	...
 	                	throw new RuntimeException("Null value in non-Nullable column");
							...
							if(colQtyInRs_tOracleInput_1 < 5) {
								row3.TIPOUSUARIO_ID = null;
							} else {
		                          
					if(rs_tOracleInput_1.getObject(5) != null) {
						row3.TIPOUSUARIO_ID = rs_tOracleInput_1.getBigDecimal(5);
					} else {
						...
						row3.UORG_ID = rs_tOracleInput_1.getBigDecimal(6);
 	                	...
 	                	throw new RuntimeException("Null value in non-Nullable column");
							...
							if(colQtyInRs_tOracleInput_1 < 7) {
								row3.DIAGNOSTICOS_ID = null;
							} else {
		                          
					if(rs_tOracleInput_1.getObject(7) != null) {
						row3.DIAGNOSTICOS_ID = rs_tOracleInput_1.getBigDecimal(7);
					} else {
					...
					if(rs_tOracleInput_1.getObject(8) != null) {
						row3.RANGOEDAD_ID = rs_tOracleInput_1.getBigDecimal(8);
					} else {
...
// # Output table : 'out1'
out1_tmp.TOTAL = row3.TOTAL ;
out1_tmp.CANTIDAD_MASCULINO = row3.CANTIDAD_MASCULINO ;
out1_tmp.CANTIDAD_FEMENINO = row3.CANTIDAD_FEMENINO ;
out1_tmp.TIEMPOS_ID = row3.TIEMPOS_ID ;
out1_tmp.TIPOAFILIADO_ID = row3.TIPOUSUARIO_ID ;
out1_tmp.UORG_ID = row3.UORG_ID ;
out1_tmp.DIAGNOSTICOS_ID = row3.DIAGNOSTICOS_ID ;
out1_tmp.RANGOEDAD_ID = row3.RANGOEDAD_ID ;
out1 = out1_tmp;
// ###############################
...
if(out1 != null) { 
	...
	currentComponent="tOracleOutput_1";
        ...
        whetherReject_tOracleOutput_1 = false;
                        pstmt_tOracleOutput_1.setBigDecimal(1, out1.TOTAL);

                        pstmt_tOracleOutput_1.setBigDecimal(2, out1.CANTIDAD_MASCULINO);

                        pstmt_tOracleOutput_1.setBigDecimal(3, out1.CANTIDAD_FEMENINO);

                        pstmt_tOracleOutput_1.setBigDecimal(4, out1.TIEMPOS_ID);

                        pstmt_tOracleOutput_1.setBigDecimal(5, out1.TIPOAFILIADO_ID);

                        pstmt_tOracleOutput_1.setBigDecimal(6, out1.UORG_ID);

                        pstmt_tOracleOutput_1.setBigDecimal(7, out1.DIAGNOSTICOS_ID);

                        pstmt_tOracleOutput_1.setBigDecimal(8, out1.RANGOEDAD_ID);
...
public static class row41Struct implements routines.system.IPersistableRow<row41Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_REP_INICIO_F5_Morbilidad.length) {
				if(length < 1024 && commonByteArray_REP_INICIO_F5_Morbilidad.length == 0) {
   					commonByteArray_REP_INICIO_F5_Morbilidad = new byte[1024];
				} else {
   					commonByteArray_REP_INICIO_F5_Morbilidad = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_REP_INICIO_F5_Morbilidad, 0, length);
			strReturn = new String(commonByteArray_REP_INICIO_F5_Morbilidad, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_REP_INICIO_F5_Morbilidad, 0, length);
			strReturn = new String(commonByteArray_REP_INICIO_F5_Morbilidad, 0, length, utf8Charset);
		}
		return strReturn;
	}
 ...
 */
    ...
    public static void main(String[] args){
        final Morbilidad MorbilidadClass = new Morbilidad();

        int exitCode = MorbilidadClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Morbilidad.class.getClassLoader().getResourceAsStream("rep_inicio_f5/morbilidad_0_2/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Morbilidad.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
            ...
            class ContextProcessing {
                private void processContext_0() {
                        ...
                        context.setContextType("PRIMER_DIA", "id_String");
                        if(context.getStringValue("PRIMER_DIA") == null) {
                            context.PRIMER_DIA = null;
                        } else {
                            context.PRIMER_DIA=(String) context.getProperty("PRIMER_DIA");
                        }
                } 
        ...
        if (parentContextMap != null && !parentContextMap.isEmpty()) {if (parentContextMap.containsKey("db_origen_AdditionalParams")) {
            ...
            }if (parentContextMap.containsKey("PRIMER_DIA")) {
                context.PRIMER_DIA = (String) parentContextMap.get("PRIMER_DIA");
            }
        }
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Morbilidad");
        }
...
/************************************************************************************************
 *     348600 characters generated by Talend Open Studio for ESB 
