...
package rep_inicio_f5.antecedentes_1_1;
...
public static class row41Struct implements routines.system.IPersistableRow<row41Struct> {
    final static byte[] commonByteArrayLock_REP_INICIO_F5_Antecedentes = new byte[0];
    static byte[] commonByteArray_REP_INICIO_F5_Antecedentes = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_REP_INICIO_F5_Antecedentes.length) {
				if(length < 1024 && commonByteArray_REP_INICIO_F5_Antecedentes.length == 0) {
   					commonByteArray_REP_INICIO_F5_Antecedentes = new byte[1024];
				} else {
   					commonByteArray_REP_INICIO_F5_Antecedentes = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_REP_INICIO_F5_Antecedentes, 0, length);
			strReturn = new String(commonByteArray_REP_INICIO_F5_Antecedentes, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_REP_INICIO_F5_Antecedentes, 0, length);
			strReturn = new String(commonByteArray_REP_INICIO_F5_Antecedentes, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_REP_INICIO_F5_Antecedentes) {
...
+"ECEDENTE_ID = TAN.ID\nWHERE ( TAN.PADRE_ID IN (SELECT ID FROM HCL_TANTECEDENTES WHERE SIGLA IN ('AP', 'AM','AG', 'HABITO"
+"S')) OR TAN.SIGLA = 'APCA')\n"+context.CONDITION;
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Antecedentes.class.getClassLoader().getResourceAsStream("rep_inicio_f5/antecedentes_1_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     359677 characters generated by Talend Open Studio for ESB 
