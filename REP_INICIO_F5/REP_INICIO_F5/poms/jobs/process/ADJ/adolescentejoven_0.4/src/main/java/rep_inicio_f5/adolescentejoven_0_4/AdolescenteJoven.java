...
package rep_inicio_f5.adolescentejoven_0_4;
...
/**
 * Job: AdolescenteJoven Purpose: <br>
 * Description:  <br>
 * @author jorgejlhc@gmail.com
 * @version 8.8.8.20240722_1936-SNAPSHOT
 * @status 
 */
public class AdolescenteJoven implements TalendJob {
...
public String getRutaSistema(){
	...
	private final String jobName = "AdolescenteJoven";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				AdolescenteJoven.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(AdolescenteJoven.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row34Struct implements routines.system.IPersistableRow<row34Struct> {
    final static byte[] commonByteArrayLock_REP_INICIO_F5_AdolescenteJoven = new byte[0];
    static byte[] commonByteArray_REP_INICIO_F5_AdolescenteJoven = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_REP_INICIO_F5_AdolescenteJoven.length) {
				if(length < 1024 && commonByteArray_REP_INICIO_F5_AdolescenteJoven.length == 0) {
   					commonByteArray_REP_INICIO_F5_AdolescenteJoven = new byte[1024];
				} else {
   					commonByteArray_REP_INICIO_F5_AdolescenteJoven = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_REP_INICIO_F5_AdolescenteJoven, 0, length);
			strReturn = new String(commonByteArray_REP_INICIO_F5_AdolescenteJoven, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_REP_INICIO_F5_AdolescenteJoven, 0, length);
			strReturn = new String(commonByteArray_REP_INICIO_F5_AdolescenteJoven, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_REP_INICIO_F5_AdolescenteJoven) {
...
//context.FANTERIOR = TalendDate.formatDate("dd-MM-YYYY",TalendDate.addDate(TalendDate.getCurrentDate(),-30,"DD"));
//context.ACTUALIZACION_TOTAL = true;

if (!context.ACTUALIZACION_TOTAL){
context.CONDITION = " AND HP.FINICIAL>= to_date('"+ context.FANTERIOR+"' ,'DD/MM/YYYY') ";
...
public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
    ...
    public String loopKey;
			    ...
			    public String TSNELLEN_OJOI;

				public String getTSNELLEN_OJOI () {
					return this.TSNELLEN_OJOI;
				}

				public Boolean TSNELLEN_OJOIIsNullable(){
				    return true;
				}
				public Boolean TSNELLEN_OJOIIsKey(){
				    return false;
				}
				public Integer TSNELLEN_OJOILength(){
				    return 4000;
				}
				public Integer TSNELLEN_OJOIPrecision(){
				    return 0;
				}
				public String TSNELLEN_OJOIDefault(){
				
					return null;
				
				}
				public String TSNELLEN_OJOIComment(){
				
				    return "";
				
				}
				public String TSNELLEN_OJOIPattern(){
				
					return "";
				
				}
				public String TSNELLEN_OJOIOriginalDbColumnName(){
				
					return "TSNELLEN_OJOI";
				
				}

				
			    public String TSNELLEN_OJOD;

				public String getTSNELLEN_OJOD () {
					return this.TSNELLEN_OJOD;
				}

				public Boolean TSNELLEN_OJODIsNullable(){
				    return true;
				}
				public Boolean TSNELLEN_OJODIsKey(){
				    return false;
				}
				public Integer TSNELLEN_OJODLength(){
				    return 4000;
				}
				public Integer TSNELLEN_OJODPrecision(){
				    return 0;
				}
				public String TSNELLEN_OJODDefault(){
				
					return null;
				
				}
				public String TSNELLEN_OJODComment(){
				
				    return "";
				
				}
				public String TSNELLEN_OJODPattern(){
				
					return "";
				
				}
				public String TSNELLEN_OJODOriginalDbColumnName(){
				
					return "TSNELLEN_OJOD";
				
				}

				
			    public String TJAEGER_OJOI;

				public String getTJAEGER_OJOI () {
					return this.TJAEGER_OJOI;
				}

				public Boolean TJAEGER_OJOIIsNullable(){
				    return true;
				}
				public Boolean TJAEGER_OJOIIsKey(){
				    return false;
				}
				public Integer TJAEGER_OJOILength(){
				    return 4000;
				}
				public Integer TJAEGER_OJOIPrecision(){
				    return 0;
				}
				public String TJAEGER_OJOIDefault(){
				
					return null;
				
				}
				public String TJAEGER_OJOIComment(){
				
				    return "";
				
				}
				public String TJAEGER_OJOIPattern(){
				
					return "";
				
				}
				public String TJAEGER_OJOIOriginalDbColumnName(){
			    ...
			    public String TJAEGER_OJOD;

				public String getTJAEGER_OJOD () {
					return this.TJAEGER_OJOD;
				}

				public Boolean TJAEGER_OJODIsNullable(){
				    return true;
				}
				public Boolean TJAEGER_OJODIsKey(){
				    return false;
				}
				public Integer TJAEGER_OJODLength(){
				    return 4000;
				}
				public Integer TJAEGER_OJODPrecision(){
				    return 0;
				}
				public String TJAEGER_OJODDefault(){
				
					return null;
				
				}
				public String TJAEGER_OJODComment(){
				
				    return "";
				
				}
				public String TJAEGER_OJODPattern(){
				
					return "";
				
				}
				public String TJAEGER_OJODOriginalDbColumnName(){
			    ...
			    public String PERCENTIL_TALLA;

				public String getPERCENTIL_TALLA () {
					return this.PERCENTIL_TALLA;
				}

				public Boolean PERCENTIL_TALLAIsNullable(){
				    return true;
				}
				public Boolean PERCENTIL_TALLAIsKey(){
				    return false;
				}
				public Integer PERCENTIL_TALLALength(){
				    return 4000;
				}
				public Integer PERCENTIL_TALLAPrecision(){
				    return 0;
				}
				public String PERCENTIL_TALLADefault(){
				
					return null;
				
				}
				public String PERCENTIL_TALLAComment(){
				
				    return "";
				
				}
				public String PERCENTIL_TALLAPattern(){
				
					return "";
				
				}
				public String PERCENTIL_TALLAOriginalDbColumnName(){
				
					return "PERCENTIL_TALLA";
				
				}

				
			    public String OTOSCOPIA_OIDOI;

				public String getOTOSCOPIA_OIDOI () {
					return this.OTOSCOPIA_OIDOI;
				}

				public Boolean OTOSCOPIA_OIDOIIsNullable(){
				    return true;
				}
				public Boolean OTOSCOPIA_OIDOIIsKey(){
				    return false;
				}
				public Integer OTOSCOPIA_OIDOILength(){
				    return 4000;
				}
				public Integer OTOSCOPIA_OIDOIPrecision(){
				    return 0;
				}
				public String OTOSCOPIA_OIDOIDefault(){
				
					return null;
				
				}
				public String OTOSCOPIA_OIDOIComment(){
				
				    return "";
				
				}
				public String OTOSCOPIA_OIDOIPattern(){
				
					return "";
				
				}
				public String OTOSCOPIA_OIDOIOriginalDbColumnName(){
				
					return "OTOSCOPIA_OIDOI";
				
				}

				
			    public String OTOSCOPIA_OIDOD;

				public String getOTOSCOPIA_OIDOD () {
					return this.OTOSCOPIA_OIDOD;
				}

				public Boolean OTOSCOPIA_OIDODIsNullable(){
				    return true;
				}
				public Boolean OTOSCOPIA_OIDODIsKey(){
				    return false;
				}
				public Integer OTOSCOPIA_OIDODLength(){
				    return 4000;
				}
				public Integer OTOSCOPIA_OIDODPrecision(){
				    return 0;
				}
				public String OTOSCOPIA_OIDODDefault(){
				
					return null;
				
				}
				public String OTOSCOPIA_OIDODComment(){
				
				    return "";
				
				}
				public String OTOSCOPIA_OIDODPattern(){
				
					return "";
				
				}
				public String OTOSCOPIA_OIDODOriginalDbColumnName(){
				
					return "OTOSCOPIA_OIDOD";
				
				}

				
			    public String VFISICA_OIDOI;

				public String getVFISICA_OIDOI () {
					return this.VFISICA_OIDOI;
				}

				public Boolean VFISICA_OIDOIIsNullable(){
				    return true;
				}
				public Boolean VFISICA_OIDOIIsKey(){
				    return false;
				}
				public Integer VFISICA_OIDOILength(){
				    return 4000;
				}
				public Integer VFISICA_OIDOIPrecision(){
				    return 0;
				}
				public String VFISICA_OIDOIDefault(){
				
					return null;
				
				}
				public String VFISICA_OIDOIComment(){
				
				    return "";
				
				}
				public String VFISICA_OIDOIPattern(){
				
					return "";
				
				}
				public String VFISICA_OIDOIOriginalDbColumnName(){
				
					return "VFISICA_OIDOI";
				
				}

				
			    public String VFISICA_OIDOD;

				public String getVFISICA_OIDOD () {
					return this.VFISICA_OIDOD;
				}

				public Boolean VFISICA_OIDODIsNullable(){
				    return true;
				}
				public Boolean VFISICA_OIDODIsKey(){
				    return false;
				}
				public Integer VFISICA_OIDODLength(){
				    return 4000;
				}
				public Integer VFISICA_OIDODPrecision(){
				    return 0;
				}
				public String VFISICA_OIDODDefault(){
				
					return null;
				
				}
				public String VFISICA_OIDODComment(){
				
				    return "";
				
				}
				public String VFISICA_OIDODPattern(){
				
					return "";
				
				}
				public String VFISICA_OIDODOriginalDbColumnName(){
				
					return "VFISICA_OIDOD";
				
				}

				
			    public String ADJ001;

				public String getADJ001 () {
					return this.ADJ001;
				}

				public Boolean ADJ001IsNullable(){
				    return true;
				}
				public Boolean ADJ001IsKey(){
				    return false;
				}
				public Integer ADJ001Length(){
				    return 100;
				}
				public Integer ADJ001Precision(){
				    return 0;
				}
				public String ADJ001Default(){
				
					return null;
				
				}
				public String ADJ001Comment(){
				
				    return "";
				
				}
				public String ADJ001Pattern(){
				
					return "";
				
				}
				public String ADJ001OriginalDbColumnName(){
			    ...
			    public String ADJ002;

				public String getADJ002 () {
					return this.ADJ002;
				}

				public Boolean ADJ002IsNullable(){
				    return true;
				}
				public Boolean ADJ002IsKey(){
				    return false;
				}
				public Integer ADJ002Length(){
				    return 100;
				}
				public Integer ADJ002Precision(){
				    return 0;
				}
				public String ADJ002Default(){
				
					return null;
				
				}
				public String ADJ002Comment(){
				
				    return "";
				
				}
				public String ADJ002Pattern(){
				
					return "";
				
				}
				public String ADJ002OriginalDbColumnName(){
			    ...
			    public String ADJ003;

				public String getADJ003 () {
					return this.ADJ003;
				}

				public Boolean ADJ003IsNullable(){
				    return true;
				}
				public Boolean ADJ003IsKey(){
				    return false;
				}
				public Integer ADJ003Length(){
				    return 100;
				}
				public Integer ADJ003Precision(){
				    return 0;
				}
				public String ADJ003Default(){
				
					return null;
				
				}
				public String ADJ003Comment(){
				
				    return "";
				
				}
				public String ADJ003Pattern(){
				
					return "";
				
				}
				public String ADJ003OriginalDbColumnName(){
			    ...
			    public String ADJ004;

				public String getADJ004 () {
					return this.ADJ004;
				}

				public Boolean ADJ004IsNullable(){
				    return true;
				}
				public Boolean ADJ004IsKey(){
				    return false;
				}
				public Integer ADJ004Length(){
				    return 100;
				}
				public Integer ADJ004Precision(){
				    return 0;
				}
				public String ADJ004Default(){
				
					return null;
				
				}
				public String ADJ004Comment(){
				
				    return "";
				
				}
				public String ADJ004Pattern(){
				
					return "";
				
				}
				public String ADJ004OriginalDbColumnName(){
			    ...
			    public String ADJ005;

				public String getADJ005 () {
					return this.ADJ005;
				}

				public Boolean ADJ005IsNullable(){
				    return true;
				}
				public Boolean ADJ005IsKey(){
				    return false;
				}
				public Integer ADJ005Length(){
				    return 100;
				}
				public Integer ADJ005Precision(){
				    return 0;
				}
				public String ADJ005Default(){
				
					return null;
				
				}
				public String ADJ005Comment(){
				
				    return "";
				
				}
				public String ADJ005Pattern(){
				
					return "";
				
				}
				public String ADJ005OriginalDbColumnName(){
			    ...
			    public String ADJ007;

				public String getADJ007 () {
					return this.ADJ007;
				}

				public Boolean ADJ007IsNullable(){
				    return true;
				}
				public Boolean ADJ007IsKey(){
				    return false;
				}
				public Integer ADJ007Length(){
				    return 100;
				}
				public Integer ADJ007Precision(){
				    return 0;
				}
				public String ADJ007Default(){
				
					return null;
				
				}
				public String ADJ007Comment(){
				
				    return "";
				
				}
				public String ADJ007Pattern(){
				
					return "";
				
				}
				public String ADJ007OriginalDbColumnName(){
			    ...
			    public String ADJ008;

				public String getADJ008 () {
					return this.ADJ008;
				}

				public Boolean ADJ008IsNullable(){
				    return true;
				}
				public Boolean ADJ008IsKey(){
				    return false;
				}
				public Integer ADJ008Length(){
				    return 100;
				}
				public Integer ADJ008Precision(){
				    return 0;
				}
				public String ADJ008Default(){
				
					return null;
				
				}
				public String ADJ008Comment(){
				
				    return "";
				
				}
				public String ADJ008Pattern(){
				
					return "";
				
				}
				public String ADJ008OriginalDbColumnName(){
			    ...
			    public String ADJ010;

				public String getADJ010 () {
					return this.ADJ010;
				}

				public Boolean ADJ010IsNullable(){
				    return true;
				}
				public Boolean ADJ010IsKey(){
				    return false;
				}
				public Integer ADJ010Length(){
				    return 100;
				}
				public Integer ADJ010Precision(){
				    return 0;
				}
				public String ADJ010Default(){
				
					return null;
				
				}
				public String ADJ010Comment(){
				
				    return "";
				
				}
				public String ADJ010Pattern(){
				
					return "";
				
				}
				public String ADJ010OriginalDbColumnName(){
			    ...
			    public String ADJ011;

				public String getADJ011 () {
					return this.ADJ011;
				}

				public Boolean ADJ011IsNullable(){
				    return true;
				}
				public Boolean ADJ011IsKey(){
				    return false;
				}
				public Integer ADJ011Length(){
				    return 100;
				}
				public Integer ADJ011Precision(){
				    return 0;
				}
				public String ADJ011Default(){
				
					return null;
				
				}
				public String ADJ011Comment(){
				
				    return "";
				
				}
				public String ADJ011Pattern(){
				
					return "";
				
				}
				public String ADJ011OriginalDbColumnName(){
			    ...
			    public String ADJ012;

				public String getADJ012 () {
					return this.ADJ012;
				}

				public Boolean ADJ012IsNullable(){
				    return true;
				}
				public Boolean ADJ012IsKey(){
				    return false;
				}
				public Integer ADJ012Length(){
				    return 100;
				}
				public Integer ADJ012Precision(){
				    return 0;
				}
				public String ADJ012Default(){
				
					return null;
				
				}
				public String ADJ012Comment(){
				
				    return "";
				
				}
				public String ADJ012Pattern(){
				
					return "";
				
				}
				public String ADJ012OriginalDbColumnName(){
			    ...
			    public String ADJ013;

				public String getADJ013 () {
					return this.ADJ013;
				}

				public Boolean ADJ013IsNullable(){
				    return true;
				}
				public Boolean ADJ013IsKey(){
				    return false;
				}
				public Integer ADJ013Length(){
				    return 100;
				}
				public Integer ADJ013Precision(){
				    return 0;
				}
				public String ADJ013Default(){
				
					return null;
				
				}
				public String ADJ013Comment(){
				
				    return "";
				
				}
				public String ADJ013Pattern(){
				
					return "";
				
				}
				public String ADJ013OriginalDbColumnName(){
			    ...
			    public String ADJ014;

				public String getADJ014 () {
					return this.ADJ014;
				}

				public Boolean ADJ014IsNullable(){
				    return true;
				}
				public Boolean ADJ014IsKey(){
				    return false;
				}
				public Integer ADJ014Length(){
				    return 100;
				}
				public Integer ADJ014Precision(){
				    return 0;
				}
				public String ADJ014Default(){
				
					return null;
				
				}
				public String ADJ014Comment(){
				
				    return "";
				
				}
				public String ADJ014Pattern(){
				
					return "";
				
				}
				public String ADJ014OriginalDbColumnName(){
			    ...
			    public String ADJ015;

				public String getADJ015 () {
					return this.ADJ015;
				}

				public Boolean ADJ015IsNullable(){
				    return true;
				}
				public Boolean ADJ015IsKey(){
				    return false;
				}
				public Integer ADJ015Length(){
				    return 100;
				}
				public Integer ADJ015Precision(){
				    return 0;
				}
				public String ADJ015Default(){
				
					return null;
				
				}
				public String ADJ015Comment(){
				
				    return "";
				
				}
				public String ADJ015Pattern(){
				
					return "";
				
				}
				public String ADJ015OriginalDbColumnName(){
			    ...
			    public String ADJ016;

				public String getADJ016 () {
					return this.ADJ016;
				}

				public Boolean ADJ016IsNullable(){
				    return true;
				}
				public Boolean ADJ016IsKey(){
				    return false;
				}
				public Integer ADJ016Length(){
				    return 100;
				}
				public Integer ADJ016Precision(){
				    return 0;
				}
				public String ADJ016Default(){
				
					return null;
				
				}
				public String ADJ016Comment(){
				
				    return "";
				
				}
				public String ADJ016Pattern(){
				
					return "";
				
				}
				public String ADJ016OriginalDbColumnName(){
			    ...
			    public String ADJ018;

				public String getADJ018 () {
					return this.ADJ018;
				}

				public Boolean ADJ018IsNullable(){
				    return true;
				}
				public Boolean ADJ018IsKey(){
				    return false;
				}
				public Integer ADJ018Length(){
				    return 100;
				}
				public Integer ADJ018Precision(){
				    return 0;
				}
				public String ADJ018Default(){
				
					return null;
				
				}
				public String ADJ018Comment(){
				
				    return "";
				
				}
				public String ADJ018Pattern(){
				
					return "";
				
				}
				public String ADJ018OriginalDbColumnName(){
			    ...
			    public String ADJ019;

				public String getADJ019 () {
					return this.ADJ019;
				}

				public Boolean ADJ019IsNullable(){
				    return true;
				}
				public Boolean ADJ019IsKey(){
				    return false;
				}
				public Integer ADJ019Length(){
				    return 100;
				}
				public Integer ADJ019Precision(){
				    return 0;
				}
				public String ADJ019Default(){
				
					return null;
				
				}
				public String ADJ019Comment(){
				
				    return "";
				
				}
				public String ADJ019Pattern(){
				
					return "";
				
				}
				public String ADJ019OriginalDbColumnName(){
			    ...
			    public String ADJ020;

				public String getADJ020 () {
					return this.ADJ020;
				}

				public Boolean ADJ020IsNullable(){
				    return true;
				}
				public Boolean ADJ020IsKey(){
				    return false;
				}
				public Integer ADJ020Length(){
				    return 100;
				}
				public Integer ADJ020Precision(){
				    return 0;
				}
				public String ADJ020Default(){
				
					return null;
				
				}
				public String ADJ020Comment(){
				
				    return "";
				
				}
				public String ADJ020Pattern(){
				
					return "";
				
				}
				public String ADJ020OriginalDbColumnName(){
			    ...
			    public String ADJ021;

				public String getADJ021 () {
					return this.ADJ021;
				}

				public Boolean ADJ021IsNullable(){
				    return true;
				}
				public Boolean ADJ021IsKey(){
				    return false;
				}
				public Integer ADJ021Length(){
				    return 100;
				}
				public Integer ADJ021Precision(){
				    return 0;
				}
				public String ADJ021Default(){
				
					return null;
				
				}
				public String ADJ021Comment(){
				
				    return "";
				
				}
				public String ADJ021Pattern(){
				
					return "";
				
				}
				public String ADJ021OriginalDbColumnName(){
			    ...
			    public String ADJ022;

				public String getADJ022 () {
					return this.ADJ022;
				}

				public Boolean ADJ022IsNullable(){
				    return true;
				}
				public Boolean ADJ022IsKey(){
				    return false;
				}
				public Integer ADJ022Length(){
				    return 100;
				}
				public Integer ADJ022Precision(){
				    return 0;
				}
				public String ADJ022Default(){
				
					return null;
				
				}
				public String ADJ022Comment(){
				
				    return "";
				
				}
				public String ADJ022Pattern(){
				
					return "";
				
				}
				public String ADJ022OriginalDbColumnName(){
			    ...
			    public String ADJ023;

				public String getADJ023 () {
					return this.ADJ023;
				}

				public Boolean ADJ023IsNullable(){
				    return true;
				}
				public Boolean ADJ023IsKey(){
				    return false;
				}
				public Integer ADJ023Length(){
				    return 100;
				}
				public Integer ADJ023Precision(){
				    return 0;
				}
				public String ADJ023Default(){
				
					return null;
				
				}
				public String ADJ023Comment(){
				
				    return "";
				
				}
				public String ADJ023Pattern(){
				
					return "";
				
				}
				public String ADJ023OriginalDbColumnName(){
			    ...
			    public String ADJ024;

				public String getADJ024 () {
					return this.ADJ024;
				}

				public Boolean ADJ024IsNullable(){
				    return true;
				}
				public Boolean ADJ024IsKey(){
				    return false;
				}
				public Integer ADJ024Length(){
				    return 100;
				}
				public Integer ADJ024Precision(){
				    return 0;
				}
				public String ADJ024Default(){
				
					return null;
				
				}
				public String ADJ024Comment(){
				
				    return "";
				
				}
				public String ADJ024Pattern(){
				
					return "";
				
				}
				public String ADJ024OriginalDbColumnName(){
			    ...
			    public String ADJ025;

				public String getADJ025 () {
					return this.ADJ025;
				}

				public Boolean ADJ025IsNullable(){
				    return true;
				}
				public Boolean ADJ025IsKey(){
				    return false;
				}
				public Integer ADJ025Length(){
				    return 100;
				}
				public Integer ADJ025Precision(){
				    return 0;
				}
				public String ADJ025Default(){
				
					return null;
				
				}
				public String ADJ025Comment(){
				
				    return "";
				
				}
				public String ADJ025Pattern(){
				
					return "";
				
				}
				public String ADJ025OriginalDbColumnName(){
			    ...
			    public String ADJ026;

				public String getADJ026 () {
					return this.ADJ026;
				}

				public Boolean ADJ026IsNullable(){
				    return true;
				}
				public Boolean ADJ026IsKey(){
				    return false;
				}
				public Integer ADJ026Length(){
				    return 100;
				}
				public Integer ADJ026Precision(){
				    return 0;
				}
				public String ADJ026Default(){
				
					return null;
				
				}
				public String ADJ026Comment(){
				
				    return "";
				
				}
				public String ADJ026Pattern(){
				
					return "";
				
				}
				public String ADJ026OriginalDbColumnName(){
			    ...
			    public String ADJ027;

				public String getADJ027 () {
					return this.ADJ027;
				}

				public Boolean ADJ027IsNullable(){
				    return true;
				}
				public Boolean ADJ027IsKey(){
				    return false;
				}
				public Integer ADJ027Length(){
				    return 100;
				}
				public Integer ADJ027Precision(){
				    return 0;
				}
				public String ADJ027Default(){
				
					return null;
				
				}
				public String ADJ027Comment(){
				
				    return "";
				
				}
				public String ADJ027Pattern(){
				
					return "";
				
				}
				public String ADJ027OriginalDbColumnName(){
			    ...
			    public String ADJ028;

				public String getADJ028 () {
					return this.ADJ028;
				}

				public Boolean ADJ028IsNullable(){
				    return true;
				}
				public Boolean ADJ028IsKey(){
				    return false;
				}
				public Integer ADJ028Length(){
				    return 100;
				}
				public Integer ADJ028Precision(){
				    return 0;
				}
				public String ADJ028Default(){
				
					return null;
				
				}
				public String ADJ028Comment(){
				
				    return "";
				
				}
				public String ADJ028Pattern(){
				
					return "";
				
				}
				public String ADJ028OriginalDbColumnName(){
			    ...
			    public String ADJ029;

				public String getADJ029 () {
					return this.ADJ029;
				}

				public Boolean ADJ029IsNullable(){
				    return true;
				}
				public Boolean ADJ029IsKey(){
				    return false;
				}
				public Integer ADJ029Length(){
				    return 100;
				}
				public Integer ADJ029Precision(){
				    return 0;
				}
				public String ADJ029Default(){
				
					return null;
				
				}
				public String ADJ029Comment(){
				
				    return "";
				
				}
				public String ADJ029Pattern(){
				
					return "";
				
				}
				public String ADJ029OriginalDbColumnName(){
			    ...
			    public String ADJ030;

				public String getADJ030 () {
					return this.ADJ030;
				}

				public Boolean ADJ030IsNullable(){
				    return true;
				}
				public Boolean ADJ030IsKey(){
				    return false;
				}
				public Integer ADJ030Length(){
				    return 100;
				}
				public Integer ADJ030Precision(){
				    return 0;
				}
				public String ADJ030Default(){
				
					return null;
				
				}
				public String ADJ030Comment(){
				
				    return "";
				
				}
				public String ADJ030Pattern(){
				
					return "";
				
				}
				public String ADJ030OriginalDbColumnName(){
			    ...
			    public String ADJ032;

				public String getADJ032 () {
					return this.ADJ032;
				}

				public Boolean ADJ032IsNullable(){
				    return true;
				}
				public Boolean ADJ032IsKey(){
				    return false;
				}
				public Integer ADJ032Length(){
				    return 100;
				}
				public Integer ADJ032Precision(){
				    return 0;
				}
				public String ADJ032Default(){
				
					return null;
				
				}
				public String ADJ032Comment(){
				
				    return "";
				
				}
				public String ADJ032Pattern(){
				
					return "";
				
				}
				public String ADJ032OriginalDbColumnName(){
			    ...
			    public String ADJ033;

				public String getADJ033 () {
					return this.ADJ033;
				}

				public Boolean ADJ033IsNullable(){
				    return true;
				}
				public Boolean ADJ033IsKey(){
				    return false;
				}
				public Integer ADJ033Length(){
				    return 100;
				}
				public Integer ADJ033Precision(){
				    return 0;
				}
				public String ADJ033Default(){
				
					return null;
				
				}
				public String ADJ033Comment(){
				
				    return "";
				
				}
				public String ADJ033Pattern(){
				
					return "";
				
				}
				public String ADJ033OriginalDbColumnName(){
			    ...
			    public String ADJ036;

				public String getADJ036 () {
					return this.ADJ036;
				}

				public Boolean ADJ036IsNullable(){
				    return true;
				}
				public Boolean ADJ036IsKey(){
				    return false;
				}
				public Integer ADJ036Length(){
				    return 100;
				}
				public Integer ADJ036Precision(){
				    return 0;
				}
				public String ADJ036Default(){
				
					return null;
				
				}
				public String ADJ036Comment(){
				
				    return "";
				
				}
				public String ADJ036Pattern(){
				
					return "";
				
				}
				public String ADJ036OriginalDbColumnName(){
			    ...
			    public String ADJ038;

				public String getADJ038 () {
					return this.ADJ038;
				}

				public Boolean ADJ038IsNullable(){
				    return true;
				}
				public Boolean ADJ038IsKey(){
				    return false;
				}
				public Integer ADJ038Length(){
				    return 100;
				}
				public Integer ADJ038Precision(){
				    return 0;
				}
				public String ADJ038Default(){
				
					return null;
				
				}
				public String ADJ038Comment(){
				
				    return "";
				
				}
				public String ADJ038Pattern(){
				
					return "";
				
				}
				public String ADJ038OriginalDbColumnName(){
			    ...
			    public String ADJ040;

				public String getADJ040 () {
					return this.ADJ040;
				}

				public Boolean ADJ040IsNullable(){
				    return true;
				}
				public Boolean ADJ040IsKey(){
				    return false;
				}
				public Integer ADJ040Length(){
				    return 100;
				}
				public Integer ADJ040Precision(){
				    return 0;
				}
				public String ADJ040Default(){
				
					return null;
				
				}
				public String ADJ040Comment(){
				
				    return "";
				
				}
				public String ADJ040Pattern(){
				
					return "";
				
				}
				public String ADJ040OriginalDbColumnName(){
			    ...
			    public String ADJ041;

				public String getADJ041 () {
					return this.ADJ041;
				}

				public Boolean ADJ041IsNullable(){
				    return true;
				}
				public Boolean ADJ041IsKey(){
				    return false;
				}
				public Integer ADJ041Length(){
				    return 100;
				}
				public Integer ADJ041Precision(){
				    return 0;
				}
				public String ADJ041Default(){
				
					return null;
				
				}
				public String ADJ041Comment(){
				
				    return "";
				
				}
				public String ADJ041Pattern(){
				
					return "";
				
				}
				public String ADJ041OriginalDbColumnName(){
			    ...
			    public String ADJ042;

				public String getADJ042 () {
					return this.ADJ042;
				}

				public Boolean ADJ042IsNullable(){
				    return true;
				}
				public Boolean ADJ042IsKey(){
				    return false;
				}
				public Integer ADJ042Length(){
				    return 100;
				}
				public Integer ADJ042Precision(){
				    return 0;
				}
				public String ADJ042Default(){
				
					return null;
				
				}
				public String ADJ042Comment(){
				
				    return "";
				
				}
				public String ADJ042Pattern(){
				
					return "";
				
				}
				public String ADJ042OriginalDbColumnName(){
			    ...
			    public String ADJ043;

				public String getADJ043 () {
					return this.ADJ043;
				}

				public Boolean ADJ043IsNullable(){
				    return true;
				}
				public Boolean ADJ043IsKey(){
				    return false;
				}
				public Integer ADJ043Length(){
				    return 100;
				}
				public Integer ADJ043Precision(){
				    return 0;
				}
				public String ADJ043Default(){
				
					return null;
				
				}
				public String ADJ043Comment(){
				
				    return "";
				
				}
				public String ADJ043Pattern(){
				
					return "";
				
				}
				public String ADJ043OriginalDbColumnName(){
			    ...
			    public String ADJ044;

				public String getADJ044 () {
					return this.ADJ044;
				}

				public Boolean ADJ044IsNullable(){
				    return true;
				}
				public Boolean ADJ044IsKey(){
				    return false;
				}
				public Integer ADJ044Length(){
				    return 100;
				}
				public Integer ADJ044Precision(){
				    return 0;
				}
				public String ADJ044Default(){
				
					return null;
				
				}
				public String ADJ044Comment(){
				
				    return "";
				
				}
				public String ADJ044Pattern(){
				
					return "";
				
				}
				public String ADJ044OriginalDbColumnName(){
			    ...
			    public String ADJ045;

				public String getADJ045 () {
					return this.ADJ045;
				}

				public Boolean ADJ045IsNullable(){
				    return true;
				}
				public Boolean ADJ045IsKey(){
				    return false;
				}
				public Integer ADJ045Length(){
				    return 100;
				}
				public Integer ADJ045Precision(){
				    return 0;
				}
				public String ADJ045Default(){
				
					return null;
				
				}
				public String ADJ045Comment(){
				
				    return "";
				
				}
				public String ADJ045Pattern(){
				
					return "";
				
				}
				public String ADJ045OriginalDbColumnName(){
			    ...
			    public String ADJ046;

				public String getADJ046 () {
					return this.ADJ046;
				}

				public Boolean ADJ046IsNullable(){
				    return true;
				}
				public Boolean ADJ046IsKey(){
				    return false;
				}
				public Integer ADJ046Length(){
				    return 100;
				}
				public Integer ADJ046Precision(){
				    return 0;
				}
				public String ADJ046Default(){
				
					return null;
				
				}
				public String ADJ046Comment(){
				
				    return "";
				
				}
				public String ADJ046Pattern(){
				
					return "";
				
				}
				public String ADJ046OriginalDbColumnName(){
			    ...
			    public String ADJ047;

				public String getADJ047 () {
					return this.ADJ047;
				}

				public Boolean ADJ047IsNullable(){
				    return true;
				}
				public Boolean ADJ047IsKey(){
				    return false;
				}
				public Integer ADJ047Length(){
				    return 100;
				}
				public Integer ADJ047Precision(){
				    return 0;
				}
				public String ADJ047Default(){
				
					return null;
				
				}
				public String ADJ047Comment(){
				
				    return "";
				
				}
				public String ADJ047Pattern(){
				
					return "";
				
				}
				public String ADJ047OriginalDbColumnName(){
			    ...
			    public String ADJ048;

				public String getADJ048 () {
					return this.ADJ048;
				}

				public Boolean ADJ048IsNullable(){
				    return true;
				}
				public Boolean ADJ048IsKey(){
				    return false;
				}
				public Integer ADJ048Length(){
				    return 100;
				}
				public Integer ADJ048Precision(){
				    return 0;
				}
				public String ADJ048Default(){
				
					return null;
				
				}
				public String ADJ048Comment(){
				
				    return "";
				
				}
				public String ADJ048Pattern(){
				
					return "";
				
				}
				public String ADJ048OriginalDbColumnName(){
			    ...
			    public String TSCOFF;

				public String getTSCOFF () {
					return this.TSCOFF;
				}

				public Boolean TSCOFFIsNullable(){
				    return true;
				}
				public Boolean TSCOFFIsKey(){
				    return false;
				}
				public Integer TSCOFFLength(){
				    return 2;
				}
				public Integer TSCOFFPrecision(){
				    return 0;
				}
				public String TSCOFFDefault(){
				
					return null;
				
				}
				public String TSCOFFComment(){
				
				    return "";
				
				}
				public String TSCOFFPattern(){
				
					return "";
				
				}
				public String TSCOFFOriginalDbColumnName(){
			    ...
			    public String ESTADIO_MADURACION;

				public String getESTADIO_MADURACION () {
					return this.ESTADIO_MADURACION;
				}

				public Boolean ESTADIO_MADURACIONIsNullable(){
				    return true;
				}
				public Boolean ESTADIO_MADURACIONIsKey(){
				    return false;
				}
				public Integer ESTADIO_MADURACIONLength(){
				    return 100;
				}
				public Integer ESTADIO_MADURACIONPrecision(){
				    return 0;
				}
				public String ESTADIO_MADURACIONDefault(){
				
					return null;
				
				}
				public String ESTADIO_MADURACIONComment(){
				
				    return "";
				
				}
				public String ESTADIO_MADURACIONPattern(){
				
					return "";
				
				}
				public String ESTADIO_MADURACIONOriginalDbColumnName(){
				
					return "ESTADIO_MADURACION";
				
				}

				
			    public String ETAPA_DESARROLLO;

				public String getETAPA_DESARROLLO () {
					return this.ETAPA_DESARROLLO;
				}

				public Boolean ETAPA_DESARROLLOIsNullable(){
				    return true;
				}
				public Boolean ETAPA_DESARROLLOIsKey(){
				    return false;
				}
				public Integer ETAPA_DESARROLLOLength(){
				    return 4000;
				}
				public Integer ETAPA_DESARROLLOPrecision(){
				    return 0;
				}
				public String ETAPA_DESARROLLODefault(){
				
					return null;
				
				}
				public String ETAPA_DESARROLLOComment(){
				
				    return "";
				
				}
				public String ETAPA_DESARROLLOPattern(){
				
					return "";
				
				}
				public String ETAPA_DESARROLLOOriginalDbColumnName(){
				
					return "ETAPA_DESARROLLO";
				
				}

				
			    public String PERIMETRO_ABDOMINAL;

				public String getPERIMETRO_ABDOMINAL () {
					return this.PERIMETRO_ABDOMINAL;
				}

				public Boolean PERIMETRO_ABDOMINALIsNullable(){
				    return true;
				}
				public Boolean PERIMETRO_ABDOMINALIsKey(){
				    return false;
				}
				public Integer PERIMETRO_ABDOMINALLength(){
				    return 4000;
				}
				public Integer PERIMETRO_ABDOMINALPrecision(){
				    return 0;
				}
				public String PERIMETRO_ABDOMINALDefault(){
				
					return null;
				
				}
				public String PERIMETRO_ABDOMINALComment(){
				
				    return "";
				
				}
				public String PERIMETRO_ABDOMINALPattern(){
				
					return "";
				
				}
				public String PERIMETRO_ABDOMINALOriginalDbColumnName(){
			    ...
			    public String JUSTIFICACION_TSCOFF;

				public String getJUSTIFICACION_TSCOFF () {
					return this.JUSTIFICACION_TSCOFF;
				}

				public Boolean JUSTIFICACION_TSCOFFIsNullable(){
				    return true;
				}
				public Boolean JUSTIFICACION_TSCOFFIsKey(){
				    return false;
				}
				public Integer JUSTIFICACION_TSCOFFLength(){
				    return 4000;
				}
				public Integer JUSTIFICACION_TSCOFFPrecision(){
				    return 0;
				}
				public String JUSTIFICACION_TSCOFFDefault(){
				
					return null;
				
				}
				public String JUSTIFICACION_TSCOFFComment(){
				
				    return "";
				
				}
				public String JUSTIFICACION_TSCOFFPattern(){
				
					return "";
				
				}
				public String JUSTIFICACION_TSCOFFOriginalDbColumnName(){
				
					return "JUSTIFICACION_TSCOFF";
				
				}

				
			    public String RIESGO_TSCOFF;

				public String getRIESGO_TSCOFF () {
					return this.RIESGO_TSCOFF;
				}

				public Boolean RIESGO_TSCOFFIsNullable(){
				    return true;
				}
				public Boolean RIESGO_TSCOFFIsKey(){
				    return false;
				}
				public Integer RIESGO_TSCOFFLength(){
				    return 17;
				}
				public Integer RIESGO_TSCOFFPrecision(){
				    return 0;
				}
				public String RIESGO_TSCOFFDefault(){
				
					return null;
				
				}
				public String RIESGO_TSCOFFComment(){
				
				    return "";
				
				}
				public String RIESGO_TSCOFFPattern(){
				
					return "";
				
				}
				public String RIESGO_TSCOFFOriginalDbColumnName(){
				
					return "RIESGO_TSCOFF";
	...
	public void copyDataTo(out1Struct other) {
		...
		other.PERSONAS_ID = this.PERSONAS_ID;
	            ...
	            other.TSNELLEN_OJOI = this.TSNELLEN_OJOI;
	            other.TSNELLEN_OJOD = this.TSNELLEN_OJOD;
	            other.TJAEGER_OJOI = this.TJAEGER_OJOI;
	            other.TJAEGER_OJOD = this.TJAEGER_OJOD;
	            other.PERCENTIL_TALLA = this.PERCENTIL_TALLA;
	            other.OTOSCOPIA_OIDOI = this.OTOSCOPIA_OIDOI;
	            other.OTOSCOPIA_OIDOD = this.OTOSCOPIA_OIDOD;
	            other.VFISICA_OIDOI = this.VFISICA_OIDOI;
	            other.VFISICA_OIDOD = this.VFISICA_OIDOD;
	            other.ADJ001 = this.ADJ001;
	            other.ADJ002 = this.ADJ002;
	            other.ADJ003 = this.ADJ003;
	            other.ADJ004 = this.ADJ004;
	            other.ADJ005 = this.ADJ005;
	            other.ADJ007 = this.ADJ007;
	            other.ADJ008 = this.ADJ008;
	            other.ADJ010 = this.ADJ010;
	            other.ADJ011 = this.ADJ011;
	            other.ADJ012 = this.ADJ012;
	            other.ADJ013 = this.ADJ013;
	            other.ADJ014 = this.ADJ014;
	            other.ADJ015 = this.ADJ015;
	            other.ADJ016 = this.ADJ016;
	            other.ADJ018 = this.ADJ018;
	            other.ADJ019 = this.ADJ019;
	            other.ADJ020 = this.ADJ020;
	            other.ADJ021 = this.ADJ021;
	            other.ADJ022 = this.ADJ022;
	            other.ADJ023 = this.ADJ023;
	            other.ADJ024 = this.ADJ024;
	            other.ADJ025 = this.ADJ025;
	            other.ADJ026 = this.ADJ026;
	            other.ADJ027 = this.ADJ027;
	            other.ADJ028 = this.ADJ028;
	            other.ADJ029 = this.ADJ029;
	            other.ADJ030 = this.ADJ030;
	            other.ADJ032 = this.ADJ032;
	            other.ADJ033 = this.ADJ033;
	            other.ADJ036 = this.ADJ036;
	            other.ADJ038 = this.ADJ038;
	            other.ADJ040 = this.ADJ040;
	            other.ADJ041 = this.ADJ041;
	            other.ADJ042 = this.ADJ042;
	            other.ADJ043 = this.ADJ043;
	            other.ADJ044 = this.ADJ044;
	            other.ADJ045 = this.ADJ045;
	            other.ADJ046 = this.ADJ046;
	            other.ADJ047 = this.ADJ047;
	            other.ADJ048 = this.ADJ048;
	            other.TSCOFF = this.TSCOFF;
	            other.ESTADIO_MADURACION = this.ESTADIO_MADURACION;
	            other.ETAPA_DESARROLLO = this.ETAPA_DESARROLLO;
	            other.PERIMETRO_ABDOMINAL = this.PERIMETRO_ABDOMINAL;
	            other.JUSTIFICACION_TSCOFF = this.JUSTIFICACION_TSCOFF;
	            other.RIESGO_TSCOFF = this.RIESGO_TSCOFF;
		...
		synchronized(commonByteArrayLock_REP_INICIO_F5_AdolescenteJoven) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.TSNELLEN_OJOI = readString(dis);
					
					this.TSNELLEN_OJOD = readString(dis);
					
					this.TJAEGER_OJOI = readString(dis);
					
					this.TJAEGER_OJOD = readString(dis);
					
					this.PERCENTIL_TALLA = readString(dis);
					
					this.OTOSCOPIA_OIDOI = readString(dis);
					
					this.OTOSCOPIA_OIDOD = readString(dis);
					
					this.VFISICA_OIDOI = readString(dis);
					
					this.VFISICA_OIDOD = readString(dis);
					
					this.ADJ001 = readString(dis);
					
					this.ADJ002 = readString(dis);
					
					this.ADJ003 = readString(dis);
					
					this.ADJ004 = readString(dis);
					
					this.ADJ005 = readString(dis);
					
					this.ADJ007 = readString(dis);
					
					this.ADJ008 = readString(dis);
					
					this.ADJ010 = readString(dis);
					
					this.ADJ011 = readString(dis);
					
					this.ADJ012 = readString(dis);
					
					this.ADJ013 = readString(dis);
					
					this.ADJ014 = readString(dis);
					
					this.ADJ015 = readString(dis);
					
					this.ADJ016 = readString(dis);
					
					this.ADJ018 = readString(dis);
					
					this.ADJ019 = readString(dis);
					
					this.ADJ020 = readString(dis);
					
					this.ADJ021 = readString(dis);
					
					this.ADJ022 = readString(dis);
					
					this.ADJ023 = readString(dis);
					
					this.ADJ024 = readString(dis);
					
					this.ADJ025 = readString(dis);
					
					this.ADJ026 = readString(dis);
					
					this.ADJ027 = readString(dis);
					
					this.ADJ028 = readString(dis);
					
					this.ADJ029 = readString(dis);
					
					this.ADJ030 = readString(dis);
					
					this.ADJ032 = readString(dis);
					
					this.ADJ033 = readString(dis);
					
					this.ADJ036 = readString(dis);
					
					this.ADJ038 = readString(dis);
					
					this.ADJ040 = readString(dis);
					
					this.ADJ041 = readString(dis);
					
					this.ADJ042 = readString(dis);
					
					this.ADJ043 = readString(dis);
					
					this.ADJ044 = readString(dis);
					
					this.ADJ045 = readString(dis);
					
					this.ADJ046 = readString(dis);
					
					this.ADJ047 = readString(dis);
					
					this.ADJ048 = readString(dis);
					
					this.TSCOFF = readString(dis);
					
					this.ESTADIO_MADURACION = readString(dis);
					
					this.ETAPA_DESARROLLO = readString(dis);
					
					this.PERIMETRO_ABDOMINAL = readString(dis);
					
					this.JUSTIFICACION_TSCOFF = readString(dis);
					
					this.RIESGO_TSCOFF = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.TSNELLEN_OJOI,dos);
					
					// String
				
						writeString(this.TSNELLEN_OJOD,dos);
					
					// String
				
						writeString(this.TJAEGER_OJOI,dos);
					
					// String
				
						writeString(this.TJAEGER_OJOD,dos);
					
					// String
				
						writeString(this.PERCENTIL_TALLA,dos);
					
					// String
				
						writeString(this.OTOSCOPIA_OIDOI,dos);
					
					// String
				
						writeString(this.OTOSCOPIA_OIDOD,dos);
					
					// String
				
						writeString(this.VFISICA_OIDOI,dos);
					
					// String
				
						writeString(this.VFISICA_OIDOD,dos);
					
					// String
				
						writeString(this.ADJ001,dos);
					
					// String
				
						writeString(this.ADJ002,dos);
					
					// String
				
						writeString(this.ADJ003,dos);
					
					// String
				
						writeString(this.ADJ004,dos);
					
					// String
				
						writeString(this.ADJ005,dos);
					
					// String
				
						writeString(this.ADJ007,dos);
					
					// String
				
						writeString(this.ADJ008,dos);
					
					// String
				
						writeString(this.ADJ010,dos);
					
					// String
				
						writeString(this.ADJ011,dos);
					
					// String
				
						writeString(this.ADJ012,dos);
					
					// String
				
						writeString(this.ADJ013,dos);
					
					// String
				
						writeString(this.ADJ014,dos);
					
					// String
				
						writeString(this.ADJ015,dos);
					
					// String
				
						writeString(this.ADJ016,dos);
					
					// String
				
						writeString(this.ADJ018,dos);
					
					// String
				
						writeString(this.ADJ019,dos);
					
					// String
				
						writeString(this.ADJ020,dos);
					
					// String
				
						writeString(this.ADJ021,dos);
					
					// String
				
						writeString(this.ADJ022,dos);
					
					// String
				
						writeString(this.ADJ023,dos);
					
					// String
				
						writeString(this.ADJ024,dos);
					
					// String
				
						writeString(this.ADJ025,dos);
					
					// String
				
						writeString(this.ADJ026,dos);
					
					// String
				
						writeString(this.ADJ027,dos);
					
					// String
				
						writeString(this.ADJ028,dos);
					
					// String
				
						writeString(this.ADJ029,dos);
					
					// String
				
						writeString(this.ADJ030,dos);
					
					// String
				
						writeString(this.ADJ032,dos);
					
					// String
				
						writeString(this.ADJ033,dos);
					
					// String
				
						writeString(this.ADJ036,dos);
					
					// String
				
						writeString(this.ADJ038,dos);
					
					// String
				
						writeString(this.ADJ040,dos);
					
					// String
				
						writeString(this.ADJ041,dos);
					
					// String
				
						writeString(this.ADJ042,dos);
					
					// String
				
						writeString(this.ADJ043,dos);
					
					// String
				
						writeString(this.ADJ044,dos);
					
					// String
				
						writeString(this.ADJ045,dos);
					
					// String
				
						writeString(this.ADJ046,dos);
					
					// String
				
						writeString(this.ADJ047,dos);
					
					// String
				
						writeString(this.ADJ048,dos);
					
					// String
				
						writeString(this.TSCOFF,dos);
					
					// String
				
						writeString(this.ESTADIO_MADURACION,dos);
					
					// String
				
						writeString(this.ETAPA_DESARROLLO,dos);
					
					// String
				
						writeString(this.PERIMETRO_ABDOMINAL,dos);
					
					// String
				
						writeString(this.JUSTIFICACION_TSCOFF,dos);
					
					// String
				
						writeString(this.RIESGO_TSCOFF,dos);
    ...
    public String toString() {
		...
		sb.append(",TSNELLEN_OJOI="+TSNELLEN_OJOI);
		sb.append(",TSNELLEN_OJOD="+TSNELLEN_OJOD);
		sb.append(",TJAEGER_OJOI="+TJAEGER_OJOI);
		sb.append(",TJAEGER_OJOD="+TJAEGER_OJOD);
		sb.append(",PERCENTIL_TALLA="+PERCENTIL_TALLA);
		sb.append(",OTOSCOPIA_OIDOI="+OTOSCOPIA_OIDOI);
		sb.append(",OTOSCOPIA_OIDOD="+OTOSCOPIA_OIDOD);
		sb.append(",VFISICA_OIDOI="+VFISICA_OIDOI);
		sb.append(",VFISICA_OIDOD="+VFISICA_OIDOD);
		sb.append(",ADJ001="+ADJ001);
		sb.append(",ADJ002="+ADJ002);
		sb.append(",ADJ003="+ADJ003);
		sb.append(",ADJ004="+ADJ004);
		sb.append(",ADJ005="+ADJ005);
		sb.append(",ADJ007="+ADJ007);
		sb.append(",ADJ008="+ADJ008);
		sb.append(",ADJ010="+ADJ010);
		sb.append(",ADJ011="+ADJ011);
		sb.append(",ADJ012="+ADJ012);
		sb.append(",ADJ013="+ADJ013);
		sb.append(",ADJ014="+ADJ014);
		sb.append(",ADJ015="+ADJ015);
		sb.append(",ADJ016="+ADJ016);
		sb.append(",ADJ018="+ADJ018);
		sb.append(",ADJ019="+ADJ019);
		sb.append(",ADJ020="+ADJ020);
		sb.append(",ADJ021="+ADJ021);
		sb.append(",ADJ022="+ADJ022);
		sb.append(",ADJ023="+ADJ023);
		sb.append(",ADJ024="+ADJ024);
		sb.append(",ADJ025="+ADJ025);
		sb.append(",ADJ026="+ADJ026);
		sb.append(",ADJ027="+ADJ027);
		sb.append(",ADJ028="+ADJ028);
		sb.append(",ADJ029="+ADJ029);
		sb.append(",ADJ030="+ADJ030);
		sb.append(",ADJ032="+ADJ032);
		sb.append(",ADJ033="+ADJ033);
		sb.append(",ADJ036="+ADJ036);
		sb.append(",ADJ038="+ADJ038);
		sb.append(",ADJ040="+ADJ040);
		sb.append(",ADJ041="+ADJ041);
		sb.append(",ADJ042="+ADJ042);
		sb.append(",ADJ043="+ADJ043);
		sb.append(",ADJ044="+ADJ044);
		sb.append(",ADJ045="+ADJ045);
		sb.append(",ADJ046="+ADJ046);
		sb.append(",ADJ047="+ADJ047);
		sb.append(",ADJ048="+ADJ048);
		sb.append(",TSCOFF="+TSCOFF);
		sb.append(",ESTADIO_MADURACION="+ESTADIO_MADURACION);
		sb.append(",ETAPA_DESARROLLO="+ETAPA_DESARROLLO);
		sb.append(",PERIMETRO_ABDOMINAL="+PERIMETRO_ABDOMINAL);
		sb.append(",JUSTIFICACION_TSCOFF="+JUSTIFICACION_TSCOFF);
		sb.append(",RIESGO_TSCOFF="+RIESGO_TSCOFF);
	    sb.append("]");
...
out1Struct out1 = new out1Struct();
	...
	currentComponent="tOracleOutput_1";
        ...
        } else if (updateKeyCount_tOracleOutput_1 == 57 && true) {
	...
	final String decryptedPassword_tOracleOutput_1 = context.db_destino_Password; 
        ...
        if(dbschema_tOracleOutput_1 == null || dbschema_tOracleOutput_1.trim().length() == 0) {
            tableName_tOracleOutput_1 = ("BADJ_ATENCIONES");
        } else {
            tableName_tOracleOutput_1 = dbschema_tOracleOutput_1 + "." + ("BADJ_ATENCIONES");
        }
                java.sql.PreparedStatement pstmt_tOracleOutput_1 = conn_tOracleOutput_1.prepareStatement("SELECT COUNT(1) FROM " + tableName_tOracleOutput_1 + " WHERE PROCESOSASISTENCIALES_ID = ?");
                resourceMap.put("pstmt_tOracleOutput_1", pstmt_tOracleOutput_1);
                String insert_tOracleOutput_1 = "INSERT INTO " + tableName_tOracleOutput_1 + " (PERSONAS_ID,PROCESOSASISTENCIALES_ID,TSNELLEN_OJOI,TSNELLEN_OJOD,TJAEGER_OJOI,TJAEGER_OJOD,PERCENTIL_TALLA,OTOSCOPIA_OIDOI,OTOSCOPIA_OIDOD,VFISICA_OIDOI,VFISICA_OIDOD,ADJ001,ADJ002,ADJ003,ADJ004,ADJ005,ADJ007,ADJ008,ADJ010,ADJ011,ADJ012,ADJ013,ADJ014,ADJ015,ADJ016,ADJ018,ADJ019,ADJ020,ADJ021,ADJ022,ADJ023,ADJ024,ADJ025,ADJ026,ADJ027,ADJ028,ADJ029,ADJ030,ADJ032,ADJ033,ADJ036,ADJ038,ADJ040,ADJ041,ADJ042,ADJ043,ADJ044,ADJ045,ADJ046,ADJ047,ADJ048,TSCOFF,ESTADIO_MADURACION,ETAPA_DESARROLLO,PERIMETRO_ABDOMINAL,JUSTIFICACION_TSCOFF,RIESGO_TSCOFF) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";    
                ...
                String update_tOracleOutput_1 = "UPDATE " + tableName_tOracleOutput_1 + " SET PERSONAS_ID = ?,TSNELLEN_OJOI = ?,TSNELLEN_OJOD = ?,TJAEGER_OJOI = ?,TJAEGER_OJOD = ?,PERCENTIL_TALLA = ?,OTOSCOPIA_OIDOI = ?,OTOSCOPIA_OIDOD = ?,VFISICA_OIDOI = ?,VFISICA_OIDOD = ?,ADJ001 = ?,ADJ002 = ?,ADJ003 = ?,ADJ004 = ?,ADJ005 = ?,ADJ007 = ?,ADJ008 = ?,ADJ010 = ?,ADJ011 = ?,ADJ012 = ?,ADJ013 = ?,ADJ014 = ?,ADJ015 = ?,ADJ016 = ?,ADJ018 = ?,ADJ019 = ?,ADJ020 = ?,ADJ021 = ?,ADJ022 = ?,ADJ023 = ?,ADJ024 = ?,ADJ025 = ?,ADJ026 = ?,ADJ027 = ?,ADJ028 = ?,ADJ029 = ?,ADJ030 = ?,ADJ032 = ?,ADJ033 = ?,ADJ036 = ?,ADJ038 = ?,ADJ040 = ?,ADJ041 = ?,ADJ042 = ?,ADJ043 = ?,ADJ044 = ?,ADJ045 = ?,ADJ046 = ?,ADJ047 = ?,ADJ048 = ?,TSCOFF = ?,ESTADIO_MADURACION = ?,ETAPA_DESARROLLO = ?,PERIMETRO_ABDOMINAL = ?,JUSTIFICACION_TSCOFF = ?,RIESGO_TSCOFF = ? WHERE PROCESOSASISTENCIALES_ID = ?";
	...
	currentComponent="tOracleInput_2";
		...
		int tos_count_tOracleInput_2 = 0;
			...
			java.sql.Statement stmt_tOracleInput_2 = conn_tOracleInput_2.createStatement(java.sql.ResultSet.TYPE_FORWARD_ONLY,
                ...
                stmt_tOracleInput_2.setFetchSize(2000);


		    String dbquery_tOracleInput_2 = "SELECT  HP.PERSONAS_ID\n        ,HP.ID AS PROCESOSASISTENCIALES_ID\n        , GR.DESCRIPCION AS ETAPA_DESARROLLO\nFROM "
+"GEN_PYP PYP \nINNER JOIN HCL_VALORACIONES HVAL ON HVAL.PYP_ID=PYP.ID\nINNER JOIN HCL_PROCESOSASISTENCIALES HP ON HP.ID=H"
+"VAL.PROCESOSASISTENCIALES_ID "+context.CONDITION+"\nINNER JOIN GEN_PERSONAS GP ON GP.ID=HP.PERSONAS_ID\nINNER JOIN GEN_RANGOEDAD GR ON GP.FECHA_NACIMIENTO > ADD_MONTHS(H"
+"P.FFINAL,-(GR.VALOR_MAYOR+1)*12) \n       AND GP.FECHA_NACIMIENTO <= ADD_MONTHS(HP.FFINAL,-(GR.VALOR_MENOR)*12) AND GR.P"
+"YP_ID = PYP.ID\nWHERE PYP.SIGLA = 'ADJ'\n  AND PYP.ESTADO = 'Activo'\n  AND PYP.ESTREGISTRO_ID = 1\n  AND HP.ESTREGISTRO"
+"_ID = 1\n  AND HVAL.ESTREGISTRO_ID = 1\n  AND GR.ESTADO = 'Activo'\n  AND GR.ESTREGISTRO_ID = 1\n  AND GR.CODIGO = 'REP1"
+"0'" ;
		    ...
		    while (rs_tOracleInput_2.next()) {
		        nb_line_tOracleInput_2++;
					...
					if(rs_tOracleInput_2.getObject(1) != null) {
						row1.PERSONAS_ID = rs_tOracleInput_2.getBigDecimal(1);
					} else {
 	                	...
 	                	throw new RuntimeException("Null value in non-Nullable column");
							...
							if(colQtyInRs_tOracleInput_2 < 2) {
								row1.PROCESOSASISTENCIALES_ID = null;
							} else {
		                          
					if(rs_tOracleInput_2.getObject(2) != null) {
						row1.PROCESOSASISTENCIALES_ID = rs_tOracleInput_2.getBigDecimal(2);
					} else {
 	                	...
 	                	throw new RuntimeException("Null value in non-Nullable column");
							...
							if(colQtyInRs_tOracleInput_2 < 3) {
								row1.ETAPA_DESARROLLO = null;
							} else {
	                         		
        	row1.ETAPA_DESARROLLO = routines.system.JDBCUtil.getString(rs_tOracleInput_2, 3, false);
		                    }
 					    ...
 					    boolean forceLooprow2 = false;
 							...
 							row2Struct row2ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row2HashKey.PROCESOSASISTENCIALES_ID = row1.PROCESOSASISTENCIALES_ID ;
				           		...
				           		if(tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row2' and it contains more one result from keys :  row2.PROCESOSASISTENCIALES_ID = '" + row2HashKey.PROCESOSASISTENCIALES_ID + "'");
								} // G 071
 					    ...
 					    boolean forceLooprow3 = false;
 							...
 							row3Struct row3ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row3HashKey.PROCESOSASISTENCIALES_ID = row1.PROCESOSASISTENCIALES_ID ;
				           		...
				           		if(tHash_Lookup_row3 != null && tHash_Lookup_row3.getCount(row3HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row3' and it contains more one result from keys :  row3.PROCESOSASISTENCIALES_ID = '" + row3HashKey.PROCESOSASISTENCIALES_ID + "'");
								} // G 071
 					    ...
 					    boolean forceLooprow4 = false;
 							...
 							row4Struct row4ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row4HashKey.PROCESOSASISTENCIALES_ID = row1.PROCESOSASISTENCIALES_ID ;
 					    ...
 					    boolean forceLooprow5 = false;
 							...
 							row5Struct row5ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row5HashKey.PROCESOSASISTENCIALES_ID = row1.PROCESOSASISTENCIALES_ID ;
...
out1_tmp.PROCESOSASISTENCIALES_ID = row1.PROCESOSASISTENCIALES_ID ;
out1_tmp.TSNELLEN_OJOI = row2._OIS_ ;
out1_tmp.TSNELLEN_OJOD = row2._ODS_ ;
out1_tmp.TJAEGER_OJOI = row2._OIJ_ ;
out1_tmp.TJAEGER_OJOD = row2._ODJ_ ;
out1_tmp.PERCENTIL_TALLA = row2._PT_ ;
out1_tmp.OTOSCOPIA_OIDOI = row2._OTOIZ_ ;
out1_tmp.OTOSCOPIA_OIDOD = row2._OTODER_ ;
out1_tmp.VFISICA_OIDOI = row2._VALFIZ_ ;
out1_tmp.VFISICA_OIDOD = row2._VALFDER_ ;
out1_tmp.ADJ001 = row3.ADJ001 ;
out1_tmp.ADJ002 = row3.ADJ002 ;
out1_tmp.ADJ003 = row3.ADJ003 ;
out1_tmp.ADJ004 = row3.ADJ004 ;
out1_tmp.ADJ005 = row3.ADJ005 ;
out1_tmp.ADJ007 = row3.ADJ007 ;
out1_tmp.ADJ008 = row3.ADJ008 ;
out1_tmp.ADJ010 = row3.ADJ010 ;
out1_tmp.ADJ011 = row3.ADJ011 ;
out1_tmp.ADJ012 = row3.ADJ012 ;
out1_tmp.ADJ013 = row3.ADJ013 ;
out1_tmp.ADJ014 = row3.ADJ014 ;
out1_tmp.ADJ015 = row3.ADJ015 ;
out1_tmp.ADJ016 = row3.ADJ016 ;
out1_tmp.ADJ018 = row3.ADJ018 ;
out1_tmp.ADJ019 = row3.ADJ019 ;
out1_tmp.ADJ020 = row3.ADJ020 ;
out1_tmp.ADJ021 = row3.ADJ021 ;
out1_tmp.ADJ022 = row3.ADJ022 ;
out1_tmp.ADJ023 = row3.ADJ023 ;
out1_tmp.ADJ024 = row3.ADJ024 ;
out1_tmp.ADJ025 = row3.ADJ025 ;
out1_tmp.ADJ026 = row3.ADJ026 ;
out1_tmp.ADJ027 = row3.ADJ027 ;
out1_tmp.ADJ028 = row3.ADJ028 ;
out1_tmp.ADJ029 = row3.ADJ029 ;
out1_tmp.ADJ030 = row3.ADJ030 ;
out1_tmp.ADJ032 = row3.ADJ032 ;
out1_tmp.ADJ033 = row3.ADJ033 ;
out1_tmp.ADJ036 = row3.ADJ036 ;
out1_tmp.ADJ038 = row3.ADJ038 ;
out1_tmp.ADJ040 = row3.ADJ040 ;
out1_tmp.ADJ041 = row3.ADJ041 ;
out1_tmp.ADJ042 = row3.ADJ042 ;
out1_tmp.ADJ043 = row3.ADJ043 ;
out1_tmp.ADJ044 = row3.ADJ044 ;
out1_tmp.ADJ045 = row3.ADJ045 ;
out1_tmp.ADJ046 = row3.ADJ046 ;
out1_tmp.ADJ047 = row3.ADJ047 ;
out1_tmp.ADJ048 = row3.ADJ048 ;
out1_tmp.TSCOFF = row4.VALOR ;
out1_tmp.ESTADIO_MADURACION = row5.ESTADIO_MADURACION ;
out1_tmp.ETAPA_DESARROLLO = row1.ETAPA_DESARROLLO ;
out1_tmp.PERIMETRO_ABDOMINAL = row5.PERIMETRO_ABDOMINAL ;
out1_tmp.JUSTIFICACION_TSCOFF = row4.JUSTIFICACION ;
out1_tmp.RIESGO_TSCOFF = row4.RIESGO ;
out1 = out1_tmp;
// ###############################
...
if(out1 != null) { 
	...
	currentComponent="tOracleOutput_1";
        ...
        whetherReject_tOracleOutput_1 = false;
                    pstmt_tOracleOutput_1.setBigDecimal(1, out1.PROCESOSASISTENCIALES_ID);
            ...
            if(checkCount_tOracleOutput_1 > 0) {
                        pstmtUpdate_tOracleOutput_1.setBigDecimal(1, out1.PERSONAS_ID);

                        if(out1.TSNELLEN_OJOI == null) {
pstmtUpdate_tOracleOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(2, out1.TSNELLEN_OJOI);
}

                        if(out1.TSNELLEN_OJOD == null) {
pstmtUpdate_tOracleOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(3, out1.TSNELLEN_OJOD);
}

                        if(out1.TJAEGER_OJOI == null) {
pstmtUpdate_tOracleOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(4, out1.TJAEGER_OJOI);
}

                        if(out1.TJAEGER_OJOD == null) {
pstmtUpdate_tOracleOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(5, out1.TJAEGER_OJOD);
}

                        if(out1.PERCENTIL_TALLA == null) {
pstmtUpdate_tOracleOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(6, out1.PERCENTIL_TALLA);
}

                        if(out1.OTOSCOPIA_OIDOI == null) {
pstmtUpdate_tOracleOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(7, out1.OTOSCOPIA_OIDOI);
}

                        if(out1.OTOSCOPIA_OIDOD == null) {
pstmtUpdate_tOracleOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(8, out1.OTOSCOPIA_OIDOD);
}

                        if(out1.VFISICA_OIDOI == null) {
pstmtUpdate_tOracleOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(9, out1.VFISICA_OIDOI);
}

                        if(out1.VFISICA_OIDOD == null) {
pstmtUpdate_tOracleOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(10, out1.VFISICA_OIDOD);
}

                        if(out1.ADJ001 == null) {
pstmtUpdate_tOracleOutput_1.setNull(11, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(11, out1.ADJ001);
}

                        if(out1.ADJ002 == null) {
pstmtUpdate_tOracleOutput_1.setNull(12, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(12, out1.ADJ002);
}

                        if(out1.ADJ003 == null) {
pstmtUpdate_tOracleOutput_1.setNull(13, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(13, out1.ADJ003);
}

                        if(out1.ADJ004 == null) {
pstmtUpdate_tOracleOutput_1.setNull(14, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(14, out1.ADJ004);
}

                        if(out1.ADJ005 == null) {
pstmtUpdate_tOracleOutput_1.setNull(15, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(15, out1.ADJ005);
}

                        if(out1.ADJ007 == null) {
pstmtUpdate_tOracleOutput_1.setNull(16, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(16, out1.ADJ007);
}

                        if(out1.ADJ008 == null) {
pstmtUpdate_tOracleOutput_1.setNull(17, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(17, out1.ADJ008);
}

                        if(out1.ADJ010 == null) {
pstmtUpdate_tOracleOutput_1.setNull(18, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(18, out1.ADJ010);
}

                        if(out1.ADJ011 == null) {
pstmtUpdate_tOracleOutput_1.setNull(19, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(19, out1.ADJ011);
}

                        if(out1.ADJ012 == null) {
pstmtUpdate_tOracleOutput_1.setNull(20, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(20, out1.ADJ012);
}

                        if(out1.ADJ013 == null) {
pstmtUpdate_tOracleOutput_1.setNull(21, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(21, out1.ADJ013);
}

                        if(out1.ADJ014 == null) {
pstmtUpdate_tOracleOutput_1.setNull(22, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(22, out1.ADJ014);
}

                        if(out1.ADJ015 == null) {
pstmtUpdate_tOracleOutput_1.setNull(23, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(23, out1.ADJ015);
}

                        if(out1.ADJ016 == null) {
pstmtUpdate_tOracleOutput_1.setNull(24, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(24, out1.ADJ016);
}

                        if(out1.ADJ018 == null) {
pstmtUpdate_tOracleOutput_1.setNull(25, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(25, out1.ADJ018);
}

                        if(out1.ADJ019 == null) {
pstmtUpdate_tOracleOutput_1.setNull(26, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(26, out1.ADJ019);
}

                        if(out1.ADJ020 == null) {
pstmtUpdate_tOracleOutput_1.setNull(27, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(27, out1.ADJ020);
}

                        if(out1.ADJ021 == null) {
pstmtUpdate_tOracleOutput_1.setNull(28, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(28, out1.ADJ021);
}

                        if(out1.ADJ022 == null) {
pstmtUpdate_tOracleOutput_1.setNull(29, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(29, out1.ADJ022);
}

                        if(out1.ADJ023 == null) {
pstmtUpdate_tOracleOutput_1.setNull(30, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(30, out1.ADJ023);
}

                        if(out1.ADJ024 == null) {
pstmtUpdate_tOracleOutput_1.setNull(31, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(31, out1.ADJ024);
}

                        if(out1.ADJ025 == null) {
pstmtUpdate_tOracleOutput_1.setNull(32, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(32, out1.ADJ025);
}

                        if(out1.ADJ026 == null) {
pstmtUpdate_tOracleOutput_1.setNull(33, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(33, out1.ADJ026);
}

                        if(out1.ADJ027 == null) {
pstmtUpdate_tOracleOutput_1.setNull(34, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(34, out1.ADJ027);
}

                        if(out1.ADJ028 == null) {
pstmtUpdate_tOracleOutput_1.setNull(35, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(35, out1.ADJ028);
}

                        if(out1.ADJ029 == null) {
pstmtUpdate_tOracleOutput_1.setNull(36, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(36, out1.ADJ029);
}

                        if(out1.ADJ030 == null) {
pstmtUpdate_tOracleOutput_1.setNull(37, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(37, out1.ADJ030);
}

                        if(out1.ADJ032 == null) {
pstmtUpdate_tOracleOutput_1.setNull(38, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(38, out1.ADJ032);
}

                        if(out1.ADJ033 == null) {
pstmtUpdate_tOracleOutput_1.setNull(39, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(39, out1.ADJ033);
}

                        if(out1.ADJ036 == null) {
pstmtUpdate_tOracleOutput_1.setNull(40, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(40, out1.ADJ036);
}

                        if(out1.ADJ038 == null) {
pstmtUpdate_tOracleOutput_1.setNull(41, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(41, out1.ADJ038);
}

                        if(out1.ADJ040 == null) {
pstmtUpdate_tOracleOutput_1.setNull(42, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(42, out1.ADJ040);
}

                        if(out1.ADJ041 == null) {
pstmtUpdate_tOracleOutput_1.setNull(43, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(43, out1.ADJ041);
}

                        if(out1.ADJ042 == null) {
pstmtUpdate_tOracleOutput_1.setNull(44, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(44, out1.ADJ042);
}

                        if(out1.ADJ043 == null) {
pstmtUpdate_tOracleOutput_1.setNull(45, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(45, out1.ADJ043);
}

                        if(out1.ADJ044 == null) {
pstmtUpdate_tOracleOutput_1.setNull(46, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(46, out1.ADJ044);
}

                        if(out1.ADJ045 == null) {
pstmtUpdate_tOracleOutput_1.setNull(47, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(47, out1.ADJ045);
}

                        if(out1.ADJ046 == null) {
pstmtUpdate_tOracleOutput_1.setNull(48, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(48, out1.ADJ046);
}

                        if(out1.ADJ047 == null) {
pstmtUpdate_tOracleOutput_1.setNull(49, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(49, out1.ADJ047);
}

                        if(out1.ADJ048 == null) {
pstmtUpdate_tOracleOutput_1.setNull(50, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(50, out1.ADJ048);
}

                        if(out1.TSCOFF == null) {
pstmtUpdate_tOracleOutput_1.setNull(51, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(51, out1.TSCOFF);
}

                        if(out1.ESTADIO_MADURACION == null) {
pstmtUpdate_tOracleOutput_1.setNull(52, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(52, out1.ESTADIO_MADURACION);
}

                        if(out1.ETAPA_DESARROLLO == null) {
pstmtUpdate_tOracleOutput_1.setNull(53, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(53, out1.ETAPA_DESARROLLO);
}

                        if(out1.PERIMETRO_ABDOMINAL == null) {
pstmtUpdate_tOracleOutput_1.setNull(54, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(54, out1.PERIMETRO_ABDOMINAL);
}

                        if(out1.JUSTIFICACION_TSCOFF == null) {
pstmtUpdate_tOracleOutput_1.setNull(55, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(55, out1.JUSTIFICACION_TSCOFF);
}

                        if(out1.RIESGO_TSCOFF == null) {
pstmtUpdate_tOracleOutput_1.setNull(56, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tOracleOutput_1.setString(56, out1.RIESGO_TSCOFF);
}

                        pstmtUpdate_tOracleOutput_1.setBigDecimal(57 + count_tOracleOutput_1, out1.PROCESOSASISTENCIALES_ID);
...
globalMap.put("tOracleOutput_1_ERROR_MESSAGE",e_tOracleOutput_1.getMessage());
                    whetherReject_tOracleOutput_1 = true;
                        ...
                        pstmtInsert_tOracleOutput_1.setBigDecimal(1, out1.PERSONAS_ID);

                        pstmtInsert_tOracleOutput_1.setBigDecimal(2, out1.PROCESOSASISTENCIALES_ID);

                        if(out1.TSNELLEN_OJOI == null) {
pstmtInsert_tOracleOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(3, out1.TSNELLEN_OJOI);
}

                        if(out1.TSNELLEN_OJOD == null) {
pstmtInsert_tOracleOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(4, out1.TSNELLEN_OJOD);
}

                        if(out1.TJAEGER_OJOI == null) {
pstmtInsert_tOracleOutput_1.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(5, out1.TJAEGER_OJOI);
}

                        if(out1.TJAEGER_OJOD == null) {
pstmtInsert_tOracleOutput_1.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(6, out1.TJAEGER_OJOD);
}

                        if(out1.PERCENTIL_TALLA == null) {
pstmtInsert_tOracleOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(7, out1.PERCENTIL_TALLA);
}

                        if(out1.OTOSCOPIA_OIDOI == null) {
pstmtInsert_tOracleOutput_1.setNull(8, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(8, out1.OTOSCOPIA_OIDOI);
}

                        if(out1.OTOSCOPIA_OIDOD == null) {
pstmtInsert_tOracleOutput_1.setNull(9, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(9, out1.OTOSCOPIA_OIDOD);
}

                        if(out1.VFISICA_OIDOI == null) {
pstmtInsert_tOracleOutput_1.setNull(10, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(10, out1.VFISICA_OIDOI);
}

                        if(out1.VFISICA_OIDOD == null) {
pstmtInsert_tOracleOutput_1.setNull(11, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(11, out1.VFISICA_OIDOD);
}

                        if(out1.ADJ001 == null) {
pstmtInsert_tOracleOutput_1.setNull(12, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(12, out1.ADJ001);
}

                        if(out1.ADJ002 == null) {
pstmtInsert_tOracleOutput_1.setNull(13, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(13, out1.ADJ002);
}

                        if(out1.ADJ003 == null) {
pstmtInsert_tOracleOutput_1.setNull(14, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(14, out1.ADJ003);
}

                        if(out1.ADJ004 == null) {
pstmtInsert_tOracleOutput_1.setNull(15, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(15, out1.ADJ004);
}

                        if(out1.ADJ005 == null) {
pstmtInsert_tOracleOutput_1.setNull(16, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(16, out1.ADJ005);
}

                        if(out1.ADJ007 == null) {
pstmtInsert_tOracleOutput_1.setNull(17, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(17, out1.ADJ007);
}

                        if(out1.ADJ008 == null) {
pstmtInsert_tOracleOutput_1.setNull(18, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(18, out1.ADJ008);
}

                        if(out1.ADJ010 == null) {
pstmtInsert_tOracleOutput_1.setNull(19, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(19, out1.ADJ010);
}

                        if(out1.ADJ011 == null) {
pstmtInsert_tOracleOutput_1.setNull(20, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(20, out1.ADJ011);
}

                        if(out1.ADJ012 == null) {
pstmtInsert_tOracleOutput_1.setNull(21, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(21, out1.ADJ012);
}

                        if(out1.ADJ013 == null) {
pstmtInsert_tOracleOutput_1.setNull(22, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(22, out1.ADJ013);
}

                        if(out1.ADJ014 == null) {
pstmtInsert_tOracleOutput_1.setNull(23, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(23, out1.ADJ014);
}

                        if(out1.ADJ015 == null) {
pstmtInsert_tOracleOutput_1.setNull(24, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(24, out1.ADJ015);
}

                        if(out1.ADJ016 == null) {
pstmtInsert_tOracleOutput_1.setNull(25, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(25, out1.ADJ016);
}

                        if(out1.ADJ018 == null) {
pstmtInsert_tOracleOutput_1.setNull(26, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(26, out1.ADJ018);
}

                        if(out1.ADJ019 == null) {
pstmtInsert_tOracleOutput_1.setNull(27, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(27, out1.ADJ019);
}

                        if(out1.ADJ020 == null) {
pstmtInsert_tOracleOutput_1.setNull(28, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(28, out1.ADJ020);
}

                        if(out1.ADJ021 == null) {
pstmtInsert_tOracleOutput_1.setNull(29, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(29, out1.ADJ021);
}

                        if(out1.ADJ022 == null) {
pstmtInsert_tOracleOutput_1.setNull(30, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(30, out1.ADJ022);
}

                        if(out1.ADJ023 == null) {
pstmtInsert_tOracleOutput_1.setNull(31, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(31, out1.ADJ023);
}

                        if(out1.ADJ024 == null) {
pstmtInsert_tOracleOutput_1.setNull(32, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(32, out1.ADJ024);
}

                        if(out1.ADJ025 == null) {
pstmtInsert_tOracleOutput_1.setNull(33, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(33, out1.ADJ025);
}

                        if(out1.ADJ026 == null) {
pstmtInsert_tOracleOutput_1.setNull(34, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(34, out1.ADJ026);
}

                        if(out1.ADJ027 == null) {
pstmtInsert_tOracleOutput_1.setNull(35, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(35, out1.ADJ027);
}

                        if(out1.ADJ028 == null) {
pstmtInsert_tOracleOutput_1.setNull(36, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(36, out1.ADJ028);
}

                        if(out1.ADJ029 == null) {
pstmtInsert_tOracleOutput_1.setNull(37, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(37, out1.ADJ029);
}

                        if(out1.ADJ030 == null) {
pstmtInsert_tOracleOutput_1.setNull(38, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(38, out1.ADJ030);
}

                        if(out1.ADJ032 == null) {
pstmtInsert_tOracleOutput_1.setNull(39, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(39, out1.ADJ032);
}

                        if(out1.ADJ033 == null) {
pstmtInsert_tOracleOutput_1.setNull(40, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(40, out1.ADJ033);
}

                        if(out1.ADJ036 == null) {
pstmtInsert_tOracleOutput_1.setNull(41, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(41, out1.ADJ036);
}

                        if(out1.ADJ038 == null) {
pstmtInsert_tOracleOutput_1.setNull(42, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(42, out1.ADJ038);
}

                        if(out1.ADJ040 == null) {
pstmtInsert_tOracleOutput_1.setNull(43, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(43, out1.ADJ040);
}

                        if(out1.ADJ041 == null) {
pstmtInsert_tOracleOutput_1.setNull(44, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(44, out1.ADJ041);
}

                        if(out1.ADJ042 == null) {
pstmtInsert_tOracleOutput_1.setNull(45, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(45, out1.ADJ042);
}

                        if(out1.ADJ043 == null) {
pstmtInsert_tOracleOutput_1.setNull(46, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(46, out1.ADJ043);
}

                        if(out1.ADJ044 == null) {
pstmtInsert_tOracleOutput_1.setNull(47, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(47, out1.ADJ044);
}

                        if(out1.ADJ045 == null) {
pstmtInsert_tOracleOutput_1.setNull(48, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(48, out1.ADJ045);
}

                        if(out1.ADJ046 == null) {
pstmtInsert_tOracleOutput_1.setNull(49, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(49, out1.ADJ046);
}

                        if(out1.ADJ047 == null) {
pstmtInsert_tOracleOutput_1.setNull(50, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(50, out1.ADJ047);
}

                        if(out1.ADJ048 == null) {
pstmtInsert_tOracleOutput_1.setNull(51, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(51, out1.ADJ048);
}

                        if(out1.TSCOFF == null) {
pstmtInsert_tOracleOutput_1.setNull(52, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(52, out1.TSCOFF);
}

                        if(out1.ESTADIO_MADURACION == null) {
pstmtInsert_tOracleOutput_1.setNull(53, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(53, out1.ESTADIO_MADURACION);
}

                        if(out1.ETAPA_DESARROLLO == null) {
pstmtInsert_tOracleOutput_1.setNull(54, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(54, out1.ETAPA_DESARROLLO);
}

                        if(out1.PERIMETRO_ABDOMINAL == null) {
pstmtInsert_tOracleOutput_1.setNull(55, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(55, out1.PERIMETRO_ABDOMINAL);
}

                        if(out1.JUSTIFICACION_TSCOFF == null) {
pstmtInsert_tOracleOutput_1.setNull(56, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(56, out1.JUSTIFICACION_TSCOFF);
}

                        if(out1.RIESGO_TSCOFF == null) {
pstmtInsert_tOracleOutput_1.setNull(57, java.sql.Types.VARCHAR);
} else {pstmtInsert_tOracleOutput_1.setString(57, out1.RIESGO_TSCOFF);
}
...
public static class row2Struct implements routines.system.IPersistableComparableLookupRow<row2Struct> {
    ...
    public String loopKey;
				...
				public String get_OIS_ () {
					return this._OIS_;
				}

				public Boolean _OIS_IsNullable(){
				    return true;
				}
				public Boolean _OIS_IsKey(){
				    return false;
				}
				public Integer _OIS_Length(){
				    return 4000;
				}
				public Integer _OIS_Precision(){
				    return 0;
				}
				public String _OIS_Default(){
				
					return null;
				
				}
				public String _OIS_Comment(){
				
				    return "";
				
				}
				public String _OIS_Pattern(){
				
					return "";
				
				}
				public String _OIS_OriginalDbColumnName(){
				...
				public String get_ODS_ () {
					return this._ODS_;
				}

				public Boolean _ODS_IsNullable(){
				    return true;
				}
				public Boolean _ODS_IsKey(){
				    return false;
				}
				public Integer _ODS_Length(){
				    return 4000;
				}
				public Integer _ODS_Precision(){
				    return 0;
				}
				public String _ODS_Default(){
				
					return null;
				
				}
				public String _ODS_Comment(){
				
				    return "";
				
				}
				public String _ODS_Pattern(){
				
					return "";
				
				}
				public String _ODS_OriginalDbColumnName(){
				...
				public String get_OIJ_ () {
					return this._OIJ_;
				}

				public Boolean _OIJ_IsNullable(){
				    return true;
				}
				public Boolean _OIJ_IsKey(){
				    return false;
				}
				public Integer _OIJ_Length(){
				    return 4000;
				}
				public Integer _OIJ_Precision(){
				    return 0;
				}
				public String _OIJ_Default(){
				
					return null;
				
				}
				public String _OIJ_Comment(){
				
				    return "";
				
				}
				public String _OIJ_Pattern(){
				
					return "";
				
				}
				public String _OIJ_OriginalDbColumnName(){
				...
				public String get_ODJ_ () {
					return this._ODJ_;
				}

				public Boolean _ODJ_IsNullable(){
				    return true;
				}
				public Boolean _ODJ_IsKey(){
				    return false;
				}
				public Integer _ODJ_Length(){
				    return 4000;
				}
				public Integer _ODJ_Precision(){
				    return 0;
				}
				public String _ODJ_Default(){
				
					return null;
				
				}
				public String _ODJ_Comment(){
				
				    return "";
				
				}
				public String _ODJ_Pattern(){
				
					return "";
				
				}
				public String _ODJ_OriginalDbColumnName(){
				...
				public String get_PT_ () {
					return this._PT_;
				}

				public Boolean _PT_IsNullable(){
				    return true;
				}
				public Boolean _PT_IsKey(){
				    return false;
				}
				public Integer _PT_Length(){
				    return 4000;
				}
				public Integer _PT_Precision(){
				    return 0;
				}
				public String _PT_Default(){
				
					return null;
				
				}
				public String _PT_Comment(){
				
				    return "";
				
				}
				public String _PT_Pattern(){
				
					return "";
				
				}
				public String _PT_OriginalDbColumnName(){
			    ...
			    public String _OTOIZ_;

				public String get_OTOIZ_ () {
					return this._OTOIZ_;
				}

				public Boolean _OTOIZ_IsNullable(){
				    return true;
				}
				public Boolean _OTOIZ_IsKey(){
				    return false;
				}
				public Integer _OTOIZ_Length(){
				    return 4000;
				}
				public Integer _OTOIZ_Precision(){
				    return 0;
				}
				public String _OTOIZ_Default(){
				
					return null;
				
				}
				public String _OTOIZ_Comment(){
				
				    return "";
				
				}
				public String _OTOIZ_Pattern(){
				
					return "";
				
				}
				public String _OTOIZ_OriginalDbColumnName(){
			    ...
			    public String _OTODER_;

				public String get_OTODER_ () {
					return this._OTODER_;
				}

				public Boolean _OTODER_IsNullable(){
				    return true;
				}
				public Boolean _OTODER_IsKey(){
				    return false;
				}
				public Integer _OTODER_Length(){
				    return 4000;
				}
				public Integer _OTODER_Precision(){
				    return 0;
				}
				public String _OTODER_Default(){
				
					return null;
				
				}
				public String _OTODER_Comment(){
				
				    return "";
				
				}
				public String _OTODER_Pattern(){
				
					return "";
				
				}
				public String _OTODER_OriginalDbColumnName(){
			    ...
			    public String _VALFIZ_;

				public String get_VALFIZ_ () {
					return this._VALFIZ_;
				}

				public Boolean _VALFIZ_IsNullable(){
				    return true;
				}
				public Boolean _VALFIZ_IsKey(){
				    return false;
				}
				public Integer _VALFIZ_Length(){
				    return 4000;
				}
				public Integer _VALFIZ_Precision(){
				    return 0;
				}
				public String _VALFIZ_Default(){
				
					return null;
				
				}
				public String _VALFIZ_Comment(){
				
				    return "";
				
				}
				public String _VALFIZ_Pattern(){
				
					return "";
				
				}
				public String _VALFIZ_OriginalDbColumnName(){
			    ...
			    public String _VALFDER_;

				public String get_VALFDER_ () {
					return this._VALFDER_;
				}

				public Boolean _VALFDER_IsNullable(){
				    return true;
				}
				public Boolean _VALFDER_IsKey(){
				    return false;
				}
				public Integer _VALFDER_Length(){
				    return 4000;
				}
				public Integer _VALFDER_Precision(){
				    return 0;
				}
				public String _VALFDER_Default(){
				
					return null;
				
				}
				public String _VALFDER_Comment(){
				
				    return "";
				
				}
				public String _VALFDER_Pattern(){
				
					return "";
				
				}
				public String _VALFDER_OriginalDbColumnName(){
	...
	public void copyDataTo(row2Struct other) {
		...
		other.PROCESOSASISTENCIALES_ID = this.PROCESOSASISTENCIALES_ID;
	            other._OIS_ = this._OIS_;
	            other._ODS_ = this._ODS_;
	            other._OIJ_ = this._OIJ_;
	            other._ODJ_ = this._ODJ_;
	            other._PT_ = this._PT_;
	            other._OTOIZ_ = this._OTOIZ_;
	            other._OTODER_ = this._OTODER_;
	            other._VALFIZ_ = this._VALFIZ_;
	            other._VALFDER_ = this._VALFDER_;
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
						...
						this._OIS_ = readString(dis,ois);
					
						this._ODS_ = readString(dis,ois);
					
						this._OIJ_ = readString(dis,ois);
					
						this._ODJ_ = readString(dis,ois);
					
						this._PT_ = readString(dis,ois);
					
						this._OTOIZ_ = readString(dis,ois);
					
						this._OTODER_ = readString(dis,ois);
					
						this._VALFIZ_ = readString(dis,ois);
					
						this._VALFDER_ = readString(dis,ois);
    ...
    public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
        try {
			int length = 0;
						...
						this._OIS_ = readString(dis,objectIn);
					
						this._ODS_ = readString(dis,objectIn);
					
						this._OIJ_ = readString(dis,objectIn);
					
						this._ODJ_ = readString(dis,objectIn);
					
						this._PT_ = readString(dis,objectIn);
					
						this._OTOIZ_ = readString(dis,objectIn);
					
						this._OTODER_ = readString(dis,objectIn);
					
						this._VALFIZ_ = readString(dis,objectIn);
					
						this._VALFDER_ = readString(dis,objectIn);
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
						...
						writeString(this._OIS_, dos, oos);
					
						writeString(this._ODS_, dos, oos);
					
						writeString(this._OIJ_, dos, oos);
					
						writeString(this._ODJ_, dos, oos);
					
						writeString(this._PT_, dos, oos);
					
						writeString(this._OTOIZ_, dos, oos);
					
						writeString(this._OTODER_, dos, oos);
					
						writeString(this._VALFIZ_, dos, oos);
					
						writeString(this._VALFDER_, dos, oos);
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
						...
						writeString(this._OIS_, dos, objectOut);
					
						writeString(this._ODS_, dos, objectOut);
					
						writeString(this._OIJ_, dos, objectOut);
					
						writeString(this._ODJ_, dos, objectOut);
					
						writeString(this._PT_, dos, objectOut);
					
						writeString(this._OTOIZ_, dos, objectOut);
					
						writeString(this._OTODER_, dos, objectOut);
					
						writeString(this._VALFIZ_, dos, objectOut);
					
						writeString(this._VALFDER_, dos, objectOut);
    ...
    public String toString() {
		...
		sb.append("[");
		sb.append("PROCESOSASISTENCIALES_ID="+String.valueOf(PROCESOSASISTENCIALES_ID));
		sb.append(",_OIS_="+_OIS_);
		sb.append(",_ODS_="+_ODS_);
		sb.append(",_OIJ_="+_OIJ_);
		sb.append(",_ODJ_="+_ODJ_);
		sb.append(",_PT_="+_PT_);
		sb.append(",_OTOIZ_="+_OTOIZ_);
		sb.append(",_OTODER_="+_OTODER_);
		sb.append(",_VALFIZ_="+_VALFIZ_);
		sb.append(",_VALFDER_="+_VALFDER_);
	    sb.append("]");
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row2";
		...
		int tos_count_tAdvancedHash_row2 = 0;
			   		...
			   		// source node:tOracleInput_3 - inputs:(after_tOracleInput_2) outputs:(row2,row2) | target node:tAdvancedHash_row2 - inputs:(row2) outputs:()
 ...
 */
	...
	currentComponent="tOracleInput_3";
		...
		int tos_count_tOracleInput_3 = 0;
		    ...
		    String dbquery_tOracleInput_3 = "SELECT * \nFROM (\n  SELECT  PROCESOSASISTENCIALES_ID,\n          SIGLA,\n          VALOR\n  FROM (\n    SELECT  GH.PRO"
+"CESOSASISTENCIALES_ID,\n            GPEXA.SIGLA,\n            CASE\n              WHEN GH.VALOR IS NOT NULL AND GPEXA.SI"
+"GLA = 'PT' THEN TR.VPREDETERMINADO\n              WHEN GH.VALOR IS NOT NULL THEN TO_CHAR(GH.VALOR)\n              ELSE G"
+"H.OBSERVACION \n            END AS VALOR\n    FROM GEN_HEXAMENES GH\n    INNER JOIN GEN_PARAMEXAMENES GPEXA ON GH.PARAME"
+"XAMENES_ID=GPEXA.ID\n    INNER JOIN GEN_TEXAMENES GTEX ON GPEXA.TEXAMENES_ID=GTEX.ID\n    INNER JOIN HCL_PROCESOSASISTEN"
+"CIALES HP ON HP.ID=GH.PROCESOSASISTENCIALES_ID " +context.CONDITION+"\n    LEFT JOIN GEN_TRESPUESTAS TR ON TR.ID = GH.VALOR\n    WHERE GPEXA.SIGLA IN ('PT', 'OTODER', 'OTOIZ', 'VALFDER', '"
+"VALFIZ') OR GTEX.SIGLA IN ('TS', 'TJ') \n  )\n) PIVOT (\n  MAX(VALOR) FOR SIGLA IN ('OIS','ODS','OIJ','ODJ','PT',\n     "
+"                       'OTOIZ','OTODER','VALFIZ','VALFDER')\n)";
		    ...
		    while (rs_tOracleInput_3.next()) {
		        nb_line_tOracleInput_3++;
					...
					if(rs_tOracleInput_3.getObject(1) != null) {
						row2.PROCESOSASISTENCIALES_ID = rs_tOracleInput_3.getBigDecimal(1);
					} else {
        	...
        	row2._OIS_ = routines.system.JDBCUtil.getString(rs_tOracleInput_3, 2, false);
		                    }
							if(colQtyInRs_tOracleInput_3 < 3) {
								row2._ODS_ = null;
							} else {
	                         		
        	row2._ODS_ = routines.system.JDBCUtil.getString(rs_tOracleInput_3, 3, false);
		                    }
							if(colQtyInRs_tOracleInput_3 < 4) {
								row2._OIJ_ = null;
							} else {
	                         		
        	row2._OIJ_ = routines.system.JDBCUtil.getString(rs_tOracleInput_3, 4, false);
		                    }
							if(colQtyInRs_tOracleInput_3 < 5) {
								row2._ODJ_ = null;
							} else {
	                         		
        	row2._ODJ_ = routines.system.JDBCUtil.getString(rs_tOracleInput_3, 5, false);
		                    }
							if(colQtyInRs_tOracleInput_3 < 6) {
								row2._PT_ = null;
							} else {
	                         		
        	row2._PT_ = routines.system.JDBCUtil.getString(rs_tOracleInput_3, 6, false);
		                    }
							if(colQtyInRs_tOracleInput_3 < 7) {
								row2._OTOIZ_ = null;
							} else {
	                         		
        	row2._OTOIZ_ = routines.system.JDBCUtil.getString(rs_tOracleInput_3, 7, false);
		                    }
							if(colQtyInRs_tOracleInput_3 < 8) {
								row2._OTODER_ = null;
							} else {
	                         		
        	row2._OTODER_ = routines.system.JDBCUtil.getString(rs_tOracleInput_3, 8, false);
		                    }
							if(colQtyInRs_tOracleInput_3 < 9) {
								row2._VALFIZ_ = null;
							} else {
	                         		
        	row2._VALFIZ_ = routines.system.JDBCUtil.getString(rs_tOracleInput_3, 9, false);
		                    }
							if(colQtyInRs_tOracleInput_3 < 10) {
								row2._VALFDER_ = null;
							} else {
	                         		
        	row2._VALFDER_ = routines.system.JDBCUtil.getString(rs_tOracleInput_3, 10, false);
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row2";
				...
				row2_HashRow.PROCESOSASISTENCIALES_ID = row2.PROCESOSASISTENCIALES_ID;
				
				row2_HashRow._OIS_ = row2._OIS_;
				
				row2_HashRow._ODS_ = row2._ODS_;
				
				row2_HashRow._OIJ_ = row2._OIJ_;
				
				row2_HashRow._ODJ_ = row2._ODJ_;
				
				row2_HashRow._PT_ = row2._PT_;
				
				row2_HashRow._OTOIZ_ = row2._OTOIZ_;
				
				row2_HashRow._OTODER_ = row2._OTODER_;
				
				row2_HashRow._VALFIZ_ = row2._VALFIZ_;
				
				row2_HashRow._VALFDER_ = row2._VALFDER_;
...
public static class row3Struct implements routines.system.IPersistableComparableLookupRow<row3Struct> {
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
						...
						this.ADJ001 = readString(dis,ois);
					
						this.ADJ002 = readString(dis,ois);
					
						this.ADJ003 = readString(dis,ois);
					
						this.ADJ004 = readString(dis,ois);
					
						this.ADJ005 = readString(dis,ois);
					
						this.ADJ007 = readString(dis,ois);
					
						this.ADJ008 = readString(dis,ois);
					
						this.ADJ010 = readString(dis,ois);
					
						this.ADJ011 = readString(dis,ois);
					
						this.ADJ012 = readString(dis,ois);
					
						this.ADJ013 = readString(dis,ois);
					
						this.ADJ014 = readString(dis,ois);
					
						this.ADJ015 = readString(dis,ois);
					
						this.ADJ016 = readString(dis,ois);
					
						this.ADJ018 = readString(dis,ois);
					
						this.ADJ019 = readString(dis,ois);
					
						this.ADJ020 = readString(dis,ois);
					
						this.ADJ021 = readString(dis,ois);
					
						this.ADJ022 = readString(dis,ois);
					
						this.ADJ023 = readString(dis,ois);
					
						this.ADJ024 = readString(dis,ois);
					
						this.ADJ025 = readString(dis,ois);
					
						this.ADJ026 = readString(dis,ois);
					
						this.ADJ027 = readString(dis,ois);
					
						this.ADJ028 = readString(dis,ois);
					
						this.ADJ029 = readString(dis,ois);
					
						this.ADJ030 = readString(dis,ois);
					
						this.ADJ032 = readString(dis,ois);
					
						this.ADJ033 = readString(dis,ois);
					
						this.ADJ036 = readString(dis,ois);
					
						this.ADJ038 = readString(dis,ois);
					
						this.ADJ040 = readString(dis,ois);
					
						this.ADJ041 = readString(dis,ois);
					
						this.ADJ042 = readString(dis,ois);
					
						this.ADJ043 = readString(dis,ois);
					
						this.ADJ044 = readString(dis,ois);
					
						this.ADJ045 = readString(dis,ois);
					
						this.ADJ046 = readString(dis,ois);
					
						this.ADJ047 = readString(dis,ois);
					
						this.ADJ048 = readString(dis,ois);
					
						this.ESTADIO_MADURACION = readString(dis,ois);
    ...
    public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
        try {
			int length = 0;
						...
						this.ADJ001 = readString(dis,objectIn);
					
						this.ADJ002 = readString(dis,objectIn);
					
						this.ADJ003 = readString(dis,objectIn);
					
						this.ADJ004 = readString(dis,objectIn);
					
						this.ADJ005 = readString(dis,objectIn);
					
						this.ADJ007 = readString(dis,objectIn);
					
						this.ADJ008 = readString(dis,objectIn);
					
						this.ADJ010 = readString(dis,objectIn);
					
						this.ADJ011 = readString(dis,objectIn);
					
						this.ADJ012 = readString(dis,objectIn);
					
						this.ADJ013 = readString(dis,objectIn);
					
						this.ADJ014 = readString(dis,objectIn);
					
						this.ADJ015 = readString(dis,objectIn);
					
						this.ADJ016 = readString(dis,objectIn);
					
						this.ADJ018 = readString(dis,objectIn);
					
						this.ADJ019 = readString(dis,objectIn);
					
						this.ADJ020 = readString(dis,objectIn);
					
						this.ADJ021 = readString(dis,objectIn);
					
						this.ADJ022 = readString(dis,objectIn);
					
						this.ADJ023 = readString(dis,objectIn);
					
						this.ADJ024 = readString(dis,objectIn);
					
						this.ADJ025 = readString(dis,objectIn);
					
						this.ADJ026 = readString(dis,objectIn);
					
						this.ADJ027 = readString(dis,objectIn);
					
						this.ADJ028 = readString(dis,objectIn);
					
						this.ADJ029 = readString(dis,objectIn);
					
						this.ADJ030 = readString(dis,objectIn);
					
						this.ADJ032 = readString(dis,objectIn);
					
						this.ADJ033 = readString(dis,objectIn);
					
						this.ADJ036 = readString(dis,objectIn);
					
						this.ADJ038 = readString(dis,objectIn);
					
						this.ADJ040 = readString(dis,objectIn);
					
						this.ADJ041 = readString(dis,objectIn);
					
						this.ADJ042 = readString(dis,objectIn);
					
						this.ADJ043 = readString(dis,objectIn);
					
						this.ADJ044 = readString(dis,objectIn);
					
						this.ADJ045 = readString(dis,objectIn);
					
						this.ADJ046 = readString(dis,objectIn);
					
						this.ADJ047 = readString(dis,objectIn);
					
						this.ADJ048 = readString(dis,objectIn);
					
						this.ESTADIO_MADURACION = readString(dis,objectIn);
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
						...
						writeString(this.ADJ001, dos, oos);
					
						writeString(this.ADJ002, dos, oos);
					
						writeString(this.ADJ003, dos, oos);
					
						writeString(this.ADJ004, dos, oos);
					
						writeString(this.ADJ005, dos, oos);
					
						writeString(this.ADJ007, dos, oos);
					
						writeString(this.ADJ008, dos, oos);
					
						writeString(this.ADJ010, dos, oos);
					
						writeString(this.ADJ011, dos, oos);
					
						writeString(this.ADJ012, dos, oos);
					
						writeString(this.ADJ013, dos, oos);
					
						writeString(this.ADJ014, dos, oos);
					
						writeString(this.ADJ015, dos, oos);
					
						writeString(this.ADJ016, dos, oos);
					
						writeString(this.ADJ018, dos, oos);
					
						writeString(this.ADJ019, dos, oos);
					
						writeString(this.ADJ020, dos, oos);
					
						writeString(this.ADJ021, dos, oos);
					
						writeString(this.ADJ022, dos, oos);
					
						writeString(this.ADJ023, dos, oos);
					
						writeString(this.ADJ024, dos, oos);
					
						writeString(this.ADJ025, dos, oos);
					
						writeString(this.ADJ026, dos, oos);
					
						writeString(this.ADJ027, dos, oos);
					
						writeString(this.ADJ028, dos, oos);
					
						writeString(this.ADJ029, dos, oos);
					
						writeString(this.ADJ030, dos, oos);
					
						writeString(this.ADJ032, dos, oos);
					
						writeString(this.ADJ033, dos, oos);
					
						writeString(this.ADJ036, dos, oos);
					
						writeString(this.ADJ038, dos, oos);
					
						writeString(this.ADJ040, dos, oos);
					
						writeString(this.ADJ041, dos, oos);
					
						writeString(this.ADJ042, dos, oos);
					
						writeString(this.ADJ043, dos, oos);
					
						writeString(this.ADJ044, dos, oos);
					
						writeString(this.ADJ045, dos, oos);
					
						writeString(this.ADJ046, dos, oos);
					
						writeString(this.ADJ047, dos, oos);
					
						writeString(this.ADJ048, dos, oos);
					
						writeString(this.ESTADIO_MADURACION, dos, oos);
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
						...
						writeString(this.ADJ001, dos, objectOut);
					
						writeString(this.ADJ002, dos, objectOut);
					
						writeString(this.ADJ003, dos, objectOut);
					
						writeString(this.ADJ004, dos, objectOut);
					
						writeString(this.ADJ005, dos, objectOut);
					
						writeString(this.ADJ007, dos, objectOut);
					
						writeString(this.ADJ008, dos, objectOut);
					
						writeString(this.ADJ010, dos, objectOut);
					
						writeString(this.ADJ011, dos, objectOut);
					
						writeString(this.ADJ012, dos, objectOut);
					
						writeString(this.ADJ013, dos, objectOut);
					
						writeString(this.ADJ014, dos, objectOut);
					
						writeString(this.ADJ015, dos, objectOut);
					
						writeString(this.ADJ016, dos, objectOut);
					
						writeString(this.ADJ018, dos, objectOut);
					
						writeString(this.ADJ019, dos, objectOut);
					
						writeString(this.ADJ020, dos, objectOut);
					
						writeString(this.ADJ021, dos, objectOut);
					
						writeString(this.ADJ022, dos, objectOut);
					
						writeString(this.ADJ023, dos, objectOut);
					
						writeString(this.ADJ024, dos, objectOut);
					
						writeString(this.ADJ025, dos, objectOut);
					
						writeString(this.ADJ026, dos, objectOut);
					
						writeString(this.ADJ027, dos, objectOut);
					
						writeString(this.ADJ028, dos, objectOut);
					
						writeString(this.ADJ029, dos, objectOut);
					
						writeString(this.ADJ030, dos, objectOut);
					
						writeString(this.ADJ032, dos, objectOut);
					
						writeString(this.ADJ033, dos, objectOut);
					
						writeString(this.ADJ036, dos, objectOut);
					
						writeString(this.ADJ038, dos, objectOut);
					
						writeString(this.ADJ040, dos, objectOut);
					
						writeString(this.ADJ041, dos, objectOut);
					
						writeString(this.ADJ042, dos, objectOut);
					
						writeString(this.ADJ043, dos, objectOut);
					
						writeString(this.ADJ044, dos, objectOut);
					
						writeString(this.ADJ045, dos, objectOut);
					
						writeString(this.ADJ046, dos, objectOut);
					
						writeString(this.ADJ047, dos, objectOut);
					
						writeString(this.ADJ048, dos, objectOut);
					
						writeString(this.ESTADIO_MADURACION, dos, objectOut);
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row3";
		...
		int tos_count_tAdvancedHash_row3 = 0;
			   		...
			   		// source node:tOracleInput_1 - inputs:(after_tOracleInput_2) outputs:(row3,row3) | target node:tAdvancedHash_row3 - inputs:(row3) outputs:()
			   		// linked node: tMap_1 - inputs:(row1,row2,row3,row4,row5) outputs:(out1)
 ...
 */
	...
	currentComponent="tOracleInput_1";
		...
		int tos_count_tOracleInput_1 = 0;
		    ...
		    String dbquery_tOracleInput_1 = "SELECT \n*\nFROM\n(\nSELECT PROCESOSASISTENCIALES_ID, PERSONAS_ID, VPREDETERMINADO, SIGLA\nFROM \n(\nSELECT \nar.PROCES"
+"OSASISTENCIALES_ID,\nar.personas_id,\ngp.pregunta,\nnvl(gt.VPREDETERMINADO,ar.opcion1) AS VPREDETERMINADO ,\ngp.sigla,\n"
+"ar.id\nfrom adj_respuestas ar\ninner join gen_preguntas gp on gp.id=ar.pregunta_id\nleft join GEN_TRESPUESTAS gt on gt.i"
+"d=ar.VPREDETERMINADO\nINNER JOIN HCL_PROCESOSASISTENCIALES HP ON HP.ID=ar.PROCESOSASISTENCIALES_ID " +context.CONDITION+"\nwhere GP.SIGLA IN ('ADJ001', 'ADJ002', 'ADJ003', 'ADJ004', 'ADJ005', 'ADJ007',\n'ADJ008', 'ADJ010', 'ADJ011', 'ADJ012"
+"', 'ADJ013', 'ADJ014', 'ADJ015', 'ADJ016', \n'ADJ018', 'ADJ019', 'ADJ020', 'ADJ021', 'ADJ022', 'ADJ023', 'ADJ024', 'ADJ0"
+"25',\n'ADJ026', 'ADJ027', 'ADJ028', 'ADJ029', 'ADJ030', 'ADJ032', 'ADJ033', 'ADJ036',\n'ADJ038', 'ADJ040', 'ADJ041', 'AD"
+"J042', 'ADJ043', 'ADJ044', 'ADJ045', 'ADJ046', \n'ADJ047', 'ADJ048','ADJMS01')\nORDER BY SIGLA\n) T\n)\nPIVOT \n(\nMAX(V"
+"PREDETERMINADO)\nFOR SIGLA IN ('ADJ001' AS ADJ001, 'ADJ002' AS ADJ002, 'ADJ003' AS ADJ003, 'ADJ004' AS ADJ004,\n'ADJ005'"
+" AS ADJ005, 'ADJ007' AS ADJ007, 'ADJ008' AS ADJ008, 'ADJ010' AS ADJ010,\n'ADJ011' AS ADJ011, 'ADJ012' AS ADJ012, 'ADJ013"
+"' AS ADJ013, 'ADJ014' AS ADJ014,\n'ADJ015' AS ADJ015, 'ADJ016' AS ADJ016, 'ADJ018' AS ADJ018, 'ADJ019' AS ADJ019,\n'ADJ0"
+"20' AS ADJ020, 'ADJ021' AS ADJ021, 'ADJ022' AS ADJ022, 'ADJ023' AS ADJ023,\n'ADJ024' AS ADJ024, 'ADJ025' AS ADJ025, 'ADJ"
+"026' AS ADJ026, 'ADJ027' AS ADJ027,\n'ADJ028' AS ADJ028, 'ADJ029' AS ADJ029, 'ADJ030' AS ADJ030, 'ADJ032' AS ADJ032,\n'A"
+"DJ033' AS ADJ033, 'ADJ036' AS ADJ036, 'ADJ038' AS ADJ038, 'ADJ040' AS ADJ040,\n'ADJ041' AS ADJ041, 'ADJ042' AS ADJ042, '"
+"ADJ043' AS ADJ043, 'ADJ044' AS ADJ044,\n'ADJ045' AS ADJ045, 'ADJ046' AS ADJ046, 'ADJ047' AS ADJ047, 'ADJ048' AS ADJ048,"
+"\n'ADJMS01' AS ESTADIO_MADURACION\n)\n)";
		    ...
		    while (rs_tOracleInput_1.next()) {
		        nb_line_tOracleInput_1++;
							...
							if(colQtyInRs_tOracleInput_1 < 1) {
								row3.PROCESOSASISTENCIALES_ID = null;
							} else {
		                          
					if(rs_tOracleInput_1.getObject(1) != null) {
						row3.PROCESOSASISTENCIALES_ID = rs_tOracleInput_1.getBigDecimal(1);
					} else {
        	...
        	row3.ADJ001 = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 3, false);
		                    }
							if(colQtyInRs_tOracleInput_1 < 4) {
								row3.ADJ002 = null;
							} else {
	                         		
        	row3.ADJ002 = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 4, false);
		                    }
							if(colQtyInRs_tOracleInput_1 < 5) {
								row3.ADJ003 = null;
							} else {
	                         		
        	row3.ADJ003 = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 5, false);
		                    }
							if(colQtyInRs_tOracleInput_1 < 6) {
								row3.ADJ004 = null;
							} else {
	                         		
        	row3.ADJ004 = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 6, false);
		                    }
							if(colQtyInRs_tOracleInput_1 < 7) {
								row3.ADJ005 = null;
							} else {
	                         		
        	row3.ADJ005 = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 7, false);
		                    }
							if(colQtyInRs_tOracleInput_1 < 8) {
								row3.ADJ007 = null;
							} else {
	                         		
        	row3.ADJ007 = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 8, false);
		                    }
							if(colQtyInRs_tOracleInput_1 < 9) {
								row3.ADJ008 = null;
							} else {
	                         		
        	row3.ADJ008 = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 9, false);
		                    }
							if(colQtyInRs_tOracleInput_1 < 10) {
								row3.ADJ010 = null;
							} else {
	                         		
        	row3.ADJ010 = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 10, false);
		                    }
							if(colQtyInRs_tOracleInput_1 < 11) {
								row3.ADJ011 = null;
							} else {
	                         		
        	row3.ADJ011 = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 11, false);
		                    }
							if(colQtyInRs_tOracleInput_1 < 12) {
								row3.ADJ012 = null;
							} else {
	                         		
        	row3.ADJ012 = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 12, false);
		                    }
							if(colQtyInRs_tOracleInput_1 < 13) {
								row3.ADJ013 = null;
							} else {
	                         		
        	row3.ADJ013 = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 13, false);
		                    }
							if(colQtyInRs_tOracleInput_1 < 14) {
								row3.ADJ014 = null;
							} else {
	                         		
        	row3.ADJ014 = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 14, false);
		                    }
							if(colQtyInRs_tOracleInput_1 < 15) {
								row3.ADJ015 = null;
							} else {
	                         		
        	row3.ADJ015 = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 15, false);
		                    }
							if(colQtyInRs_tOracleInput_1 < 16) {
								row3.ADJ016 = null;
							} else {
	                         		
        	row3.ADJ016 = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 16, false);
		                    }
							if(colQtyInRs_tOracleInput_1 < 17) {
								row3.ADJ018 = null;
							} else {
	                         		
        	row3.ADJ018 = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 17, false);
		                    }
							if(colQtyInRs_tOracleInput_1 < 18) {
								row3.ADJ019 = null;
							} else {
	                         		
        	row3.ADJ019 = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 18, false);
		                    }
							if(colQtyInRs_tOracleInput_1 < 19) {
								row3.ADJ020 = null;
							} else {
	                         		
        	row3.ADJ020 = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 19, false);
		                    }
							if(colQtyInRs_tOracleInput_1 < 20) {
								row3.ADJ021 = null;
							} else {
	                         		
        	row3.ADJ021 = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 20, false);
		                    }
							if(colQtyInRs_tOracleInput_1 < 21) {
								row3.ADJ022 = null;
							} else {
	                         		
        	row3.ADJ022 = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 21, false);
		                    }
							if(colQtyInRs_tOracleInput_1 < 22) {
								row3.ADJ023 = null;
							} else {
	                         		
        	row3.ADJ023 = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 22, false);
		                    }
							if(colQtyInRs_tOracleInput_1 < 23) {
								row3.ADJ024 = null;
							} else {
	                         		
        	row3.ADJ024 = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 23, false);
		                    }
							if(colQtyInRs_tOracleInput_1 < 24) {
								row3.ADJ025 = null;
							} else {
	                         		
        	row3.ADJ025 = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 24, false);
		                    }
							if(colQtyInRs_tOracleInput_1 < 25) {
								row3.ADJ026 = null;
							} else {
	                         		
        	row3.ADJ026 = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 25, false);
		                    }
							if(colQtyInRs_tOracleInput_1 < 26) {
								row3.ADJ027 = null;
							} else {
	                         		
        	row3.ADJ027 = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 26, false);
		                    }
							if(colQtyInRs_tOracleInput_1 < 27) {
								row3.ADJ028 = null;
							} else {
	                         		
        	row3.ADJ028 = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 27, false);
		                    }
							if(colQtyInRs_tOracleInput_1 < 28) {
								row3.ADJ029 = null;
							} else {
	                         		
        	row3.ADJ029 = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 28, false);
		                    }
							if(colQtyInRs_tOracleInput_1 < 29) {
								row3.ADJ030 = null;
							} else {
	                         		
        	row3.ADJ030 = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 29, false);
		                    }
							if(colQtyInRs_tOracleInput_1 < 30) {
								row3.ADJ032 = null;
							} else {
	                         		
        	row3.ADJ032 = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 30, false);
		                    }
							if(colQtyInRs_tOracleInput_1 < 31) {
								row3.ADJ033 = null;
							} else {
	                         		
        	row3.ADJ033 = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 31, false);
		                    }
							if(colQtyInRs_tOracleInput_1 < 32) {
								row3.ADJ036 = null;
							} else {
	                         		
        	row3.ADJ036 = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 32, false);
		                    }
							if(colQtyInRs_tOracleInput_1 < 33) {
								row3.ADJ038 = null;
							} else {
	                         		
        	row3.ADJ038 = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 33, false);
		                    }
							if(colQtyInRs_tOracleInput_1 < 34) {
								row3.ADJ040 = null;
							} else {
	                         		
        	row3.ADJ040 = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 34, false);
		                    }
							if(colQtyInRs_tOracleInput_1 < 35) {
								row3.ADJ041 = null;
							} else {
	                         		
        	row3.ADJ041 = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 35, false);
		                    }
							if(colQtyInRs_tOracleInput_1 < 36) {
								row3.ADJ042 = null;
							} else {
	                         		
        	row3.ADJ042 = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 36, false);
		                    }
							if(colQtyInRs_tOracleInput_1 < 37) {
								row3.ADJ043 = null;
							} else {
	                         		
        	row3.ADJ043 = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 37, false);
		                    }
							if(colQtyInRs_tOracleInput_1 < 38) {
								row3.ADJ044 = null;
							} else {
	                         		
        	row3.ADJ044 = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 38, false);
		                    }
							if(colQtyInRs_tOracleInput_1 < 39) {
								row3.ADJ045 = null;
							} else {
	                         		
        	row3.ADJ045 = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 39, false);
		                    }
							if(colQtyInRs_tOracleInput_1 < 40) {
								row3.ADJ046 = null;
							} else {
	                         		
        	row3.ADJ046 = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 40, false);
		                    }
							if(colQtyInRs_tOracleInput_1 < 41) {
								row3.ADJ047 = null;
							} else {
	                         		
        	row3.ADJ047 = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 41, false);
		                    }
							if(colQtyInRs_tOracleInput_1 < 42) {
								row3.ADJ048 = null;
							} else {
	                         		
        	row3.ADJ048 = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 42, false);
		                    }
							if(colQtyInRs_tOracleInput_1 < 43) {
								row3.ESTADIO_MADURACION = null;
							} else {
	                         		
        	row3.ESTADIO_MADURACION = routines.system.JDBCUtil.getString(rs_tOracleInput_1, 43, false);
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row3";
				...
				row3_HashRow.PROCESOSASISTENCIALES_ID = row3.PROCESOSASISTENCIALES_ID;
				
				row3_HashRow.PERSONAS_ID = row3.PERSONAS_ID;
				
				row3_HashRow.ADJ001 = row3.ADJ001;
				
				row3_HashRow.ADJ002 = row3.ADJ002;
				
				row3_HashRow.ADJ003 = row3.ADJ003;
				
				row3_HashRow.ADJ004 = row3.ADJ004;
				
				row3_HashRow.ADJ005 = row3.ADJ005;
				
				row3_HashRow.ADJ007 = row3.ADJ007;
				
				row3_HashRow.ADJ008 = row3.ADJ008;
				
				row3_HashRow.ADJ010 = row3.ADJ010;
				
				row3_HashRow.ADJ011 = row3.ADJ011;
				
				row3_HashRow.ADJ012 = row3.ADJ012;
				
				row3_HashRow.ADJ013 = row3.ADJ013;
				
				row3_HashRow.ADJ014 = row3.ADJ014;
				
				row3_HashRow.ADJ015 = row3.ADJ015;
				
				row3_HashRow.ADJ016 = row3.ADJ016;
				
				row3_HashRow.ADJ018 = row3.ADJ018;
				
				row3_HashRow.ADJ019 = row3.ADJ019;
				
				row3_HashRow.ADJ020 = row3.ADJ020;
				
				row3_HashRow.ADJ021 = row3.ADJ021;
				
				row3_HashRow.ADJ022 = row3.ADJ022;
				
				row3_HashRow.ADJ023 = row3.ADJ023;
				
				row3_HashRow.ADJ024 = row3.ADJ024;
				
				row3_HashRow.ADJ025 = row3.ADJ025;
				
				row3_HashRow.ADJ026 = row3.ADJ026;
				
				row3_HashRow.ADJ027 = row3.ADJ027;
				
				row3_HashRow.ADJ028 = row3.ADJ028;
				
				row3_HashRow.ADJ029 = row3.ADJ029;
				
				row3_HashRow.ADJ030 = row3.ADJ030;
				
				row3_HashRow.ADJ032 = row3.ADJ032;
				
				row3_HashRow.ADJ033 = row3.ADJ033;
				
				row3_HashRow.ADJ036 = row3.ADJ036;
				
				row3_HashRow.ADJ038 = row3.ADJ038;
				
				row3_HashRow.ADJ040 = row3.ADJ040;
				
				row3_HashRow.ADJ041 = row3.ADJ041;
				
				row3_HashRow.ADJ042 = row3.ADJ042;
				
				row3_HashRow.ADJ043 = row3.ADJ043;
				
				row3_HashRow.ADJ044 = row3.ADJ044;
				
				row3_HashRow.ADJ045 = row3.ADJ045;
				
				row3_HashRow.ADJ046 = row3.ADJ046;
				
				row3_HashRow.ADJ047 = row3.ADJ047;
				
				row3_HashRow.ADJ048 = row3.ADJ048;
				
				row3_HashRow.ESTADIO_MADURACION = row3.ESTADIO_MADURACION;
...
public static class row4Struct implements routines.system.IPersistableComparableLookupRow<row4Struct> {
    ...
    public String loopKey;
				...
				public Boolean RIESGOIsNullable(){
				    return true;
				}
				public Boolean RIESGOIsKey(){
				    return false;
				}
				public Integer RIESGOLength(){
				    return 17;
				}
				public Integer RIESGOPrecision(){
				    return 0;
				}
				public String RIESGODefault(){
				
					return null;
				
				}
				public String RIESGOComment(){
				
				    return "";
				
				}
				public String RIESGOPattern(){
				
					return "";
				
				}
				public String RIESGOOriginalDbColumnName(){
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
						...
						this.JUSTIFICACION = readString(dis,ois);
					
						this.VALOR = readString(dis,ois);
					
						this.RIESGO = readString(dis,ois);
    ...
    public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
        try {
			int length = 0;
						...
						this.JUSTIFICACION = readString(dis,objectIn);
					
						this.VALOR = readString(dis,objectIn);
					
						this.RIESGO = readString(dis,objectIn);
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
						...
						writeString(this.JUSTIFICACION, dos, oos);
					
						writeString(this.VALOR, dos, oos);
					
						writeString(this.RIESGO, dos, oos);
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
						...
						writeString(this.JUSTIFICACION, dos, objectOut);
					
						writeString(this.VALOR, dos, objectOut);
					
						writeString(this.RIESGO, dos, objectOut);
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row4";
		...
		int tos_count_tAdvancedHash_row4 = 0;
			   		...
			   		// source node:tOracleInput_4 - inputs:(after_tOracleInput_2) outputs:(row4,row4) | target node:tAdvancedHash_row4 - inputs:(row4) outputs:()
			   		// linked node: tMap_1 - inputs:(row1,row2,row3,row4,row5) outputs:(out1)
 ...
 */
	...
	currentComponent="tOracleInput_4";
		...
		int tos_count_tOracleInput_4 = 0;
		    ...
		    String dbquery_tOracleInput_4 = "SELECT\nGH.PROCESOSASISTENCIALES_ID,\nreplace(replace(nvl(CASE WHEN MIN(GPEXA.SIGLA)='TSJNR' THEN MIN(GH.OBSERVACION) E"
+"ND,'No aplica'),chr(10),''),chr(13),'') AS JUSTIFICACION,\nCASE WHEN MIN(GPEXA.SIGLA)!='TSJNR' THEN 'Si' ELSE 'No' END A"
+"S VALOR,\nCASE \nWHEN \n(SUM(CASE WHEN GPEXA.SIGLA!='TSJNR' AND GH.OBSERVACION='Si' THEN 1 ELSE 0 END))>=2 THEN 'Hay rie"
+"sgo TCA' \nWHEN (CASE WHEN MIN(GPEXA.SIGLA)!='TSJNR' THEN 'Si' ELSE 'No' END) = 'No' THEN 'No aplica' \n ELSE  'No hay r"
+"iesgo TCA' END AS RIESGO\nFROM GEN_HEXAMENES GH\nINNER JOIN GEN_PARAMEXAMENES GPEXA ON GH.PARAMEXAMENES_ID=GPEXA.ID \nLE"
+"FT JOIN GEN_TEXAMENES GTEX ON GPEXA.TEXAMENES_ID=GTEX.ID\nINNER JOIN HCL_PROCESOSASISTENCIALES HP ON HP.ID=GH.PROCESOSAS"
+"ISTENCIALES_ID   " +context.CONDITION+"\nwhere (GTEX.SIGLA='TSC' OR GPEXA.SIGLA = 'TSJNR')\nGROUP BY GH.PROCESOSASISTENCIALES_ID";
		    ...
		    while (rs_tOracleInput_4.next()) {
		        nb_line_tOracleInput_4++;
							...
							if(colQtyInRs_tOracleInput_4 < 1) {
								row4.PROCESOSASISTENCIALES_ID = null;
							} else {
		                          
					if(rs_tOracleInput_4.getObject(1) != null) {
						row4.PROCESOSASISTENCIALES_ID = rs_tOracleInput_4.getBigDecimal(1);
					} else {
						...
						row4.PROCESOSASISTENCIALES_ID = null;
							...
							if(colQtyInRs_tOracleInput_4 < 2) {
								row4.JUSTIFICACION = null;
							} else {
	                         		
        	row4.JUSTIFICACION = routines.system.JDBCUtil.getString(rs_tOracleInput_4, 2, false);
		                    }
							if(colQtyInRs_tOracleInput_4 < 3) {
								row4.VALOR = null;
							} else {
	                         		
        	row4.VALOR = routines.system.JDBCUtil.getString(rs_tOracleInput_4, 3, false);
		                    }
							if(colQtyInRs_tOracleInput_4 < 4) {
								row4.RIESGO = null;
							} else {
	                         		
        	row4.RIESGO = routines.system.JDBCUtil.getString(rs_tOracleInput_4, 4, false);
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row4";
				...
				row4_HashRow.JUSTIFICACION = row4.JUSTIFICACION;
				
				row4_HashRow.VALOR = row4.VALOR;
				
				row4_HashRow.RIESGO = row4.RIESGO;
...
public static class row5Struct implements routines.system.IPersistableComparableLookupRow<row5Struct> {
    ...
    public void readValuesData(DataInputStream dis, ObjectInputStream ois) {
        try {
			...
			int length = 0;
						...
						this.PERIMETRO_ABDOMINAL = readString(dis,ois);
    ...
    public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
        try {
			int length = 0;
						...
						this.PERIMETRO_ABDOMINAL = readString(dis,objectIn);
    ...
    public void writeValuesData(DataOutputStream dos, ObjectOutputStream oos) {
        try {
						...
						writeString(this.PERIMETRO_ABDOMINAL, dos, oos);
    ...
    public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut){
                try {
						...
						writeString(this.PERIMETRO_ABDOMINAL, dos, objectOut);
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row5";
		...
		int tos_count_tAdvancedHash_row5 = 0;
			   		...
			   		// source node:tOracleInput_5 - inputs:(after_tOracleInput_2) outputs:(row5,row5) | target node:tAdvancedHash_row5 - inputs:(row5) outputs:()
			   		// linked node: tMap_1 - inputs:(row1,row2,row3,row4,row5) outputs:(out1)
 ...
 */
	...
	currentComponent="tOracleInput_5";
		...
		int tos_count_tOracleInput_5 = 0;
		    ...
		    String dbquery_tOracleInput_5 = "SELECT PROCESOSASISTENCIALES_ID, PERIMETRO_ABDOMINAL, NVL(MSEXF,MSEXM ) AS ESTADIO_MADURACION\nFROM (\n  SELECT  GH.PRO"
+"CESOSASISTENCIALES_ID,\n          GPEXA.SIGLA,\n          CASE\n          WHEN GH.VALOR IS NOT NULL THEN TO_CHAR(GH.VALO"
+"R)\n          ELSE GH.OBSERVACION END AS VALOR      \n  FROM GEN_HEXAMENES GH\n  INNER JOIN GEN_PARAMEXAMENES GPEXA ON G"
+"H.PARAMEXAMENES_ID=GPEXA.ID\n  INNER JOIN HCL_PROCESOSASISTENCIALES HP ON HP.ID=GH.PROCESOSASISTENCIALES_ID" +context.CONDITION+"\n  WHERE GPEXA.SIGLA IN ('PABD', 'MSEXF','MSEXM')\n) PIVOT (\nMAX(VALOR) \n  FOR SIGLA IN ('PABD' AS PERIMETRO_ABDOMIN"
+"AL, 'MSEXF' AS MSEXF ,'MSEXM' AS MSEXM)\n)";
		    ...
		    while (rs_tOracleInput_5.next()) {
		        nb_line_tOracleInput_5++;
					...
					if(rs_tOracleInput_5.getObject(1) != null) {
						row5.PROCESOSASISTENCIALES_ID = rs_tOracleInput_5.getBigDecimal(1);
					} else {
 	                	...
 	                	throw new RuntimeException("Null value in non-Nullable column");
							...
							if(colQtyInRs_tOracleInput_5 < 2) {
								row5.PERIMETRO_ABDOMINAL = null;
							} else {
	                         		
        	row5.PERIMETRO_ABDOMINAL = routines.system.JDBCUtil.getString(rs_tOracleInput_5, 2, false);
		                    }
							if(colQtyInRs_tOracleInput_5 < 3) {
								row5.ESTADIO_MADURACION = null;
							} else {
	                         		
        	row5.ESTADIO_MADURACION = routines.system.JDBCUtil.getString(rs_tOracleInput_5, 3, false);
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row5";
				...
				row5_HashRow.PERIMETRO_ABDOMINAL = row5.PERIMETRO_ABDOMINAL;
				
				row5_HashRow.ESTADIO_MADURACION = row5.ESTADIO_MADURACION;
 ...
 */
    ...
    public static void main(String[] args){
        final AdolescenteJoven AdolescenteJovenClass = new AdolescenteJoven();

        int exitCode = AdolescenteJovenClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = AdolescenteJoven.class.getClassLoader().getResourceAsStream("rep_inicio_f5/adolescentejoven_0_4/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = AdolescenteJoven.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
e_tPostjob_1.printStackTrace();
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : AdolescenteJoven");
        }
...
/************************************************************************************************
 *     593777 characters generated by Talend Open Studio for ESB 
 *     on the October 16, 2024, 12:28:33 AM COT
 ************************************************************************************************/