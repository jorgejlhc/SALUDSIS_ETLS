...
package hcl_historia_clinica.mail_1_3;
...
public String getService_name_destino(){
	...
	private final String projectName = "HCL_HISTORIA_CLINICA";
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_HCL_HISTORIA_CLINICA_Mail = new byte[0];
    static byte[] commonByteArray_HCL_HISTORIA_CLINICA_Mail = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_HCL_HISTORIA_CLINICA_Mail.length) {
				if(length < 1024 && commonByteArray_HCL_HISTORIA_CLINICA_Mail.length == 0) {
   					commonByteArray_HCL_HISTORIA_CLINICA_Mail = new byte[1024];
				} else {
   					commonByteArray_HCL_HISTORIA_CLINICA_Mail = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_HCL_HISTORIA_CLINICA_Mail, 0, length);
			strReturn = new String(commonByteArray_HCL_HISTORIA_CLINICA_Mail, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_HCL_HISTORIA_CLINICA_Mail, 0, length);
			strReturn = new String(commonByteArray_HCL_HISTORIA_CLINICA_Mail, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_HCL_HISTORIA_CLINICA_Mail) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Mail.class.getClassLoader().getResourceAsStream("hcl_historia_clinica/mail_1_3/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     128160 characters generated by Talend Open Studio for ESB 
 *     on the August 21, 2024, 2:42:43 PM COT
 ************************************************************************************************/