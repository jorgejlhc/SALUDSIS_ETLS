...
public class TOracleOutputMainJava {
  ...
  protected final String TEXT_55 = ".setQueryTimeout(";
  ...
  protected final String TEXT_62 = NL + "            try (java.sql.Statement stmtCreate_";
  protected final String TEXT_63 = NL + "                              stmtCreate_";
  protected final String TEXT_64 = NL + "                    \troutines.system.Dynamic dynamic_";
  protected final String TEXT_65 = " = ";
  protected final String TEXT_66 = ";" + NL + "\t                    if (";
  protected final String TEXT_67 = ") {" + NL + "\t                        for (int x_";
  protected final String TEXT_68 = " = 0; x_";
  protected final String TEXT_69 = " < dynamic_";
  protected final String TEXT_70 = ".getColumnCount(); x_";
  protected final String TEXT_71 = "++) {" + NL + "\t                        \troutines.system.DynamicMetadata column_";
  protected final String TEXT_72 = " = dynamic_";
  protected final String TEXT_73 = ".getColumnMetadata(x_";
  protected final String TEXT_74 = ");" + NL + "\t                        \tcolumn_";
  protected final String TEXT_75 = ".setName(column_";
  protected final String TEXT_76 = ".getName().toLowerCase());" + NL + "\t                        }" + NL + "\t                    }" + NL + "                        stmtCreate_";
  protected final String TEXT_77 = ".execute(((\"";
  protected final String TEXT_78 = "\").replace(\"{TALEND_DYNAMIC_COLUMN}\",DynamicUtils.getCreateTableSQL(dynamic_";
  protected final String TEXT_79 = ", \"";
  protected final String TEXT_80 = "\")";
  protected final String TEXT_81 = ".toUpperCase()";
  protected final String TEXT_82 = ")+\")";
  protected final String TEXT_83 = "\"));";
  protected final String TEXT_84 = NL + "                stmtCreate_";
  protected final String TEXT_85 = ")\");";
  protected final String TEXT_86 = NL + "                    routines.system.Dynamic dynamic_";
  protected final String TEXT_87 = ";" + NL + "                    if (";
  protected final String TEXT_88 = ") {" + NL + "                        for (int x_";
  protected final String TEXT_89 = "++) {" + NL + "                        \troutines.system.DynamicMetadata column_";
  protected final String TEXT_90 = ");" + NL + "                        \tcolumn_";
  protected final String TEXT_91 = ".getName().toLowerCase());" + NL + "                        }" + NL + "                    }" + NL + "                    stmtCreate_";
  protected final String TEXT_92 = NL;
  protected final String TEXT_93 = NL + "                    String keyCheckTable_";
  protected final String TEXT_94 = " = \"[Informix]\"+\"[\"+";
  protected final String TEXT_95 = "+\"][\"+";
  protected final String TEXT_96 = "+\"]\"+ \"[checktable]\" + \"[\" + ";
  protected final String TEXT_97 = " + \"]\";";
  protected final String TEXT_98 = NL + "                    // [%connection%][checktable][tableName]" + NL + "                    String keyCheckTable_";
  protected final String TEXT_99 = " + \"[checktable]\" + \"[\" + ";
  protected final String TEXT_100 = NL + NL + "                if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_101 = ")== null){//}" + NL + "" + NL + "                    synchronized (GlobalResource.resourceLockMap.get(keyCheckTable_";
  protected final String TEXT_102 = ")) {//}" + NL + "                        if(GlobalResource.resourceMap.get(keyCheckTable_";
  protected final String TEXT_103 = ")== null){//}";
  protected final String TEXT_104 = NL + "                                boolean whetherExist_";
  protected final String TEXT_105 = " = false;" + NL + "                                try (java.sql.Statement isExistStmt_";
  protected final String TEXT_106 = ".createStatement()) {" + NL + "                                    try {" + NL + "                                    \t";
  protected final String TEXT_107 = NL + "                                             isExistStmt_";
  protected final String TEXT_108 = NL + "                                        isExistStmt_";
  protected final String TEXT_109 = ".execute(\"SELECT TOP 1 1 FROM [\" + tableName_";
  protected final String TEXT_110 = " + \"]\" );" + NL + "                                        whetherExist_";
  protected final String TEXT_111 = " = true;" + NL + "                                    } catch (java.lang.Exception e){" + NL + "globalMap.put(\"";
  protected final String TEXT_112 = "_ERROR_MESSAGE\",e.getMessage());" + NL + "                                        whetherExist_";
  protected final String TEXT_113 = " = false;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_114 = NL + "                                ";
  protected final String TEXT_115 = NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_116 = ".getMetaData();" + NL + "                                if(tableNameForSearch_";
  protected final String TEXT_117 = ".indexOf(\"\\\"\")==-1){" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_118 = " = tableNameForSearch_";
  protected final String TEXT_119 = ".toUpperCase();" + NL + "                                }else{" + NL + "                                    tableNameForSearch_";
  protected final String TEXT_120 = ".replaceAll(\"\\\"\",\"\");" + NL + "                                }" + NL + "                                boolean whetherExist_";
  protected final String TEXT_121 = " = false;" + NL + "                                try (java.sql.ResultSet rsTable_";
  ...
  protected final String TEXT_125 = ", new String[]{\"TABLE\"})) {" + NL + "                                    if(rsTable_";
  protected final String TEXT_126 = ".next()) {" + NL + "                                        whetherExist_";
  protected final String TEXT_127 = " = true;" + NL + "                                    }" + NL + "                                }" + NL;
  ...
  protected final String TEXT_141 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_142 = "((";
  protected final String TEXT_143 = ") || (dbschema_";
  protected final String TEXT_144 = ".trim().length() ==0 && dbUser_";
  protected final String TEXT_145 = ".equalsIgnoreCase(schema_";
  protected final String TEXT_146 = ")))) {" + NL + "                                            whetherExist_";
  protected final String TEXT_147 = ".getTables(null, null, null, new String[]{\"TABLE\"})) {" + NL + "                                    String defaultSchema_";
  protected final String TEXT_148 = " = \"public\";" + NL + "                                    if(dbschema_";
  protected final String TEXT_149 = ".trim().length() == 0) {" + NL + "                                        try(java.sql.Statement stmtSchema_";
  protected final String TEXT_150 = ".createStatement();" + NL + "                                            java.sql.ResultSet rsSchema_";
  protected final String TEXT_151 = " = stmtSchema_";
  protected final String TEXT_152 = ".executeQuery(\"select current_schema() \")) {" + NL + "                                            while(rsSchema_";
  protected final String TEXT_153 = ".next()){" + NL + "                                                defaultSchema_";
  protected final String TEXT_154 = " = rsSchema_";
  protected final String TEXT_155 = ".getString(\"current_schema\");" + NL + "                                            }" + NL + "                                        }" + NL + "                                    }" + NL + "                                    while(rsTable_";
  protected final String TEXT_156 = ".toLowerCase()";
  protected final String TEXT_157 = ") || ((dbschema_";
  protected final String TEXT_158 = " ==null || dbschema_";
  protected final String TEXT_159 = ".trim().length() ==0) && defaultSchema_";
  protected final String TEXT_160 = "(schema_";
  protected final String TEXT_161 = NL + "                                String tableForSearch_";
  protected final String TEXT_162 = ";" + NL + "                                if(tableForSearch_";
  protected final String TEXT_163 = " != null){" + NL + "                                    if(tableForSearch_";
  protected final String TEXT_164 = ".startsWith(\"\\\"\") && tableForSearch_";
  protected final String TEXT_165 = ".endsWith(\"\\\"\")){" + NL + "                                        tableForSearch_";
  protected final String TEXT_166 = " =  tableForSearch_";
  protected final String TEXT_167 = ".substring(1,tableForSearch_";
  protected final String TEXT_168 = ".length()-1);" + NL + "                                    }else{" + NL + "                                        tableForSearch_";
  protected final String TEXT_169 = ".toUpperCase();" + NL + "                                    }" + NL + "                                }" + NL + "                                java.sql.DatabaseMetaData dbMetaData_";
  protected final String TEXT_170 = ".getTables(null, conn_";
  protected final String TEXT_171 = ".getSchema(), tableForSearch_";
  protected final String TEXT_172 = ", new String[]{\"TABLE\"})) {" + NL + "                                       if(rsTable_";
  protected final String TEXT_173 = " = true;" + NL + "                                    }" + NL + "                                }";
  protected final String TEXT_174 = ".getTables(null, schemaForSearch_";
  protected final String TEXT_175 = ", null, new String[]{\"TABLE\"})) {" + NL + "                                    while(rsTable_";
  protected final String TEXT_176 = ".next()) {" + NL + "                                        if(rsTable_";
  protected final String TEXT_177 = ".getString(\"TABLE_NAME\").equalsIgnoreCase(tableForSearch_";
  protected final String TEXT_178 = ")) {" + NL + "                                            whetherExist_";
  protected final String TEXT_179 = " = true;" + NL + "                                            break;" + NL + "                                        }" + NL + "                                    }" + NL + "                                }" + NL + "                            " + NL + "                            ";
  protected final String TEXT_180 = ".getMetaData();";
  protected final String TEXT_181 = NL + "                                    java.sql.ResultSet rsTable_";
  protected final String TEXT_182 = ".getTables(";
  protected final String TEXT_183 = ", null, null, new String[]{\"TABLE\"});";
  protected final String TEXT_184 = ".getTables(conn_";
  protected final String TEXT_185 = ".getCatalog(), null, null, new String[]{\"TABLE\"});";
  ...
  protected final String TEXT_194 = ") {" + NL + "                                    try (java.sql.Statement stmtCreate_";
  protected final String TEXT_195 = NL + "                                                      stmtCreate_";
  protected final String TEXT_196 = NL + "                                            routines.system.Dynamic dynamic_";
  protected final String TEXT_197 = ";" + NL + "\t\t\t\t\t\t                    if (";
  protected final String TEXT_198 = ") {" + NL + "\t\t\t\t\t\t                        for (int x_";
  protected final String TEXT_199 = "++) {" + NL + "\t\t\t\t\t\t                        \troutines.system.DynamicMetadata column_";
  protected final String TEXT_200 = ");" + NL + "\t\t\t\t\t\t                        \tcolumn_";
  protected final String TEXT_201 = ".getName().toLowerCase());" + NL + "\t\t\t\t\t\t                        }" + NL + "\t\t\t\t\t\t                    }" + NL + "                                            stmtCreate_";
  ...
  protected final String TEXT_205 = ") {" + NL + "                                    try (java.sql.Statement stmtDrop_";
  protected final String TEXT_206 = NL + "                                                      stmtDrop_";
  protected final String TEXT_207 = NL + "                                        stmtDrop_";
  protected final String TEXT_208 = NL + "                                    }";
  protected final String TEXT_209 = NL + "                                            conn_";
  protected final String TEXT_210 = NL + "                                }" + NL + "                                try(java.sql.Statement stmtCreate_";
  protected final String TEXT_211 = NL + "                                                  stmtCreate_";
  protected final String TEXT_212 = NL + "\t\t                                routines.system.Dynamic dynamic_";
  protected final String TEXT_213 = ";" + NL + "\t\t\t\t\t                    if (";
  protected final String TEXT_214 = ") {" + NL + "\t\t\t\t\t                        for (int x_";
  protected final String TEXT_215 = "++) {" + NL + "\t\t\t\t\t                        \troutines.system.DynamicMetadata column_";
  protected final String TEXT_216 = ");" + NL + "\t\t\t\t\t                        \tcolumn_";
  protected final String TEXT_217 = ".getName().toLowerCase());" + NL + "\t\t\t\t\t                        }" + NL + "\t\t\t\t\t                    }" + NL + "                                        stmtCreate_";
  protected final String TEXT_218 = NL + "                                    stmtCreate_";
  protected final String TEXT_219 = NL + "                                }";
  protected final String TEXT_220 = NL + "                            GlobalResource.resourceMap.put(keyCheckTable_";
  protected final String TEXT_221 = ", true);" + NL + "            //{{{" + NL + "                        } // end of if" + NL + "                    } // end synchronized" + NL + "                }";
  protected final String TEXT_222 = NL + "            try (java.sql.Statement stmtClear_";
  protected final String TEXT_223 = NL + "                              stmtClear_";
  protected final String TEXT_224 = NL + "                stmtClear_";
  protected final String TEXT_225 = ".executeUpdate(\"";
  protected final String TEXT_226 = "\");";
  protected final String TEXT_227 = NL + "            int rsTruncCountNumber_";
  protected final String TEXT_228 = " = 0;" + NL + "            try(java.sql.Statement stmtTruncCount_";
  protected final String TEXT_229 = NL + "                              stmtTruncCount_";
  protected final String TEXT_230 = NL + "                try (java.sql.ResultSet rsTruncCount_";
  protected final String TEXT_231 = " = stmtTruncCount_";
  protected final String TEXT_232 = ".executeQuery(\"";
  protected final String TEXT_233 = "\")) {" + NL + "                    if(rsTruncCount_";
  protected final String TEXT_234 = ".next()) {" + NL + "                        rsTruncCountNumber_";
  protected final String TEXT_235 = " = rsTruncCount_";
  protected final String TEXT_236 = ".getInt(1);" + NL + "                    }" + NL + "                }" + NL + "            }" + NL + "            try (java.sql.Statement stmtTrunc_";
  protected final String TEXT_237 = NL + "                              stmtTrunc_";
  protected final String TEXT_238 = NL + "                conn_";
  protected final String TEXT_239 = NL + "                stmtTrunc_";
  protected final String TEXT_240 = NL + "                    if(!conn_";
  protected final String TEXT_241 = ".getAutoCommit()){" + NL + "                        conn_";
  protected final String TEXT_242 = ".commit();" + NL + "                    }";
  protected final String TEXT_243 = NL + "                deletedCount_";
  protected final String TEXT_244 = " += rsTruncCountNumber_";
  protected final String TEXT_245 = ";" + NL + "            }";
  protected final String TEXT_246 = NL + "            try (java.sql.Statement stmtTruncCount_";
  ...
  protected final String TEXT_249 = NL + "                while(rsTruncCount_";
  protected final String TEXT_250 = ".next()) {" + NL + "                    deletedCount_";
  protected final String TEXT_251 = " += rsTruncCount_";
  protected final String TEXT_252 = ".getInt(1);" + NL + "                }" + NL + "            }";
  protected final String TEXT_253 = NL + "                            String insert_";
  protected final String TEXT_254 = " = \"INSERT INTO \" + tableName_";
  protected final String TEXT_255 = " + \" (";
  protected final String TEXT_256 = ", \"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_257 = ",\"";
  protected final String TEXT_258 = "+\") VALUES (";
  protected final String TEXT_259 = ", \"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_260 = ")+\")\";";
  protected final String TEXT_261 = " + \" (\"+DynamicUtils.getInsertIntoStmtColumnsList(";
  protected final String TEXT_262 = "+\") VALUES (\"+DynamicUtils.getInsertIntoStmtValuesList(";
  protected final String TEXT_263 = "\t" + NL + "    StringBuffer insertStringBuffer_";
  protected final String TEXT_264 = " = new StringBuffer(insert_";
  protected final String TEXT_265 = ");" + NL + "    insertStringBuffer_";
  protected final String TEXT_266 = ".insert(insert_";
  protected final String TEXT_267 = ".indexOf(\"INSERT\")+ \"INSERT\".length() + 1 , ";
  protected final String TEXT_268 = " + \" \");" + NL + "    insert_";
  protected final String TEXT_269 = " =insertStringBuffer_";
  protected final String TEXT_270 = ".toString(); ";
  ...
  protected final String TEXT_280 = ");" + NL + "                            resourceMap.put(\"pstmt_";
  protected final String TEXT_281 = ");" + NL + "                            GlobalResource.resourceMap.put(keyPsmt_";
  protected final String TEXT_282 = ", pstmt_";
  protected final String TEXT_283 = ");" + NL + "                        }else{" + NL + "                            pstmt_";
  protected final String TEXT_284 = " = (java.sql.PreparedStatement)GlobalResource.resourceMap.get(keyPsmt_";
  ...
  protected final String TEXT_289 = ", \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_290 = "+\" WHERE ";
  protected final String TEXT_291 = "\";";
  protected final String TEXT_292 = " + \" SET \"+DynamicUtils.getUpdateSet(";
  protected final String TEXT_293 = NL + "\t    StringBuffer updateStringBuffer_";
  protected final String TEXT_294 = " = new StringBuffer(update_";
  protected final String TEXT_295 = ");" + NL + "\t    updateStringBuffer_";
  protected final String TEXT_296 = ".insert(update_";
  protected final String TEXT_297 = ".indexOf(\"UPDATE\")+ \"UPDATE\".length() +1 , ";
  protected final String TEXT_298 = "  + \" \");" + NL + "\t    update_";
  protected final String TEXT_299 = " =updateStringBuffer_";
  protected final String TEXT_300 = NL + "                    pstmt_";
  protected final String TEXT_301 = ".prepareStatement(update_";
  protected final String TEXT_302 = ");" + NL + "                    resourceMap.put(\"pstmt_";
  ...
  protected final String TEXT_306 = "    " + NL + "                    pstmtInsert_";
  protected final String TEXT_307 = ");" + NL + "                    resourceMap.put(\"pstmtInsert_";
  protected final String TEXT_308 = "\", pstmtInsert_";
  protected final String TEXT_309 = NL + "                    pstmtUpdate_";
  protected final String TEXT_310 = ");" + NL + "                    resourceMap.put(\"pstmtUpdate_";
  protected final String TEXT_311 = "\", pstmtUpdate_";
  protected final String TEXT_312 = NL + "                    String delete_";
  protected final String TEXT_313 = " = \"DELETE FROM \" + tableName_";
  protected final String TEXT_314 = NL + "    StringBuffer deleteStringBuffer_";
  protected final String TEXT_315 = " = new StringBuffer(delete_";
  protected final String TEXT_316 = ");" + NL + "    deleteStringBuffer_";
  protected final String TEXT_317 = ".insert(delete_";
  protected final String TEXT_318 = ".indexOf(\"DELETE\")+ \"DELETE\".length()+1 , ";
  protected final String TEXT_319 = "  + \" \" );" + NL + "    delete_";
  protected final String TEXT_320 = " =deleteStringBuffer_";
  ...
  protected final String TEXT_324 = NL + "\t\t \tinsertSQLSplits_";
  protected final String TEXT_325 = " = insert_";
  protected final String TEXT_326 = ".split(\"\\\\?\");";
  protected final String TEXT_327 = NL + "\t\t\tupdate_";
  protected final String TEXT_328 = " += \" \";" + NL + "\t    \tupdateSQLSplits_";
  protected final String TEXT_329 = " = update_";
  protected final String TEXT_330 = " += \" \";" + NL + "\t\t\tupdateSQLSplits_";
  protected final String TEXT_331 = ".split(\"\\\\?\");" + NL + "\t\t\tinsertSQLSplits_";
  protected final String TEXT_332 = NL + "\t\t\tdelete_";
  protected final String TEXT_333 = " += \" \";" + NL + "\t\t   \tdeleteSQLSplits_";
  protected final String TEXT_334 = " = delete_";
  protected final String TEXT_335 = NL + "\t\t\treplace_";
  protected final String TEXT_336 = " += \" \";" + NL + "\t\t\treplaceSQLSplits_";
  protected final String TEXT_337 = " = replace_";
  protected final String TEXT_338 = NL + "\t\t\tinsertIgnore_";
  protected final String TEXT_339 = " += \" \";" + NL + "\t\t\tinsertIgnoreSQLSplits_";
  protected final String TEXT_340 = " = insertIgnore_";
  protected final String TEXT_341 = NL + "        }";
  protected final String TEXT_342 = NL + "        query_";
  protected final String TEXT_343 = " = new StringBuffer(\"\");";
  protected final String TEXT_344 = NL + "                commitEvery_";
  protected final String TEXT_345 = " = buffersSize_";
  protected final String TEXT_346 = NL + "            batchSize_";
  protected final String TEXT_347 = NL + "        whetherReject_";
  protected final String TEXT_348 = " = false;";
  protected final String TEXT_349 = NL + "                            // TODO unable to parse integer: ";
  protected final String TEXT_350 = NL + "                            // TODO error: ";
  protected final String TEXT_351 = NL + "                        org.talend.sdi.geometry.Geometry tGeometry_";
  protected final String TEXT_352 = " = (org.talend.sdi.geometry.Geometry)";
  protected final String TEXT_353 = ";" + NL + "                        com.vividsolutions.jts.geom.Geometry geometry_";
  protected final String TEXT_354 = " = tGeometry_";
  protected final String TEXT_355 = "._getInternalGeometry();" + NL + "" + NL + "                        com.vividsolutions.jts.geom.Envelope extends_";
  protected final String TEXT_356 = " = geometryColumnToExtends.get(\"";
  protected final String TEXT_357 = "\");" + NL + "                        if (extends_";
  protected final String TEXT_358 = " == null) {" + NL + "                            geometryColumnToExtends.put(\"";
  protected final String TEXT_359 = "\", geometry_";
  protected final String TEXT_360 = ".getEnvelopeInternal());" + NL + "                        }" + NL + "                        else {" + NL + "                            extends_";
  protected final String TEXT_361 = ".expandToInclude(geometry_";
  protected final String TEXT_362 = ".getEnvelopeInternal());" + NL + "                        }" + NL + "" + NL + "                        String wkt_";
  protected final String TEXT_363 = " = geometry_";
  protected final String TEXT_364 = ".toText();" + NL + "                        oracle.spatial.util.WKT oracle_wkt_";
  protected final String TEXT_365 = " = new oracle.spatial.util.WKT();" + NL + "                        oracle.spatial.geometry.JGeometry jgeometry_";
  protected final String TEXT_366 = " = oracle_wkt_";
  protected final String TEXT_367 = ".toJGeometry(wkt_";
  protected final String TEXT_368 = ".getBytes());" + NL;
  protected final String TEXT_369 = NL + "                            jgeometry_";
  protected final String TEXT_370 = ".setSRID(";
  protected final String TEXT_371 = ".setObject(";
  protected final String TEXT_372 = ", oracle.spatial.geometry.JGeometry.store(jgeometry_";
  protected final String TEXT_373 = ", conn_";
  protected final String TEXT_374 = "));";
  protected final String TEXT_375 = NL + "                        query_";
  protected final String TEXT_376 = NL + "                    routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_377 = ",";
  protected final String TEXT_378 = ", ";
  protected final String TEXT_379 = ",insertSQLSplits_";
  protected final String TEXT_380 = NL + "                \t\tblobTypeUtil_";
  protected final String TEXT_381 = ".adaptBlobFromOtherDB(";
  protected final String TEXT_382 = ",conn_";
  protected final String TEXT_383 = ");" + NL + "                \t";
  protected final String TEXT_384 = NL + "                    DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_392 = NL + "                try {" + NL + "                    nb_line_";
  protected final String TEXT_393 = NL + "                    int processedCount_";
  protected final String TEXT_394 = " = pstmt_";
  protected final String TEXT_395 = ".executeUpdate();" + NL + "                    insertedCount_";
  protected final String TEXT_396 = " += processedCount_";
  protected final String TEXT_397 = ";" + NL + "                    rowsToCommitCount_";
  protected final String TEXT_398 = NL + "                } catch(java.lang.Exception e_";
  protected final String TEXT_399 = ") {" + NL + "globalMap.put(\"";
  protected final String TEXT_400 = "_ERROR_MESSAGE\",e_";
  protected final String TEXT_401 = ".getMessage());" + NL + "                    whetherReject_";
  protected final String TEXT_402 = " = true;";
  ...
  protected final String TEXT_410 = ".errorCode = ((java.sql.SQLException)e_";
  protected final String TEXT_411 = ").getSQLState();";
  protected final String TEXT_412 = ".errorMessage = e_";
  protected final String TEXT_413 = ".getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_414 = NL + "                            System.err.print(e_";
  protected final String TEXT_415 = ".getMessage());";
  protected final String TEXT_416 = NL + "                }";
  protected final String TEXT_417 = NL + "                        routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_418 = ",updateSQLSplits_";
  protected final String TEXT_419 = NL + "                    int count_";
  protected final String TEXT_420 = "=DynamicUtils.writeColumnsToDatabse(";
  ...
  protected final String TEXT_425 = ".executeUpdate();" + NL + "                    updatedCount_";
  protected final String TEXT_426 = NL + "            int checkCount_";
  protected final String TEXT_427 = " = -1;" + NL + "            try (java.sql.ResultSet rs_";
  protected final String TEXT_428 = ".executeQuery()) {" + NL + "                while(rs_";
  protected final String TEXT_429 = ".next()) {" + NL + "                    checkCount_";
  protected final String TEXT_430 = " = rs_";
  protected final String TEXT_431 = ".getInt(1);" + NL + "                }" + NL + "            }" + NL + "            if(checkCount_";
  protected final String TEXT_432 = " > 0) {";
  protected final String TEXT_433 = NL + "                            routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_434 = NL + "\t                \t\tblobTypeUtil_";
  protected final String TEXT_435 = ");" + NL + "\t                \t";
  protected final String TEXT_436 = NL + "                        int count_";
  ...
  protected final String TEXT_441 = " = pstmtUpdate_";
  protected final String TEXT_442 = ";" + NL + "                    nb_line_";
  protected final String TEXT_443 = NL + "                        nb_line_";
  protected final String TEXT_444 = NL + "                }" + NL + "            } else {";
  protected final String TEXT_445 = NL + "                        DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_446 = ", pstmtInsert_";
  protected final String TEXT_447 = " = pstmtInsert_";
  protected final String TEXT_448 = NL + "                }" + NL + "            }";
  protected final String TEXT_449 = NL + "            int updateFlag_";
  protected final String TEXT_450 = " = 0;";
  protected final String TEXT_451 = NL + NL + "            try {" + NL + "                updateFlag_";
  protected final String TEXT_452 = ".executeUpdate();" + NL + "                updatedCount_";
  protected final String TEXT_453 = " = updatedCount_";
  protected final String TEXT_454 = "+updateFlag_";
  protected final String TEXT_455 = ";" + NL + "                rowsToCommitCount_";
  protected final String TEXT_456 = " += updateFlag_";
  protected final String TEXT_457 = ";" + NL + "                if(updateFlag_";
  protected final String TEXT_458 = " == 0) {";
  protected final String TEXT_459 = NL + "                                routines.system.DynamicUtils.debugDynamicSql(query_";
  protected final String TEXT_460 = NL + "\t\t                \t\tblobTypeUtil_";
  protected final String TEXT_461 = ");" + NL + "\t\t                \t";
  protected final String TEXT_462 = NL + "                            DynamicUtils.writeColumnsToDatabse(";
  protected final String TEXT_463 = NL + "                        globalMap.put(\"";
  protected final String TEXT_464 = NL + "                }else{" + NL + "                    nb_line_";
  protected final String TEXT_465 = NL + "                }" + NL + "            } catch(java.lang.Exception e_";
  protected final String TEXT_466 = ".getMessage());" + NL + "                whetherReject_";
  protected final String TEXT_467 = NL + "                    throw(e_";
  protected final String TEXT_468 = NL + "                    nb_line_";
  protected final String TEXT_469 = NL + "                        rejectedCount_";
  protected final String TEXT_470 = NL + "                        System.err.print(e_";
  protected final String TEXT_471 = NL + "            }";
  protected final String TEXT_472 = ".executeUpdate();" + NL + "                    deletedCount_";
  protected final String TEXT_473 = NL + "            if(!whetherReject_";
  protected final String TEXT_474 = ") {";
  protected final String TEXT_475 = NL + "            if (batchSize_";
  protected final String TEXT_476 = " > 0 &&  batchSize_";
  protected final String TEXT_477 = " <= batchSizeCounter_";
  protected final String TEXT_478 = ") {" + NL + "                try {";
  protected final String TEXT_479 = ".executeBatch();";
  protected final String TEXT_480 = NL + "                }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_481 = "){" + NL + "globalMap.put(\"";
  protected final String TEXT_482 = ".getMessage());" + NL + "\t\t\t        java.sql.SQLException ne_";
  protected final String TEXT_483 = " = e_";
  protected final String TEXT_484 = ".getNextException(),sqle_";
  protected final String TEXT_485 = "=null;" + NL + "\t\t\t    \tString errormessage_";
  protected final String TEXT_486 = ";" + NL + "\t\t\t\t\tif (ne_";
  protected final String TEXT_487 = " != null) {" + NL + "\t\t\t\t\t\t// build new exception to provide the original cause" + NL + "\t\t\t\t\t\tsqle_";
  protected final String TEXT_488 = " = new java.sql.SQLException(e_";
  protected final String TEXT_489 = ".getMessage() + \"\\ncaused by: \" + ne_";
  protected final String TEXT_490 = ".getMessage(), ne_";
  protected final String TEXT_491 = ".getSQLState(), ne_";
  protected final String TEXT_492 = ".getErrorCode(), ne_";
  protected final String TEXT_493 = ");" + NL + "\t\t\t\t\t\terrormessage_";
  protected final String TEXT_494 = " = sqle_";
  protected final String TEXT_495 = ".getMessage();" + NL + "\t\t\t\t\t}else{" + NL + "\t\t\t\t\t\terrormessage_";
  protected final String TEXT_496 = ".getMessage();" + NL + "\t\t\t\t\t}" + NL + "\t            \t";
  protected final String TEXT_497 = NL + "\t\t\t    \t\tif (ne_";
  protected final String TEXT_498 = " != null) {" + NL + "\t\t\t    \t\t\tthrow(sqle_";
  protected final String TEXT_499 = ");" + NL + "\t\t\t    \t\t}else{" + NL + "\t\t\t            \tthrow(e_";
  protected final String TEXT_500 = ");" + NL + "\t\t\t            }" + NL + "\t            \t";
  protected final String TEXT_501 = NL + "\t                \tSystem.err.println(errormessage_";
  protected final String TEXT_502 = ");" + NL + "\t            \t";
  protected final String TEXT_503 = NL + "\t        \t}" + NL + "                tmp_batchUpdateCount_";
  protected final String TEXT_504 = ".getUpdateCount();";
  protected final String TEXT_505 = NL + "                    insertedCount_";
  protected final String TEXT_506 = NL + "                    updatedCount_";
  protected final String TEXT_507 = NL + "                    deletedCount_";
  protected final String TEXT_508 = NL + "                += (tmp_batchUpdateCount_";
  protected final String TEXT_509 = "!=-1?tmp_batchUpdateCount_";
  protected final String TEXT_510 = ":0);" + NL + "                rowsToCommitCount_";
  protected final String TEXT_511 = " += (tmp_batchUpdateCount_";
  protected final String TEXT_512 = ":0);" + NL + "                batchSizeCounter_";
  protected final String TEXT_513 = " = 0;" + NL + "            }";
  protected final String TEXT_514 = NL + "                commitCounter_";
  protected final String TEXT_515 = "++;" + NL + "                if(commitEvery_";
  protected final String TEXT_516 = " <= commitCounter_";
  protected final String TEXT_517 = NL + "                    if(batchSizeCounter_";
  protected final String TEXT_518 = " > 0) {" + NL + "                        try {";
  protected final String TEXT_519 = NL + "                            pstmt_";
  protected final String TEXT_520 = NL + "                        }catch (java.sql.BatchUpdateException e_";
  protected final String TEXT_521 = ".getMessage());" + NL + "\t\t\t\t\t        java.sql.SQLException ne_";
  protected final String TEXT_522 = "=null;" + NL + "\t\t\t\t\t    \tString errormessage_";
  protected final String TEXT_523 = ";" + NL + "\t\t\t\t\t\t\tif (ne_";
  protected final String TEXT_524 = " != null) {" + NL + "\t\t\t\t\t\t\t\t// build new exception to provide the original cause" + NL + "\t\t\t\t\t\t\t\tsqle_";
  protected final String TEXT_525 = ");" + NL + "\t\t\t\t\t\t\t\terrormessage_";
  ...
  protected final String TEXT_532 = NL + "\t\t\t                \tSystem.err.println(errormessage_";
  protected final String TEXT_533 = ");" + NL + "\t\t\t            \t";
  protected final String TEXT_534 = NL + "\t\t\t        \t}" + NL + "                        tmp_batchUpdateCount_";
  protected final String TEXT_535 = NL + "                            insertedCount_";
  protected final String TEXT_536 = NL + "                            updatedCount_";
  protected final String TEXT_537 = NL + "                            deletedCount_";
  protected final String TEXT_538 = NL + "                        += (tmp_batchUpdateCount_";
  protected final String TEXT_539 = ":0);" + NL + "                        rowsToCommitCount_";
  protected final String TEXT_540 = ":0);" + NL + "                    }";
  protected final String TEXT_541 = NL + "                    if(rowsToCommitCount_";
  protected final String TEXT_542 = " != 0){" + NL + "                    \t";
  protected final String TEXT_543 = NL + "                    }" + NL + "                    conn_";
  protected final String TEXT_544 = ".commit();" + NL + "                    if(rowsToCommitCount_";
  protected final String TEXT_545 = NL + "                    \trowsToCommitCount_";
  protected final String TEXT_546 = " = 0;" + NL + "                    }" + NL + "                    commitCounter_";
  protected final String TEXT_547 = "=0;";
  protected final String TEXT_548 = NL + "                    \tbatchSizeCounter_";
