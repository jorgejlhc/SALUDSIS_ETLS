...
public class TFileOutputExcelMainJava
{
  ...
  protected final String TEXT_148 = NL + "\t    \t\t\t\t} else {" + NL + "\t    \t\t\t\t\txlsxTool_";
  protected final String TEXT_149 = ".addCellNullValue();" + NL + "\t    \t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_150 = NL + "\t\t\t\t\tbufferCount_";
  protected final String TEXT_151 = "++;" + NL + "\t\t\t\t\tif(bufferCount_";
  protected final String TEXT_152 = " >= flushRowNum_";
  protected final String TEXT_153 = "){" + NL + "    \t\t\t\t\txlsxTool_";
  protected final String TEXT_154 = ".flushRowInMemory();" + NL + "    \t\t\t\t\tbufferCount_";
