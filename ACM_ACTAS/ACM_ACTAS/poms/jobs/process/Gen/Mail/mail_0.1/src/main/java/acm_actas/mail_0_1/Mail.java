...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_ACM_ACTAS_Mail = new byte[0];
    static byte[] commonByteArray_ACM_ACTAS_Mail = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ACM_ACTAS_Mail.length) {
				if(length < 1024 && commonByteArray_ACM_ACTAS_Mail.length == 0) {
   					commonByteArray_ACM_ACTAS_Mail = new byte[1024];
				} else {
   					commonByteArray_ACM_ACTAS_Mail = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ACM_ACTAS_Mail, 0, length);
			strReturn = new String(commonByteArray_ACM_ACTAS_Mail, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_ACM_ACTAS_Mail, 0, length);
			strReturn = new String(commonByteArray_ACM_ACTAS_Mail, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ACM_ACTAS_Mail) {
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Mail.class.getClassLoader().getResourceAsStream("acm_actas/mail_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     123088 characters generated by Talend Open Studio for ESB 
 *     on the November 1, 2024, 1:05:55 AM COT
 ************************************************************************************************/