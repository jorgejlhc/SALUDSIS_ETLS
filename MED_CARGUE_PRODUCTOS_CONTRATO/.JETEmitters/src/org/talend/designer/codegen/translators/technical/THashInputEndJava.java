...
public class THashInputEndJava
{
  ...
  protected final String TEXT_8 = "\t" + NL + "    \t\tmf_";
  protected final String TEXT_9 = ".clearCache(\"tHashFile_";
  protected final String TEXT_10 = "_\" + pid +\"_";
  protected final String TEXT_11 = "\");" + NL + "    \t";
  protected final String TEXT_12 = NL + "\t\torg.talend.designer.components.hashfile.common.MapHashFile.resourceLockMap.remove(\"tHashFile_";
