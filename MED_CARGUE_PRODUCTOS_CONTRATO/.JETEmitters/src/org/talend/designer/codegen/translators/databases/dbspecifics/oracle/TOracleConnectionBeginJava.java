...
public class TOracleConnectionBeginJava
{
  ...
  protected final String TEXT_148 = NL + "        \t\t\tjava.util.Properties properties_";
  protected final String TEXT_149 = " = new java.util.Properties();" + NL + "                                                        properties_";
  protected final String TEXT_150 = ".setProperty(\"user\",dbUser_";
  protected final String TEXT_151 = NL + "                                                        if (dbPwd_";
  protected final String TEXT_152 = " != null) {" + NL + "                                                            properties_";
  protected final String TEXT_153 = ".setProperty(\"password\",dbPwd_";
  protected final String TEXT_154 = ");" + NL + "                                                        }";
  protected final String TEXT_155 = NL + "                                                        properties_";
  protected final String TEXT_156 = ".setProperty(";
  protected final String TEXT_157 = ",";
  protected final String TEXT_158 = NL + NL + "                                    \tconn_";
  protected final String TEXT_159 = ",properties_";
  protected final String TEXT_160 = ");" + NL + "        \t\t\t";
  protected final String TEXT_161 = ".rollback();" + NL + "\t\t\t";
  protected final String TEXT_162 = ".commit();" + NL + "\t\t\t";
  protected final String TEXT_163 = ".close();" + NL + "\t\t\t";
  protected final String TEXT_164 = NL + "\t\t\tif(\"com.mysql.cj.jdbc.Driver\".equals((String)globalMap.get(\"driverClass_";
  protected final String TEXT_165 = "\"))" + NL + "\t\t\t    && routines.system.BundleUtils.inOSGi()) {" + NL + "\t\t\t        Class.forName(\"com.mysql.cj.jdbc.AbandonedConnectionCleanupThread\")." + NL + "\t\t\t            getMethod(\"checkedShutdown\").invoke(null, (Object[]) null);" + NL + "\t\t\t}" + NL + "\t\t\t";
  ...
  protected final String TEXT_174 = ".executeBatch();" + NL + "\t\t\t";
  protected final String TEXT_175 = NL + "\t\t\t\tint countSum_";
  protected final String TEXT_176 = " = 0;" + NL + "\t\t\t\tfor(int countEach_";
  ...
  protected final String TEXT_180 = " < 0 ? 0 : ";
  protected final String TEXT_181 = ");" + NL + "\t\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_182 = NL + "\t";
  protected final String TEXT_183 = NL + "\tjava.util.Map<String, routines.system.TalendDataSource> dataSources_";
  protected final String TEXT_184 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap.get(KEY_DB_DATASOURCES);" + NL + "\tboolean inOSGi = routines.system.BundleUtils.inOSGi();" + NL + "\tif (!(inOSGi && dataSources_";
  protected final String TEXT_185 = " != null && ";
  protected final String TEXT_186 = ".replaceAll(\"\\\\s+\",\"\").length() > 0)) {";
  protected final String TEXT_187 = NL + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_188 = NL + "\t} else {" + NL + "\t\tString dsAlias_";
  protected final String TEXT_189 = ";" + NL + "\t\tif (dataSources_";
  protected final String TEXT_190 = ".get(dsAlias_";
  protected final String TEXT_191 = ") == null) {" + NL + "   \t\t\tthrow new Exception(\"No DataSource with alias: \" + dsAlias_";
  protected final String TEXT_192 = " + \" available!\");" + NL + "      \t}" + NL + "\t\tconn_";
  protected final String TEXT_193 = " = dataSources_";
  protected final String TEXT_194 = ").getConnection();" + NL + "\t\tglobalMap.put(\"conn_";
  protected final String TEXT_195 = ");" + NL + "\t}";
  protected final String TEXT_196 = NL + "\tif (null != conn_";
  protected final String TEXT_197 = ") {" + NL + "\t\t";
  protected final String TEXT_198 = NL + "\t}";
  protected final String TEXT_199 = NL;
  protected final String TEXT_200 = NL + "  \tglobalMap.put(\"dbschema_\" + \"";
  protected final String TEXT_201 = "\",conn_";
  protected final String TEXT_202 = ".getMetaData().getUserName());";
  protected final String TEXT_203 = NL + "\tglobalMap.put(\"dbschema_\" + \"";
