...
package med_cargar_anexo_tecnico.servicecargaranexotecnico_0_2;
...
/**
 * Job: ServiceCargarAnexoTecnico Purpose: <br>
 * Description:  <br>
 * @author jorgejlhc@gmail.com
 * @version 8.8.8.20240722_1936-SNAPSHOT
 * @status 
 */
public class ServiceCargarAnexoTecnico implements TalendJob {
...
public String getResult(){
	...
	private final String jobName = "ServiceCargarAnexoTecnico";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ServiceCargarAnexoTecnico.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ServiceCargarAnexoTecnico.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class RestServiceProviderImpl4TalendJob {
	...
	private final ServiceCargarAnexoTecnico job;

	public RestServiceProviderImpl4TalendJob(ServiceCargarAnexoTecnico job) {
		this.job = job;
	}

	private void populateRequestWithJobContext(java.util.Map<String, Object> requestGlobalMap, ServiceCargarAnexoTecnico job) {
...
class Thread4RestServiceProviderEndpoint extends Thread {
	...
	public Thread4RestServiceProviderEndpoint(ServiceCargarAnexoTecnico job, String endpointUrl) {
		this.job = job;
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression, String jobName)
			...
			java.io.InputStream inContext = ServiceCargarAnexoTecnico.class.getClassLoader()
					.getResourceAsStream("med_cargar_anexo_tecnico/servicecargaranexotecnico_0_2/contexts/" + currentContext  + ".properties");
			if (inContext == null) {
				inContext = ServiceCargarAnexoTecnico.class.getClassLoader()
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_MED_CARGAR_ANEXO_TECNICO_ServiceCargarAnexoTecnico = new byte[0];
    static byte[] commonByteArray_MED_CARGAR_ANEXO_TECNICO_ServiceCargarAnexoTecnico = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_MED_CARGAR_ANEXO_TECNICO_ServiceCargarAnexoTecnico) {
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_MED_CARGAR_ANEXO_TECNICO_ServiceCargarAnexoTecnico.length) {
				if(length < 1024 && commonByteArray_MED_CARGAR_ANEXO_TECNICO_ServiceCargarAnexoTecnico.length == 0) {
   					commonByteArray_MED_CARGAR_ANEXO_TECNICO_ServiceCargarAnexoTecnico = new byte[1024];
				} else {
   					commonByteArray_MED_CARGAR_ANEXO_TECNICO_ServiceCargarAnexoTecnico = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_MED_CARGAR_ANEXO_TECNICO_ServiceCargarAnexoTecnico, 0, length);
			strReturn = new String(commonByteArray_MED_CARGAR_ANEXO_TECNICO_ServiceCargarAnexoTecnico, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_MED_CARGAR_ANEXO_TECNICO_ServiceCargarAnexoTecnico, 0, length);
			strReturn = new String(commonByteArray_MED_CARGAR_ANEXO_TECNICO_ServiceCargarAnexoTecnico, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
if (needRoot) {
	needRoot=false;
		...
		valueMap.put("root_1","Proceso de cargar anexo técnico ejecuctado satisfactoriamente");
...
if (needRoot) {
	needRoot=false;
		...
		org.dom4j.Element root_1 = null;
				root_1 = root.addElement("Message");
		valueMap.put("root_1","Error de ejecución del proceso de Cargar anexo técnico");
		if(valueMap.get("root_1")!=null) {
			routines.system.NestXMLTool.setText(root_1,FormatterUtils.fm(valueMap.get("root_1"),null));
		}
		org.dom4j.Element root_2 = null;
...
public static class RequestOKStruct implements routines.system.IPersistableRow<RequestOKStruct> {
    ...
    static byte[] commonByteArray_MED_CARGAR_ANEXO_TECNICO_ServiceCargarAnexoTecnico = new byte[0];
			    ...
			    public String carga_id;

				public String getCarga_id () {
					return this.carga_id;
				}

				public Boolean carga_idIsNullable(){
				    return true;
				}
				public Boolean carga_idIsKey(){
				    return false;
				}
				public Integer carga_idLength(){
				    return null;
				}
				public Integer carga_idPrecision(){
				    return null;
				}
				public String carga_idDefault(){
				
					return null;
				
				}
				public String carga_idComment(){
				
				    return "";
				
				}
				public String carga_idPattern(){
				
					return "";
				
				}
				public String carga_idOriginalDbColumnName(){
				...
				public Boolean numeroContratoIsNullable(){
				    return true;
				}
				public Boolean numeroContratoIsKey(){
				    return false;
				}
				public Integer numeroContratoLength(){
				    return null;
				}
				public Integer numeroContratoPrecision(){
				    return null;
				}
				public String numeroContratoDefault(){
				
					return null;
				
				}
				public String numeroContratoComment(){
				
				    return "";
				
				}
				public String numeroContratoPattern(){
				
					return "";
				
				}
				public String numeroContratoOriginalDbColumnName(){
		...
		synchronized(commonByteArrayLock_MED_CARGAR_ANEXO_TECNICO_ServiceCargarAnexoTecnico) {
        	...
        	try {
        		...
        		int length = 0;
					...
					this.carga_id = readString(dis);
					
					this.numeroContrato = readString(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// String
						...
						writeString(this.carga_id,dos);
					
					// String
				
						writeString(this.numeroContrato,dos);
    ...
    public String toString() {
		...
		sb.append(super.toString());
		sb.append("[");
		sb.append("carga_id="+carga_id);
		sb.append(",numeroContrato="+numeroContrato);
...
RequestERRORStruct RequestERROR = new RequestERRORStruct();
	...
	currentComponent="tRESTRequest_1_Loop";
		...
		int tos_count_tRESTRequest_1_Loop = 0;
						...
						if(execStat){
							runStat.updateStatOnConnection(iterateId,0,0,"row3","ErrorCall","in","RequestOK","row2","row5","RequestERROR");
						}
...
if (needRoot) {
	needRoot=false;
		...
		org.dom4j.Element root_1 = null;
				root_1 = root.addElement("Message");
		valueMap.put("root_1","Error en el llamado del ETL de Cargar anexo técnico");
		if(valueMap.get("root_1")!=null) {
			routines.system.NestXMLTool.setText(root_1,FormatterUtils.fm(valueMap.get("root_1"),null));
		}
		org.dom4j.Element root_2 = null;
...
if (needRoot) {
	needRoot=false;
		...
		org.dom4j.Element root_1 = null;
				root_1 = root.addElement("Message");
		valueMap.put("root_1",treeNodeAPI.get_String("in.body:/root/carga_id") == null ? "El identificador de la carga no puede ser nulo" : 
treeNodeAPI.get_String("in.body:/root/numeroContrato") == null ? "El identificador del número de contrato no puede ser nulo" : 
treeNodeAPI.get_String("in.body:/root/userId") == null ? "El identificador del número de usuario no puede ser nulo" : "" );
		if(valueMap.get("root_1")!=null) {
			routines.system.NestXMLTool.setText(root_1, FormatterUtils.fm(valueMap.get("root_1"),null));
		}
		org.dom4j.Element root_2 = null;
...
if(in != null) { 
	...
	boolean isMatchDocRowtXMLMap_4_TXMLMAP_OUT = false;
				...
				absolutePathMappings_tXMLMap_4_TXMLMAP_OUT[0] = "in.body:/root/numeroContrato";
				relativePathMappings_tXMLMap_4_TXMLMAP_OUT[0] = "numeroContrato";
				
				absolutePathMappings_tXMLMap_4_TXMLMAP_OUT[1] = "in.body:/root/carga_id";
				relativePathMappings_tXMLMap_4_TXMLMAP_OUT[1] = "carga_id";
				
				absolutePathMappings_tXMLMap_4_TXMLMAP_OUT[2] = "in.body:/root/userId";
				relativePathMappings_tXMLMap_4_TXMLMAP_OUT[2] = "userId";
...
treeNodeAPI_tXMLMap_4_TXMLMAP_OUT.get_String("in.body:/root/carga_id") != null && treeNodeAPI_tXMLMap_4_TXMLMAP_OUT.get_String("in.body:/root/numeroContrato") != null && treeNodeAPI_tXMLMap_4_TXMLMAP_OUT.get_String("in.body:/root/userId") != null

 ) {

RequestOK_tmp = new RequestOKStruct();
RequestOK_tmp.carga_id = treeNodeAPI_tXMLMap_4_TXMLMAP_OUT.get_String("in.body:/root/carga_id");
RequestOK_tmp.numeroContrato = treeNodeAPI_tXMLMap_4_TXMLMAP_OUT.get_String("in.body:/root/numeroContrato");
RequestOK_tmp.userId = treeNodeAPI_tXMLMap_4_TXMLMAP_OUT.get_String("in.body:/root/userId");allOutsForAggregate_tXMLMap_4.add(RequestOK_tmp);
...
context.carga_id = new BigDecimal(RequestOK.carga_id);
context.numeroContrato = RequestOK.numeroContrato;
context.userId = RequestOK.userId;
 ...
 */
	...
	java.util.Map<String, Object> parentContextMap_tRunJob_1 = new java.util.HashMap<String, Object>();
		...
		context.synchronizeContext();
            class ContextProcessor_tRunJob_1 {
                    ...
                    parentContextMap_tRunJob_1.put("carga_id", context.carga_id);
                    paraList_tRunJob_1.add("--context_type " + "carga_id" + "=" + "id_BigDecimal");
                    parentContextMap_tRunJob_1.put("numeroContrato", context.numeroContrato);
                    paraList_tRunJob_1.add("--context_type " + "numeroContrato" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("userId", context.userId);
                    paraList_tRunJob_1.add("--context_type " + "userId" + "=" + "id_String");
                    parentContextMap_tRunJob_1.put("Result", context.Result);
                    paraList_tRunJob_1.add("--context_type " + "Result" + "=" + "id_String");
                        }
	...
	Object obj_tRunJob_1 = null;
		...
		obj_tRunJob_1 = context.carga_id;
		if(obj_tRunJob_1!=null) {
			if (obj_tRunJob_1.getClass().getName().equals("java.util.Date")) {
				paraList_tRunJob_1.add("--context_param carga_id=" + ((java.util.Date) obj_tRunJob_1).getTime());
			} else {
				
					paraList_tRunJob_1.add("--context_param carga_id=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
					
				
			}
		} else {
			paraList_tRunJob_1.add("--context_param carga_id=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_1.put("carga_id", obj_tRunJob_1);
	
		obj_tRunJob_1 = context.numeroContrato;
		if(obj_tRunJob_1!=null) {
			if (obj_tRunJob_1.getClass().getName().equals("java.util.Date")) {
				paraList_tRunJob_1.add("--context_param numeroContrato=" + ((java.util.Date) obj_tRunJob_1).getTime());
			} else {
				
					paraList_tRunJob_1.add("--context_param numeroContrato=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
					
				
			}
		} else {
			paraList_tRunJob_1.add("--context_param numeroContrato=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_1.put("numeroContrato", obj_tRunJob_1);
	
		obj_tRunJob_1 = context.userId;
		if(obj_tRunJob_1!=null) {
			if (obj_tRunJob_1.getClass().getName().equals("java.util.Date")) {
				paraList_tRunJob_1.add("--context_param userId=" + ((java.util.Date) obj_tRunJob_1).getTime());
			} else {
				
					paraList_tRunJob_1.add("--context_param userId=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
					
				
			}
		} else {
			paraList_tRunJob_1.add("--context_param userId=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_1.put("userId", obj_tRunJob_1);
	
	
		med_cargar_anexo_tecnico.cargaanexotecnico_1_19.CargaAnexoTecnico childJob_tRunJob_1 = new med_cargar_anexo_tecnico.cargaanexotecnico_1_19.CargaAnexoTecnico();
	    // pass DataSources
		...
		String[][] childReturn_tRunJob_1 = childJob_tRunJob_1.runJob((String[]) paraList_tRunJob_1.toArray(new String[paraList_tRunJob_1.size()]));
			...
			for (String[] item_tRunJob_1 : childReturn_tRunJob_1) { 
				if(childJob_tRunJob_1.hastBufferOutputComponent() || false){
			    			
						if(0 < item_tRunJob_1.length){				
			           		
				           		row5.Result = item_tRunJob_1[0];
 ...
 */
	...
	globalMap.put("tRESTRequest_1_NB_LINE", nb_line_tRESTRequest_1);
				...
				if(execStat){
					runStat.updateStatOnConnection(iterateId,2,0,"row3","ErrorCall","in","RequestOK","row2","row5","RequestERROR");
				}
 ...
 */
    ...
    public static void main(String[] args){
        final ServiceCargarAnexoTecnico ServiceCargarAnexoTecnicoClass = new ServiceCargarAnexoTecnico();

        int exitCode = ServiceCargarAnexoTecnicoClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ServiceCargarAnexoTecnico.class.getClassLoader().getResourceAsStream("med_cargar_anexo_tecnico/servicecargaranexotecnico_0_2/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = ServiceCargarAnexoTecnico.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ServiceCargarAnexoTecnico");
        }
...
/************************************************************************************************
 *     228805 characters generated by Talend Open Studio for ESB 
 *     on the October 28, 2024, 2:44:00 PM COT
 ************************************************************************************************/