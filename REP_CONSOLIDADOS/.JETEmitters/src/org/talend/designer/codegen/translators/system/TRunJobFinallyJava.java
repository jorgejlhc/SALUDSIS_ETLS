...
public class TRunJobFinallyJava
{
  protected static String nl;
  public static synchronized TRunJobFinallyJava create(String lineSeparator)
  {
    nl = lineSeparator;
    TRunJobFinallyJava result = new TRunJobFinallyJava();
    nl = null;
    return result;
  }
  ...
  protected final String TEXT_21 = NL + NL + "if(resourceMap.get(\"context_writer_";
  protected final String TEXT_22 = "\") != null){ " + NL + "    ((org.talend.components.lib.ContextWriter)resourceMap.get(\"context_writer_";
  protected final String TEXT_23 = "\")).clean();" + NL + "}" + NL;
