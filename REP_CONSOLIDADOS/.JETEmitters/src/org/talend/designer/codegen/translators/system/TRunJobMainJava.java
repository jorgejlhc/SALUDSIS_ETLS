...
public class TRunJobMainJava
{
  ...
  protected final String TEXT_22 = ".toLowerCase(java.util.Locale.US).startsWith(\"win\")){" + NL + "\t\t\t\t";
  ...
  protected final String TEXT_123 = NL + "\t\t\t\tif( parametersToEncrypt_";
  protected final String TEXT_124 = " .contains(key_";
  protected final String TEXT_125 = ")) {" + NL + "\t\t\t\t\tparaList_";
  protected final String TEXT_126 = ".add(\"--context_param \" + key_";
  protected final String TEXT_127 = " + \"=\" + routines.system.PasswordEncryptUtil.encryptPassword(String.valueOf(value_";
  protected final String TEXT_128 = ")));" + NL + "\t\t\t\t}else {" + NL + "\t\t\t\t";
  protected final String TEXT_129 = NL + "\t\t\t\t\tparaList_";
  protected final String TEXT_130 = " + \"=\" + value_";
  protected final String TEXT_131 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_132 = " } ";
  protected final String TEXT_133 = NL + "\t\t\t} else {" + NL + "\t\t\t\tparaList_";
  ...
  protected final String TEXT_137 = " != null) {" + NL + "\t\t\t\tparaListForLog_";
  protected final String TEXT_138 = ")));" + NL + "\t\t\t} else {" + NL + "\t\t\t\tparaListForLog_";
  protected final String TEXT_139 = ");" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_140 = NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_141 = NL + NL + "\tObject obj_";
  protected final String TEXT_142 = " = null;" + NL + "" + NL + "\t";
  protected final String TEXT_143 = NL + "\t\tobj_";
  protected final String TEXT_144 = ";" + NL + "\t\tif(obj_";
  protected final String TEXT_145 = "!=null) {" + NL + "\t\t\tif (obj_";
  protected final String TEXT_146 = ".getClass().getName().equals(\"java.util.Date\")) {" + NL + "\t\t\t\tparaList_";
  protected final String TEXT_147 = ".add(\"--context_param ";
  protected final String TEXT_148 = "=\" + ((java.util.Date) obj_";
  protected final String TEXT_149 = ").getTime());" + NL + "\t\t\t} else {" + NL + "\t\t\t\t";
  protected final String TEXT_150 = " .contains(\"";
  protected final String TEXT_151 = "\")) {" + NL + "\t\t\t\t\tparaList_";
  protected final String TEXT_152 = "=\" + routines.system.PasswordEncryptUtil.encryptPassword(String.valueOf(RuntimeUtils.tRunJobConvertContext(obj_";
  protected final String TEXT_153 = "))));" + NL + "\t\t\t\t}else {" + NL + "\t\t\t\t";
  protected final String TEXT_154 = "=\" + RuntimeUtils.tRunJobConvertContext(obj_";
  protected final String TEXT_155 = "));" + NL + "\t\t\t\t\t";
  protected final String TEXT_156 = NL + "\t\t\t\t" + NL + "\t\t\t}" + NL + "\t\t} else {" + NL + "\t\t\tparaList_";
  protected final String TEXT_157 = "=\" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_158 = NL + "\t\tif(parametersToEncrypt_";
  protected final String TEXT_159 = "\") && obj_";
  protected final String TEXT_160 = " != null) {" + NL + "\t\t\tparaListForLog_";
  protected final String TEXT_161 = "))));" + NL + "\t\t} else {" + NL + "\t\t\tparaListForLog_";
  protected final String TEXT_162 = "));" + NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_163 = NL + "\t\tparentContextMap_";
  protected final String TEXT_164 = "\", obj_";
  protected final String TEXT_165 = ");" + NL + "\t";
  protected final String TEXT_166 = NL + "\t";
  protected final String TEXT_167 = NL + "\t\tSystem.out.println(\"";
  protected final String TEXT_168 = " in ";
  protected final String TEXT_169 = " call ";
  protected final String TEXT_170 = "\"+";
  protected final String TEXT_171 = "+\"";
  protected final String TEXT_172 = " with:\\n\\n\" + paraListForLog_";
  protected final String TEXT_173 = " + \"\\n\");" + NL + "\t";
  protected final String TEXT_174 = " childJob_";
  protected final String TEXT_175 = " = new ";
  protected final String TEXT_176 = NL + "        if (childJob_";
  protected final String TEXT_177 = " instanceof routines.system.api.TalendESBJob) {" + NL + "            ((routines.system.api.TalendESBJob)childJob_";
  protected final String TEXT_178 = ").setEndpointRegistry(registry);" + NL + "        }" + NL;
  protected final String TEXT_179 = NL + "\t    // pass DataSources" + NL + "\t    java.util.Map<String, routines.system.TalendDataSource> talendDataSources_";
  protected final String TEXT_180 = " = (java.util.Map<String, routines.system.TalendDataSource>) globalMap" + NL + "\t            .get(KEY_DB_DATASOURCES);" + NL + "\t    if (null != talendDataSources_";
  protected final String TEXT_181 = ") {" + NL + "\t        java.util.Map<String, javax.sql.DataSource> dataSources_";
  protected final String TEXT_182 = " = new java.util.HashMap<String, javax.sql.DataSource>();" + NL + "\t        for (java.util.Map.Entry<String, routines.system.TalendDataSource> talendDataSourceEntry_";
  protected final String TEXT_183 = " : talendDataSources_";
  protected final String TEXT_184 = NL + "\t\t\t        .entrySet()) {" + NL + "\t            dataSources_";
  protected final String TEXT_185 = ".put(talendDataSourceEntry_";
  protected final String TEXT_186 = ".getKey()," + NL + "\t                    talendDataSourceEntry_";
  protected final String TEXT_187 = ".getValue().getRawDataSource());" + NL + "\t        }" + NL + "\t        childJob_";
  protected final String TEXT_188 = ".setDataSources(dataSources_";
  protected final String TEXT_189 = ");" + NL + "\t    }" + NL + "\t\t";
  protected final String TEXT_190 = "  " + NL + "\t\t\tchildJob_";
  protected final String TEXT_191 = ".parentContextMap = parentContextMap_";
  protected final String TEXT_192 = ";" + NL + "\t\t";
  protected final String TEXT_193 = "  " + NL + "\t\t";
  protected final String TEXT_194 = NL + "\t\t\tlog.info(\"";
  protected final String TEXT_195 = " - The child job '";
  protected final String TEXT_196 = "' starts on the version '";
  protected final String TEXT_197 = "' with the context '";
  protected final String TEXT_198 = "'.\");" + NL + "\t\t";
  protected final String TEXT_199 = NL + "\t\tString[][] childReturn_";
  protected final String TEXT_200 = " = childJob_";
  protected final String TEXT_201 = ".runJob((String[]) paraList_";
  protected final String TEXT_202 = ".toArray(new String[paraList_";
  protected final String TEXT_203 = ".size()]));" + NL + "\t\t";
  protected final String TEXT_204 = "' is done.\");" + NL + "\t\t";
  protected final String TEXT_205 = NL + "            if(childJob_";
  protected final String TEXT_206 = ".getErrorCode() == null){" + NL + "                globalMap.put(\"";
  protected final String TEXT_207 = "_CHILD_RETURN_CODE\", childJob_";
  protected final String TEXT_208 = ".getStatus() != null && (\"failure\").equals(childJob_";
  protected final String TEXT_209 = ".getStatus()) ? 1 : 0);" + NL + "            }else{" + NL + "                globalMap.put(\"";
  protected final String TEXT_210 = ".getErrorCode());" + NL + "            }" + NL + "            if (childJob_";
  protected final String TEXT_211 = ".getExceptionStackTrace() != null) {" + NL + "                globalMap.put(\"";
  protected final String TEXT_212 = "_CHILD_EXCEPTION_STACKTRACE\", childJob_";
  protected final String TEXT_213 = ".getExceptionStackTrace());" + NL + "            }";
  protected final String TEXT_214 = NL + "                    ((java.util.Map)threadLocal.get()).put(\"errorCode\", childJob_";
  protected final String TEXT_215 = ".getErrorCode());";
  protected final String TEXT_216 = NL + "                    errorCode = childJob_";
  protected final String TEXT_217 = ".getErrorCode();";
  protected final String TEXT_218 = NL + "                if (childJob_";
  protected final String TEXT_219 = ".getErrorCode() != null || (\"failure\").equals(childJob_";
  protected final String TEXT_220 = ".getStatus())) {" + NL + "                    java.lang.Exception ce_";
  protected final String TEXT_221 = ".getException();" + NL + "                    throw new RuntimeException(\"Child job running failed.\\n\" + ((ce_";
  protected final String TEXT_222 = "!=null) ? (ce_";
  protected final String TEXT_223 = ".getClass().getName() + \": \" + ce_";
  protected final String TEXT_224 = ".getMessage()) : \"\"));" + NL + "                }";
  protected final String TEXT_225 = NL + "\t\t\tfor (String[] item_";
  protected final String TEXT_226 = " : childReturn_";
  protected final String TEXT_227 = ") { " + NL + "\t\t\t\tif(childJob_";
  protected final String TEXT_228 = ".hastBufferOutputComponent() || ";
  ...
  protected final String TEXT_237 = " = ParserUtils.parseTo_Date(item_";
  protected final String TEXT_238 = "], ";
  protected final String TEXT_239 = ");" + NL + "\t\t\t           \t\t";
  protected final String TEXT_240 = "\t\t\t\t\t\t\t" + NL + "\t\t\t           \t\t\t";
  protected final String TEXT_241 = "].getBytes();" + NL + "\t\t\t           \t\t";
  protected final String TEXT_242 = NL + "\t\t\t           \t\t\t";
  protected final String TEXT_243 = " = ParserUtils.parseTo_";
  protected final String TEXT_244 = "(item_";
  ...
  protected final String TEXT_259 = NL + "\t\t\t\t\t\t\t\t\tioe.printStackTrace();" + NL + "\t\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t};" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\tConsoleHelper_";
  protected final String TEXT_260 = " consoleHelper_";
  protected final String TEXT_261 = " = new ConsoleHelper_";
  protected final String TEXT_262 = "();" + NL + "" + NL + "\t\tRuntime runtime_";
  protected final String TEXT_263 = " = Runtime.getRuntime();" + NL + "\t\tProcess ps_";
  protected final String TEXT_264 = " = null;" + NL + "\t\t";
  protected final String TEXT_265 = NL + "\t\t//Write contexts to tmp file" + NL + "\t\torg.talend.components.lib.ContextWriter writer_";
  protected final String TEXT_266 = " = new org.talend.components.lib.ContextWriter(pid);" + NL + "\t\twriter_";
  protected final String TEXT_267 = ".write2File(paraList_";
  protected final String TEXT_268 = ");" + NL + "\t\tresourceMap.put(\"context_writer_";
  protected final String TEXT_269 = "\",writer_";
  protected final String TEXT_270 = ");";
  protected final String TEXT_271 = NL + "\t\t//0 indicates normal termination" + NL + "        int result_";
  protected final String TEXT_272 = ";" + NL + "        StringBuffer errorMsg_";
  protected final String TEXT_273 = " = new StringBuffer();" + NL + "        try {" + NL + "            ps_";
  protected final String TEXT_274 = " = runtime_";
  protected final String TEXT_275 = ".exec((String[])paraList_";
  protected final String TEXT_276 = ".size()]));" + NL + "" + NL + "            Thread normal_";
  protected final String TEXT_277 = " = consoleHelper_";
  protected final String TEXT_278 = ".getNormalThread(ps_";
  protected final String TEXT_279 = NL + "                log.info(\"";
  protected final String TEXT_280 = "'.\");";
  protected final String TEXT_281 = NL + "            normal_";
  protected final String TEXT_282 = ".start();";
  protected final String TEXT_283 = "' is done.\");";
  protected final String TEXT_284 = NL + NL + "            Thread error_";
  protected final String TEXT_285 = ".getErrorThread(ps_";
  protected final String TEXT_286 = ", errorMsg_";
  protected final String TEXT_287 = ");" + NL + "            error_";
  protected final String TEXT_288 = ".start();" + NL + "" + NL + "            result_";
  protected final String TEXT_289 = " = ps_";
  protected final String TEXT_290 = ".waitFor();" + NL + "            normal_";
  protected final String TEXT_291 = ".join();" + NL + "            error_";
  protected final String TEXT_292 = ".join();" + NL + "        } catch (ThreadDeath tde) {" + NL + "globalMap.put(\"";
  protected final String TEXT_293 = "_ERROR_MESSAGE\",tde.getMessage());";
  protected final String TEXT_294 = NL + "            \tlog.error(\"";
  protected final String TEXT_295 = " - thread was terminated.\");";
  protected final String TEXT_296 = NL + "            ps_";
  protected final String TEXT_297 = ".destroy();" + NL + "            throw tde;" + NL + "        }" + NL + "" + NL + "\t\tglobalMap.put(\"";
  ...
  protected final String TEXT_308 = ".toString());" + NL + "\t\t\t\t";
  protected final String TEXT_309 = NL + "\t\t\t\tSystem.err.println(\"Child job returns \" + result_";
  protected final String TEXT_310 = NL + "  \t\t}" + NL + "" + NL + "\t\t";
  protected final String TEXT_311 = NL + "  \t\t\t\tSystem.err.println(\"when tRunJob runs in an independent process, it can't extract datas from tBufferOutput of child job.\"); " + NL + "\t\t\t";
