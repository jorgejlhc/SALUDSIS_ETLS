...
public class Component_part_headerJava
{
  ...
  protected final String TEXT_64 = NL + "\t\t\tcLabel=\"";
  protected final String TEXT_65 = "\";" + NL + "\t\t";
  protected final String TEXT_66 = NL + "\t\t\tif(";
  protected final String TEXT_67 = "execStat";
  protected final String TEXT_68 = " || ";
  protected final String TEXT_69 = "enableLogStash";
  protected final String TEXT_70 = ") {" + NL + "\t\t\t\trunStat.updateStatOnConnectionAndLog(resourceMap,globalMap,iterateLoop,iterateId,";
  protected final String TEXT_71 = "false";
  protected final String TEXT_72 = ",enableLogStash,0";
  protected final String TEXT_73 = ",\"";
  protected final String TEXT_74 = "\"";
  protected final String TEXT_75 = ");" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_76 = NL + "\t\t\trunStat.updateStatAndLog(execStat,enableLogStash,resourceMap,iterateId,0,0";
  protected final String TEXT_77 = ");" + NL + "\t\t\t";
  protected final String TEXT_78 = NL + "\t\t\t\t\tif(execStat) {" + NL + "\t\t\t\t\t\trunStat.updateStatOnConnection(resourceMap,iterateId,0,0";
  protected final String TEXT_79 = ");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_80 = NL + "\t\t\t\t\tif(enableLogStash) {" + NL + "\t\t\t\t\t\trunStat.log(resourceMap,iterateId,0,0";
  protected final String TEXT_81 = NL + "\t\t\tif(runStat.update(execStat,enableLogStash,iterateId,1,1" + NL + "\t\t\t\t";
  protected final String TEXT_82 = NL + "\t\t\t\t\t,\"";
  protected final String TEXT_83 = "\",\"";
  protected final String TEXT_84 = "\"" + NL + "\t\t\t\t";
  protected final String TEXT_85 = NL + "\t\t\t)) {" + NL + "\t\t\t\t";
  protected final String TEXT_86 = "Process(globalMap);" + NL + "\t\t\t}" + NL + "\t\t\t";
  protected final String TEXT_87 = NL + "\t\t\t\t\tif(execStat){" + NL + "\t\t\t\t\t\trunStat.updateStatOnConnection(iterateId,1,1" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_88 = NL + "\t\t\t\t\t\t\t,\"";
  protected final String TEXT_89 = "\"" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_90 = NL + "\t\t\t\t\t\t);" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_91 = NL + "\t\t\t\t\tif(enableLogStash) {" + NL + "\t\t\t\t\t\tif(runStat.updateLog(iterateId,1,1" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_92 = NL + "\t\t\t\t\t\t)) {" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_93 = "Process(globalMap);" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_94 = NL + "\t\t\t\t\tif(runStat.update(execStat,enableLogStash,iterateId,1,1" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_95 = "\"" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_96 = NL + "\t\t\t\t\t)) {" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_97 = "Process(globalMap);" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t\t";
  protected final String TEXT_98 = NL + "\t\t\t\t\t\tif(execStat){" + NL + "\t\t\t\t\t\t\trunStat.updateStatOnConnection(iterateId,1,1" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_99 = NL + "\t\t\t\t\t\t\t\t\t,\"";
  protected final String TEXT_100 = "\"" + NL + "\t\t\t\t\t\t\t\t\t";
  protected final String TEXT_101 = NL + "\t\t\t\t\t\t\t);" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_102 = NL + "\t\t\t\t\t\tif(enableLogStash) {" + NL + "\t\t\t\t\t\t\tif(runStat.updateLog(iterateId,1,1" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_103 = NL + "\t\t\t\t\t\t\t)) {" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_104 = "Process(globalMap);" + NL + "\t\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_105 = NL + "    \t\t\tif(log.isTraceEnabled()){" + NL + "    \t\t\t\tlog.trace(\"";
  protected final String TEXT_106 = " - \" + (";
  protected final String TEXT_107 = "==null? \"\": ";
  protected final String TEXT_108 = ".toLogString()));" + NL + "    \t\t\t}" + NL + "    \t\t";
  protected final String TEXT_109 = NL + "\t\tint tos_count_";
  protected final String TEXT_110 = " = 0;" + NL + "\t\t";
  protected final String TEXT_111 = NL + "\t\tclass ParameterUtil_";
  protected final String TEXT_112 = "{" + NL + "\t\t" + NL + "            public java.util.Map<String, String> getParameter() throws Exception{" + NL + "                java.util.Map<String, String> component_parameters = new java.util.HashMap<>();";
  protected final String TEXT_113 = NL;
  protected final String TEXT_114 = NL + "                        component_parameters.put(\"";
  ...
  protected final String TEXT_121 = NL + "                    component_parameters.put(\"";
  protected final String TEXT_122 = "\", String.valueOf(";
  protected final String TEXT_123 = NL + "                return component_parameters;" + NL + "            }" + NL + "        }" + NL + "        ";
  protected final String TEXT_124 = NL + "        ";
  protected final String TEXT_125 = ".addComponentParameterMessage(\"";
  protected final String TEXT_126 = "\", \"";
  protected final String TEXT_127 = "\"," + NL + "          new ParameterUtil_";
  protected final String TEXT_128 = "().getParameter());";
  protected final String TEXT_129 = "Process(globalMap);" + NL + "\t\t";
  protected final String TEXT_130 = NL + "\t\t\tif(enableLogStash) {" + NL + "\t\t\t\t";
  protected final String TEXT_131 = ".addCM(\"";
  protected final String TEXT_132 = NL + "\t\t\t\tif(";
  protected final String TEXT_133 = "){" + NL + "\t\t\t\t\trunStat.updateStatOnConnectionAndLog(globalMap,iterateLoop,iterateId,";
  protected final String TEXT_134 = ");" + NL + "\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_135 = NL + "\t\t\t\t\trunStat.updateStatAndLog(execStat,enableLogStash,iterateId,0,0";
  protected final String TEXT_136 = ");" + NL + "\t\t\t\t\t";
  protected final String TEXT_137 = NL + "\t\t\t\t\t\tif(execStat){" + NL + "\t\t\t\t\t\t\trunStat.updateStatOnConnection(iterateId,0,0";
  protected final String TEXT_138 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_139 = NL + "\t\t\t\t\t\t" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_140 = NL + "\t\t\t\t\t\tif(enableLogStash){" + NL + "\t\t\t\t\t\t\trunStat.log(iterateId,0,0";
  protected final String TEXT_141 = NL + "\t\t\t\tresourceMap.put(\"inIterateVComp\", true);" + NL + "\t\t\t";
  protected final String TEXT_142 = NL + "\t\t\t\tresourceMap.remove(\"inIterateVComp\");" + NL + "\t\t\t";
  protected final String TEXT_143 = NL + "\t\t\t\t\t\tresourceMap.remove(\"inIterateVComp\");" + NL + "\t\t\t\t\t";
  protected final String TEXT_144 = NL + "\t\t\t\t\t\tresourceMap.put(\"inIterateVComp\", true);" + NL + "\t\t\t\t\t";
...
LogUtil log = null;
    ...
    stringBuffer.append(NodeUtil.getLabel(node));
