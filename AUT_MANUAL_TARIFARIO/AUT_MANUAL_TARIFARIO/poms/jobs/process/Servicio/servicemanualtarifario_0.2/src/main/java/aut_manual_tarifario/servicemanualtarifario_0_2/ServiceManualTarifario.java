...
package aut_manual_tarifario.servicemanualtarifario_0_2;
...
/**
 * Job: ServiceManualTarifario Purpose: <br>
 * Description:  <br>
 * @author jorgejlhc@gmail.com
 * @version 8.8.8.20240722_1936-SNAPSHOT
 * @status 
 */
public class ServiceManualTarifario implements TalendJob {
...
public Integer getIdSolicitud(){
	...
	private final String jobName = "ServiceManualTarifario";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ServiceManualTarifario.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ServiceManualTarifario.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class RestServiceProviderImpl4TalendJob {
	...
	private final ServiceManualTarifario job;

	public RestServiceProviderImpl4TalendJob(ServiceManualTarifario job) {
		this.job = job;
	}

	private void populateRequestWithJobContext(java.util.Map<String, Object> requestGlobalMap, ServiceManualTarifario job) {
...
class Thread4RestServiceProviderEndpoint extends Thread {
	...
	public Thread4RestServiceProviderEndpoint(ServiceManualTarifario job, String endpointUrl) {
		this.job = job;
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression, String jobName)
			...
			java.io.InputStream inContext = ServiceManualTarifario.class.getClassLoader()
					.getResourceAsStream("aut_manual_tarifario/servicemanualtarifario_0_2/contexts/" + currentContext  + ".properties");
			if (inContext == null) {
				inContext = ServiceManualTarifario.class.getClassLoader()
...
public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
    final static byte[] commonByteArrayLock_AUT_MANUAL_TARIFARIO_ServiceManualTarifario = new byte[0];
    static byte[] commonByteArray_AUT_MANUAL_TARIFARIO_ServiceManualTarifario = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_AUT_MANUAL_TARIFARIO_ServiceManualTarifario) {
...
public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_AUT_MANUAL_TARIFARIO_ServiceManualTarifario.length) {
				if(length < 1024 && commonByteArray_AUT_MANUAL_TARIFARIO_ServiceManualTarifario.length == 0) {
   					commonByteArray_AUT_MANUAL_TARIFARIO_ServiceManualTarifario = new byte[1024];
				} else {
   					commonByteArray_AUT_MANUAL_TARIFARIO_ServiceManualTarifario = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_AUT_MANUAL_TARIFARIO_ServiceManualTarifario, 0, length);
			strReturn = new String(commonByteArray_AUT_MANUAL_TARIFARIO_ServiceManualTarifario, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_AUT_MANUAL_TARIFARIO_ServiceManualTarifario, 0, length);
			strReturn = new String(commonByteArray_AUT_MANUAL_TARIFARIO_ServiceManualTarifario, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
if (needRoot) {
	needRoot=false;
		...
		valueMap.put("root_1","Proceso de manual tarifario ejecuctado satisfactoriamente");
...
if (needRoot) {
	needRoot=false;
		...
		org.dom4j.Element root_1 = null;
				root_1 = root.addElement("Message");
		valueMap.put("root_1","Error en el llamado del ETL de manual tarifario");
		if(valueMap.get("root_1")!=null) {
			routines.system.NestXMLTool.setText(root_1,FormatterUtils.fm(valueMap.get("root_1"),null));
		}
		org.dom4j.Element root_2 = null;
...
if (needRoot) {
	needRoot=false;
		...
		org.dom4j.Element root_1 = null;
				root_1 = root.addElement("Message");
		valueMap.put("root_1","El identificador del anexo no puede ser nulo");
		if(valueMap.get("root_1")!=null) {
			routines.system.NestXMLTool.setText(root_1, FormatterUtils.fm(valueMap.get("root_1"),null));
		}
		org.dom4j.Element root_2 = null;
...
if(in != null) { 
	...
	boolean isMatchDocRowtXMLMap_4_TXMLMAP_OUT = false;
				...
				absolutePathMappings_tXMLMap_4_TXMLMAP_OUT[0] = "in.body:/root/AnexosId";
				relativePathMappings_tXMLMap_4_TXMLMAP_OUT[0] = "AnexosId";
...
treeNodeAPI_tXMLMap_4_TXMLMAP_OUT.get_String("in.body:/root/AnexosId") != null

 ) {

RequestOK_tmp = new RequestOKStruct();
RequestOK_tmp.IdSolicitud = treeNodeAPI_tXMLMap_4_TXMLMAP_OUT.get_String("in.body:/root/AnexosId");allOutsForAggregate_tXMLMap_4.add(RequestOK_tmp);
	...
	Object obj_tRunJob_1 = null;
		...
		if(obj_tRunJob_1!=null) {
			if (obj_tRunJob_1.getClass().getName().equals("java.util.Date")) {
				paraList_tRunJob_1.add("--context_param AnexosId=" + ((java.util.Date) obj_tRunJob_1).getTime());
			} else {
				
					paraList_tRunJob_1.add("--context_param AnexosId=" + RuntimeUtils.tRunJobConvertContext(obj_tRunJob_1));
					
				
			}
		} else {
			paraList_tRunJob_1.add("--context_param AnexosId=" + NULL_VALUE_EXPRESSION_IN_COMMAND_STRING_FOR_CHILD_JOB_ONLY);
		}
		
		parentContextMap_tRunJob_1.put("AnexosId", obj_tRunJob_1);
	
	
		aut_manual_tarifario.manualtarifario_0_1.ManualTarifario childJob_tRunJob_1 = new aut_manual_tarifario.manualtarifario_0_1.ManualTarifario();
	    // pass DataSources
 ...
 */
    ...
    public static void main(String[] args){
        final ServiceManualTarifario ServiceManualTarifarioClass = new ServiceManualTarifario();

        int exitCode = ServiceManualTarifarioClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ServiceManualTarifario.class.getClassLoader().getResourceAsStream("aut_manual_tarifario/servicemanualtarifario_0_2/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = ServiceManualTarifario.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ServiceManualTarifario");
        }
...
/************************************************************************************************
 *     212574 characters generated by Talend Open Studio for ESB 
